...
//! This documentation was generated from *Data Catalog* crate version *3.0.0+20220224*, where *20220224* is the exact revision of the *datacatalog:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.0*.
//! 
