...
use google_pagespeedonline2::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "pagespeedonline2-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/pagespeedonline2", config_dir))
        .build()
        .await
        .unwrap();
