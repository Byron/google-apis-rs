...
//! This documentation was generated from *Home Graph Service* crate version *7.0.0+20251218*, where *20251218* is the exact revision of the *homegraph:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
