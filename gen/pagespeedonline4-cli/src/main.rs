...
extern crate mime;
extern crate strsim;
extern crate google_pagespeedonline4 as api;
...
impl<'n> Engine<'n> {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           ...
                                                                           v.extend(["utm-campaign", "screenshot", "locale", "rule", "strategy", "snapshots", "filter-third-party-resources", "utm-source"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "pagespeedonline4-secret.json",
