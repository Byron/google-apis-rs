...
pub struct ProjectAppAppAttestConfigPatchCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaAppAttestConfig,
   pub(super) _name: String,
...
pub struct ProjectAppDebugTokenCreateCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaDebugToken,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppDeviceCheckConfigPatchCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaDeviceCheckConfig,
   pub(super) _name: String,
   pub(super) _update_mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct ProjectAppPlayIntegrityConfigPatchCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaPlayIntegrityConfig,
   pub(super) _name: String,
   pub(super) _update_mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct ProjectAppRecaptchaConfigPatchCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaRecaptchaConfig,
   pub(super) _name: String,
   pub(super) _update_mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct ProjectAppRecaptchaEnterpriseConfigPatchCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaRecaptchaEnterpriseConfig,
   pub(super) _name: String,
   pub(super) _update_mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct ProjectAppRecaptchaV3ConfigPatchCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaRecaptchaV3Config,
   pub(super) _name: String,
   pub(super) _update_mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct ProjectAppSafetyNetConfigPatchCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaSafetyNetConfig,
   pub(super) _name: String,
   pub(super) _update_mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct ProjectAppExchangeAppAttestAssertionCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ProjectAppExchangeAppAttestAttestationCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaExchangeAppAttestAttestationRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppExchangeCustomTokenCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaExchangeCustomTokenRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppExchangeDebugTokenCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaExchangeDebugTokenRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppExchangeDeviceCheckTokenCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaExchangeDeviceCheckTokenRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppExchangePlayIntegrityTokenCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaExchangePlayIntegrityTokenRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppExchangeRecaptchaEnterpriseTokenCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaExchangeRecaptchaEnterpriseTokenRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppExchangeRecaptchaTokenCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppExchangeRecaptchaV3TokenCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaExchangeRecaptchaV3TokenRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppExchangeSafetyNetTokenCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppGenerateAppAttestChallengeCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaGenerateAppAttestChallengeRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectAppGeneratePlayIntegrityChallengeCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaGeneratePlayIntegrityChallengeRequest,
   pub(super) _app: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectServiceBatchUpdateCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaBatchUpdateServicesRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectServicePatchCall<'a, S>
   ...
   pub(super) hub: &'a Firebaseappcheck<S>,
   pub(super) _request: GoogleFirebaseAppcheckV1betaService,
   pub(super) _name: String,
   pub(super) _update_mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
