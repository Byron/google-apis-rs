...
impl<C> common::Hub for AnalyticsReporting<C> {}

impl<'a, C> AnalyticsReporting<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> AnalyticsReporting<C> {
        AnalyticsReporting {
            client,
            auth: Box::new(auth),
...
pub struct Activity {
    ...
    pub activity_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::Part for CohortGroup {}
...
impl common::Part for ColumnHeader {}
...
impl common::Part for DateRangeValues {}
...
impl common::Part for DimensionFilterClause {}
...
impl common::Part for DynamicSegment {}
...
impl common::Part for EcommerceData {}
...
impl common::RequestValue for GetReportsRequest {}
...
impl common::ResponseResult for GetReportsResponse {}
...
impl common::Part for GoalSetData {}
...
impl common::Part for MetricFilter {}
...
impl common::Part for MetricFilterClause {}
...
impl common::Part for MetricHeaderEntry {}
...
impl common::Part for OrFiltersForSegment {}
...
impl common::Part for PageviewData {}
...
impl common::Part for PivotHeaderEntry {}
...
impl common::Part for PivotValueRegion {}
...
impl common::Part for ProductData {}
...
pub struct ReportData {
    ...
    pub data_last_refreshed: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::Part for ReportData {}
...
impl common::Part for ReportRequest {}
...
impl common::Part for ResourceQuotasRemaining {}
...
impl common::Part for ScreenviewData {}
...
impl common::RequestValue for SearchUserActivityRequest {}
...
impl common::ResponseResult for SearchUserActivityResponse {}
...
impl common::Part for SegmentDefinition {}
...
impl common::Part for SegmentDimensionFilter {}
...
impl common::Part for SegmentFilter {}
...
impl common::Part for SegmentFilterClause {}
...
impl common::Part for SegmentMetricFilter {}
...
impl common::Part for SegmentSequenceStep {}
...
impl common::Part for SequenceSegment {}
...
impl common::Part for SimpleSegment {}
...
impl common::Part for TransactionData {}
...
impl common::Part for UserActivitySession {}
...
impl<'a, C> common::MethodsBuilder for UserActivityMethods<'a, C> {}
...
impl<'a, C> common::CallBuilder for ReportBatchGetCall<'a, C> {}

impl<'a, C> ReportBatchGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, GetReportsResponse)> {
        use std::borrow::Cow;
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ReportBatchGetCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ReportBatchGetCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ReportBatchGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for UserActivitySearchCall<'a, C> {}

impl<'a, C> UserActivitySearchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SearchUserActivityResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: SearchUserActivityRequest,
    ) -> UserActivitySearchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserActivitySearchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserActivitySearchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserActivitySearchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
