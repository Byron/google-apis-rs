...
impl<C> common::Hub for SemanticTile<C> {}
...
impl common::Part for BasemapZOrder {}
...
impl common::Part for ExtrudedArea {}
...
impl common::Resource for FeatureTile {}
impl common::ResponseResult for FeatureTile {}
...
impl common::Part for FirstDerivativeElevationGrid {}
...
impl common::Part for ModeledVolume {}
...
impl common::Part for ProviderInfo {}
...
impl common::Part for SecondDerivativeElevationGrid {}
...
impl common::Resource for TerrainTile {}
impl common::ResponseResult for TerrainTile {}
...
impl common::Part for TileCoordinates {}
...
impl common::Part for TriangleStrip {}
...
impl common::Part for Vertex2DList {}
...
impl common::Part for Vertex3DList {}
...
impl<'a, C> common::MethodsBuilder for FeaturetileMethods<'a, C> {}
...
impl<'a, C> common::MethodsBuilder for TerraintileMethods<'a, C> {}
...
impl<'a, C> common::CallBuilder for FeaturetileGetCall<'a, C> {}

impl<'a, C> FeaturetileGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, FeatureTile)> {
        use std::borrow::Cow;
    ...
    pub fn always_include_building_footprints(
        mut self,
        new_value: bool,
    ) -> FeaturetileGetCall<'a, C> {
...
impl<'a, C> common::CallBuilder for TerraintileGetCall<'a, C> {}

impl<'a, C> TerraintileGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, TerrainTile)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("name", self._name);
        if !self._terrain_formats.is_empty() {
