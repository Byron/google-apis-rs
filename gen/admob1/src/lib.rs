...
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.AdMob.html) ... 
//! 
//! * accounts
//!  * [*get*](struct.AccountGetCall.html), [*list*](struct.AccountListCall.html), [*mediation report generate*](struct.AccountMediationReportGenerateCall.html) and [*network report generate*](struct.AccountNetworkReportGenerateCall.html)
//! 
//! 
//! 
//! 
...
impl<'a, C, A> Hub for AdMob<C, A> {}

impl<'a, C, A> AdMob<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> AdMob<C, A> {
        AdMob {
...
impl Part for NetworkReportSpecDimensionFilter {}
...
impl Part for MediationReportSpecDimensionFilter {}
...
/// 
/// * [mediation report generate accounts](struct.AccountMediationReportGenerateCall.html) (response)
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl ResponseResult for GenerateMediationReportResponse {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [network report generate accounts](struct.AccountNetworkReportGenerateCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl RequestValue for GenerateNetworkReportRequest {}
...
impl Part for LocalizationSettings {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [mediation report generate accounts](struct.AccountMediationReportGenerateCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl RequestValue for GenerateMediationReportRequest {}
...
impl Part for MediationReportSpecSortCondition {}
...
impl ResponseResult for ListPublisherAccountsResponse {}
...
impl Part for NetworkReportSpecSortCondition {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [network report generate accounts](struct.AccountNetworkReportGenerateCall.html) (response)
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl ResponseResult for GenerateNetworkReportResponse {}
...
impl Part for ReportRowMetricValue {}
...
impl Part for ReportRowDimensionValue {}
...
impl Part for MediationReportSpec {}
...
impl<'a, C, A> AccountMethods<'a, C, A> {
    ...
    /// # Arguments
    ///
    /// * `name` - Required. Resource name of the publisher account to retrieve.
    ///            Example: accounts/pub-9876543210987654
    pub fn get(&self, name: &str) -> AccountGetCall<'a, C, A> {
        AccountGetCall {
            hub: self.hub,
    ...
    ///              Example: accounts/pub-9876543210987654
    pub fn network_report_generate(&self, request: GenerateNetworkReportRequest, parent: &str) -> AccountNetworkReportGenerateCall<'a, C, A> {
    ...
    /// * `parent` - Resource name of the account to generate the report for.
    ///              Example: accounts/pub-9876543210987654
    pub fn mediation_report_generate(&self, request: GenerateMediationReportRequest, parent: &str) -> AccountMediationReportGenerateCall<'a, C, A> {
...
impl<'a, C, A> AccountListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListPublisherAccountsResponse)> {
        ...
        dlg.begin(MethodInfo { id: "admob.accounts.list",
    ...
    pub fn page_size(mut self, new_value: i32) -> AccountListCall<'a, C, A> {
...
impl<'a, C, A> AccountGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, PublisherAccount)> {
        ...
        dlg.begin(MethodInfo { id: "admob.accounts.get",
                               http_method: hyper::method::Method::Get });
    ...
    pub fn name(mut self, new_value: &str) -> AccountGetCall<'a, C, A> {
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_admob1 as admob1;
/// use admob1::GenerateNetworkReportRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use admob1::AdMob;
...
/// # }
/// ```
pub struct AccountNetworkReportGenerateCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for AccountNetworkReportGenerateCall<'a, C, A> {}

impl<'a, C, A> AccountNetworkReportGenerateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, GenerateNetworkReportResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{ContentType, ContentLength, Authorization, Bearer, UserAgent, Location};
        let mut dd = DefaultDelegate;
        ...
        dlg.begin(MethodInfo { id: "admob.accounts.networkReport.generate",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GenerateNetworkReportRequest) -> AccountNetworkReportGenerateCall<'a, C, A> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> AccountNetworkReportGenerateCall<'a, C, A> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> AccountNetworkReportGenerateCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> AccountNetworkReportGenerateCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_admob1 as admob1;
/// use admob1::GenerateMediationReportRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use admob1::AdMob;
...
/// # }
/// ```
pub struct AccountMediationReportGenerateCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for AccountMediationReportGenerateCall<'a, C, A> {}

impl<'a, C, A> AccountMediationReportGenerateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, GenerateMediationReportResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{ContentType, ContentLength, Authorization, Bearer, UserAgent, Location};
        let mut dd = DefaultDelegate;
        ...
        dlg.begin(MethodInfo { id: "admob.accounts.mediationReport.generate",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GenerateMediationReportRequest) -> AccountMediationReportGenerateCall<'a, C, A> {
        self._request = new_value;
        self
    }
    /// Resource name of the account to generate the report for.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> AccountMediationReportGenerateCall<'a, C, A> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> AccountMediationReportGenerateCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> AccountMediationReportGenerateCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
