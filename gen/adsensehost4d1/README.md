...
This documentation was generated from *AdSense Host* crate version *0.1.9+20151013*, where *20151013* is the exact revision of the *adsensehost:v4.1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.9*.
