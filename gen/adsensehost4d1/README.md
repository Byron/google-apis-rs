...
This documentation was generated from *AdSense Host* crate version *0.1.15+20160907*, where *20160907* is the exact revision of the *adsensehost:v4.1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.15*.
