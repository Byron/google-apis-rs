...
//! This documentation was generated from *Access Approval* crate version *7.0.0+20251205*, where *20251205* is the exact revision of the *accessapproval:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
