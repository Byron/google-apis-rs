...
//! This documentation was generated from *Access Approval* crate version *2.0.4+20210318*, where *20210318* is the exact revision of the *accessapproval:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.4*.
//! 
