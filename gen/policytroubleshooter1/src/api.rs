...
impl<C> common::Hub for PolicyTroubleshooter<C> {}

impl<'a, C> PolicyTroubleshooter<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> PolicyTroubleshooter<C> {
...
impl common::Part for GoogleCloudPolicytroubleshooterV1AccessTuple {}
...
pub struct GoogleCloudPolicytroubleshooterV1BindingExplanation {
    ...
    pub memberships: Option<
        HashMap<String, GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership>,
    >,
...
impl common::Part for GoogleCloudPolicytroubleshooterV1BindingExplanation {}
...
impl common::Part for GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership {}
...
impl common::Part for GoogleCloudPolicytroubleshooterV1ExplainedPolicy {}
...
impl common::RequestValue for GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest {}
...
impl common::ResponseResult for GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse {}
...
impl<'a, C> common::MethodsBuilder for IamMethods<'a, C> {}
...
impl<'a, C> IamMethods<'a, C> {
    ...
    pub fn troubleshoot(
        &self,
        request: GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest,
    ) -> IamTroubleshootCall<'a, C> {
        IamTroubleshootCall {
            hub: self.hub,
            _request: request,
...
impl<'a, C> common::CallBuilder for IamTroubleshootCall<'a, C> {}

impl<'a, C> IamTroubleshootCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest,
    ) -> IamTroubleshootCall<'a, C> {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> IamTroubleshootCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> IamTroubleshootCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> IamTroubleshootCall<'a, C> {
        self._scopes.clear();
        self
    }
}
