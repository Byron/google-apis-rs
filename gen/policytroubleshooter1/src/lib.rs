...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/policytroubleshooter1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.PolicyTroubleshooter.html) ... 
//! 
//! * iam
//!  * [*troubleshoot*](struct.IamTroubleshootCall.html)
//! 
//! 
//! 
//! 
...
//! 
//! * **[Hub](struct.PolicyTroubleshooter.html)**
...
/// # }
/// ```
pub struct PolicyTroubleshooter<C, A> {
    client: RefCell<C>,
    auth: RefCell<A>,
    _user_agent: String,
    _base_url: String,
...
impl<'a, C, A> Hub for PolicyTroubleshooter<C, A> {}

impl<'a, C, A> PolicyTroubleshooter<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> PolicyTroubleshooter<C, A> {
    ...
    pub fn iam(&'a self) -> IamMethods<'a, C, A> {
        IamMethods { hub: &self }
    }
...
impl Part for GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership {}
...
impl Part for GoogleCloudPolicytroubleshooterV1ExplainedPolicy {}
...
impl Part for GoogleIamV1Policy {}
...
/// 
/// * [troubleshoot iam](struct.IamTroubleshootCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl ResponseResult for GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse {}
...
impl Part for GoogleCloudPolicytroubleshooterV1AccessTuple {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [troubleshoot iam](struct.IamTroubleshootCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl RequestValue for GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest {}
...
/// # }
/// ```
pub struct IamMethods<'a, C, A>
    where C: 'a, A: 'a {

    hub: &'a PolicyTroubleshooter<C, A>,
}

impl<'a, C, A> MethodsBuilder for IamMethods<'a, C, A> {}

impl<'a, C, A> IamMethods<'a, C, A> {
    ...
    pub fn troubleshoot(&self, request: GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest) -> IamTroubleshootCall<'a, C, A> {
        IamTroubleshootCall {
            hub: self.hub,
            _request: request,
...
/// # }
/// ```
pub struct IamTroubleshootCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for IamTroubleshootCall<'a, C, A> {}

impl<'a, C, A> IamTroubleshootCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse)> {
        ...
        dlg.begin(MethodInfo { id: "policytroubleshooter.iam.troubleshoot",
    ...
    pub fn request(mut self, new_value: GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest) -> IamTroubleshootCall<'a, C, A> {
    ...
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> IamTroubleshootCall<'a, C, A> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> IamTroubleshootCall<'a, C, A>
                                                        where T: AsRef<str> {
    ...
    pub fn add_scope<T, S>(mut self, scope: T) -> IamTroubleshootCall<'a, C, A>
