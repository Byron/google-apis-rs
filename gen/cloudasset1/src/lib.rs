...
//! This documentation was generated from *Cloud Asset* crate version *2.0.0+20210319*, where *20210319* is the exact revision of the *cloudasset:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.0*.
//! 
