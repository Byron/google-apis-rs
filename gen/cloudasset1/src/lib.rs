...
//! This documentation was generated from *Cloud Asset* crate version *8.0.0+20250822*, where *20250822* is the exact revision of the *cloudasset:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
