...
//! This documentation was generated from *Cloud Asset* crate version *6.0.0+20240621*, where *20240621* is the exact revision of the *cloudasset:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
