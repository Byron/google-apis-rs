...
//! This documentation was generated from *Cloud Asset* crate version *7.0.0+20251212*, where *20251212* is the exact revision of the *cloudasset:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
