...
pub struct FeedCreateCall<'a, S>
   ...
   pub(super) hub: &'a CloudAsset<S>,
   pub(super) _request: CreateFeedRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct FeedPatchCall<'a, S>
   ...
   pub(super) hub: &'a CloudAsset<S>,
   pub(super) _request: UpdateFeedRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct SavedQueryCreateCall<'a, S>
   ...
   pub(super) hub: &'a CloudAsset<S>,
   pub(super) _request: SavedQuery,
   pub(super) _parent: String,
   pub(super) _saved_query_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MethodAnalyzeIamPolicyCall<'a, S>
   ...
   pub(super) hub: &'a CloudAsset<S>,
   pub(super) _scope: String,
   pub(super) _saved_analysis_query: Option<String>,
   pub(super) _execution_timeout: Option<client::chrono::Duration>,
   pub(super) _analysis_query_resource_selector_full_resource_name: Option<String>,
   pub(super) _analysis_query_options_output_resource_edges: Option<bool>,
   pub(super) _analysis_query_options_output_group_edges: Option<bool>,
   pub(super) _analysis_query_options_expand_roles: Option<bool>,
   pub(super) _analysis_query_options_expand_resources: Option<bool>,
   pub(super) _analysis_query_options_expand_groups: Option<bool>,
   pub(super) _analysis_query_options_analyze_service_account_impersonation: Option<bool>,
   pub(super) _analysis_query_identity_selector_identity: Option<String>,
   pub(super) _analysis_query_condition_context_access_time: Option<client::chrono::DateTime<client::chrono::offset::Utc>>,
   pub(super) _analysis_query_access_selector_roles: Vec<String>,
   pub(super) _analysis_query_access_selector_permissions: Vec<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MethodAnalyzeIamPolicyLongrunningCall<'a, S>
   ...
   pub(super) hub: &'a CloudAsset<S>,
   pub(super) _request: AnalyzeIamPolicyLongrunningRequest,
   pub(super) _scope: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct MethodAnalyzeOrgPolicyCall<'a, S>
   ...
   pub(super) _page_size: Option<i32>,
   pub(super) _filter: Option<String>,
   pub(super) _constraint: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct MethodExportAssetCall<'a, S>
   ...
   pub(super) hub: &'a CloudAsset<S>,
   pub(super) _request: ExportAssetsRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct MethodQueryAssetCall<'a, S>
   ...
   pub(super) hub: &'a CloudAsset<S>,
   pub(super) _request: QueryAssetsRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
