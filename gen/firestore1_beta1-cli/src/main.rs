...
extern crate mime;
extern crate strsim;
extern crate google_firestore1_beta1 as api;
...
impl<'n> Engine<'n> {
    ...
    fn _projects_databases_indexes_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_databases_indexes_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_databases_indexes_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_databases_indexes_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
            ...
            ("projects", Some(opt)) => {
                match opt.subcommand() {
                    ...
                    ("databases-indexes-create", Some(opt)) => {
                        call_result = self._projects_databases_indexes_create(opt, dry_run, &mut err);
                    },
                    ("databases-indexes-delete", Some(opt)) => {
                        call_result = self._projects_databases_indexes_delete(opt, dry_run, &mut err);
                    },
                    ("databases-indexes-get", Some(opt)) => {
                        call_result = self._projects_databases_indexes_get(opt, dry_run, &mut err);
                    },
                    ("databases-indexes-list", Some(opt)) => {
                        call_result = self._projects_databases_indexes_list(opt, dry_run, &mut err);
                    },
                    _ => {
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "firestore1-beta1-secret.json",
    ...
    let arg_data = [
        ...
        Indexes with a single field cannot be created."##),
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"The name of the database this index will apply to. For example:
        `projects/{project_id}/databases/{database_id}`"##),
                     Some(true),
                     Some(false)),
            ...
            ("databases-indexes-delete",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The index name. For example:
        `projects/{project_id}/databases/{database_id}/indexes/{index_id}`"##),
            ...
            ("databases-indexes-get",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The name of the index. For example:
        `projects/{project_id}/databases/{database_id}/indexes/{index_id}`"##),
                     Some(true),
                     Some(false)),
            ...
            ("databases-indexes-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"The database name. For example:
        `projects/{project_id}/databases/{database_id}`"##),
                     Some(true),
                     Some(false)),
