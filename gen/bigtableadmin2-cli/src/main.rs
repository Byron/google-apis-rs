...
use google_bigtableadmin2::{api, Error, oauth2, client::chrono, FieldMask};
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    async fn _operations_projects_operations_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_app_profiles_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["app-profile-id", "ignore-warnings"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    async fn _projects_instances_app_profiles_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_app_profiles_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_app_profiles_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_app_profiles_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_clusters_backups_copy(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["backup-id", "expire-time", "source-backup"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut call = self.hub.projects().instances_clusters_backups_copy(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_instances_clusters_backups_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "source-backup" => Some(("sourceBackup", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "source-table" => Some(("sourceTable", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "start-time" => Some(("startTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "state" => Some(("state", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["code", "encryption-info", "encryption-status", "encryption-type", "end-time", "expire-time", "kms-key-version", "message", "name", "size-bytes", "source-backup", "source-table", "start-time", "state"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut call = self.hub.projects().instances_clusters_backups_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "backup-id" => {
    ...
    async fn _projects_instances_clusters_backups_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().instances_clusters_backups_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_instances_clusters_backups_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().instances_clusters_backups_get(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_instances_clusters_backups_get_iam_policy(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_clusters_backups_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().instances_clusters_backups_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    async fn _projects_instances_clusters_backups_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Backup = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().instances_clusters_backups_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "update-mask" => {
    ...
    async fn _projects_instances_clusters_backups_set_iam_policy(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_clusters_backups_test_iam_permissions(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_clusters_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "cluster-config.cluster-autoscaling-config.autoscaling-limits.max-serve-nodes" => Some(("clusterConfig.clusterAutoscalingConfig.autoscalingLimits.maxServeNodes", JsonTypeInfo { jtype: JsonType::Int, ctype: ComplexType::Pod })),
                    "cluster-config.cluster-autoscaling-config.autoscaling-limits.min-serve-nodes" => Some(("clusterConfig.clusterAutoscalingConfig.autoscalingLimits.minServeNodes", JsonTypeInfo { jtype: JsonType::Int, ctype: ComplexType::Pod })),
                    "cluster-config.cluster-autoscaling-config.autoscaling-targets.cpu-utilization-percent" => Some(("clusterConfig.clusterAutoscalingConfig.autoscalingTargets.cpuUtilizationPercent", JsonTypeInfo { jtype: JsonType::Int, ctype: ComplexType::Pod })),
                    "cluster-config.cluster-autoscaling-config.autoscaling-targets.storage-utilization-gib-per-node" => Some(("clusterConfig.clusterAutoscalingConfig.autoscalingTargets.storageUtilizationGibPerNode", JsonTypeInfo { jtype: JsonType::Int, ctype: ComplexType::Pod })),
                    ...
                    "state" => Some(("state", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["autoscaling-limits", "autoscaling-targets", "cluster-autoscaling-config", "cluster-config", "cpu-utilization-percent", "default-storage-type", "encryption-config", "kms-key-name", "location", "max-serve-nodes", "min-serve-nodes", "name", "serve-nodes", "state", "storage-utilization-gib-per-node"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
    ...
    async fn _projects_instances_clusters_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_clusters_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_clusters_hot_tablets_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().instances_clusters_hot_tablets_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "start-time" => {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["end-time", "page-size", "page-token", "start-time"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    async fn _projects_instances_clusters_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_clusters_partial_update_cluster(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Cluster = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().instances_clusters_partial_update_cluster(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "update-mask" => {
    ...
    async fn _projects_instances_clusters_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "instance.satisfies-pzs" => Some(("instance.satisfiesPzs", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["create-time", "display-name", "instance", "instance-id", "labels", "name", "parent", "satisfies-pzs", "state", "type"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
    ...
    async fn _projects_instances_partial_update_instance(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["create-time", "display-name", "labels", "name", "satisfies-pzs", "state", "type"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
    ...
    async fn _projects_instances_tables_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "table.restore-info.backup-info.backup" => Some(("table.restoreInfo.backupInfo.backup", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "table.restore-info.backup-info.end-time" => Some(("table.restoreInfo.backupInfo.endTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "table.restore-info.backup-info.source-backup" => Some(("table.restoreInfo.backupInfo.sourceBackup", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "table.restore-info.backup-info.source-table" => Some(("table.restoreInfo.backupInfo.sourceTable", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "table.restore-info.backup-info.start-time" => Some(("table.restoreInfo.backupInfo.startTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "table.restore-info.source-type" => Some(("table.restoreInfo.sourceType", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "table.stats.average-cells-per-column" => Some(("table.stats.averageCellsPerColumn", JsonTypeInfo { jtype: JsonType::Float, ctype: ComplexType::Pod })),
                    "table.stats.average-columns-per-row" => Some(("table.stats.averageColumnsPerRow", JsonTypeInfo { jtype: JsonType::Float, ctype: ComplexType::Pod })),
                    "table.stats.logical-data-bytes" => Some(("table.stats.logicalDataBytes", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
    ...
    async fn _projects_instances_tables_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_tables_drop_row_range(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_tables_generate_consistency_token(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_tables_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_tables_get_iam_policy(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_tables_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_tables_modify_column_families(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_tables_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "restore-info.backup-info.end-time" => Some(("restoreInfo.backupInfo.endTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "restore-info.backup-info.source-backup" => Some(("restoreInfo.backupInfo.sourceBackup", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "restore-info.backup-info.source-table" => Some(("restoreInfo.backupInfo.sourceTable", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "restore-info.backup-info.start-time" => Some(("restoreInfo.backupInfo.startTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "restore-info.source-type" => Some(("restoreInfo.sourceType", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "stats.average-cells-per-column" => Some(("stats.averageCellsPerColumn", JsonTypeInfo { jtype: JsonType::Float, ctype: ComplexType::Pod })),
                    "stats.average-columns-per-row" => Some(("stats.averageColumnsPerRow", JsonTypeInfo { jtype: JsonType::Float, ctype: ComplexType::Pod })),
        ...
        let mut call = self.hub.projects().instances_tables_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "update-mask" => {
    ...
    async fn _projects_instances_tables_restore(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "table-id" => Some(("tableId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["backup", "table-id"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::RestoreTableRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().instances_tables_restore(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_instances_tables_set_iam_policy(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_tables_test_iam_permissions(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_instances_tables_undelete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::UndeleteTableRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().instances_tables_undelete(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_instances_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
            ...
            ("operations", Some(opt)) => {
                match opt.subcommand() {
                    ...
                    ("projects-operations-list", Some(opt)) => {
                        call_result = self._operations_projects_operations_list(opt, dry_run, &mut err).await;
                    },
                    _ => {
            ...
            ("projects", Some(opt)) => {
                match opt.subcommand() {
                    ("instances-app-profiles-create", Some(opt)) => {
                        call_result = self._projects_instances_app_profiles_create(opt, dry_run, &mut err).await;
                    },
                    ("instances-app-profiles-delete", Some(opt)) => {
                        call_result = self._projects_instances_app_profiles_delete(opt, dry_run, &mut err).await;
                    },
                    ("instances-app-profiles-get", Some(opt)) => {
                        call_result = self._projects_instances_app_profiles_get(opt, dry_run, &mut err).await;
                    },
                    ("instances-app-profiles-list", Some(opt)) => {
                        call_result = self._projects_instances_app_profiles_list(opt, dry_run, &mut err).await;
                    },
                    ("instances-app-profiles-patch", Some(opt)) => {
                        call_result = self._projects_instances_app_profiles_patch(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-backups-copy", Some(opt)) => {
                        call_result = self._projects_instances_clusters_backups_copy(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-backups-create", Some(opt)) => {
                        call_result = self._projects_instances_clusters_backups_create(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-backups-delete", Some(opt)) => {
                        call_result = self._projects_instances_clusters_backups_delete(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-backups-get", Some(opt)) => {
                        call_result = self._projects_instances_clusters_backups_get(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-backups-get-iam-policy", Some(opt)) => {
                        call_result = self._projects_instances_clusters_backups_get_iam_policy(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-backups-list", Some(opt)) => {
                        call_result = self._projects_instances_clusters_backups_list(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-backups-patch", Some(opt)) => {
                        call_result = self._projects_instances_clusters_backups_patch(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-backups-set-iam-policy", Some(opt)) => {
                        call_result = self._projects_instances_clusters_backups_set_iam_policy(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-backups-test-iam-permissions", Some(opt)) => {
                        call_result = self._projects_instances_clusters_backups_test_iam_permissions(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-create", Some(opt)) => {
                        call_result = self._projects_instances_clusters_create(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-delete", Some(opt)) => {
                        call_result = self._projects_instances_clusters_delete(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-get", Some(opt)) => {
                        call_result = self._projects_instances_clusters_get(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-hot-tablets-list", Some(opt)) => {
                        call_result = self._projects_instances_clusters_hot_tablets_list(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-list", Some(opt)) => {
                        call_result = self._projects_instances_clusters_list(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-partial-update-cluster", Some(opt)) => {
                        call_result = self._projects_instances_clusters_partial_update_cluster(opt, dry_run, &mut err).await;
                    },
                    ("instances-clusters-update", Some(opt)) => {
                        call_result = self._projects_instances_clusters_update(opt, dry_run, &mut err).await;
                    },
                    ...
                    ("instances-partial-update-instance", Some(opt)) => {
                        call_result = self._projects_instances_partial_update_instance(opt, dry_run, &mut err).await;
                    },
                    ...
                    ("instances-tables-create", Some(opt)) => {
                        call_result = self._projects_instances_tables_create(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-delete", Some(opt)) => {
                        call_result = self._projects_instances_tables_delete(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-drop-row-range", Some(opt)) => {
                        call_result = self._projects_instances_tables_drop_row_range(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-generate-consistency-token", Some(opt)) => {
                        call_result = self._projects_instances_tables_generate_consistency_token(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-get", Some(opt)) => {
                        call_result = self._projects_instances_tables_get(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-get-iam-policy", Some(opt)) => {
                        call_result = self._projects_instances_tables_get_iam_policy(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-list", Some(opt)) => {
                        call_result = self._projects_instances_tables_list(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-modify-column-families", Some(opt)) => {
                        call_result = self._projects_instances_tables_modify_column_families(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-patch", Some(opt)) => {
                        call_result = self._projects_instances_tables_patch(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-restore", Some(opt)) => {
                        call_result = self._projects_instances_tables_restore(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-set-iam-policy", Some(opt)) => {
                        call_result = self._projects_instances_tables_set_iam_policy(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-test-iam-permissions", Some(opt)) => {
                        call_result = self._projects_instances_tables_test_iam_permissions(opt, dry_run, &mut err).await;
                    },
                    ("instances-tables-undelete", Some(opt)) => {
                        call_result = self._projects_instances_tables_undelete(opt, dry_run, &mut err).await;
                    },
    ...
    async fn new(opt: ArgMatches<'n>, connector: S) -> Result<Engine<'n, S>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "bigtableadmin2-secret.json",
        ...
        let auth = oauth2::InstalledFlowAuthenticator::with_client(
            ...
            client.clone(),
        ).persist_tokens_to_disk(format!("{}/bigtableadmin2", config_dir)).build().await.unwrap();
        ...
        ("projects", "methods: 'instances-app-profiles-create', 'instances-app-profiles-delete', 'instances-app-profiles-get', 'instances-app-profiles-list', 'instances-app-profiles-patch', 'instances-clusters-backups-copy', 'instances-clusters-backups-create', 'instances-clusters-backups-delete', 'instances-clusters-backups-get', 'instances-clusters-backups-get-iam-policy', 'instances-clusters-backups-list', 'instances-clusters-backups-patch', 'instances-clusters-backups-set-iam-policy', 'instances-clusters-backups-test-iam-permissions', 'instances-clusters-create', 'instances-clusters-delete', 'instances-clusters-get', 'instances-clusters-hot-tablets-list', 'instances-clusters-list', 'instances-clusters-partial-update-cluster', 'instances-clusters-update', 'instances-create', 'instances-delete', 'instances-get', 'instances-get-iam-policy', 'instances-list', 'instances-partial-update-instance', 'instances-set-iam-policy', 'instances-tables-check-consistency', 'instances-tables-create', 'instances-tables-delete', 'instances-tables-drop-row-range', 'instances-tables-generate-consistency-token', 'instances-tables-get', 'instances-tables-get-iam-policy', 'instances-tables-list', 'instances-tables-modify-column-families', 'instances-tables-patch', 'instances-tables-restore', 'instances-tables-set-iam-policy', 'instances-tables-test-iam-permissions', 'instances-tables-undelete', 'instances-test-iam-permissions', 'instances-update' and 'locations-list'", vec![
            ("instances-app-profiles-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The unique name of the instance in which to create the new app profile. Values are of the form `projects/{project}/instances/{instance}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-app-profiles-delete",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the app profile to be deleted. Values are of the form `projects/{project}/instances/{instance}/appProfiles/{app_profile}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-app-profiles-get",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the requested app profile. Values are of the form `projects/{project}/instances/{instance}/appProfiles/{app_profile}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-app-profiles-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The unique name of the instance for which a list of app profiles is requested. Values are of the form `projects/{project}/instances/{instance}`. Use `{instance} = '-'` to list AppProfiles for all Instances in a project, e.g., `projects/myproject/instances/-`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-app-profiles-patch",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The unique name of the app profile. Values are of the form `projects/{project}/instances/{instance}/appProfiles/_a-zA-Z0-9*`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-backups-copy",
                    Some(r##"Copy a Cloud Bigtable backup to a new backup in the destination cluster located in the destination instance and project."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-clusters-backups-copy",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The name of the destination cluster that will contain the backup copy. The cluster must already exists. Values are of the form: `projects/{project}/instances/{instance}/clusters/{cluster}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-backups-create",
                    Some(r##"Starts creating a new Cloud Bigtable Backup. The returned backup long-running operation can be used to track creation of the backup. The metadata field type is CreateBackupMetadata. The response field type is Backup, if successful. Cancelling the returned operation will stop the creation and delete the backup."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-clusters-backups-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. This must be one of the clusters in the instance in which this table is located. The backup will be stored in this cluster. Values are of the form `projects/{project}/instances/{instance}/clusters/{cluster}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-backups-delete",
                    Some(r##"Deletes a pending or completed Cloud Bigtable backup."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-clusters-backups-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the backup to delete. Values are of the form `projects/{project}/instances/{instance}/clusters/{cluster}/backups/{backup}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-backups-get",
                    Some(r##"Gets metadata on a pending or completed Cloud Bigtable Backup."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-clusters-backups-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the backup. Values are of the form `projects/{project}/instances/{instance}/clusters/{cluster}/backups/{backup}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-backups-list",
                    Some(r##"Lists Cloud Bigtable backups. Returns both completed and pending backups."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-clusters-backups-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The cluster to list backups from. Values are of the form `projects/{project}/instances/{instance}/clusters/{cluster}`. Use `{cluster} = '-'` to list backups for all clusters in an instance, e.g., `projects/{project}/instances/{instance}/clusters/-`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-backups-patch",
                    Some(r##"Updates a pending or completed Cloud Bigtable Backup."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-clusters-backups-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"A globally unique identifier for the backup which cannot be changed. Values are of the form `projects/{project}/instances/{instance}/clusters/{cluster}/ backups/_a-zA-Z0-9*` The final segment of the name must be between 1 and 50 characters in length. The backup is stored in the cluster identified by the prefix of the backup name of the form `projects/{project}/instances/{instance}/clusters/{cluster}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-create",
                    Some(r##"Creates a cluster within an instance. Note that exactly one of Cluster.serve_nodes and Cluster.cluster_config.cluster_autoscaling_config can be set. If serve_nodes is set to non-zero, then the cluster is manually scaled. If cluster_config.cluster_autoscaling_config is non-empty, then autoscaling is enabled."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-clusters-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The unique name of the instance in which to create the new cluster. Values are of the form `projects/{project}/instances/{instance}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-delete",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the cluster to be deleted. Values are of the form `projects/{project}/instances/{instance}/clusters/{cluster}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-get",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the requested cluster. Values are of the form `projects/{project}/instances/{instance}/clusters/{cluster}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-hot-tablets-list",
                    Some(r##"Lists hot tablets in a cluster, within the time range provided. Hot tablets are ordered based on CPU usage."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-clusters-hot-tablets-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The cluster name to list hot tablets. Value is in the following form: `projects/{project}/instances/{instance}/clusters/{cluster}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The unique name of the instance for which a list of clusters is requested. Values are of the form `projects/{project}/instances/{instance}`. Use `{instance} = '-'` to list Clusters for all Instances in a project, e.g., `projects/myproject/instances/-`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-partial-update-cluster",
                    Some(r##"Partially updates a cluster within a project. This method is the preferred way to update a Cluster. To enable and update autoscaling, set cluster_config.cluster_autoscaling_config. When autoscaling is enabled, serve_nodes is treated as an OUTPUT_ONLY field, meaning that updates to it are ignored. Note that an update cannot simultaneously set serve_nodes to non-zero and cluster_config.cluster_autoscaling_config to non-empty, and also specify both in the update_mask. To disable autoscaling, clear cluster_config.cluster_autoscaling_config, and explicitly set a serve_node count via the update_mask."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-clusters-partial-update-cluster",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The unique name of the cluster. Values are of the form `projects/{project}/instances/{instance}/clusters/a-z*`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-clusters-update",
                    Some(r##"Updates a cluster within an instance. Note that UpdateCluster does not support updating cluster_config.cluster_autoscaling_config. In order to update it, you must use PartialUpdateCluster."##),
            ...
            ("instances-create",
                    Some(r##"Create an instance within a project. Note that exactly one of Cluster.serve_nodes and Cluster.cluster_config.cluster_autoscaling_config can be set. If serve_nodes is set to non-zero, then the cluster is manually scaled. If cluster_config.cluster_autoscaling_config is non-empty, then autoscaling is enabled."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The unique name of the project in which to create the new instance. Values are of the form `projects/{project}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-delete",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the instance to be deleted. Values are of the form `projects/{project}/instances/{instance}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-get",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the requested instance. Values are of the form `projects/{project}/instances/{instance}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-get-iam-policy",
                    Some(r##"Gets the access control policy for an instance resource. Returns an empty policy if an instance exists but does not have a policy set."##),
            ...
            ("instances-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The unique name of the project for which a list of instances is requested. Values are of the form `projects/{project}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-partial-update-instance",
                    Some(r##"Partially updates an instance within a project. This method can modify all fields of an Instance and is the preferred way to update an Instance."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-partial-update-instance",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The unique name of the instance. Values are of the form `projects/{project}/instances/a-z+[a-z0-9]`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-set-iam-policy",
                    Some(r##"Sets the access control policy on an instance resource. Replaces any existing policy."##),
            ...
            ("instances-tables-check-consistency",
                    Some(r##"Checks replication consistency based on a consistency token, that is, if replication has caught up based on the conditions specified in the token and the check request."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-tables-check-consistency",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the Table for which to check replication consistency. Values are of the form `projects/{project}/instances/{instance}/tables/{table}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-tables-create",
                    Some(r##"Creates a new table in the specified instance. The table can be created with a full set of initial column families, specified in the request."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-tables-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The unique name of the instance in which to create the table. Values are of the form `projects/{project}/instances/{instance}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-tables-delete",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the table to be deleted. Values are of the form `projects/{project}/instances/{instance}/tables/{table}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-tables-drop-row-range",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the table on which to drop a range of rows. Values are of the form `projects/{project}/instances/{instance}/tables/{table}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-tables-generate-consistency-token",
                    Some(r##"Generates a consistency token for a Table, which can be used in CheckConsistency to check whether mutations to the table that finished before this call started have been replicated. The tokens will be available for 90 days."##),
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the Table for which to create a consistency token. Values are of the form `projects/{project}/instances/{instance}/tables/{table}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-tables-get",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the requested table. Values are of the form `projects/{project}/instances/{instance}/tables/{table}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-tables-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The unique name of the instance for which tables should be listed. Values are of the form `projects/{project}/instances/{instance}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-tables-modify-column-families",
                    Some(r##"Performs a series of column family modifications on the specified table. Either all or none of the modifications will occur before this method returns, but data requests received prior to that point may see a table where only some modifications have taken effect."##),
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the table whose families should be modified. Values are of the form `projects/{project}/instances/{instance}/tables/{table}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-tables-patch",
                    Some(r##"Updates a specified table."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-tables-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The unique name of the table. Values are of the form `projects/{project}/instances/{instance}/tables/_a-zA-Z0-9*`. Views: `NAME_ONLY`, `SCHEMA_VIEW`, `REPLICATION_VIEW`, `STATS_VIEW`, `FULL`"##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-tables-restore",
                    Some(r##"Create a new table by restoring from a completed backup. The returned table long-running operation can be used to track the progress of the operation, and to cancel it. The metadata field type is RestoreTableMetadata. The response type is Table, if successful."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-tables-restore",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The name of the instance in which to create the restored table. Values are of the form `projects//instances/`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-tables-undelete",
                    Some(r##"Restores a specified table which was accidentally deleted."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigtableadmin2_cli/projects_instances-tables-undelete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The unique name of the table to be restored. Values are of the form `projects/{project}/instances/{instance}/tables/{table}`."##),
                     Some(true),
                     Some(false)),
            ...
            ("instances-update",
                    Some(r##"Updates an instance within a project. This method updates only the display name and type for an Instance. To update other Instance properties, such as labels, use PartialUpdateInstance."##),
