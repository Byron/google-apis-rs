...
The [delegate trait](https://docs.rs/google-vmmigration1/6.0.0+20240613/google_vmmigration1/common::Delegate) is default-implemented, allowing you to customize it with minimal effort.
