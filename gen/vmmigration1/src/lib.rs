...
//! This documentation was generated from *VM Migration Service* crate version *3.1.0+20220225*, where *20220225* is the exact revision of the *vmmigration:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.1.0*.
//! 
