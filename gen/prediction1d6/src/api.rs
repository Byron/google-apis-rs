...
impl<C> common::Hub for Prediction<C> {}

impl<'a, C> Prediction<C> {
    pub fn new<A: 'static + common::GetToken>(client: common::Client<C>, auth: A) -> Prediction<C> {
        Prediction {
            client,
            auth: Box::new(auth),
...
impl common::ResponseResult for Analyze {}
...
impl common::RequestValue for Input {}
...
impl common::RequestValue for Insert {}
...
pub struct Insert2 {
    ...
    pub training_complete: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::ResponseResult for Insert2 {}
...
impl common::ResponseResult for List {}
...
impl common::ResponseResult for Output {}
...
impl common::RequestValue for Update {}
...
impl common::NestedType for AnalyzeDataDescription {}
impl common::Part for AnalyzeDataDescription {}
...
impl common::NestedType for AnalyzeDataDescriptionFeatures {}
impl common::Part for AnalyzeDataDescriptionFeatures {}
...
impl common::NestedType for AnalyzeDataDescriptionFeaturesCategorical {}
impl common::Part for AnalyzeDataDescriptionFeaturesCategorical {}
...
impl common::NestedType for AnalyzeDataDescriptionFeaturesCategoricalValues {}
impl common::Part for AnalyzeDataDescriptionFeaturesCategoricalValues {}
...
impl common::NestedType for AnalyzeDataDescriptionFeaturesNumeric {}
impl common::Part for AnalyzeDataDescriptionFeaturesNumeric {}
...
impl common::NestedType for AnalyzeDataDescriptionFeaturesText {}
impl common::Part for AnalyzeDataDescriptionFeaturesText {}
...
impl common::NestedType for AnalyzeDataDescriptionOutputFeature {}
impl common::Part for AnalyzeDataDescriptionOutputFeature {}
...
impl common::NestedType for AnalyzeDataDescriptionOutputFeatureNumeric {}
impl common::Part for AnalyzeDataDescriptionOutputFeatureNumeric {}
...
impl common::NestedType for AnalyzeDataDescriptionOutputFeatureText {}
impl common::Part for AnalyzeDataDescriptionOutputFeatureText {}
...
impl common::NestedType for AnalyzeModelDescription {}
impl common::Part for AnalyzeModelDescription {}
...
impl common::NestedType for InputInput {}
impl common::Part for InputInput {}
...
impl common::NestedType for InsertTrainingInstances {}
impl common::Part for InsertTrainingInstances {}
...
impl common::NestedType for Insert2ModelInfo {}
impl common::Part for Insert2ModelInfo {}
...
impl common::NestedType for OutputOutputMulti {}
impl common::Part for OutputOutputMulti {}
...
impl<'a, C> common::MethodsBuilder for HostedmodelMethods<'a, C> {}
...
impl<'a, C> common::MethodsBuilder for TrainedmodelMethods<'a, C> {}
...
impl<'a, C> common::CallBuilder for HostedmodelPredictCall<'a, C> {}

impl<'a, C> HostedmodelPredictCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Output)> {
        use std::borrow::Cow;
        ...
        params.push("hostedModelName", self._hosted_model_name);

        params.extend(self._additional_params.iter());

        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "{project}/hostedmodels/{hostedModelName}/predict";
        ...
        {
            let to_remove = ["hostedModelName", "project"];
    ...
    pub fn add_scope<St>(mut self, scope: St) -> HostedmodelPredictCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> HostedmodelPredictCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> HostedmodelPredictCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TrainedmodelAnalyzeCall<'a, C> {}

impl<'a, C> TrainedmodelAnalyzeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Analyze)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TrainedmodelAnalyzeCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TrainedmodelAnalyzeCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TrainedmodelAnalyzeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TrainedmodelDeleteCall<'a, C> {}

impl<'a, C> TrainedmodelDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TrainedmodelDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TrainedmodelDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TrainedmodelDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TrainedmodelGetCall<'a, C> {}

impl<'a, C> TrainedmodelGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Insert2)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TrainedmodelGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TrainedmodelGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TrainedmodelGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TrainedmodelInsertCall<'a, C> {}

impl<'a, C> TrainedmodelInsertCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TrainedmodelInsertCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TrainedmodelInsertCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TrainedmodelInsertCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TrainedmodelListCall<'a, C> {}

impl<'a, C> TrainedmodelListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, List)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TrainedmodelListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TrainedmodelListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TrainedmodelListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TrainedmodelPredictCall<'a, C> {}

impl<'a, C> TrainedmodelPredictCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TrainedmodelPredictCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TrainedmodelPredictCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TrainedmodelPredictCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TrainedmodelUpdateCall<'a, C> {}

impl<'a, C> TrainedmodelUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TrainedmodelUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TrainedmodelUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TrainedmodelUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
