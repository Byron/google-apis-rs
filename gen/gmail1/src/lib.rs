...
//! This documentation was generated from *Gmail* crate version *8.0.0+20251027*, where *20251027* is the exact revision of the *gmail:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
