...
//! This documentation was generated from *gmail* crate version *1.0.0+20160711*, where *20160711* is the exact revision of the *gmail:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.0*.
//! 
