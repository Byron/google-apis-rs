...
//! This documentation was generated from *Gmail* crate version *5.0.5+20240617*, where *20240617* is the exact revision of the *gmail:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.5*.
//! 
