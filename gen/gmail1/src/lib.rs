...
//! This documentation was generated from *Gmail* crate version *2.0.0+20210322*, where *20210322* is the exact revision of the *gmail:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.0*.
//! 
