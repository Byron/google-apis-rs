...
impl<'n, 'a> Engine<'n, 'a> {
    fn _achievement_definitions_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _achievements_increment(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _achievements_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["page-token", "state", "language", "max-results"]
                                                            ));
                    }
                }
            }
    ...
    fn _achievements_reveal(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _achievements_set_steps_at_least(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _achievements_unlock(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _achievements_update_multiple(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::AchievementUpdateMultipleRequest::default();
    ...
    fn _applications_get(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["platform-type", "language"]
                                                            ));
                    }
                }
            }
    ...
    fn _applications_played(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _events_list_by_player(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _events_list_definitions(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _events_record(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::EventRecordRequest::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
    ...
    fn _leaderboards_get(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _leaderboards_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _metagame_get_metagame_config(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _metagame_list_categories_by_player(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _players_get(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _players_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _pushtokens_remove(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::PushTokenId::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
            ...
            match &temp_cursor.to_string()[..] {
                ...
                "ios.apns-device-token" => {
                        ...
                        request.ios.as_mut().unwrap().apns_device_token = Some(value.unwrap_or("").to_string());
                    },
                "ios.apns-environment" => {
                        request_ios_init(&mut request);
                        request.ios.as_mut().unwrap().apns_environment = Some(value.unwrap_or("").to_string());
                    },
                _ => {
    ...
    fn _pushtokens_update(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::PushToken::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
            ...
            match &temp_cursor.to_string()[..] {
                ...
                "id.ios.apns-device-token" => {
                        ...
                        request.id.as_mut().unwrap().ios.as_mut().unwrap().apns_device_token = Some(value.unwrap_or("").to_string());
                    },
                "id.ios.apns-environment" => {
                        request_id_ios_init(&mut request);
                        request.id.as_mut().unwrap().ios.as_mut().unwrap().apns_environment = Some(value.unwrap_or("").to_string());
                    },
                "language" => {
                        request_id_init(&mut request);
    ...
    fn _quest_milestones_claim(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.quest_milestones().claim(opt.value_of("quest-id").unwrap_or(""), opt.value_of("milestone-id").unwrap_or(""), opt.value_of("request-id").unwrap_or(""));
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _quests_accept(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.quests().accept(opt.value_of("quest-id").unwrap_or(""));
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "language" => {
    ...
    fn _quests_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.quests().list(opt.value_of("player-id").unwrap_or(""));
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    fn _revisions_check(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _rooms_create(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::RoomCreateRequest::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
            ...
            match &temp_cursor.to_string()[..] {
                ...
                "auto-matching-criteria.kind" => {
                        ...
                        request.auto_matching_criteria.as_mut().unwrap().kind = Some(value.unwrap_or("").to_string());
                    },
                "auto-matching-criteria.min-auto-matching-players" => {
                        request_auto_matching_criteria_init(&mut request);
                        request.auto_matching_criteria.as_mut().unwrap().min_auto_matching_players = Some(arg_from_str(value.unwrap_or("-0"), err, "auto-matching-criteria.min-auto-matching-players", "integer"));
                    },
                "auto-matching-criteria.exclusive-bitmask" => {
                        request_auto_matching_criteria_init(&mut request);
                        request.auto_matching_criteria.as_mut().unwrap().exclusive_bitmask = Some(value.unwrap_or("").to_string());
                    },
                "auto-matching-criteria.max-auto-matching-players" => {
                        request_auto_matching_criteria_init(&mut request);
                        request.auto_matching_criteria.as_mut().unwrap().max_auto_matching_players = Some(arg_from_str(value.unwrap_or("-0"), err, "auto-matching-criteria.max-auto-matching-players", "integer"));
                    },
                "invited-player-ids" => {
                        request_auto_matching_criteria_init(&mut request);
                ...
                "network-diagnostics.kind" => {
                        ...
                        request.network_diagnostics.as_mut().unwrap().kind = Some(value.unwrap_or("").to_string());
                    },
                "network-diagnostics.ios-network-type" => {
                        request_network_diagnostics_init(&mut request);
                        request.network_diagnostics.as_mut().unwrap().ios_network_type = Some(arg_from_str(value.unwrap_or("-0"), err, "network-diagnostics.ios-network-type", "integer"));
                    },
                "network-diagnostics.network-operator-code" => {
                        request_network_diagnostics_init(&mut request);
                        request.network_diagnostics.as_mut().unwrap().network_operator_code = Some(value.unwrap_or("").to_string());
                    },
                "network-diagnostics.android-network-subtype" => {
                        request_network_diagnostics_init(&mut request);
                        request.network_diagnostics.as_mut().unwrap().android_network_subtype = Some(arg_from_str(value.unwrap_or("-0"), err, "network-diagnostics.android-network-subtype", "integer"));
                    },
                "network-diagnostics.network-operator-name" => {
                        request_network_diagnostics_init(&mut request);
                        request.network_diagnostics.as_mut().unwrap().network_operator_name = Some(value.unwrap_or("").to_string());
                    },
                "network-diagnostics.registration-latency-millis" => {
                        request_network_diagnostics_init(&mut request);
                        request.network_diagnostics.as_mut().unwrap().registration_latency_millis = Some(arg_from_str(value.unwrap_or("-0"), err, "network-diagnostics.registration-latency-millis", "integer"));
                    },
                "network-diagnostics.android-network-type" => {
                        request_network_diagnostics_init(&mut request);
                        request.network_diagnostics.as_mut().unwrap().android_network_type = Some(arg_from_str(value.unwrap_or("-0"), err, "network-diagnostics.android-network-type", "integer"));
                    },
                "client-address.kind" => {
                        request_client_address_init(&mut request);
                        request.client_address.as_mut().unwrap().kind = Some(value.unwrap_or("").to_string());
                    },
                "client-address.xmpp-address" => {
                        request_client_address_init(&mut request);
                        request.client_address.as_mut().unwrap().xmpp_address = Some(value.unwrap_or("").to_string());
                    },
                "request-id" => {
                        request_client_address_init(&mut request);
                        request.request_id = Some(value.unwrap_or("").to_string());
    ...
    fn _rooms_decline(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _rooms_dismiss(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _rooms_get(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _rooms_join(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::RoomJoinRequest::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
    ...
    fn _rooms_leave(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::RoomLeaveRequest::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
            ...
            match &temp_cursor.to_string()[..] {
                ...
                "leave-diagnostics.kind" => {
                        ...
                        request.leave_diagnostics.as_mut().unwrap().kind = Some(value.unwrap_or("").to_string());
                    },
                "leave-diagnostics.sockets-used" => {
                        request_leave_diagnostics_init(&mut request);
                        request.leave_diagnostics.as_mut().unwrap().sockets_used = Some(arg_from_str(value.unwrap_or("false"), err, "leave-diagnostics.sockets-used", "boolean"));
                    },
                "leave-diagnostics.ios-network-type" => {
                        request_leave_diagnostics_init(&mut request);
                        request.leave_diagnostics.as_mut().unwrap().ios_network_type = Some(arg_from_str(value.unwrap_or("-0"), err, "leave-diagnostics.ios-network-type", "integer"));
                    },
                "leave-diagnostics.network-operator-code" => {
                        request_leave_diagnostics_init(&mut request);
                        request.leave_diagnostics.as_mut().unwrap().network_operator_code = Some(value.unwrap_or("").to_string());
                    },
                "leave-diagnostics.android-network-subtype" => {
                        request_leave_diagnostics_init(&mut request);
                        request.leave_diagnostics.as_mut().unwrap().android_network_subtype = Some(arg_from_str(value.unwrap_or("-0"), err, "leave-diagnostics.android-network-subtype", "integer"));
                    },
                "leave-diagnostics.network-operator-name" => {
                        request_leave_diagnostics_init(&mut request);
                        request.leave_diagnostics.as_mut().unwrap().network_operator_name = Some(value.unwrap_or("").to_string());
                    },
                "leave-diagnostics.android-network-type" => {
                        request_leave_diagnostics_init(&mut request);
                        request.leave_diagnostics.as_mut().unwrap().android_network_type = Some(arg_from_str(value.unwrap_or("-0"), err, "leave-diagnostics.android-network-type", "integer"));
                    },
                _ => {
    ...
    fn _rooms_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _rooms_report_status(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::RoomP2PStatuses::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
    ...
    fn _scores_get(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["page-token", "language", "max-results", "include-rank-type"]
                                                            ));
                    }
                }
            }
    ...
    fn _scores_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _scores_list_window(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["return-top-if-absent", "results-above", "language", "max-results", "page-token"]
                                                            ));
                    }
                }
            }
    ...
    fn _scores_submit(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["language", "score-tag"]
                                                            ));
                    }
                }
            }
    ...
    fn _scores_submit_multiple(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::PlayerScoreSubmissionList::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
    ...
    fn _turn_based_matches_cancel(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _turn_based_matches_create(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::TurnBasedMatchCreateRequest::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
    ...
    fn _turn_based_matches_decline(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _turn_based_matches_dismiss(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _turn_based_matches_finish(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::TurnBasedMatchResults::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
            ...
            match &temp_cursor.to_string()[..] {
                ...
                "data.kind" => {
                        ...
                        request.data.as_mut().unwrap().kind = Some(value.unwrap_or("").to_string());
                    },
                "data.data" => {
                        request_data_init(&mut request);
                        request.data.as_mut().unwrap().data = Some(value.unwrap_or("").to_string());
                    },
                "match-version" => {
                        request_data_init(&mut request);
    ...
    fn _turn_based_matches_get(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["language", "include-match-data"]
                                                            ));
                    }
                }
            }
    ...
    fn _turn_based_matches_join(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _turn_based_matches_leave(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _turn_based_matches_leave_turn(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["language", "pending-participant-id"]
                                                            ));
                    }
                }
            }
    ...
    fn _turn_based_matches_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["page-token", "max-completed-matches", "language", "max-results", "include-match-data"]
                                                            ));
                    }
                }
            }
    ...
    fn _turn_based_matches_rematch(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["request-id", "language"]
                                                            ));
                    }
                }
            }
    ...
    fn _turn_based_matches_sync(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _turn_based_matches_take_turn(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        
        let mut request = api::TurnBasedMatchTurn::default();
        let mut field_cursor = FieldCursor::default();
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            let last_errc = err.issues.len();
            let (key, value) = parse_kv_arg(&*kvarg, err, false);
    ...
    fn _doit(&self, dry_run: bool) -> Result<Result<(), DoitError>, Option<InvalidOptionsError>> {
        ...
        match self.opt.subcommand() {
            ...
            ("quest-milestones", Some(opt)) => {
                match opt.subcommand() {
                    ("claim", Some(opt)) => {
                        call_result = self._quest_milestones_claim(opt, dry_run, &mut err);
                    },
                    _ => {
                        err.issues.push(CLIError::MissingMethodError("quest-milestones".to_string()));
                        writeln!(io::stderr(), "{}\n", opt.usage()).ok();
                    }
                }
            },
            ("quests", Some(opt)) => {
                match opt.subcommand() {
                    ("accept", Some(opt)) => {
                        call_result = self._quests_accept(opt, dry_run, &mut err);
                    },
                    ("list", Some(opt)) => {
                        call_result = self._quests_list(opt, dry_run, &mut err);
                    },
                    _ => {
...
fn main() {
    let arg_data = [
        ...
        ("applications", "methods: 'get' and 'played'", vec![
            ("get",  
        ...
        ("quest-milestones", "methods: 'claim'", vec![
            ("claim",  
                    Some(r##"Report that a reward for the milestone corresponding to milestoneId for the quest corresponding to questId has been claimed by the currently authorized user."##),
                    "Details at http://byron.github.io/google-apis-rs/google_games1_cli/quest-milestones_claim",
                  vec![
                    (Some(r##"quest-id"##),
                     None,
                    ...
                    (Some(r##"milestone-id"##),
                     None,
                     Some(r##"The ID of the milestone."##),
                     Some(true),
                     Some(false)),
        
                    (Some(r##"request-id"##),
                     None,
                     Some(r##"A numeric ID to ensure that the request is handled correctly across retries. Your client application must generate this ID randomly."##),
                     Some(true),
                     Some(false)),
        ...
        ("quests", "methods: 'accept' and 'list'", vec![
            ("accept",  
                    Some(r##"Indicates that the currently authorized user will participate in the quest."##),
                    "Details at http://byron.github.io/google-apis-rs/google_games1_cli/quests_accept",
                  vec![
                    (Some(r##"quest-id"##),
                     None,
                     Some(r##"The ID of the quest."##),
            ...
            ("list",  
                    Some(r##"Get a list of quests for your application and the currently authenticated player."##),
                    "Details at http://byron.github.io/google-apis-rs/google_games1_cli/quests_list",
                  vec![
                    (Some(r##"player-id"##),
                     None,
                     Some(r##"A player ID. A value of me may be used in place of the authenticated player's ID."##),
