...
use google_speech1_beta1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _speech_asyncrecognize(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "config.speech-context.phrases" => Some((
                    "config.speechContext.phrases",
                    JsonTypeInfo {
                        jtype: JsonType::String,
        ...
        let mut request: api::AsyncRecognizeRequest =
    ...
    async fn _speech_syncrecognize(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::SyncRecognizeRequest = serde_json::value::from_value(object).unwrap();
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "speech1-beta1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/speech1-beta1", config_dir))
        .build()
        .await
        .unwrap();
