...
This documentation was generated from the *Cloud Healthcare* API at revision *20251211*. The CLI is at version *7.0.0*.
...
healthcare1-beta1 [options]
        projects
                ...
                locations-datasets-dicom-stores-studies-series-instances-update-metadata <parent> <dicom-web-path> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-datasets-dicom-stores-studies-series-update-metadata <parent> <dicom-web-path> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-datasets-dicom-stores-studies-store-instances <parent> <dicom-web-path> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-datasets-dicom-stores-studies-update-instances <parent> <dicom-web-path> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-datasets-dicom-stores-studies-update-metadata <parent> <dicom-web-path> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-datasets-dicom-stores-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-datasets-dicom-stores-update-instances <parent> <dicom-web-path> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-datasets-fhir-stores-bulk-export-group <name> [-p <v>]... [-o <out>]
                ...
                locations-datasets-fhir-stores-fhir--binary-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-datasets-fhir-stores-fhir--binary-read <name> [-p <v>]... [-o <out>]
                locations-datasets-fhir-stores-fhir--binary-update <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-datasets-fhir-stores-fhir--binary-vread <name> [-p <v>]... [-o <out>]
                ...
                locations-datasets-fhir-stores-fhir--encounter-everything <name> [-p <v>]... [-o <out>]
                ...
                locations-datasets-fhir-stores-fhir-bulk-export <name> [-p <v>]... [-o <out>]
                ...
                locations-datasets-fhir-stores-operations-delete-fhir-operation <name> [-p <v>]... [-o <out>]
                locations-datasets-fhir-stores-operations-get-fhir-operation-status <name> [-p <v>]... [-o <out>]
                ...
                locations-datasets-hl7-v2-stores-rollback <name> (-r <kv>)... [-p <v>]... [-o <out>]
