...
use google_adsense1d4::{api, yup_oauth2, Error};
...
{
    async fn _accounts_adclients_get_ad_code(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().adclients_get_ad_code(
    ...
    async fn _accounts_adunits_customchannels_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().adunits_customchannels_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
    ...
    async fn _accounts_alerts_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().alerts_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("alert-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _accounts_alerts_list(
        ...
        let mut call = self
            .hub
            .accounts()
            .alerts_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_customchannels_adunits_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().customchannels_adunits_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
    ...
    async fn _accounts_customchannels_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().customchannels_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("custom-channel-id").unwrap_or(""),
        );
    ...
    async fn _accounts_customchannels_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().customchannels_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
        );
        for parg in opt
            ...
            .iter()
        {
            ...
            match key {
                "tree" => {
                    call = call.tree(
                        value
                            .map(|v| arg_from_str(v, err, "tree", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _accounts_payments_list(
        ...
        let mut call = self
            .hub
            .accounts()
            .payments_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            ...
            .iter()
        {
            ...
            match key {
                "use-timezone-reporting" => {
                    call = call.use_timezone_reporting(
                        value
                            .map(|v| arg_from_str(v, err, "use-timezone-reporting", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "start-index" => {
    ...
    async fn _accounts_reports_saved_generate(
        ...
        let mut call = self.hub.accounts().reports_saved_generate(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("saved-report-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["locale", "max-results", "start-index"].iter().map(|v| *v),
                                );
                                v
                            }));
                    }
    ...
    async fn _accounts_reports_saved_list(
        ...
        let mut call = self
            .hub
            .accounts()
            .reports_saved_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_savedadstyles_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().savedadstyles_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("saved-ad-style-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _accounts_savedadstyles_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .savedadstyles_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_urlchannels_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().urlchannels_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _adunits_customchannels_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.adunits().customchannels_list(
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("ad-unit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _adunits_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.adunits().get(
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("ad-unit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _adunits_get_ad_code(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.adunits().get_ad_code(
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("ad-unit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _customchannels_adunits_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.customchannels().adunits_list(
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("custom-channel-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _metadata_dimensions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _metadata_metrics_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _reports_saved_generate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .reports()
            .saved_generate(opt.value_of("saved-report-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _savedadstyles_get(
        ...
        let mut call = self
            .hub
            .savedadstyles()
            .get(opt.value_of("saved-ad-style-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("accounts", Some(opt)) => match opt.subcommand() {
                ("adclients-get-ad-code", Some(opt)) => {
                    call_result = self
                        ._accounts_adclients_get_ad_code(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("adunits-customchannels-list", Some(opt)) => {
                    call_result = self
                        ._accounts_adunits_customchannels_list(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("customchannels-adunits-list", Some(opt)) => {
                    call_result = self
                        ._accounts_customchannels_adunits_list(opt, dry_run, &mut err)
                        .await;
                }
                ("customchannels-get", Some(opt)) => {
                    call_result = self
                        ._accounts_customchannels_get(opt, dry_run, &mut err)
                        .await;
                }
                ("customchannels-list", Some(opt)) => {
                    call_result = self
                        ._accounts_customchannels_list(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                ("savedadstyles-get", Some(opt)) => {
                    call_result = self
                        ._accounts_savedadstyles_get(opt, dry_run, &mut err)
                        .await;
                }
                ("savedadstyles-list", Some(opt)) => {
                    call_result = self
                        ._accounts_savedadstyles_list(opt, dry_run, &mut err)
                        .await;
                }
                ("urlchannels-list", Some(opt)) => {
                    call_result = self
                        ._accounts_urlchannels_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("adunits", Some(opt)) => match opt.subcommand() {
                ("customchannels-list", Some(opt)) => {
                    call_result = self
                        ._adunits_customchannels_list(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("adunits".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("customchannels", Some(opt)) => match opt.subcommand() {
                ("adunits-list", Some(opt)) => {
                    call_result = self
                        ._customchannels_adunits_list(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
            ...
            ("payments", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._payments_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("payments".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("savedadstyles", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("savedadstyles".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "adsense1d4-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/adsense1d4", config_dir))
        .build()
        .await
        .unwrap();
