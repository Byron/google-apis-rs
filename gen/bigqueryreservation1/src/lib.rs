...
//! This documentation was generated from *BigQuery Reservation* crate version *2.0.4+20210324*, where *20210324* is the exact revision of the *bigqueryreservation:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.4*.
//! 
