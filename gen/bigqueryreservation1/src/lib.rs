...
//! This documentation was generated from *BigQuery Reservation* crate version *5.0.2-beta-1+20230117*, where *20230117* is the exact revision of the *bigqueryreservation:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2-beta-1*.
//! 
