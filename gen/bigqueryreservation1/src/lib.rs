...
//! This documentation was generated from *BigQuery Reservation* crate version *8.0.0+20251009*, where *20251009* is the exact revision of the *bigqueryreservation:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
