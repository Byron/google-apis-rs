...
//! This documentation was generated from *BigQuery Reservation* crate version *7.0.0+20251207*, where *20251207* is the exact revision of the *bigqueryreservation:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
...
//!
//! * projects
//!  * [*locations capacity commitments create*](api::ProjectLocationCapacityCommitmentCreateCall), [*locations capacity commitments delete*](api::ProjectLocationCapacityCommitmentDeleteCall), [*locations capacity commitments get*](api::ProjectLocationCapacityCommitmentGetCall), [*locations capacity commitments list*](api::ProjectLocationCapacityCommitmentListCall), [*locations capacity commitments merge*](api::ProjectLocationCapacityCommitmentMergeCall), [*locations capacity commitments patch*](api::ProjectLocationCapacityCommitmentPatchCall), [*locations capacity commitments split*](api::ProjectLocationCapacityCommitmentSplitCall), [*locations get bi reservation*](api::ProjectLocationGetBiReservationCall), [*locations reservation groups create*](api::ProjectLocationReservationGroupCreateCall), [*locations reservation groups delete*](api::ProjectLocationReservationGroupDeleteCall), [*locations reservation groups get*](api::ProjectLocationReservationGroupGetCall), [*locations reservation groups list*](api::ProjectLocationReservationGroupListCall), [*locations reservations assignments create*](api::ProjectLocationReservationAssignmentCreateCall), [*locations reservations assignments delete*](api::ProjectLocationReservationAssignmentDeleteCall), [*locations reservations assignments get iam policy*](api::ProjectLocationReservationAssignmentGetIamPolicyCall), [*locations reservations assignments list*](api::ProjectLocationReservationAssignmentListCall), [*locations reservations assignments move*](api::ProjectLocationReservationAssignmentMoveCall), [*locations reservations assignments patch*](api::ProjectLocationReservationAssignmentPatchCall), [*locations reservations assignments set iam policy*](api::ProjectLocationReservationAssignmentSetIamPolicyCall), [*locations reservations assignments test iam permissions*](api::ProjectLocationReservationAssignmentTestIamPermissionCall), [*locations reservations create*](api::ProjectLocationReservationCreateCall), [*locations reservations delete*](api::ProjectLocationReservationDeleteCall), [*locations reservations failover reservation*](api::ProjectLocationReservationFailoverReservationCall), [*locations reservations get*](api::ProjectLocationReservationGetCall), [*locations reservations get iam policy*](api::ProjectLocationReservationGetIamPolicyCall), [*locations reservations list*](api::ProjectLocationReservationListCall), [*locations reservations patch*](api::ProjectLocationReservationPatchCall), [*locations reservations set iam policy*](api::ProjectLocationReservationSetIamPolicyCall), [*locations reservations test iam permissions*](api::ProjectLocationReservationTestIamPermissionCall), [*locations search all assignments*](api::ProjectLocationSearchAllAssignmentCall), [*locations search assignments*](api::ProjectLocationSearchAssignmentCall) and [*locations update bi reservation*](api::ProjectLocationUpdateBiReservationCall)
//!
//!
//!
//!
