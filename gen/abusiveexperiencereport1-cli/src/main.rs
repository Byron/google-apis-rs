...
extern crate mime;
extern crate strsim;
extern crate google_abusiveexperiencereport1 as api;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::AbusiveExperienceReport<hyper::Client, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client>>,
    gp: Vec<&'static str>,
...
impl<'n> Engine<'n> {
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "abusiveexperiencereport1-secret.json",
        ...
        let auth = Authenticator::new(  &secret, DefaultAuthenticatorDelegate,
                                        ...
                                        JsonTokenStorage {
                                          program_name: "abusiveexperiencereport1",
