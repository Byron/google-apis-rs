...
//! This documentation was generated from *Cloud Memorystore for Memcached* crate version *7.0.0+20251005*, where *20251005* is the exact revision of the *memcache:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
