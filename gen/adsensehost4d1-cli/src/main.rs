...
impl Engine {
    ...
    fn _accounts_adunits_insert(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::AdUnit = Default::default();
        ...
        for kvarg in self.opt.arg_kv.iter() {
            ...
            match &field_name.to_string()[..] {
                ...
                "content-ads-settings.type" => {
                        ...
                        request.content_ads_settings.as_mut().unwrap().type_ = value.unwrap_or("").to_string();
                    },
                "content-ads-settings.backup-option.color" => {
                        request_content_ads_settings_init(&mut request);
                        request.content_ads_settings.as_mut().unwrap().backup_option.color = value.unwrap_or("").to_string();
                    },
                "content-ads-settings.backup-option.url" => {
                        request_content_ads_settings_init(&mut request);
                        request.content_ads_settings.as_mut().unwrap().backup_option.url = value.unwrap_or("").to_string();
                    },
                "content-ads-settings.backup-option.type" => {
                        request_content_ads_settings_init(&mut request);
                        request.content_ads_settings.as_mut().unwrap().backup_option.type_ = value.unwrap_or("").to_string();
                    },
                "content-ads-settings.size" => {
                        request_content_ads_settings_init(&mut request);
                        request.content_ads_settings.as_mut().unwrap().size = value.unwrap_or("").to_string();
                    },
                "id" => {
                        request_content_ads_settings_init(&mut request);
                ...
                "mobile-content-ads-settings.scripting-language" => {
                        ...
                        request.mobile_content_ads_settings.as_mut().unwrap().scripting_language = value.unwrap_or("").to_string();
                    },
                "mobile-content-ads-settings.type" => {
                        request_mobile_content_ads_settings_init(&mut request);
                        request.mobile_content_ads_settings.as_mut().unwrap().type_ = value.unwrap_or("").to_string();
                    },
                "mobile-content-ads-settings.markup-language" => {
                        request_mobile_content_ads_settings_init(&mut request);
                        request.mobile_content_ads_settings.as_mut().unwrap().markup_language = value.unwrap_or("").to_string();
                    },
                "mobile-content-ads-settings.size" => {
                        request_mobile_content_ads_settings_init(&mut request);
                        request.mobile_content_ads_settings.as_mut().unwrap().size = value.unwrap_or("").to_string();
                    },
                "custom-style.corners" => {
                        request_custom_style_init(&mut request);
                        request.custom_style.as_mut().unwrap().corners = value.unwrap_or("").to_string();
                    },
                "custom-style.colors.url" => {
                        request_custom_style_init(&mut request);
                        request.custom_style.as_mut().unwrap().colors.url = value.unwrap_or("").to_string();
                    },
                "custom-style.colors.text" => {
                        request_custom_style_init(&mut request);
                        request.custom_style.as_mut().unwrap().colors.text = value.unwrap_or("").to_string();
                    },
                "custom-style.colors.border" => {
                        request_custom_style_init(&mut request);
                        request.custom_style.as_mut().unwrap().colors.border = value.unwrap_or("").to_string();
                    },
                "custom-style.colors.background" => {
                        request_custom_style_init(&mut request);
                        request.custom_style.as_mut().unwrap().colors.background = value.unwrap_or("").to_string();
                    },
                "custom-style.colors.title" => {
                        request_custom_style_init(&mut request);
                        request.custom_style.as_mut().unwrap().colors.title = value.unwrap_or("").to_string();
                    },
                "custom-style.font.family" => {
                        request_custom_style_init(&mut request);
                        request.custom_style.as_mut().unwrap().font.family = value.unwrap_or("").to_string();
                    },
                "custom-style.font.size" => {
                        request_custom_style_init(&mut request);
                        request.custom_style.as_mut().unwrap().font.size = value.unwrap_or("").to_string();
                    },
                "custom-style.kind" => {
                        request_custom_style_init(&mut request);
                        request.custom_style.as_mut().unwrap().kind = value.unwrap_or("").to_string();
                    },
                _ => {
    ...
    fn _customchannels_insert(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::CustomChannel = Default::default();
    ...
    fn _urlchannels_insert(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::UrlChannel = Default::default();
    ...
    fn new(opt: Options) -> Result<Engine, InvalidOptionsError> {
        ...
        let engine = Engine {
            opt: opt,
            hub: api::AdSenseHost::new(hyper::Client::new(), auth),
        };
