...
use google_adsensehost4d1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    async fn _accounts_adclients_get(
        ...
        let mut call = self.hub.accounts().adclients_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _accounts_adclients_list(
        ...
        let mut call = self
            .hub
            .accounts()
            .adclients_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_adunits_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().adunits_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("ad-unit-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _accounts_adunits_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().adunits_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("ad-unit-id").unwrap_or(""),
        );
    ...
    async fn _accounts_adunits_get_ad_code(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().adunits_get_ad_code(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("ad-unit-id").unwrap_or(""),
        );
    ...
    async fn _accounts_adunits_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "content-ads-settings.backup-option.color" => Some((
                ...
                "content-ads-settings.backup-option.type" => Some((
                ...
                "content-ads-settings.backup-option.url" => Some((
                ...
                "custom-style.colors.background" => Some((
                ...
                "custom-style.colors.border" => Some((
                ...
                "custom-style.colors.title" => Some((
                ...
                "mobile-content-ads-settings.markup-language" => Some((
                ...
                "mobile-content-ads-settings.scripting-language" => Some((
                ...
                "mobile-content-ads-settings.size" => Some((
                ...
                "mobile-content-ads-settings.type" => Some((
        ...
        let mut call = self.hub.accounts().adunits_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
        );
    ...
    async fn _accounts_adunits_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().adunits_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
        );
        for parg in opt
            ...
            .iter()
        {
            ...
            match key {
                ...
                "include-inactive" => {
                    call = call.include_inactive(
                        value
                            .map(|v| arg_from_str(v, err, "include-inactive", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["include-inactive", "max-results", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _accounts_adunits_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AdUnit = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.accounts().adunits_patch(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("ad-unit-id").unwrap_or(""),
    ...
    async fn _accounts_adunits_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AdUnit = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.accounts().adunits_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("ad-client-id").unwrap_or(""),
        );
    ...
    async fn _accounts_list(
        ...
        let mut call = self.hub.accounts().list(
            &opt.values_of("filter-ad-client-id")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
                .map(|&v| v.to_string())
    ...
    async fn _accounts_reports_generate(
        ...
        let mut call = self.hub.accounts().reports_generate(
            opt.value_of("account-id").unwrap_or(""),
    ...
    async fn _adclients_get(
        ...
        let mut call = self
            .hub
            .adclients()
            .get(opt.value_of("ad-client-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _associationsessions_start(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.associationsessions().start(
            &opt.values_of("product-code")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
                .map(|&v| v.to_string())
                .collect::<Vec<String>>(),
            opt.value_of("website-url").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["callback-url", "user-locale", "website-locale"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _associationsessions_verify(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .associationsessions()
            .verify(opt.value_of("token").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _customchannels_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.customchannels().delete(
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("custom-channel-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _customchannels_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.customchannels().get(
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("custom-channel-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _customchannels_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["code", "id", "kind", "name"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut call = self
            .hub
            .customchannels()
            .insert(request, opt.value_of("ad-client-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _customchannels_list(
        ...
        let mut call = self
            .hub
            .customchannels()
            .list(opt.value_of("ad-client-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _customchannels_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CustomChannel = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.customchannels().patch(
            request,
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("custom-channel-id").unwrap_or(""),
        );
    ...
    async fn _customchannels_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .customchannels()
            .update(request, opt.value_of("ad-client-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _reports_generate(
        ...
        let mut call = self.hub.reports().generate(
            opt.value_of("start-date").unwrap_or(""),
            opt.value_of("end-date").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _urlchannels_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.urlchannels().delete(
            opt.value_of("ad-client-id").unwrap_or(""),
            opt.value_of("url-channel-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _urlchannels_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["id", "kind", "url-pattern"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::UrlChannel = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .urlchannels()
            .insert(request, opt.value_of("ad-client-id").unwrap_or(""));
        ...
        match self.opt.subcommand() {
            ("accounts", Some(opt)) => match opt.subcommand() {
                ...
                ("adunits-get-ad-code", Some(opt)) => {
                    call_result = self
                        ._accounts_adunits_get_ad_code(opt, dry_run, &mut err)
                        .await;
                }
            ...
            ("adclients", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("adclients".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("associationsessions", Some(opt)) => match opt.subcommand() {
                ("start", Some(opt)) => {
                    call_result = self
                        ._associationsessions_start(opt, dry_run, &mut err)
                        .await;
                }
                ("verify", Some(opt)) => {
                    call_result = self
                        ._associationsessions_verify(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "associationsessions".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("customchannels", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("customchannels".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("urlchannels", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("urlchannels".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "adsensehost4d1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/adsensehost4d1", config_dir))
        .build()
        .await
        .unwrap();
