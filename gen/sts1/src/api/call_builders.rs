...
pub struct MethodIntrospectCall<'a, S>
   ...
   pub(super) _request: GoogleIdentityStsV1IntrospectTokenRequest,
...
pub struct MethodOauthtokenCall<'a, S>
   ...
   pub(super) hub: &'a CloudSecurityToken<S>,
   pub(super) _request: GoogleIdentityStsV1ExchangeOauthTokenRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
...
pub struct MethodTokenCall<'a, S>
   ...
   pub(super) hub: &'a CloudSecurityToken<S>,
   pub(super) _request: GoogleIdentityStsV1ExchangeTokenRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
