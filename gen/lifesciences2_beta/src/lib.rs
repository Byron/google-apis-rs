...
//! This documentation was generated from *Cloud Life Sciences* crate version *5.0.5+20240607*, where *20240607* is the exact revision of the *lifesciences:v2beta* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.5*.
//! 
