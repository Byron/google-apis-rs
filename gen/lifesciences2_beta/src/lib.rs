...
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.CloudLifeSciences.html) ... 
//! 
//! * projects
//!  * [*locations get*](struct.ProjectLocationGetCall.html), [*locations list*](struct.ProjectLocationListCall.html), [*locations operations cancel*](struct.ProjectLocationOperationCancelCall.html), [*locations operations get*](struct.ProjectLocationOperationGetCall.html), [*locations operations list*](struct.ProjectLocationOperationListCall.html) and [*locations pipelines run*](struct.ProjectLocationPipelineRunCall.html)
//! 
//! 
//! 
//! 
...
//! 
//! * **[Hub](struct.CloudLifeSciences.html)**
...
/// # }
/// ```
pub struct CloudLifeSciences<C, A> {
    client: RefCell<C>,
    auth: RefCell<A>,
    _user_agent: String,
    _base_url: String,
...
impl<'a, C, A> Hub for CloudLifeSciences<C, A> {}

impl<'a, C, A> CloudLifeSciences<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> CloudLifeSciences<C, A> {
        CloudLifeSciences {
...
/// 
/// * [locations pipelines run projects](struct.ProjectLocationPipelineRunCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations pipelines run projects](struct.ProjectLocationPipelineRunCall.html) (response)
...
impl<'a, C, A> ProjectMethods<'a, C, A> {
    ...
    pub fn locations_pipelines_run(&self, request: RunPipelineRequest, parent: &str) -> ProjectLocationPipelineRunCall<'a, C, A> {
...
/// # }
/// ```
pub struct ProjectLocationPipelineRunCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectLocationPipelineRunCall<'a, C, A> {}

impl<'a, C, A> ProjectLocationPipelineRunCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "lifesciences.projects.locations.pipelines.run",
    ...
    pub fn request(mut self, new_value: RunPipelineRequest) -> ProjectLocationPipelineRunCall<'a, C, A> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationPipelineRunCall<'a, C, A> {
    ...
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> ProjectLocationPipelineRunCall<'a, C, A> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationPipelineRunCall<'a, C, A>
                                                        where T: AsRef<str> {
    ...
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationPipelineRunCall<'a, C, A>
...
impl<'a, C, A> ProjectLocationGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Location)> {
        ...
        dlg.begin(MethodInfo { id: "lifesciences.projects.locations.get",
...
impl<'a, C, A> ProjectLocationOperationGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "lifesciences.projects.locations.operations.get",
                               http_method: hyper::method::Method::Get });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_lifesciences2_beta as lifesciences2_beta;
/// use lifesciences2_beta::CancelOperationRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use lifesciences2_beta::CloudLifeSciences;
...
impl<'a, C, A> ProjectLocationOperationCancelCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Empty)> {
        ...
        dlg.begin(MethodInfo { id: "lifesciences.projects.locations.operations.cancel",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a, C, A> ProjectLocationListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListLocationsResponse)> {
        ...
        dlg.begin(MethodInfo { id: "lifesciences.projects.locations.list",
                               http_method: hyper::method::Method::Get });
...
impl<'a, C, A> ProjectLocationOperationListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListOperationsResponse)> {
        ...
        dlg.begin(MethodInfo { id: "lifesciences.projects.locations.operations.list",
                               http_method: hyper::method::Method::Get });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        if let Some(value) = self._page_token {
