...
//! This documentation was generated from *storagetransfer* crate version *0.1.14+20150811*, where *20150811* is the exact revision of the *storagetransfer:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.14*.
//! 
