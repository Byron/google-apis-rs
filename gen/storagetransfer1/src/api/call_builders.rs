...
pub struct ProjectAgentPoolCreateCall<'a, S>
   ...
   pub(super) hub: &'a Storagetransfer<S>,
   pub(super) _request: AgentPool,
   pub(super) _project_id: String,
   pub(super) _agent_pool_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct TransferJobCreateCall<'a, S>
   ...
   pub(super) hub: &'a Storagetransfer<S>,
   pub(super) _request: TransferJob,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct TransferJobPatchCall<'a, S>
   ...
   pub(super) hub: &'a Storagetransfer<S>,
   pub(super) _request: UpdateTransferJobRequest,
   pub(super) _job_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct TransferJobRunCall<'a, S>
   ...
   pub(super) hub: &'a Storagetransfer<S>,
   pub(super) _request: RunTransferJobRequest,
   pub(super) _job_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct TransferOperationPauseCall<'a, S>
   ...
   pub(super) hub: &'a Storagetransfer<S>,
   pub(super) _request: PauseTransferOperationRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct TransferOperationResumeCall<'a, S>
   ...
   pub(super) hub: &'a Storagetransfer<S>,
   pub(super) _request: ResumeTransferOperationRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
