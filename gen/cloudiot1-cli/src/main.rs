...
use google_cloudiot1::{api, yup_oauth2, Error};
...
{
    async fn _projects_locations_registries_bind_device_to_gateway(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["device-id", "gateway-id"]);
        ...
        let mut request: api::BindDeviceToGatewayRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_registries_bind_device_to_gateway(
                request,
    ...
    async fn _projects_locations_registries_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "http-config.http-enabled-state" => Some((
                ...
                "mqtt-config.mqtt-enabled-state" => Some((
                ...
                "state-notification-config.pubsub-topic-name" => Some((
        ...
        let mut request: api::DeviceRegistry = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_registries_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_devices_config_versions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_devices_config_versions_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "num-versions" => {
                    call = call.num_versions(
                        value
                            .map(|v| arg_from_str(v, err, "num-versions", "int32"))
                            .unwrap_or(-0),
                    );
                }
                _ => {
    ...
    async fn _projects_locations_registries_devices_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "gateway-config.gateway-auth-method" => Some((
                ...
                "gateway-config.gateway-type" => Some((
                ...
                "gateway-config.last-accessed-gateway-id" => Some((
                ...
                "gateway-config.last-accessed-gateway-time" => Some((
                ...
                "last-error-status.message" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "gateway-type",
                            "id",
                            "last-accessed-gateway-id",
                            "last-accessed-gateway-time",
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_devices_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_devices_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_devices_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_devices_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_devices_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_devices_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_devices_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "device-num-ids" => {
                    call = call.add_device_num_ids(
                        value
                            .map(|v| arg_from_str(v, err, "device-num-ids", "uint64"))
                            .unwrap_or(0),
                    );
                }
                "device-ids" => {
    ...
    async fn _projects_locations_registries_devices_modify_cloud_to_device_config(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["binary-data", "version-to-update"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::ModifyCloudToDeviceConfigRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_registries_devices_modify_cloud_to_device_config(
                request,
    ...
    async fn _projects_locations_registries_devices_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_devices_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_devices_send_command_to_device(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["binary-data", "subfolder"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::SendCommandToDeviceRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_registries_devices_send_command_to_device(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_registries_devices_states_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_devices_states_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "num-states" => {
                    call = call.num_states(
                        value
                            .map(|v| arg_from_str(v, err, "num-states", "int32"))
                            .unwrap_or(-0),
                    );
                }
                _ => {
    ...
    async fn _projects_locations_registries_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_get_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_groups_devices_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_groups_devices_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_groups_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_groups_get_iam_policy(
                request,
    ...
    async fn _projects_locations_registries_groups_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_registries_groups_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_registries_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_registries_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_registries_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_registries_unbind_device_from_gateway(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UnbindDeviceFromGatewayRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_registries_unbind_device_from_gateway(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-registries-bind-device-to-gateway", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_bind_device_to_gateway(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-registries-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-devices-config-versions-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_devices_config_versions_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-registries-devices-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_devices_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-devices-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_devices_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-devices-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_devices_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-devices-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_devices_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-devices-modify-cloud-to-device-config", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_devices_modify_cloud_to_device_config(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-registries-devices-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_devices_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-devices-send-command-to-device", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_devices_send_command_to_device(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-registries-devices-states-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_devices_states_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-groups-devices-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_groups_devices_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-groups-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_groups_get_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-registries-groups-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_groups_set_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-registries-groups-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_groups_test_iam_permissions(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-registries-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-registries-unbind-device-from-gateway", Some(opt)) => {
                    call_result = self
                        ._projects_locations_registries_unbind_device_from_gateway(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "cloudiot1-secret.json",
