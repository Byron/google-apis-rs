...
//! This documentation was generated from *gan* crate version *0.1.8+20130205*, where *20130205* is the exact revision of the *gan:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.8*.
//! 
