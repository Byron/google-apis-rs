...
pub struct MethodLogImpressionCall<'a, S>
   ...
   pub(super) _request: GoogleMapsPlayablelocationsV3LogImpressionsRequest,
...
pub struct MethodLogPlayerReportCall<'a, S>
   ...
   pub(super) hub: &'a PlayableLocations<S>,
   pub(super) _request: GoogleMapsPlayablelocationsV3LogPlayerReportsRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
...
pub struct MethodSamplePlayableLocationCall<'a, S>
   ...
   pub(super) hub: &'a PlayableLocations<S>,
   pub(super) _request: GoogleMapsPlayablelocationsV3SamplePlayableLocationsRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
