...
impl<C> common::Hub for PlayableLocations<C> {}
...
impl common::Part for GoogleMapsPlayablelocationsV3Impression {}
...
impl common::RequestValue for GoogleMapsPlayablelocationsV3LogImpressionsRequest {}
...
impl common::ResponseResult for GoogleMapsPlayablelocationsV3LogImpressionsResponse {}
...
impl common::RequestValue for GoogleMapsPlayablelocationsV3LogPlayerReportsRequest {}
...
impl common::ResponseResult for GoogleMapsPlayablelocationsV3LogPlayerReportsResponse {}
...
impl common::Part for GoogleMapsPlayablelocationsV3PlayerReport {}
...
impl common::Part for GoogleMapsPlayablelocationsV3SampleAreaFilter {}
...
pub struct GoogleMapsPlayablelocationsV3SampleCriterion {
    ...
    pub fields_to_return: Option<common::FieldMask>,
...
impl common::Part for GoogleMapsPlayablelocationsV3SampleCriterion {}
...
impl common::Part for GoogleMapsPlayablelocationsV3SampleFilter {}
...
impl common::Part for GoogleMapsPlayablelocationsV3SamplePlayableLocation {}
...
impl common::Part for GoogleMapsPlayablelocationsV3SamplePlayableLocationList {}
...
impl common::RequestValue for GoogleMapsPlayablelocationsV3SamplePlayableLocationsRequest {}
...
pub struct GoogleMapsPlayablelocationsV3SamplePlayableLocationsResponse {
    ...
    pub locations_per_game_object_type:
        Option<HashMap<String, GoogleMapsPlayablelocationsV3SamplePlayableLocationList>>,
...
impl common::ResponseResult for GoogleMapsPlayablelocationsV3SamplePlayableLocationsResponse {}
...
impl common::Part for GoogleMapsPlayablelocationsV3SampleSpacingOptions {}
...
impl common::Part for GoogleMapsUnityClientInfo {}
...
impl<'a, C> common::CallBuilder for MethodLogImpressionCall<'a, C> {}

impl<'a, C> MethodLogImpressionCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub fn request(
        mut self,
        new_value: GoogleMapsPlayablelocationsV3LogImpressionsRequest,
    ) -> MethodLogImpressionCall<'a, C> {
...
impl<'a, C> common::CallBuilder for MethodLogPlayerReportCall<'a, C> {}

impl<'a, C> MethodLogPlayerReportCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleMapsPlayablelocationsV3LogPlayerReportsRequest,
    ) -> MethodLogPlayerReportCall<'a, C> {
        self._request = new_value;
        self
    }
...
impl<'a, C> common::CallBuilder for MethodSamplePlayableLocationCall<'a, C> {}

impl<'a, C> MethodSamplePlayableLocationCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleMapsPlayablelocationsV3SamplePlayableLocationsRequest,
    ) -> MethodSamplePlayableLocationCall<'a, C> {
        self._request = new_value;
        self
    }
