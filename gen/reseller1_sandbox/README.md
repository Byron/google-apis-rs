...
This documentation was generated from *reseller* crate version *0.1.0+20141112*, where *20141112* is the exact revision of the *reseller:v1sandbox* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.0*.
...
[decodable](http://byron.github.io/google-apis-rs/google-reseller1_sandbox/trait.ResponseResult.html) via json. Optionals are used to indicate that partial requests are responses are valid.
Most optionals are are considered [Parts](http://byron.github.io/google-apis-rs/google-reseller1_sandbox/trait.Part.html) which are identifyable by name, which will be sent to 
