...
use google_accesscontextmanager1_beta::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _access_policies_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["name", "parent", "title"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
    ...
    async fn _access_policies_service_perimeters_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "status.unrestricted-services" => Some((
                    "status.unrestrictedServices",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "accesscontextmanager1-beta-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/accesscontextmanager1-beta", config_dir))
        .build()
        .await
        .unwrap();
