...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/manager1_beta2).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](Manager) ... 
//! 
//! * [deployments](api::Deployment)
//!  * [*delete*](api::DeploymentDeleteCall), [*get*](api::DeploymentGetCall), [*insert*](api::DeploymentInsertCall) and [*list*](api::DeploymentListCall)
//! * [templates](api::Template)
//!  * [*delete*](api::TemplateDeleteCall), [*get*](api::TemplateGetCall), [*insert*](api::TemplateInsertCall) and [*list*](api::TemplateListCall)
//! 
//! 
//! 
//! 
