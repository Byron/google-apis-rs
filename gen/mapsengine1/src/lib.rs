...
//! This documentation was generated from *Maps Engine* crate version *0.1.10+20150629*, where *20150629* is the exact revision of the *mapsengine:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.10*.
//! 
...
//!              .role("consetetur")
//!              .project_id("eirmod")
//!              .processing_status("labore")
//!              .page_token("gubergren")
//!              .modified_before("et")
//!              .modified_after("sadipscing")
//!              .max_results(28)
//!              .creator_email("magna")
//!              .created_before("Lorem")
//!              .created_after("rebum.")
//!              .bbox("et")
//!              .doit();
//! 
