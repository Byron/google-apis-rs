...
impl<C> common::Hub for CloudIot<C> {}

impl<'a, C> CloudIot<C> {
    pub fn new<A: 'static + common::GetToken>(client: common::Client<C>, auth: A) -> CloudIot<C> {
        CloudIot {
            client,
            auth: Box::new(auth),
...
impl common::RequestValue for BindDeviceToGatewayRequest {}
...
impl common::ResponseResult for BindDeviceToGatewayResponse {}
...
pub struct Device {
    ...
    pub last_config_ack_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    /// [Output only] The last time a cloud-to-device config version was sent to the device.
    #[serde(rename = "lastConfigSendTime")]
    pub last_config_send_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    pub last_error_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    pub last_heartbeat_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    /// [Output only] The last time a state event was received. Timestamps are periodically collected and written to storage; they may be stale by a few minutes.
    #[serde(rename = "lastStateTime")]
    pub last_state_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
pub struct DeviceConfig {
    ...
    pub cloud_update_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    pub device_ack_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::ResponseResult for DeviceConfig {}
...
impl common::Part for DeviceCredential {}
...
impl common::RequestValue for DeviceRegistry {}
impl common::ResponseResult for DeviceRegistry {}
...
impl common::Part for DeviceState {}
...
impl common::Part for EventNotificationConfig {}
...
pub struct GatewayConfig {
    ...
    pub last_accessed_gateway_time: Option<chrono::DateTime<chrono::offset::Utc>>,
}

impl common::Part for GatewayConfig {}
...
impl common::Part for HttpConfig {}
...
impl common::ResponseResult for ListDeviceConfigVersionsResponse {}
...
impl common::ResponseResult for ListDeviceRegistriesResponse {}
...
impl common::ResponseResult for ListDeviceStatesResponse {}
...
impl common::RequestValue for ModifyCloudToDeviceConfigRequest {}
...
impl common::Part for MqttConfig {}
...
impl common::Part for PublicKeyCertificate {}
...
impl common::Part for PublicKeyCredential {}
...
impl common::Part for RegistryCredential {}
...
impl common::RequestValue for SendCommandToDeviceRequest {}
...
impl common::ResponseResult for SendCommandToDeviceResponse {}
...
impl common::Part for StateNotificationConfig {}
...
impl common::RequestValue for UnbindDeviceFromGatewayRequest {}
...
impl common::ResponseResult for UnbindDeviceFromGatewayResponse {}
...
impl common::Part for X509CertificateDetails {}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_registries_devices_config_versions_list(
        &self,
        name: &str,
    ) -> ProjectLocationRegistryDeviceConfigVersionListCall<'a, C> {
    ...
    pub fn locations_registries_devices_states_list(
        &self,
        name: &str,
    ) -> ProjectLocationRegistryDeviceStateListCall<'a, C> {
    ...
    pub fn locations_registries_devices_create(
        ...
        request: Device,
        parent: &str,
    ) -> ProjectLocationRegistryDeviceCreateCall<'a, C> {
    ...
    pub fn locations_registries_devices_delete(
        &self,
        name: &str,
    ) -> ProjectLocationRegistryDeviceDeleteCall<'a, C> {
    ...
    pub fn locations_registries_devices_get(
        &self,
        name: &str,
    ) -> ProjectLocationRegistryDeviceGetCall<'a, C> {
    ...
    pub fn locations_registries_devices_list(
        &self,
        parent: &str,
    ) -> ProjectLocationRegistryDeviceListCall<'a, C> {
    ...
    pub fn locations_registries_devices_modify_cloud_to_device_config(
        ...
        name: &str,
    ) -> ProjectLocationRegistryDeviceModifyCloudToDeviceConfigCall<'a, C> {
    ...
    pub fn locations_registries_devices_patch(
        ...
        request: Device,
        name: &str,
    ) -> ProjectLocationRegistryDevicePatchCall<'a, C> {
    ...
    pub fn locations_registries_devices_send_command_to_device(
        ...
        name: &str,
    ) -> ProjectLocationRegistryDeviceSendCommandToDeviceCall<'a, C> {
    ...
    pub fn locations_registries_groups_devices_list(
        &self,
        parent: &str,
    ) -> ProjectLocationRegistryGroupDeviceListCall<'a, C> {
    ...
    pub fn locations_registries_groups_get_iam_policy(
        ...
        resource: &str,
    ) -> ProjectLocationRegistryGroupGetIamPolicyCall<'a, C> {
    ...
    pub fn locations_registries_groups_set_iam_policy(
        ...
        resource: &str,
    ) -> ProjectLocationRegistryGroupSetIamPolicyCall<'a, C> {
    ...
    pub fn locations_registries_groups_test_iam_permissions(
        ...
        resource: &str,
    ) -> ProjectLocationRegistryGroupTestIamPermissionCall<'a, C> {
    ...
    pub fn locations_registries_bind_device_to_gateway(
        ...
        parent: &str,
    ) -> ProjectLocationRegistryBindDeviceToGatewayCall<'a, C> {
    ...
    pub fn locations_registries_create(
        ...
        parent: &str,
    ) -> ProjectLocationRegistryCreateCall<'a, C> {
    ...
    pub fn locations_registries_delete(
        &self,
        name: &str,
    ) -> ProjectLocationRegistryDeleteCall<'a, C> {
    ...
    pub fn locations_registries_get_iam_policy(
        ...
        request: GetIamPolicyRequest,
        resource: &str,
    ) -> ProjectLocationRegistryGetIamPolicyCall<'a, C> {
    ...
    pub fn locations_registries_list(
        &self,
        parent: &str,
    ) -> ProjectLocationRegistryListCall<'a, C> {
    ...
    pub fn locations_registries_patch(
        ...
        request: DeviceRegistry,
        name: &str,
    ) -> ProjectLocationRegistryPatchCall<'a, C> {
    ...
    pub fn locations_registries_set_iam_policy(
        ...
        request: SetIamPolicyRequest,
        resource: &str,
    ) -> ProjectLocationRegistrySetIamPolicyCall<'a, C> {
    ...
    pub fn locations_registries_test_iam_permissions(
        ...
        request: TestIamPermissionsRequest,
        resource: &str,
    ) -> ProjectLocationRegistryTestIamPermissionCall<'a, C> {
    ...
    pub fn locations_registries_unbind_device_from_gateway(
        ...
        parent: &str,
    ) -> ProjectLocationRegistryUnbindDeviceFromGatewayCall<'a, C> {
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryDeviceConfigVersionListCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryDeviceConfigVersionListCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, ListDeviceConfigVersionsResponse)> {
        use std::borrow::Cow;
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryDeviceConfigVersionListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryDeviceStateListCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryDeviceStateListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListDeviceStatesResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryDeviceStateListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryDeviceStateListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryDeviceCreateCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryDeviceCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryDeviceCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryDeviceCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryDeviceCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryDeviceDeleteCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryDeviceDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryDeviceDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryDeviceDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryDeviceDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryDeviceGetCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryDeviceGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryDeviceGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryDeviceGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryDeviceGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryDeviceListCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryDeviceListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryDeviceListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryDeviceListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryDeviceListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder
    for ProjectLocationRegistryDeviceModifyCloudToDeviceConfigCall<'a, C>
{
}

impl<'a, C> ProjectLocationRegistryDeviceModifyCloudToDeviceConfigCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, DeviceConfig)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: ModifyCloudToDeviceConfigRequest,
    ) -> ProjectLocationRegistryDeviceModifyCloudToDeviceConfigCall<'a, C> {
        self._request = new_value;
        self
    }
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryDevicePatchCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryDevicePatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryDevicePatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryDevicePatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryDevicePatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryDeviceSendCommandToDeviceCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryDeviceSendCommandToDeviceCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SendCommandToDeviceResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: SendCommandToDeviceRequest,
    ) -> ProjectLocationRegistryDeviceSendCommandToDeviceCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryDeviceSendCommandToDeviceCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryGroupDeviceListCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryGroupDeviceListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryGroupDeviceListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryGroupDeviceListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryGroupGetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryGroupGetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryGroupGetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryGroupGetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryGroupSetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryGroupSetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryGroupSetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryGroupSetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryGroupTestIamPermissionCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryGroupTestIamPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryGroupTestIamPermissionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryBindDeviceToGatewayCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryBindDeviceToGatewayCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, BindDeviceToGatewayResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: BindDeviceToGatewayRequest,
    ) -> ProjectLocationRegistryBindDeviceToGatewayCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryBindDeviceToGatewayCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryCreateCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, DeviceRegistry)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryDeleteCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryGetCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> ProjectLocationRegistryGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryGetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryGetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryGetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryGetIamPolicyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryGetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryListCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, ListDeviceRegistriesResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryPatchCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistryPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrySetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrySetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrySetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistrySetIamPolicyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrySetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryTestIamPermissionCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryTestIamPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistryTestIamPermissionCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryTestIamPermissionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistryUnbindDeviceFromGatewayCall<'a, C> {}

impl<'a, C> ProjectLocationRegistryUnbindDeviceFromGatewayCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, UnbindDeviceFromGatewayResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: UnbindDeviceFromGatewayRequest,
    ) -> ProjectLocationRegistryUnbindDeviceFromGatewayCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistryUnbindDeviceFromGatewayCall<'a, C> {
        self._scopes.clear();
        self
    }
}
