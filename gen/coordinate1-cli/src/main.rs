        ...
        match self.opt.subcommand() {
            ("custom-field-def", Some(opt)) => {
                match opt.subcommand() {
                    ("list", Some(opt)) => {
                        call_result = self._custom_field_def_list(opt, dry_run, &mut err);
                    },
                    _ => {
            ...
            ("jobs", Some(opt)) => {
                match opt.subcommand() {
                    ...
                    ("patch", Some(opt)) => {
                        call_result = self._jobs_patch(opt, dry_run, &mut err);
                    },
                    ("update", Some(opt)) => {
                        call_result = self._jobs_update(opt, dry_run, &mut err);
                    },
                    _ => {
            ...
            ("location", Some(opt)) => {
                match opt.subcommand() {
                    ("list", Some(opt)) => {
                        call_result = self._location_list(opt, dry_run, &mut err);
                    },
                    _ => {
            ...
            ("schedule", Some(opt)) => {
                match opt.subcommand() {
                    ("get", Some(opt)) => {
                        call_result = self._schedule_get(opt, dry_run, &mut err);
                    },
                    ("patch", Some(opt)) => {
                        call_result = self._schedule_patch(opt, dry_run, &mut err);
                    },
                    ("update", Some(opt)) => {
                        call_result = self._schedule_update(opt, dry_run, &mut err);
                    },
                    _ => {
            ...
            ("team", Some(opt)) => {
                match opt.subcommand() {
                    ("list", Some(opt)) => {
                        call_result = self._team_list(opt, dry_run, &mut err);
                    },
                    _ => {
            ...
            ("worker", Some(opt)) => {
                match opt.subcommand() {
                    ("list", Some(opt)) => {
                        call_result = self._worker_list(opt, dry_run, &mut err);
                    },
                    _ => {
