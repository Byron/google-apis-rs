...
//! This documentation was generated from *TPU* crate version *2.0.3+20210217*, where *20210217* is the exact revision of the *tpu:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.3*.
//! 
