...
This documentation was generated from the *Iam* API at revision *20251204*. The CLI is at version *7.0.0*.
...
iam1 [options]
        ...
        locations
                ...
                workforce-pools-providers-scim-tenants-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-delete <name> [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-get <name> [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-list <parent> [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-tokens-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-tokens-delete <name> [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-tokens-get <name> [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-tokens-list <parent> [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-tokens-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-tokens-undelete <name> (-r <kv>)... [-p <v>]... [-o <out>]
                workforce-pools-providers-scim-tenants-undelete <name> (-r <kv>)... [-p <v>]... [-o <out>]
        ...
        projects
                ...
                locations-workload-identity-pools-get-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-workload-identity-pools-list <parent> [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-delete <name> [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-get <name> [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-list <parent> [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-add-attestation-rule <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-delete <name> [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-get <name> [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-list <parent> [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-list-attestation-rules <resource> [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-operations-get <name> [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-remove-attestation-rule <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-set-attestation-rules <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-managed-identities-undelete <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-workload-identity-pools-namespaces-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-workload-identity-pools-namespaces-undelete <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-workload-identity-pools-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-workload-identity-pools-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
