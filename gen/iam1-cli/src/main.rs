...
extern crate mime;
extern crate strsim;
extern crate google_iam1 as api;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::Iam<hyper::Client, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client>>,
    gp: Vec<&'static str>,
...
impl<'n> Engine<'n> {
    ...
    fn _organizations_roles_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _organizations_roles_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _organizations_roles_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["show-deleted", "page-size", "page-token", "view"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _organizations_roles_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _organizations_roles_undelete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _permissions_query_testable_permissions(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_roles_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_roles_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_roles_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_roles_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_roles_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_roles_undelete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_service_accounts_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_service_accounts_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_service_accounts_get_iam_policy(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_service_accounts_keys_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_service_accounts_keys_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_service_accounts_keys_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_service_accounts_keys_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_service_accounts_sign_jwt(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_service_accounts_test_iam_permissions(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["show-deleted", "page-token", "page-size", "parent", "view"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _doit(&self, dry_run: bool) -> Result<Result<(), DoitError>, Option<InvalidOptionsError>> {
        ...
        match self.opt.subcommand() {
            ...
            ("organizations", Some(opt)) => {
                match opt.subcommand() {
                    ("roles-create", Some(opt)) => {
                        call_result = self._organizations_roles_create(opt, dry_run, &mut err);
                    },
                    ("roles-delete", Some(opt)) => {
                        call_result = self._organizations_roles_delete(opt, dry_run, &mut err);
                    },
                    ("roles-get", Some(opt)) => {
                        call_result = self._organizations_roles_get(opt, dry_run, &mut err);
                    },
                    ("roles-list", Some(opt)) => {
                        call_result = self._organizations_roles_list(opt, dry_run, &mut err);
                    },
                    ("roles-patch", Some(opt)) => {
                        call_result = self._organizations_roles_patch(opt, dry_run, &mut err);
                    },
                    ("roles-undelete", Some(opt)) => {
                        call_result = self._organizations_roles_undelete(opt, dry_run, &mut err);
                    },
                    _ => {
            ...
            ("permissions", Some(opt)) => {
                match opt.subcommand() {
                    ("query-testable-permissions", Some(opt)) => {
                        call_result = self._permissions_query_testable_permissions(opt, dry_run, &mut err);
                    },
                    _ => {
            ...
            ("projects", Some(opt)) => {
                match opt.subcommand() {
                    ("roles-create", Some(opt)) => {
                        call_result = self._projects_roles_create(opt, dry_run, &mut err);
                    },
                    ("roles-delete", Some(opt)) => {
                        call_result = self._projects_roles_delete(opt, dry_run, &mut err);
                    },
                    ("roles-get", Some(opt)) => {
                        call_result = self._projects_roles_get(opt, dry_run, &mut err);
                    },
                    ("roles-list", Some(opt)) => {
                        call_result = self._projects_roles_list(opt, dry_run, &mut err);
                    },
                    ("roles-patch", Some(opt)) => {
                        call_result = self._projects_roles_patch(opt, dry_run, &mut err);
                    },
                    ("roles-undelete", Some(opt)) => {
                        call_result = self._projects_roles_undelete(opt, dry_run, &mut err);
                    },
                    ("service-accounts-create", Some(opt)) => {
                        call_result = self._projects_service_accounts_create(opt, dry_run, &mut err);
                    },
                    ...
                    ("service-accounts-get-iam-policy", Some(opt)) => {
                        call_result = self._projects_service_accounts_get_iam_policy(opt, dry_run, &mut err);
                    },
                    ("service-accounts-keys-create", Some(opt)) => {
                        call_result = self._projects_service_accounts_keys_create(opt, dry_run, &mut err);
                    },
                    ("service-accounts-keys-delete", Some(opt)) => {
                        call_result = self._projects_service_accounts_keys_delete(opt, dry_run, &mut err);
                    },
                    ("service-accounts-keys-get", Some(opt)) => {
                        call_result = self._projects_service_accounts_keys_get(opt, dry_run, &mut err);
                    },
                    ...
                    ("service-accounts-sign-jwt", Some(opt)) => {
                        call_result = self._projects_service_accounts_sign_jwt(opt, dry_run, &mut err);
                    },
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "iam1-secret.json",
        ...
        ("organizations", "methods: 'roles-create', 'roles-delete', 'roles-get', 'roles-list', 'roles-patch' and 'roles-undelete'", vec![
            ("roles-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"The `parent` parameter's value depends on the target resource for the
        request, namely
        ...
        * [`organizations.roles.create()`](/iam/reference/rest/v1/organizations.roles/create):
        ...
        with the role are removed."##),
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The `name` parameter's value depends on the target resource for the
        request, namely
        [`projects`](/iam/reference/rest/v1/projects.roles) or
        [`organizations`](/iam/reference/rest/v1/organizations.roles). Each
        ...
        * [`organizations.roles.undelete()`](/iam/reference/rest/v1/organizations.roles/undelete):
        ...
        and returns it."##),
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the project associated with the service
