...
//! This documentation was generated from *Cloud OS Login* crate version *7.0.0+20251212*, where *20251212* is the exact revision of the *oslogin:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
...
//!
//! * projects
//!  * [*locations sign ssh public key*](api::ProjectLocationSignSshPublicKeyCall)
//! * users
//!  * [*get login profile*](api::UserGetLoginProfileCall), [*import ssh public key*](api::UserImportSshPublicKeyCall), [*projects delete*](api::UserProjectDeleteCall), [*projects provision posix account*](api::UserProjectProvisionPosixAccountCall), [*ssh public keys create*](api::UserSshPublicKeyCreateCall), [*ssh public keys delete*](api::UserSshPublicKeyDeleteCall), [*ssh public keys get*](api::UserSshPublicKeyGetCall) and [*ssh public keys patch*](api::UserSshPublicKeyPatchCall)
//!
//!
//!
//!
