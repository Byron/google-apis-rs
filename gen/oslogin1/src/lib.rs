...
//! This documentation was generated from *Cloud OS Login* crate version *8.0.0+20251012*, where *20251012* is the exact revision of the *oslogin:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
