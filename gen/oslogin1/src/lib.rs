...
//! This documentation was generated from *Cloud OS Login* crate version *1.0.13+20200329*, where *20200329* is the exact revision of the *oslogin:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.13*.
//! 
