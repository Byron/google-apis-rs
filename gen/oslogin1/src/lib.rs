...
//! This documentation was generated from *Cloud OS Login* crate version *1.0.11+20190614*, where *20190614* is the exact revision of the *oslogin:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.11*.
//! 
