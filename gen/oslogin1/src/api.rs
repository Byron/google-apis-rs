...
/// let mut hub = CloudOSLogin::new(client, auth);
/// // Usually you wouldn't bind this to a variable, but keep calling *CallBuilders*
/// // like `get_login_profile(...)`, `import_ssh_public_key(...)`, `projects_delete(...)`, `projects_provision_posix_account(...)`, `ssh_public_keys_create(...)`, `ssh_public_keys_delete(...)`, `ssh_public_keys_get(...)` and `ssh_public_keys_patch(...)`
/// // to build up your call.
/// let rb = hub.users();
/// # }
/// ```
...
/// # extern crate hyper_rustls;
/// # extern crate google_oslogin1 as oslogin1;
/// use oslogin1::api::SignSshPublicKeyRequest;
/// # async fn dox() {
/// # use oslogin1::{CloudOSLogin, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, SignSshPublicKeyResponse)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}:signSshPublicKey";
...
/// # extern crate hyper_rustls;
/// # extern crate google_oslogin1 as oslogin1;
/// use oslogin1::api::ProvisionPosixAccountRequest;
/// # async fn dox() {
/// # use oslogin1::{CloudOSLogin, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
