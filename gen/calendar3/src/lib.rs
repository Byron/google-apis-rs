...
//! This documentation was generated from *calendar* crate version *0.1.7+20150326*, where *20150326* is the exact revision of the *calendar:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.7*.
//! 
