...
//! * organizations
//!  * [*locations retrieve config*](api::OrganizationLocationRetrieveConfigCall), [*locations retrieve effective config*](api::OrganizationLocationRetrieveEffectiveConfigCall) and [*locations set config*](api::OrganizationLocationSetConfigCall)
//! * projects
