...
//! 
//! * projects
//!  * [*locations list pipelines*](api::ProjectLocationListPipelineCall), [*locations pipelines create*](api::ProjectLocationPipelineCreateCall), [*locations pipelines delete*](api::ProjectLocationPipelineDeleteCall), [*locations pipelines get*](api::ProjectLocationPipelineGetCall), [*locations pipelines jobs list*](api::ProjectLocationPipelineJobListCall), [*locations pipelines patch*](api::ProjectLocationPipelinePatchCall), [*locations pipelines run*](api::ProjectLocationPipelineRunCall) and [*locations pipelines stop*](api::ProjectLocationPipelineStopCall)
//! 
//! 
//! 
//! 
