...
impl<C> common::Hub for Datapipelines<C> {}

impl<'a, C> Datapipelines<C> {
...
impl common::Part for GoogleCloudDatapipelinesV1DataflowJobDetails {}
...
impl common::Part for GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment {}
...
impl common::Part for GoogleCloudDatapipelinesV1Job {}
...
impl common::Part for GoogleCloudDatapipelinesV1LaunchFlexTemplateParameter {}
...
impl common::Part for GoogleCloudDatapipelinesV1LaunchFlexTemplateRequest {}
...
impl common::Part for GoogleCloudDatapipelinesV1LaunchTemplateParameters {}
...
impl common::Part for GoogleCloudDatapipelinesV1LaunchTemplateRequest {}
...
impl common::ResponseResult for GoogleCloudDatapipelinesV1ListJobsResponse {}
...
impl common::ResponseResult for GoogleCloudDatapipelinesV1ListPipelinesResponse {}
...
impl common::RequestValue for GoogleCloudDatapipelinesV1Pipeline {}
impl common::ResponseResult for GoogleCloudDatapipelinesV1Pipeline {}
...
impl common::RequestValue for GoogleCloudDatapipelinesV1RunPipelineRequest {}
...
impl common::ResponseResult for GoogleCloudDatapipelinesV1RunPipelineResponse {}
...
impl common::Part for GoogleCloudDatapipelinesV1RuntimeEnvironment {}
...
pub struct GoogleCloudDatapipelinesV1ScheduleSpec {
    ...
    pub next_job_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::Part for GoogleCloudDatapipelinesV1ScheduleSpec {}
...
impl common::Part for GoogleCloudDatapipelinesV1SdkVersion {}
...
impl common::RequestValue for GoogleCloudDatapipelinesV1StopPipelineRequest {}
...
impl common::Part for GoogleCloudDatapipelinesV1Workload {}
...
/// # }
/// ```
pub struct ProjectLocationPipelineJobListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Datapipelines<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationPipelineJobListCall<'a, C> {}

impl<'a, C> ProjectLocationPipelineJobListCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleCloudDatapipelinesV1ListJobsResponse)> {
        use std::borrow::Cow;
    ...
    pub fn parent(mut self, new_value: &str) -> ProjectLocationPipelineJobListCall<'a, C> {
    ...
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationPipelineJobListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationPipelineJobListCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationPipelineJobListCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationPipelineJobListCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationPipelineJobListCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationPipelineJobListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleCloudDatapipelinesV1Pipeline)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudDatapipelinesV1Pipeline,
    ) -> ProjectLocationPipelineCreateCall<'a, C> {
...
/// # }
/// ```
pub struct ProjectLocationPipelineRunCall<'a, C>
where
    C: 'a,
{
    hub: &'a Datapipelines<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationPipelineRunCall<'a, C> {}

impl<'a, C> ProjectLocationPipelineRunCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudDatapipelinesV1RunPipelineRequest,
    ) -> ProjectLocationPipelineRunCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationPipelineRunCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationPipelineRunCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationPipelineRunCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationPipelineRunCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationPipelineRunCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationPipelineStopCall<'a, C>
where
    C: 'a,
{
    hub: &'a Datapipelines<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationPipelineStopCall<'a, C> {}

impl<'a, C> ProjectLocationPipelineStopCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudDatapipelinesV1StopPipelineRequest,
    ) -> ProjectLocationPipelineStopCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationPipelineStopCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationPipelineStopCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationPipelineStopCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationPipelineStopCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationPipelineStopCall<'a, C> {
        self._scopes.clear();
        self
    }
}
