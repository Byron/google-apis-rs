...
pub struct ProjectLocationPipelineCreateCall<'a, S>
   ...
   pub(super) hub: &'a Datapipelines<S>,
   pub(super) _request: GoogleCloudDatapipelinesV1Pipeline,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationPipelineRunCall<'a, S>
   ...
   pub(super) hub: &'a Datapipelines<S>,
   pub(super) _request: GoogleCloudDatapipelinesV1RunPipelineRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationPipelineStopCall<'a, S>
   ...
   pub(super) hub: &'a Datapipelines<S>,
   pub(super) _request: GoogleCloudDatapipelinesV1StopPipelineRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
