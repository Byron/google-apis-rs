...
pub struct FolderMoveCall<'a, S>
   ...
   pub(super) hub: &'a CloudResourceManager<S>,
   pub(super) _request: MoveFolderRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct FolderUndeleteCall<'a, S>
   ...
   pub(super) hub: &'a CloudResourceManager<S>,
   pub(super) _request: UndeleteFolderRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectMoveCall<'a, S>
   ...
   pub(super) hub: &'a CloudResourceManager<S>,
   pub(super) _request: MoveProjectRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
