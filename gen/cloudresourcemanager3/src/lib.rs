...
//! * locations
//!  * [*effective tag binding collections get*](api::LocationEffectiveTagBindingCollectionGetCall), [*tag binding collections get*](api::LocationTagBindingCollectionGetCall) and [*tag binding collections update*](api::LocationTagBindingCollectionUpdateCall)
