...
//! This documentation was generated from *Search Console* crate version *2.0.4+20210325*, where *20210325* is the exact revision of the *searchconsole:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.4*.
//! 
