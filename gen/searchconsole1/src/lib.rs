...
//! This documentation was generated from *Search Console* crate version *8.0.0+20251029*, where *20251029* is the exact revision of the *searchconsole:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
