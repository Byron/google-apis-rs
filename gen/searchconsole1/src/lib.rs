...
//! This documentation was generated from *Search Console* crate version *5.0.2-beta-1+20230123*, where *20230123* is the exact revision of the *searchconsole:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2-beta-1*.
//! 
