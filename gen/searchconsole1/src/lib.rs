...
//! This documentation was generated from *Search Console* crate version *7.0.0+20251221*, where *20251221* is the exact revision of the *searchconsole:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
//! Everything else about the *Search Console* *v1* API can be found at the
//! [official documentation site](https://developers.google.com/webmaster-tools/about).
