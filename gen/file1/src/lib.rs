...
//! This documentation was generated from *Cloud Filestore* crate version *1.0.10+20190627*, where *20190627* is the exact revision of the *file:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.10*.
//! 
