...
impl client::Part for AllowlistResult {}
...
pub struct AttestationAuthenticator {
    ...
    #[serde(rename="pkixPublicKeySet")]
    
    pub pkix_public_key_set: Option<PkixPublicKeySet>,
}

impl client::Part for AttestationAuthenticator {}
...
pub struct AttestationSource {
    ...
    #[serde(rename="containerAnalysisAttestationProjects")]
    
    pub container_analysis_attestation_projects: Option<Vec<String>>,
}

impl client::Part for AttestationSource {}
...
pub struct Check {
    ...
    #[serde(rename="imageFreshnessCheck")]
    ...
    #[serde(rename="sigstoreSignatureCheck")]
    ...
    #[serde(rename="simpleSigningAttestationCheck")]
    ...
    #[serde(rename="vulnerabilityCheck")]
    
    pub vulnerability_check: Option<VulnerabilityCheck>,
}

impl client::Part for Check {}
...
impl client::Part for CheckResult {}
...
impl client::Part for CheckResults {}
...
impl client::Part for CheckSetResult {}
...
/// * [platforms policies delete projects](ProjectPlatformPolicyDeleteCall) (response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [platforms gke policies evaluate projects](ProjectPlatformGkePolicyEvaluateCall) (request)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl client::RequestValue for EvaluateGkePolicyRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [platforms gke policies evaluate projects](ProjectPlatformGkePolicyEvaluateCall) (response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl client::ResponseResult for EvaluateGkePolicyResponse {}
...
impl client::Part for EvaluationResult {}
...
impl client::Part for GkePolicy {}
...
pub struct ImageAllowlist {
    ...
    #[serde(rename="allowPattern")]
    
    pub allow_pattern: Option<Vec<String>>,
}

impl client::Part for ImageAllowlist {}
...
pub struct ImageFreshnessCheck {
    ...
    #[serde(rename="maxUploadAgeDays")]
    
    pub max_upload_age_days: Option<i32>,
}

impl client::Part for ImageFreshnessCheck {}
...
impl client::Part for ImageResult {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [platforms policies list projects](ProjectPlatformPolicyListCall) (response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct ListPlatformPoliciesResponse {
    ...
    #[serde(rename="platformPolicies")]
    
    pub platform_policies: Option<Vec<PlatformPolicy>>,
}

impl client::ResponseResult for ListPlatformPoliciesResponse {}
...
pub struct PkixPublicKeySet {
    ...
    #[serde(rename="pkixPublicKeys")]
    
    pub pkix_public_keys: Option<Vec<PkixPublicKey>>,
}

impl client::Part for PkixPublicKeySet {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [platforms policies create projects](ProjectPlatformPolicyCreateCall) (request|response)
/// * [platforms policies get projects](ProjectPlatformPolicyGetCall) (response)
/// * [platforms policies replace platform policy projects](ProjectPlatformPolicyReplacePlatformPolicyCall) (request|response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl client::RequestValue for PlatformPolicy {}
impl client::ResponseResult for PlatformPolicy {}
...
pub struct PodResult {
    ...
    #[serde(rename="kubernetesServiceAccount")]
...
impl client::Part for PodResult {}
...
impl client::Part for SigstoreAuthority {}
...
impl client::Part for SigstorePublicKey {}
...
impl client::Part for SigstorePublicKeySet {}
...
pub struct SigstoreSignatureCheck {
    ...
    #[serde(rename="sigstoreAuthorities")]
    
    pub sigstore_authorities: Option<Vec<SigstoreAuthority>>,
}

impl client::Part for SigstoreSignatureCheck {}
...
pub struct SimpleSigningAttestationCheck {
    ...
    #[serde(rename="attestationAuthenticators")]
...
impl client::Part for SimpleSigningAttestationCheck {}
...
impl client::Part for SlsaCheck {}
...
pub struct TrustedDirectoryCheck {
    ...
    #[serde(rename="trustedDirPatterns")]
    
    pub trusted_dir_patterns: Option<Vec<String>>,
}

impl client::Part for TrustedDirectoryCheck {}
...
pub struct VerificationRule {
    ...
    #[serde(rename="attestationSource")]
    ...
    #[serde(rename="configBasedBuildRequired")]
    ...
    #[serde(rename="trustedSourceRepoPatterns")]
    
    pub trusted_source_repo_patterns: Option<Vec<String>>,
}

impl client::Part for VerificationRule {}
...
pub struct VulnerabilityCheck {
    ...
    #[serde(rename="containerAnalysisVulnerabilityProjects")]
    ...
    #[serde(rename="maximumFixableSeverity")]
    ...
    #[serde(rename="maximumUnfixableSeverity")]
    
    pub maximum_unfixable_severity: Option<String>,
}

impl client::Part for VulnerabilityCheck {}
...
/// // like `attestors_create(...)`, `attestors_delete(...)`, `attestors_get(...)`, `attestors_get_iam_policy(...)`, `attestors_list(...)`, `attestors_set_iam_policy(...)`, `attestors_test_iam_permissions(...)`, `attestors_update(...)`, `attestors_validate_attestation_occurrence(...)`, `get_policy(...)`, `platforms_gke_policies_evaluate(...)`, `platforms_policies_create(...)`, `platforms_policies_delete(...)`, `platforms_policies_get(...)`, `platforms_policies_list(...)`, `platforms_policies_replace_platform_policy(...)`, `policy_get_iam_policy(...)`, `policy_set_iam_policy(...)`, `policy_test_iam_permissions(...)` and `update_policy(...)`
...
impl<'a, S> ProjectMethods<'a, S> {
    ...
    ///
    /// * `request` - No description provided.
    /// * `name` - Required. The name of the platform policy to evaluate in the format `projects/*/platforms/*/policies/*`.
    pub fn platforms_gke_policies_evaluate(&self, request: EvaluateGkePolicyRequest, name: &str) -> ProjectPlatformGkePolicyEvaluateCall<'a, S> {
        ProjectPlatformGkePolicyEvaluateCall {
            hub: self.hub,
            _request: request,
            _name: name.to_string(),
            _delegate: Default::default(),
    ...
    pub fn platforms_policies_create(&self, request: PlatformPolicy, parent: &str) -> ProjectPlatformPolicyCreateCall<'a, S> {
        ProjectPlatformPolicyCreateCall {
            hub: self.hub,
            _request: request,
            _parent: parent.to_string(),
            _policy_id: Default::default(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
            _scopes: Default::default(),
        }
    ...
    /// # Arguments
    ///
    /// * `name` - Required. The name of the platform policy to delete, in the format `projects/*/platforms/*/policies/*`.
    pub fn platforms_policies_delete(&self, name: &str) -> ProjectPlatformPolicyDeleteCall<'a, S> {
        ProjectPlatformPolicyDeleteCall {
            hub: self.hub,
            _name: name.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
    ...
    /// # Arguments
    ///
    /// * `name` - Required. The name of the platform policy to retrieve in the format `projects/*/platforms/*/policies/*`.
    pub fn platforms_policies_get(&self, name: &str) -> ProjectPlatformPolicyGetCall<'a, S> {
        ProjectPlatformPolicyGetCall {
            hub: self.hub,
            _name: name.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
    ...
    /// # Arguments
    ///
    /// * `parent` - Required. The resource name of the platform associated with the platform policies using the format `projects/*/platforms/*`.
    pub fn platforms_policies_list(&self, parent: &str) -> ProjectPlatformPolicyListCall<'a, S> {
        ProjectPlatformPolicyListCall {
            hub: self.hub,
            _parent: parent.to_string(),
            _page_token: Default::default(),
            _page_size: Default::default(),
    ...
    pub fn platforms_policies_replace_platform_policy(&self, request: PlatformPolicy, name: &str) -> ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S> {
        ProjectPlatformPolicyReplacePlatformPolicyCall {
            hub: self.hub,
            _request: request,
            _name: name.to_string(),
            _delegate: Default::default(),
...
/// Evaluates a Kubernetes object versus a GKE platform policy. Returns `NOT_FOUND` if the policy doesn't exist, `INVALID_ARGUMENT` if the policy or request is malformed and `PERMISSION_DENIED` if the client does not have sufficient permissions.
///
/// A builder for the *platforms.gke.policies.evaluate* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_binaryauthorization1 as binaryauthorization1;
/// use binaryauthorization1::api::EvaluateGkePolicyRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use binaryauthorization1::{BinaryAuthorization, oauth2, hyper, hyper_rustls, chrono, FieldMask};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = EvaluateGkePolicyRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().platforms_gke_policies_evaluate(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectPlatformGkePolicyEvaluateCall<'a, S>
    where S: 'a {

    hub: &'a BinaryAuthorization<S>,
    _request: EvaluateGkePolicyRequest,
    _name: String,
    _delegate: Option<&'a mut dyn client::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>
...
impl<'a, S> client::CallBuilder for ProjectPlatformGkePolicyEvaluateCall<'a, S> {}

impl<'a, S> ProjectPlatformGkePolicyEvaluateCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, EvaluateGkePolicyResponse)> {
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::{ToParts, url::Params};
        use std::borrow::Cow;
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "binaryauthorization.projects.platforms.gke.policies.evaluate",
                               http_method: hyper::Method::POST });
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+name}:evaluate";
        if self._scopes.is_empty() {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: EvaluateGkePolicyRequest) -> ProjectPlatformGkePolicyEvaluateCall<'a, S> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectPlatformGkePolicyEvaluateCall<'a, S> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectPlatformGkePolicyEvaluateCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectPlatformGkePolicyEvaluateCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectPlatformGkePolicyEvaluateCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectPlatformGkePolicyEvaluateCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectPlatformGkePolicyEvaluateCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
/// Creates a platform policy, and returns a copy of it. Returns `NOT_FOUND` if the project or platform doesn't exist, `INVALID_ARGUMENT` if the request is malformed, `ALREADY_EXISTS` if the policy already exists, and `INVALID_ARGUMENT` if the policy contains a platform-specific policy that does not match the platform value specified in the URL.
///
/// A builder for the *platforms.policies.create* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_binaryauthorization1 as binaryauthorization1;
/// use binaryauthorization1::api::PlatformPolicy;
/// # async fn dox() {
/// # use std::default::Default;
/// # use binaryauthorization1::{BinaryAuthorization, oauth2, hyper, hyper_rustls, chrono, FieldMask};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = PlatformPolicy::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().platforms_policies_create(req, "parent")
///              .policy_id("amet")
///              .doit().await;
/// # }
/// ```
pub struct ProjectPlatformPolicyCreateCall<'a, S>
    where S: 'a {

    hub: &'a BinaryAuthorization<S>,
    _request: PlatformPolicy,
    _parent: String,
...
impl<'a, S> client::CallBuilder for ProjectPlatformPolicyCreateCall<'a, S> {}

impl<'a, S> ProjectPlatformPolicyCreateCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, PlatformPolicy)> {
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::{ToParts, url::Params};
        use std::borrow::Cow;
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "binaryauthorization.projects.platforms.policies.create",
                               http_method: hyper::Method::POST });

        for &field in ["alt", "parent", "policyId"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
        ...
        let mut params = Params::with_capacity(5 + self._additional_params.len());
        params.push("parent", self._parent);
        if let Some(value) = self._policy_id.as_ref() {
            params.push("policyId", value);
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: PlatformPolicy) -> ProjectPlatformPolicyCreateCall<'a, S> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectPlatformPolicyCreateCall<'a, S> {
        self._parent = new_value.to_string();
        self
    }
    /// Required. The platform policy ID.
    ///
    /// Sets the *policy id* query property to the given value.
    pub fn policy_id(mut self, new_value: &str) -> ProjectPlatformPolicyCreateCall<'a, S> {
        self._policy_id = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    /// while executing the actual API request.
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectPlatformPolicyCreateCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectPlatformPolicyCreateCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectPlatformPolicyCreateCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectPlatformPolicyCreateCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectPlatformPolicyCreateCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
/// Deletes a platform policy. Returns `NOT_FOUND` if the policy doesn't exist.
///
/// A builder for the *platforms.policies.delete* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().platforms_policies_delete("name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectPlatformPolicyDeleteCall<'a, S>
    where S: 'a {
...
impl<'a, S> client::CallBuilder for ProjectPlatformPolicyDeleteCall<'a, S> {}

impl<'a, S> ProjectPlatformPolicyDeleteCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "binaryauthorization.projects.platforms.policies.delete",
                               http_method: hyper::Method::DELETE });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectPlatformPolicyDeleteCall<'a, S> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectPlatformPolicyDeleteCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectPlatformPolicyDeleteCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectPlatformPolicyDeleteCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectPlatformPolicyDeleteCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectPlatformPolicyDeleteCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
/// Gets a platform policy. Returns `NOT_FOUND` if the policy doesn't exist.
///
/// A builder for the *platforms.policies.get* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().platforms_policies_get("name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectPlatformPolicyGetCall<'a, S>
    where S: 'a {
...
impl<'a, S> client::CallBuilder for ProjectPlatformPolicyGetCall<'a, S> {}

impl<'a, S> ProjectPlatformPolicyGetCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, PlatformPolicy)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "binaryauthorization.projects.platforms.policies.get",
                               http_method: hyper::Method::GET });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectPlatformPolicyGetCall<'a, S> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectPlatformPolicyGetCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectPlatformPolicyGetCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectPlatformPolicyGetCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectPlatformPolicyGetCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectPlatformPolicyGetCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
/// Lists platform policies owned by a project in the specified platform. Returns `INVALID_ARGUMENT` if the project or the platform doesn't exist.
///
/// A builder for the *platforms.policies.list* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().platforms_policies_list("parent")
///              .page_token("ut")
///              .page_size(-12)
///              .doit().await;
/// # }
/// ```
pub struct ProjectPlatformPolicyListCall<'a, S>
    where S: 'a {
...
impl<'a, S> client::CallBuilder for ProjectPlatformPolicyListCall<'a, S> {}

impl<'a, S> ProjectPlatformPolicyListCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListPlatformPoliciesResponse)> {
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::{ToParts, url::Params};
        use std::borrow::Cow;
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "binaryauthorization.projects.platforms.policies.list",
                               http_method: hyper::Method::GET });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectPlatformPolicyListCall<'a, S> {
        self._parent = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ProjectPlatformPolicyListCall<'a, S> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProjectPlatformPolicyListCall<'a, S> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectPlatformPolicyListCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectPlatformPolicyListCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectPlatformPolicyListCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectPlatformPolicyListCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectPlatformPolicyListCall<'a, S> {
        self._scopes.clear();
        self
    }
}
...
/// Replaces a platform policy. Returns `NOT_FOUND` if the policy doesn't exist.
///
/// A builder for the *platforms.policies.replacePlatformPolicy* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().platforms_policies_replace_platform_policy(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S>
    where S: 'a {
...
impl<'a, S> client::CallBuilder for ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S> {}

impl<'a, S> ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S>
where
    S: tower_service::Service<http::Uri> + Clone + Send + Sync + 'static,
    S::Response: hyper::client::connect::Connection + AsyncRead + AsyncWrite + Send + Unpin + 'static,
    S::Future: Send + Unpin + 'static,
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, PlatformPolicy)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "binaryauthorization.projects.platforms.policies.replacePlatformPolicy",
                               http_method: hyper::Method::PUT });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: PlatformPolicy) -> ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S> {
        self._request = new_value;
        self
    }
    /// Output only. The relative resource name of the Binary Authorization platform policy, in the form of `projects/*/platforms/*/policies/*`.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S>
                                                        where St: AsRef<str> {
        self._scopes.insert(String::from(scope.as_ref()));
        self
    }
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S>
                                                        where I: IntoIterator<Item = St>,
                                                         St: AsRef<str> {
        self._scopes
            .extend(scopes.into_iter().map(|s| String::from(s.as_ref())));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectPlatformPolicyReplacePlatformPolicyCall<'a, S> {
        self._scopes.clear();
        self
    }
}
