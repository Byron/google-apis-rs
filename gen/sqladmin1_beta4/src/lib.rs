...
//! This documentation was generated from *SQL Admin* crate version *2.0.8+20210321*, where *20210321* is the exact revision of the *sqladmin:v1beta4* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.8*.
//! 
