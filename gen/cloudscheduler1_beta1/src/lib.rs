...
//! This documentation was generated from *Cloud Scheduler* crate version *8.0.0+20251022*, where *20251022* is the exact revision of the *cloudscheduler:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
