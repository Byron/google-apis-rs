...
//! This documentation was generated from *Cloud Scheduler* crate version *3.0.2+20220212*, where *20220212* is the exact revision of the *cloudscheduler:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
...
//!     ).build().await.unwrap();
//! let mut hub = CloudScheduler::new(hyper::Client::builder().build(hyper_rustls::HttpsConnector::with_native_roots().https_or_http().enable_http1().enable_http2().build()), auth);
