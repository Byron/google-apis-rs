...
//! This documentation was generated from *Cloud Scheduler* crate version *5.0.4+20240226*, where *20240226* is the exact revision of the *cloudscheduler:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.4*.
//! 
