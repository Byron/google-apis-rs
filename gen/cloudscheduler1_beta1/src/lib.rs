...
//! This documentation was generated from *Cloud Scheduler* crate version *7.0.0+20251212*, where *20251212* is the exact revision of the *cloudscheduler:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
...
//!
//! * projects
//!  * [*locations get*](api::ProjectLocationGetCall), [*locations jobs create*](api::ProjectLocationJobCreateCall), [*locations jobs delete*](api::ProjectLocationJobDeleteCall), [*locations jobs get*](api::ProjectLocationJobGetCall), [*locations jobs list*](api::ProjectLocationJobListCall), [*locations jobs patch*](api::ProjectLocationJobPatchCall), [*locations jobs pause*](api::ProjectLocationJobPauseCall), [*locations jobs resume*](api::ProjectLocationJobResumeCall), [*locations jobs run*](api::ProjectLocationJobRunCall), [*locations list*](api::ProjectLocationListCall), [*locations operations cancel*](api::ProjectLocationOperationCancelCall), [*locations operations delete*](api::ProjectLocationOperationDeleteCall), [*locations operations get*](api::ProjectLocationOperationGetCall) and [*locations operations list*](api::ProjectLocationOperationListCall)
//!
//!
//!
//!
