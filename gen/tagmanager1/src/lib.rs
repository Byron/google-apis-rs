...
//! This documentation was generated from *Tag Manager* crate version *3.0.0+20220301*, where *20220301* is the exact revision of the *tagmanager:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.0*.
//! 
...
//! use tagmanager1::{TagManager, oauth2, hyper, hyper_rustls};
//! 
