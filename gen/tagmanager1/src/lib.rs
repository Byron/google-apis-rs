...
//! This documentation was generated from *Tag Manager* crate version *1.0.5+20160310*, where *20160310* is the exact revision of the *tagmanager:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.5*.
//! 
