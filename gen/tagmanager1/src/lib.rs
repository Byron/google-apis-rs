...
//! This documentation was generated from *Tag Manager* crate version *0.1.8+20150526*, where *20150526* is the exact revision of the *tagmanager:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.8*.
//! 
