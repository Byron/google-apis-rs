...
impl<'n> Engine<'n> {
    ...
    fn _organizations_apiproducts_attributes(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Attributes = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().apiproducts_attributes(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_apiproducts_attributes_update_api_product_attribute(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["name", "value"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::GoogleCloudApigeeV1Attribute = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().apiproducts_attributes_update_api_product_attribute(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_apiproducts_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1ApiProduct = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().apiproducts_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_apiproducts_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                "expand" => {
                    call = call.expand(arg_from_str(value.unwrap_or("false"), err, "expand", "boolean"));
                },
                "count" => {
                    call = call.count(value.unwrap_or(""));
                },
                "attributevalue" => {
                    call = call.attributevalue(value.unwrap_or(""));
                },
                "attributename" => {
                    call = call.attributename(value.unwrap_or(""));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
    ...
    fn _organizations_apiproducts_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1ApiProduct = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().apiproducts_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_apis_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleApiHttpBody = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().apis_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "validate" => {
                    call = call.validate(arg_from_str(value.unwrap_or("false"), err, "validate", "boolean"));
                },
                "name" => {
    ...
    fn _organizations_apis_keyvaluemaps_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "encrypted" => Some(("encrypted", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    "name" => Some(("name", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
        ...
        let mut request: api::GoogleCloudApigeeV1KeyValueMap = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().apis_keyvaluemaps_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_apis_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                "include-revisions" => {
                    call = call.include_revisions(arg_from_str(value.unwrap_or("false"), err, "include-revisions", "boolean"));
                },
                "include-meta-data" => {
                    call = call.include_meta_data(arg_from_str(value.unwrap_or("false"), err, "include-meta-data", "boolean"));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["include-revisions", "include-meta-data"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _organizations_apis_revisions_update_api_proxy_revision(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleApiHttpBody = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().apis_revisions_update_api_proxy_revision(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "validate" => {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["validate"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _organizations_apps_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                "rows" => {
                    call = call.rows(value.unwrap_or(""));
                },
                "key-status" => {
                    call = call.key_status(value.unwrap_or(""));
                },
                "include-cred" => {
                    call = call.include_cred(arg_from_str(value.unwrap_or("false"), err, "include-cred", "boolean"));
                },
                "ids" => {
                    call = call.ids(value.unwrap_or(""));
                },
                "expand" => {
                    call = call.expand(arg_from_str(value.unwrap_or("false"), err, "expand", "boolean"));
                },
                "apptype" => {
                    call = call.apptype(value.unwrap_or(""));
                },
                "api-product" => {
                    call = call.api_product(value.unwrap_or(""));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
    ...
    fn _organizations_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Organization = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().create(request);
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "parent" => {
    ...
    fn _organizations_deployments_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                "shared-flows" => {
                    call = call.shared_flows(arg_from_str(value.unwrap_or("false"), err, "shared-flows", "boolean"));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
    ...
    fn _organizations_developers_apps_attributes(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Attributes = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_apps_attributes(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_developers_apps_attributes_update_developer_app_attribute(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Attribute = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_apps_attributes_update_developer_app_attribute(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_developers_apps_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1DeveloperApp = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_apps_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_developers_apps_generate_key_pair_or_update_developer_app_status(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1DeveloperApp = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_apps_generate_key_pair_or_update_developer_app_status(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "action" => {
    ...
    fn _organizations_developers_apps_keys_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1DeveloperAppKey = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_apps_keys_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_developers_apps_keys_create_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1DeveloperAppKey = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_apps_keys_create_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_developers_apps_keys_replace_developer_app_key(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1DeveloperAppKey = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_apps_keys_replace_developer_app_key(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_developers_apps_keys_update_developer_app_key(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1DeveloperAppKey = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_apps_keys_update_developer_app_key(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "action" => {
    ...
    fn _organizations_developers_apps_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                "shallow-expand" => {
                    call = call.shallow_expand(arg_from_str(value.unwrap_or("false"), err, "shallow-expand", "boolean"));
                },
                "expand" => {
                    call = call.expand(arg_from_str(value.unwrap_or("false"), err, "expand", "boolean"));
                },
    ...
    fn _organizations_developers_apps_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1DeveloperApp = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_apps_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_developers_attributes(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Attributes = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_attributes(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_developers_attributes_update_developer_attribute(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Attribute = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_attributes_update_developer_attribute(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_developers_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Developer = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_developers_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                "include-company" => {
                    call = call.include_company(arg_from_str(value.unwrap_or("false"), err, "include-company", "boolean"));
                },
                "ids" => {
                    call = call.ids(value.unwrap_or(""));
                },
    ...
    fn _organizations_developers_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Developer = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().developers_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_apis_revisions_debugsessions_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1DebugSession = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_apis_revisions_debugsessions_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "timeout" => {
                    call = call.timeout(value.unwrap_or(""));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
    ...
    fn _organizations_environments_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Environment = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "name" => {
    ...
    fn _organizations_environments_flowhooks_attach_shared_flow_to_flow_hook(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1FlowHook = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_flowhooks_attach_shared_flow_to_flow_hook(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_keystores_aliases_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleApiHttpBody = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_keystores_aliases_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "ignore-newline-validation" => {
                    call = call.ignore_newline_validation(arg_from_str(value.unwrap_or("false"), err, "ignore-newline-validation", "boolean"));
                },
                "ignore-expiry-validation" => {
                    call = call.ignore_expiry_validation(arg_from_str(value.unwrap_or("false"), err, "ignore-expiry-validation", "boolean"));
                },
                "format" => {
                    call = call.format(value.unwrap_or(""));
                },
                "alias" => {
                    call = call.alias(value.unwrap_or(""));
                },
                "-password" => {
                    call = call._password(value.unwrap_or(""));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
    ...
    fn _organizations_environments_keystores_aliases_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleApiHttpBody = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_keystores_aliases_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "ignore-newline-validation" => {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["ignore-newline-validation", "ignore-expiry-validation"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _organizations_environments_keystores_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Keystore = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_keystores_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "name" => {
    ...
    fn _organizations_environments_keyvaluemaps_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1KeyValueMap = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_keyvaluemaps_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_optimized_stats_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                "sonar" => {
                    call = call.sonar(arg_from_str(value.unwrap_or("false"), err, "sonar", "boolean"));
                },
                "select" => {
                ...
                "agg-table" => {
                    call = call.agg_table(value.unwrap_or(""));
                },
                "accuracy" => {
    ...
    fn _organizations_environments_queries_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut call = self.hub.organizations().environments_queries_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_references_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Reference = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_references_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_references_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Reference = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_references_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_resourcefiles_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleApiHttpBody = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_resourcefiles_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "type" => {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["type", "name"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _organizations_environments_resourcefiles_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleApiHttpBody = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_resourcefiles_update(request, opt.value_of("parent").unwrap_or(""), opt.value_of("type").unwrap_or(""), opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_set_iam_policy(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut call = self.hub.organizations().environments_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_targetservers_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1TargetServer = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_targetservers_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "name" => {
    ...
    fn _organizations_environments_targetservers_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1TargetServer = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_targetservers_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_test_iam_permissions(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut call = self.hub.organizations().environments_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_unsubscribe(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Subscription = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_unsubscribe(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Environment = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_environments_update_debugmask(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1DebugMask = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_update_debugmask(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "update-mask" => {
                ...
                "replace-repeated-fields" => {
                    call = call.replace_repeated_fields(arg_from_str(value.unwrap_or("false"), err, "replace-repeated-fields", "boolean"));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["replace-repeated-fields", "update-mask"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _organizations_environments_update_environment(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1Environment = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().environments_update_environment(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_get_sync_authorization(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1GetSyncAuthorizationRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().get_sync_authorization(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_keyvaluemaps_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudApigeeV1KeyValueMap = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().keyvaluemaps_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_reports_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut call = self.hub.organizations().reports_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_set_sync_authorization(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "identities" => Some(("identities", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Vec })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["etag", "identities"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::GoogleCloudApigeeV1SyncAuthorization = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().set_sync_authorization(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _organizations_sharedflows_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleApiHttpBody = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().sharedflows_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "name" => {
    ...
    fn _organizations_sharedflows_revisions_update_shared_flow_revision(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleApiHttpBody = json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().sharedflows_revisions_update_shared_flow_revision(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "validate" => {
    ...
    let arg_data = [
        ...
        ids."##),
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Must be of the form `hybrid/issuers`."##),
                     Some(true),
                     Some(false)),
        ...
        <pre>organizations/<var>organization_ID</var>/apiproducts/<var>api_product_name</var></pre>"##),
            ...
            ("apiproducts-attributes-delete",
                    Some(r##"Deletes an API product attribute."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_apiproducts-attributes-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"**Required.** API product name in the following form:
        ...
        **Note**: To validate the API proxy configuration bundle only
        ...
        revisions. The API proxy must be undeployed before you can delete it."##),
          ...
          `organizations/{org}/apis/{api}`"##),
            ...
            ("apis-deployments-list",
                    Some(r##"Lists all deployments of an API proxy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_apis-deployments-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        following format:
         `organizations/{org}/apis/{api}`"##),
            ...
            ("apis-get",
                    Some(r##"Gets an API proxy including a list of existing revisions."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_apis-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the API proxy in the following format:
          `organizations/{org}/apis/{api}`"##),
            ...
            ("apis-keyvaluemaps-create",
                    Some(r##"Creates a key value map in an api proxy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_apis-keyvaluemaps-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        `organizations/{organization}/apis/{api}`."##),
            ...
            ("apis-keyvaluemaps-delete",
                    Some(r##"Delete a key value map in an api proxy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_apis-keyvaluemaps-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        before you can delete it."##),
          ...
          `organizations/{org}/apis/{api}/revisions/{rev}`"##),
            ...
            ("apis-revisions-deployments-list",
                    Some(r##"Lists all deployments of an API proxy revision."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_apis-revisions-deployments-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        `multipart/form-data` or `application/octet-stream`."##),
          ...
          `organizations/{org}/apis/{api}/revisions/{rev}`"##),
            ...
            ("apps-get",
                    Some(r##"Gets the app profile for the specified app ID."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_apps-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        current attributes with those specified in the request."##),
          ...
          `organizations/{org}/developers/{developer_email}/apps/{app}`"##),
            ...
            ("developers-apps-attributes-delete",
                    Some(r##"Deletes a developer app attribute."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_developers-apps-attributes-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        request:
          `organizations/{org}/developers/{developer_email}/apps/{app}/attributes/{attribute}`"##),
            ...
            ("developers-apps-attributes-get",
                    Some(r##"Returns a developer app attribute."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_developers-apps-attributes-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the developer app attribute. Use the following structure in your
        request:
          `organizations/{org}/developers/{developer_email}/apps/{app}/attributes/{attribute}`"##),
            ...
            ("developers-apps-attributes-list",
                    Some(r##"Returns a list of all developer app attributes."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_developers-apps-attributes-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Name of the developer app. Use the following structure in your request:
        ...
        * To migrate existing consumer keys and secrets to hybrid from another
        ...
        CreateDeveloperAppKey API."##),
          ...
          `organizations/{org}/developers/{developer_email}/apps/{app}`"##),
            ...
            ("developers-apps-get",
                    Some(r##"Returns the details for a developer app."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_developers-apps-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the developer app. Use the following structure in your request:
        ...
        **Note**: OAuth access tokens and Key Management Service (KMS) entities
        ...
        the following format:
          `organizations/{org}/developers/{developer_email}`"##),
            ...
            ("developers-attributes-delete",
                    Some(r##"Deletes a developer attribute."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_developers-attributes-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        request:
          `organizations/{org}/developers/{developer_email}/attributes/{attribute}`"##),
            ...
            ("developers-attributes-get",
                    Some(r##"Returns the value of the specified developer attribute."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_developers-attributes-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the developer attribute. Use the following structure in your
        request:
          `organizations/{org}/developers/{developer_email}/attributes/{attribute}`"##),
            ...
            ("developers-attributes-list",
                    Some(r##"Returns a list of all developer attributes."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_developers-attributes-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        **Note**: OAuth access tokens and Key Management Service (KMS) entities
        ...
        form `organizations/{org}/environments/{env}/analytics/admin/schemav2`."##),
            ...
            ("environments-apis-deployments-list",
                    Some(r##"Lists all deployments of an API proxy in an environment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-apis-deployments-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        format:
          `organizations/{org}/environments/{env}/apis/{api}`"##),
            ...
            ("environments-apis-revisions-debugsessions-create",
                    Some(r##"Creates a debug session for a deployed API Proxy revision."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-apis-revisions-debugsessions-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        to create the DebugSession. Must be of the form
         `organizations/{organization}/environments/{environment}/apis/{api}/revisions/{revision}`."##),
            ...
            ("environments-apis-revisions-debugsessions-data-get",
                    Some(r##"Gets the debug data from a transaction."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-apis-revisions-debugsessions-data-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        Must be of the form:
         `organizations/{organization}/environments/{environment}/apis/{api}/revisions/{revision}/debugsessions/{debugsession}`."##),
            ...
            ("environments-apis-revisions-debugsessions-get",
                    Some(r##"Retrieves a debug session."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-apis-revisions-debugsessions-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        environment in the following format:
          `organizations/{org}/environments/{env}/apis/{api}/revisions/{rev}`"##),
            ...
            ("environments-caches-delete",
                    Some(r##"Deletes a cache."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-caches-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("environments-create",
                    Some(r##"Creates an environment in an organization."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        be created. Use the following structure in your request:
         `organizations/{org}`"##),
            ...
            ("environments-delete",
                    Some(r##"Deletes an environment from an organization."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        following format:
          `organizations/{org}/environments/{env}`"##),
            ...
            ("environments-flowhooks-attach-shared-flow-to-flow-hook",
                    Some(r##"Attaches a shared flow to a flow hook."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-flowhooks-attach-shared-flow-to-flow-hook",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        attached in the following format:
          `organizations/{org}/environments/{env}/flowhooks/{flowhook}`"##),
            ...
            ("environments-flowhooks-detach-shared-flow-from-flow-hook",
                    Some(r##"Detaches a shared flow from a flow hook."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-flowhooks-detach-shared-flow-from-flow-hook",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        an error; it simply does not return a name in the response."##),
          ...
          `organizations/{org}/environments/{env}/flowhooks/{flowhook}`"##),
            ...
            ("environments-get",
                    Some(r##"Gets environment details."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-get",
                  vec![
                    (Some(r##"name"##),
                     None,
         ...
         `organizations/{org}/environments/{env}`"##),
            ...
            ("environments-get-debugmask",
                    Some(r##"Gets the debug mask singleton resource for an environment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-get-debugmask",
                  vec![
                    (Some(r##"name"##),
                     None,
          ...
          `organizations/{org}/environments/{env}/debugmask`."##),
            ...
            ("environments-get-deployed-config",
                    Some(r##"Gets the deployed configuration for an environment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-get-deployed-config",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        * `selfsignedcert` - A new private key and certificate are generated. The
        ...
        `organizations/{organization}/environments/{environment}/keystores/{keystore}/aliases/{alias}`."##),
            ...
            ("environments-keystores-aliases-delete",
                    Some(r##"Deletes an alias."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-keystores-aliases-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the alias. Must be of the form
        `organizations/{organization}/environments/{environment}/keystores/{keystore}/aliases/{alias}`."##),
            ...
            ("environments-keystores-aliases-get",
                    Some(r##"Gets an alias."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-keystores-aliases-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the alias. Must be of the form
        `organizations/{organization}/environments/{environment}/keystores/{keystore}/aliases/{alias}`."##),
            ...
            ("environments-keystores-aliases-get-certificate",
                    Some(r##"Gets the certificate from an alias in PEM-encoded form."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-keystores-aliases-get-certificate",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the alias. Must be of the form
        ...
        `organizations/{organization}/environments/{environment}`."##),
            ...
            ("environments-keystores-delete",
                    Some(r##"Deletes a keystore or truststore."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-keystores-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        `organizations/{organization}/environments/{environment}/keystores/{keystore}`."##),
            ...
            ("environments-keystores-get",
                    Some(r##"Gets a keystore or truststore."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-keystores-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        `organizations/{organization}/environments/{environment}/keystores/{keystore}`."##),
            ...
            ("environments-keyvaluemaps-create",
                    Some(r##"Creates a key value map in an environment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-keyvaluemaps-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The name of the environment in which to create the key value map.
        ...
        `organizations/{organization}/environments/{environment}`."##),
            ...
            ("environments-keyvaluemaps-delete",
                    Some(r##"Delete a key value map in an environment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-keyvaluemaps-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the key value map.
        ...
        form `organizations/{org}/environments/{env}/queries/{queryId}/result`."##),
            ...
            ("environments-queries-list",
                    Some(r##"Return a list of Asynchronous Queries"##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-queries-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent resource name.
        Must be of the form `organizations/{org}/environments/{env}`."##),
            ...
            ("environments-references-create",
                    Some(r##"Creates a Reference in the specified environment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-references-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        of the form `organizations/{org}/environments/{env}/references/{ref}`."##),
            ...
            ("environments-references-get",
                    Some(r##"Gets a Reference resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-references-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        See the operation documentation for the appropriate value for this field."##),
            ...
            ("environments-sharedflows-deployments-list",
                    Some(r##"Lists all deployments of a shared flow in an environment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-sharedflows-deployments-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        The "name" and "push_config" must *not* be specified."##),
         ...
         `organizations/{org}/environments/{env}`"##),
            ...
            ("environments-targetservers-create",
                    Some(r##"Creates a TargetServer in the specified environment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-targetservers-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        `organizations/{org}/environments/{env}/targetservers/{target_server_id}`."##),
            ...
            ("environments-targetservers-get",
                    Some(r##"Gets a TargetServer resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-targetservers-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        See the operation documentation for the appropriate value for this field."##),
            ...
            ("environments-unsubscribe",
                    Some(r##"Deletes a subscription for the environment's Pub/Sub topic."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-unsubscribe",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Name of the environment. Use the following structure in your request:
        ...
        properties for the environment, use the [Get Environment API](get)."##),
         ...
         `organizations/{org}/environments/{env}`"##),
            ...
            ("environments-update-debugmask",
                    Some(r##"Updates the debug mask singleton resource for an environment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_environments-update-debugmask",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Name of the debug mask."##),
                     Some(true),
                     Some(false)),
        ...
        **Note**: Available to Apigee hybrid only."##),
        ...
        request:
         `organizations/{org}`"##),
            ...
            ("keyvaluemaps-create",
                    Some(r##"Creates a key value map in an organization."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_keyvaluemaps-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        file. Must be of the form `organizations/{organization}`."##),
            ...
            ("keyvaluemaps-delete",
                    Some(r##"Delete a key value map in an organization."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_keyvaluemaps-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the key value map.
        ...
        be created. Must be of the form:
          `organizations/{organization_id}/reports`"##),
            ...
            ("reports-delete",
                    Some(r##"Deletes an existing custom report definition"##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_reports-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
          ...
          `organizations/{organization_id}/reports/{report_name}`"##),
            ...
            ("reports-get",
                    Some(r##"Retrieve a custom report definition."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_reports-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Custom Report name of the form:
          `organizations/{organization_id}/reports/{report_name}`"##),
            ...
            ("reports-list",
                    Some(r##"Return a list of Custom Reports"##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_reports-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent organization name under which the API product will
        be listed
          `organizations/{organization_id}/reports`"##),
            ...
            ("reports-update",
                    Some(r##"Update an existing custom report definition"##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_reports-update",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Custom Report name of the form:
        ...
        **Note**: Available to Apigee hybrid only."##),
        ...
        undeployed before you can delete it."##),
          ...
          `organizations/{organization_id}/sharedflows/{shared_flow_id}`"##),
            ...
            ("sharedflows-deployments-list",
                    Some(r##"Lists all deployments of a shared flow."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_sharedflows-deployments-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        following format:
          `organizations/{org}/sharedflows/{sharedflow}`"##),
            ...
            ("sharedflows-get",
                    Some(r##"Gets a shared flow by name, including a list of its revisions."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_sharedflows-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        form:
          `organizations/{organization_id}/sharedflows/{shared_flow_id}/revisions/{revision_id}`"##),
            ...
            ("sharedflows-revisions-deployments-list",
                    Some(r##"Lists all deployments of a shared flow revision."##),
                    "Details at http://byron.github.io/google-apis-rs/google_apigee1_cli/organizations_sharedflows-revisions-deployments-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Name of the API proxy revision for which to return deployment information
