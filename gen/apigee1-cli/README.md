...
This documentation was generated from the *Apigee* API at revision *20251216*. The CLI is at version *7.0.0*.
...
apigee1 [options]
        ...
        organizations
                ...
                apim-service-extensions-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                apim-service-extensions-delete <name> [-p <v>]... [-o <out>]
                apim-service-extensions-get <name> [-p <v>]... [-o <out>]
                apim-service-extensions-list <parent> [-p <v>]... [-o <out>]
                apim-service-extensions-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                apiproducts-move <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                apis-debugsessions-list <parent> [-p <v>]... [-o <out>]
                ...
                apis-keyvaluemaps-get <name> [-p <v>]... [-o <out>]
                apis-keyvaluemaps-update <name> (-r <kv>)... [-p <v>]... [-o <out>]
                apis-list <parent> [-p <v>]... [-o <out>]
                apis-move <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                appgroups-balance-adjust <name> (-r <kv>)... [-p <v>]... [-o <out>]
                appgroups-balance-credit <name> (-r <kv>)... [-p <v>]... [-o <out>]
                appgroups-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                appgroups-delete <name> [-p <v>]... [-o <out>]
                appgroups-get <name> [-p <v>]... [-o <out>]
                appgroups-get-balance <name> [-p <v>]... [-o <out>]
                appgroups-get-monetization-config <name> [-p <v>]... [-o <out>]
                appgroups-list <parent> [-p <v>]... [-o <out>]
                appgroups-subscriptions-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                appgroups-subscriptions-expire <name> (-r <kv>)... [-p <v>]... [-o <out>]
                appgroups-subscriptions-get <name> [-p <v>]... [-o <out>]
                appgroups-subscriptions-list <parent> [-p <v>]... [-o <out>]
                appgroups-update <name> (-r <kv>)... [-p <v>]... [-o <out>]
                appgroups-update-monetization-config <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                dns-zones-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                dns-zones-delete <name> [-p <v>]... [-o <out>]
                dns-zones-get <name> [-p <v>]... [-o <out>]
                dns-zones-list <parent> [-p <v>]... [-o <out>]
                ...
                environments-deployments-get <name> [-p <v>]... [-o <out>]
                environments-deployments-get-iam-policy <resource> [-p <v>]... [-o <out>]
                environments-deployments-list <parent> [-p <v>]... [-o <out>]
                environments-deployments-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                environments-deployments-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                environments-keyvaluemaps-get <name> [-p <v>]... [-o <out>]
                environments-keyvaluemaps-update <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                environments-security-actions-delete <name> [-p <v>]... [-o <out>]
                ...
                environments-security-actions-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                get <name> [-p <v>]... [-o <out>]
                get-control-plane-access <name> [-p <v>]... [-o <out>]
                ...
                keyvaluemaps-get <name> [-p <v>]... [-o <out>]
                keyvaluemaps-update <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                security-feedback-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                security-feedback-delete <name> [-p <v>]... [-o <out>]
                security-feedback-get <name> [-p <v>]... [-o <out>]
                security-feedback-list <parent> [-p <v>]... [-o <out>]
                security-feedback-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                security-monitoring-conditions-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                security-monitoring-conditions-delete <name> [-p <v>]... [-o <out>]
                security-monitoring-conditions-get <name> [-p <v>]... [-o <out>]
                security-monitoring-conditions-list <parent> [-p <v>]... [-o <out>]
                security-monitoring-conditions-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                security-profiles-v2-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                security-profiles-v2-delete <name> [-p <v>]... [-o <out>]
                security-profiles-v2-get <name> [-p <v>]... [-o <out>]
                security-profiles-v2-list <parent> [-p <v>]... [-o <out>]
                security-profiles-v2-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                sharedflows-move <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                spaces-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                spaces-delete <name> [-p <v>]... [-o <out>]
                spaces-get <name> [-p <v>]... [-o <out>]
                spaces-get-iam-policy <resource> [-p <v>]... [-o <out>]
                spaces-list <parent> [-p <v>]... [-o <out>]
                spaces-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                spaces-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                spaces-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                update <name> (-r <kv>)... [-p <v>]... [-o <out>]
                update-control-plane-access <name> (-r <kv>)... [-p <v>]... [-o <out>]
