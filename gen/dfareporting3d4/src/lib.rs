...
//! This documentation was generated from *Dfareporting* crate version *3.1.0+20220104*, where *20220104* is the exact revision of the *dfareporting:v3.4* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.1.0*.
//! 
//! Everything else about the *Dfareporting* *v3d4* API can be found at the
//! [official documentation site](https://developers.google.com/doubleclick-advertisers/).
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/dfareporting3d4).
//! # Features
//! 
...
//! * [custom events](api::CustomEvent)
//!  * [*batchinsert*](api::CustomEventBatchinsertCall)
...
//! use dfareporting3d4::{Dfareporting, oauth2, hyper, hyper_rustls};
//! 
