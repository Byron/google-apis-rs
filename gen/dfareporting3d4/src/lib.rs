...
//! This documentation was generated from *Dfareporting* crate version *8.0.0+20230118*, where *20230118* is the exact revision of the *dfareporting:v3.4* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
