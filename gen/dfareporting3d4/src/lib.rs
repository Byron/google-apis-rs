...
//! This documentation was generated from *Dfareporting* crate version *2.0.4+20210210*, where *20210210* is the exact revision of the *dfareporting:v3.4* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.4*.
//! 
