...
impl client::ResponseResult for AdvertiserLandingPagesListResponse {}
...
impl client::Part for CampaignManagerIds {}
...
impl client::Part for ChannelGroupingRule {}
...
pub struct CompatibleFields {
    ...
    #[serde(rename="pathAttributionReportCompatibleFields")]
    
    pub path_attribution_report_compatible_fields: Option<PathReportCompatibleFields>,
    /// Contains items that are compatible to be selected for a report of type "PATH".
    #[serde(rename="pathReportCompatibleFields")]
    
    pub path_report_compatible_fields: Option<PathReportCompatibleFields>,
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [batchinsert custom events](CustomEventBatchinsertCall) (none)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct CustomEvent {
    ...
    #[serde(rename="annotateClickEvent")]
    ...
    #[serde(rename="annotateImpressionEvent")]
    ...
    pub event_type: Option<CustomEventEventTypeEnum>,
...
impl client::Resource for CustomEvent {}
...
impl client::Part for CustomEventClickAnnotation {}
...
pub struct CustomEventError {
    ...
    pub code: Option<CustomEventErrorCodeEnum>,
...
impl client::Part for CustomEventError {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct CustomEventImpressionAnnotation {
    ...
    #[serde(rename="pathImpressionId")]
    
    pub path_impression_id: Option<String>,
}

impl client::Part for CustomEventImpressionAnnotation {}
...
pub struct CustomEventInsert {
    ...
    #[serde(rename="cmDimensions")]
    
    pub cm_dimensions: Option<CampaignManagerIds>,
    /// DV360 dimensions associated with the event.
    #[serde(rename="dv3Dimensions")]
    
    pub dv3_dimensions: Option<DV3Ids>,
    /// The type of event to insert.
    #[serde(rename="insertEventType")]
    
    pub insert_event_type: Option<CustomEventInsertInsertEventTypeEnum>,
...
impl client::Part for CustomEventInsert {}
...
impl client::Part for CustomEventStatus {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [batchinsert custom events](CustomEventBatchinsertCall) (request)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct CustomEventsBatchInsertRequest {
...
impl client::RequestValue for CustomEventsBatchInsertRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [batchinsert custom events](CustomEventBatchinsertCall) (response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct CustomEventsBatchInsertResponse {
    ...
    pub status: Option<Vec<CustomEventStatus>>,
}

impl client::ResponseResult for CustomEventsBatchInsertResponse {}
...
impl client::Part for CustomVariable {}
...
impl client::Part for CustomViewabilityMetric {}
...
impl client::Part for CustomViewabilityMetricConfiguration {}
...
pub struct EventFilter {
    ...
    pub dimension_filter: Option<PathReportDimensionValue>,
...
pub struct FloodlightActivity {
    ...
    #[serde(rename="attributionEnabled")]
    ...
    pub status: Option<FloodlightActivityStatusEnum>,
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [get mobile apps](MobileAppGetCall) (response)
/// * [list mobile apps](MobileAppListCall) (none)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl client::Resource for MobileApp {}
impl client::ResponseResult for MobileApp {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [list mobile apps](MobileAppListCall) (response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl client::ResponseResult for MobileAppsListResponse {}
...
impl client::Part for PathReportCompatibleFields {}
...
pub struct PathReportDimensionValue {
    ...
    pub match_type: Option<PathReportDimensionValueMatchTypeEnum>,
    /// The possible values of the dimension.
    
    pub values: Option<Vec<String>>,
}

impl client::Part for PathReportDimensionValue {}
...
pub struct Report {
    ...
    #[serde(rename="pathAttributionCriteria")]
    
    pub path_attribution_criteria: Option<ReportPathAttributionCriteria>,
    /// The report criteria for a report of type "PATH".
    #[serde(rename="pathCriteria")]
    
    pub path_criteria: Option<ReportPathCriteria>,
...
impl client::Part for SiteCompanionSetting {}
...
impl client::Part for SiteSkippableSetting {}
...
impl client::Part for SiteTranscodeSetting {}
...
impl client::Part for SiteVideoSettings {}
...
pub struct ReportPathAttributionCriteria {
    ...
    /// Channel Grouping.
    #[serde(rename="customChannelGrouping")]
...
impl client::NestedType for ReportPathAttributionCriteria {}
impl client::Part for ReportPathAttributionCriteria {}
...
impl client::NestedType for ReportPathCriteria {}
impl client::Part for ReportPathCriteria {}
