...
//! This documentation was generated from *Cloud Profiler* crate version *5.0.2-beta-1+20230123*, where *20230123* is the exact revision of the *cloudprofiler:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2-beta-1*.
//! 
...
//! 
//! * projects
//!  * [*profiles create*](api::ProjectProfileCreateCall), [*profiles create offline*](api::ProjectProfileCreateOfflineCall) and [*profiles patch*](api::ProjectProfilePatchCall)
//! 
//! 
//! 
//! 
