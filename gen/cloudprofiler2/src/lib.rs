...
//! This documentation was generated from *Cloud Profiler* crate version *7.0.0+20251006*, where *20251006* is the exact revision of the *cloudprofiler:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
