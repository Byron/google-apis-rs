...
//! This documentation was generated from *Cloud Profiler* crate version *3.0.0+20220228*, where *20220228* is the exact revision of the *cloudprofiler:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.0*.
//! 
