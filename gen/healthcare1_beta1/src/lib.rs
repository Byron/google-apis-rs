...
//! This documentation was generated from *Cloud Healthcare* crate version *3.0.2+20220223*, where *20220223* is the exact revision of the *healthcare:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
...
//! use healthcare1_beta1::{CloudHealthcare, oauth2, hyper, hyper_rustls};
//! 
...
//!     ).build().await.unwrap();
//! let mut hub = CloudHealthcare::new(hyper::Client::builder().build(hyper_rustls::HttpsConnector::with_native_roots().https_or_http().enable_http1().enable_http2().build()), auth);
