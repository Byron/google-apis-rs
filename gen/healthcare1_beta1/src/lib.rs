...
//! This documentation was generated from *Cloud Healthcare* crate version *5.0.2-beta-1+20221220*, where *20221220* is the exact revision of the *healthcare:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2-beta-1*.
//! 
