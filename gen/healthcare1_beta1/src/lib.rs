...
//! This documentation was generated from *Cloud Healthcare* crate version *3.1.0+20220223*, where *20220223* is the exact revision of the *healthcare:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.1.0*.
//! 
