...
//! This documentation was generated from *Cloud Healthcare* crate version *2.0.5+20210317*, where *20210317* is the exact revision of the *healthcare:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.5*.
//! 
