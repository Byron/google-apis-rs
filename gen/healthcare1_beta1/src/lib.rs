...
//! This documentation was generated from *Cloud Healthcare* crate version *7.0.0+20251211*, where *20251211* is the exact revision of the *healthcare:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
...
//! let r = hub.projects().locations_datasets_dicom_stores_studies_series_instances_update_metadata(...).doit().await
...
//! let r = hub.projects().locations_datasets_dicom_stores_studies_series_update_metadata(...).doit().await
...
//! let r = hub.projects().locations_datasets_dicom_stores_studies_update_instances(...).doit().await
//! let r = hub.projects().locations_datasets_dicom_stores_studies_update_metadata(...).doit().await
...
//! let r = hub.projects().locations_datasets_dicom_stores_update_instances(...).doit().await
//! let r = hub.projects().locations_datasets_fhir_stores_fhir__binary_create(...).doit().await
//! let r = hub.projects().locations_datasets_fhir_stores_fhir__binary_read(...).doit().await
//! let r = hub.projects().locations_datasets_fhir_stores_fhir__binary_update(...).doit().await
//! let r = hub.projects().locations_datasets_fhir_stores_fhir__binary_vread(...).doit().await
...
//! let r = hub.projects().locations_datasets_fhir_stores_fhir__encounter_everything(...).doit().await
...
//! let r = hub.projects().locations_datasets_fhir_stores_fhir_bulk_export(...).doit().await
...
//! let r = hub.projects().locations_datasets_fhir_stores_operations_delete_fhir_operation(...).doit().await
//! let r = hub.projects().locations_datasets_fhir_stores_operations_get_fhir_operation_status(...).doit().await
//! let r = hub.projects().locations_datasets_fhir_stores_bulk_export_group(...).doit().await
//! ```
//!
