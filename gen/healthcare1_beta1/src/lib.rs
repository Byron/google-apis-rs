...
//! This documentation was generated from *Cloud Healthcare* crate version *4.0.1+20220223*, where *20220223* is the exact revision of the *healthcare:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v4.0.1*.
//! 
