...
pub struct Action {
    ...
    #[serde(rename="cleanImageTag")]
    
    pub clean_image_tag: Option<ImageConfig>,
    ...
    #[serde(rename="cleanTextTag")]
    
    pub clean_text_tag: Option<CleanTextTag>,
    /// Delete tag.
    #[serde(rename="deleteTag")]
    
    pub delete_tag: Option<DeleteTag>,
    /// Keep tag unchanged.
    #[serde(rename="keepTag")]
    
    pub keep_tag: Option<KeepTag>,
    ...
    #[serde(rename="recurseTag")]
    
    pub recurse_tag: Option<RecurseTag>,
    ...
    #[serde(rename="regenUidTag")]
    
    pub regen_uid_tag: Option<RegenUidTag>,
    /// Replace with empty tag.
    #[serde(rename="removeTag")]
    
    pub remove_tag: Option<RemoveTag>,
    /// Reset tag to a placeholder value.
    #[serde(rename="resetTag")]
    
    pub reset_tag: Option<ResetTag>,
}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets annotation stores annotations create projects](ProjectLocationDatasetAnnotationStoreAnnotationCreateCall) (request|response)
/// * [locations datasets annotation stores annotations get projects](ProjectLocationDatasetAnnotationStoreAnnotationGetCall) (response)
/// * [locations datasets annotation stores annotations patch projects](ProjectLocationDatasetAnnotationStoreAnnotationPatchCall) (request|response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
pub struct AnnotationSource {
    ...
    pub cloud_healthcare_source: Option<CloudHealthcareSource>,
}

impl client::Part for AnnotationSource {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets annotation stores create projects](ProjectLocationDatasetAnnotationStoreCreateCall) (request|response)
/// * [locations datasets annotation stores get projects](ProjectLocationDatasetAnnotationStoreGetCall) (response)
/// * [locations datasets annotation stores patch projects](ProjectLocationDatasetAnnotationStorePatchCall) (request|response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets hl7 v2 stores messages batch get projects](ProjectLocationDatasetHl7V2StoreMessageBatchGetCall) (response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl client::ResponseResult for BatchGetMessagesResponse {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct CharacterMaskField { _never_set: Option<bool> }

impl client::Part for CharacterMaskField {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct CleanDescriptorsOption { _never_set: Option<bool> }
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct CleanTextField { _never_set: Option<bool> }
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct CleanTextTag { _never_set: Option<bool> }

impl client::Part for CleanTextTag {}
...
impl client::Part for CloudHealthcareSource {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets fhir stores configure search projects](ProjectLocationDatasetFhirStoreConfigureSearchCall) (request)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct ConfigureSearchRequest {
    ...
    #[serde(rename="canonicalUrls")]
    
    pub canonical_urls: Option<Vec<String>>,
...
impl client::RequestValue for ConfigureSearchRequest {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct ContextualDeidConfig { _never_set: Option<bool> }

impl client::Part for ContextualDeidConfig {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct CryptoHashField { _never_set: Option<bool> }

impl client::Part for CryptoHashField {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct DateShiftField { _never_set: Option<bool> }

impl client::Part for DateShiftField {}
...
pub struct DeidentifyConfig {
    ...
    #[serde(rename="dicomTagConfig")]
    
    pub dicom_tag_config: Option<DicomTagConfig>,
    /// Configures de-id of application/FHIR content. Deprecated. Use `fhir_field_config` instead.
    
    pub fhir: Option<FhirConfig>,
    /// Configures de-id of application/FHIR content.
    #[serde(rename="fhirFieldConfig")]
    
    pub fhir_field_config: Option<FhirFieldConfig>,
    ...
    pub operation_metadata: Option<DeidentifyOperationMetadata>,
...
pub struct DeidentifyOperationMetadata {
    ...
    #[serde(rename="fhirOutput")]
    
    pub fhir_output: Option<FhirOutput>,
}

impl client::Part for DeidentifyOperationMetadata {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct DeleteTag { _never_set: Option<bool> }

impl client::Part for DeleteTag {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets annotation stores annotations delete projects](ProjectLocationDatasetAnnotationStoreAnnotationDeleteCall) (response)
/// * [locations datasets annotation stores delete projects](ProjectLocationDatasetAnnotationStoreDeleteCall) (response)
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets annotation stores evaluate projects](ProjectLocationDatasetAnnotationStoreEvaluateCall) (request)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl client::RequestValue for EvaluateAnnotationStoreRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets annotation stores export projects](ProjectLocationDatasetAnnotationStoreExportCall) (request)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct ExportAnnotationsRequest {
    ...
    pub gcs_destination: Option<GoogleCloudHealthcareV1beta1AnnotationGcsDestination>,
}

impl client::RequestValue for ExportAnnotationsRequest {}
...
impl client::Part for FhirOutput {}
...
impl client::Part for FilterList {}
...
impl client::Part for GoogleCloudHealthcareV1beta1AnnotationGcsDestination {}
...
impl client::Part for GoogleCloudHealthcareV1beta1AnnotationGcsSource {}
...
impl client::Part for GoogleCloudHealthcareV1beta1ConsentGcsDestination {}
...
impl client::Part for GoogleCloudHealthcareV1beta1ConsentPolicy {}
...
pub struct GoogleCloudHealthcareV1beta1DeidentifyOptions {
    ...
    #[serde(rename="keepExtensions")]
    
    pub keep_extensions: Option<KeepExtensionsConfig>,
}

impl client::Part for GoogleCloudHealthcareV1beta1DeidentifyOptions {}
...
impl client::Part for GoogleCloudHealthcareV1beta1DicomGcsDestination {}
...
impl client::Part for GoogleCloudHealthcareV1beta1DicomGcsSource {}
...
impl client::Part for GoogleCloudHealthcareV1beta1DicomStreamConfig {}
...
impl client::Part for GoogleCloudHealthcareV1beta1FhirGcsDestination {}
...
impl client::Part for GoogleCloudHealthcareV1beta1FhirGcsSource {}
...
impl client::Part for ImageAnnotation {}
...
pub struct ImageConfig {
    ...
    #[serde(rename="additionalInfoTypes")]
    
    pub additional_info_types: Option<Vec<String>>,
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets annotation stores import projects](ProjectLocationDatasetAnnotationStoreImportCall) (request)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct ImportAnnotationsRequest {
    ...
    pub gcs_source: Option<GoogleCloudHealthcareV1beta1AnnotationGcsSource>,
}

impl client::RequestValue for ImportAnnotationsRequest {}
...
pub struct ImportResourcesRequest {
    ...
    pub gcs_source: Option<GoogleCloudHealthcareV1beta1FhirGcsSource>,
}
...
impl client::Part for InfoTypeConfig {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct KeepExtensionsConfig { _never_set: Option<bool> }

impl client::Part for KeepExtensionsConfig {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct KeepField { _never_set: Option<bool> }

impl client::Part for KeepField {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct KeepTag { _never_set: Option<bool> }

impl client::Part for KeepTag {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets annotation stores list projects](ProjectLocationDatasetAnnotationStoreListCall) (response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct ListAnnotationStoresResponse {
    ...
    pub annotation_stores: Option<Vec<AnnotationStore>>,
...
impl client::ResponseResult for ListAnnotationStoresResponse {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets annotation stores annotations list projects](ProjectLocationDatasetAnnotationStoreAnnotationListCall) (response)
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl client::ResponseResult for ListAnnotationsResponse {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets annotation stores evaluate projects](ProjectLocationDatasetAnnotationStoreEvaluateCall) (response)
...
pub struct Options {
    ...
    #[serde(rename="cleanDescriptors")]
    
    pub clean_descriptors: Option<CleanDescriptorsOption>,
    ...
    #[serde(rename="cleanImage")]
    
    pub clean_image: Option<ImageConfig>,
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations datasets annotation stores get iam policy projects](ProjectLocationDatasetAnnotationStoreGetIamPolicyCall) (response)
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct RecurseTag { _never_set: Option<bool> }

impl client::Part for RecurseTag {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct RegenUidTag { _never_set: Option<bool> }

impl client::Part for RegenUidTag {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct RemoveField { _never_set: Option<bool> }

impl client::Part for RemoveField {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct RemoveTag { _never_set: Option<bool> }

impl client::Part for RemoveTag {}
...
#[serde_with::serde_as(crate = "::client::serde_with")]
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct ResetTag { _never_set: Option<bool> }

impl client::Part for ResetTag {}
...
impl client::Part for ResourceAnnotation {}
...
pub struct SearchConfig {
    ...
    pub search_parameters: Option<Vec<SearchParameter>>,
}

impl client::Part for SearchConfig {}
...
impl client::Part for SearchParameter {}
...
pub struct SensitiveTextAnnotation {
    ...
    pub details: Option<HashMap<String, Detail>>,
}
