...
impl Engine {
    ...
    fn _collections_insert(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::Collection = Default::default();
    ...
    fn _devices_set_state(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::DeviceState = Default::default();
    ...
    fn _enterprises_enroll(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::Enterprise = Default::default();
    ...
    fn _enterprises_set_account(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::EnterpriseAccount = Default::default();
    ...
    fn _entitlements_patch(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::Entitlement = Default::default();
    ...
    fn _installs_patch(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::Install = Default::default();
    ...
    fn _products_update_permissions(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::ProductPermissions = Default::default();
    ...
    fn new(opt: Options) -> Result<Engine, InvalidOptionsError> {
        ...
        let engine = Engine {
            opt: opt,
            hub: api::AndroidEnterprise::new(hyper::Client::new(), auth),
        };
