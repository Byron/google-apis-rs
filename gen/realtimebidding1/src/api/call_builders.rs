...
impl<'a, S> client::Hub for RealTimeBidding<S> {}

impl<'a, S> RealTimeBidding<S> {

    pub fn new<A: 'static + client::GetToken>(client: hyper::Client<S, hyper::body::Body>, auth: A) -> RealTimeBidding<S> {
        RealTimeBidding {
            client,
            auth: Box::new(auth),
