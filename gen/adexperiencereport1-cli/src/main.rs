...
use google_adexperiencereport1::{api, Error};
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::AdExperienceReport<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>
    >,
    gp: Vec<&'static str>,
