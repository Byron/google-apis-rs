...
extern crate mime;
extern crate strsim;
extern crate google_redis1 as api;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::CloudRedis<hyper::Client, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client>>,
    gp: Vec<&'static str>,
...
impl<'n> Engine<'n> {
    ...
    fn _projects_locations_instances_failover(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "redis1-secret.json",
    ...
    let arg_data = [
        ...
        where `location_id` refers to a GCP region"##),
            ...
            ("locations-instances-delete",
                    Some(r##"Deletes a specific Redis instance.  Instance stops serving and data is
        deleted."##),
        ...
        where `location_id` refers to a GCP region"##),
            ...
            ("locations-instances-list",
                    Some(r##"Lists all Redis instances owned by a project in either the specified
        ...
        * `projects/{project_id}/locations/{location_id}`
        ...
        where `location_id` refers to a GCP region"##),
            ...
            ("locations-instances-patch",
                    Some(r##"Updates the metadata and configuration of a specific Redis instance.
