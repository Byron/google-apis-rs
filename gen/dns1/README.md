...
This documentation was generated from *dns* crate version *0.1.5+20150218*, where *20150218* is the exact revision of the *dns:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.5*.
...
* [request values](http://byron.github.io/google-apis-rs/google_dns1/trait.RequestValue.html) are borrowed
