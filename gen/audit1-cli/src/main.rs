                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["actor-email", "actor-application-id", "actor-ip-address", "caller", "max-results", "event-name", "start-time", "end-time", "continuation-token"]
                                                            ));
                    }
                }
            }
