...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/serviceuser1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.ServiceUser.html) ... 
//! 
//! * projects
//!  * [*services disable*](struct.ProjectServiceDisableCall.html), [*services enable*](struct.ProjectServiceEnableCall.html) and [*services list*](struct.ProjectServiceListCall.html)
//! * [services](struct.Service.html)
//!  * [*search*](struct.ServiceSearchCall.html)
//! 
//! 
//! 
//! 
...
/// Central instance to access all ServiceUser related resource activities
///
/// # Examples
///
...
impl<'a, C, A> Hub for ServiceUser<C, A> {}

impl<'a, C, A> ServiceUser<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> ServiceUser<C, A> {
        ServiceUser {
            client: RefCell::new(client),
            auth: RefCell::new(authenticator),
            _user_agent: "google-api-rust-client/1.0.6".to_string(),
            _base_url: "https://serviceuser.googleapis.com/".to_string(),
            _root_url: "https://serviceuser.googleapis.com/".to_string(),
        }
    }
    ...
    /// It defaults to `https://serviceuser.googleapis.com/`.
    ///
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [services list projects](struct.ProjectServiceListCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct ListEnabledServicesResponse {
    ...
    pub services: Option<Vec<PublishedService>>,
}

impl ResponseResult for ListEnabledServicesResponse {}
...
impl Part for PublishedService {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [services disable projects](struct.ProjectServiceDisableCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct DisableServiceRequest { _never_set: Option<bool> }
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [services enable projects](struct.ProjectServiceEnableCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl ResponseResult for SearchServicesResponse {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [services enable projects](struct.ProjectServiceEnableCall.html) (response)
/// * [services disable projects](struct.ProjectServiceDisableCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// It is not used directly, but through the `ServiceUser` hub.
///
/// # Example
///
...
impl<'a, C, A> ServiceMethods<'a, C, A> {
    ...
    pub fn search(&self) -> ServiceSearchCall<'a, C, A> {
        ServiceSearchCall {
            hub: self.hub,
...
/// let mut hub = ServiceUser::new(hyper::Client::with_connector(hyper::net::HttpsConnector::new(hyper_rustls::TlsClient::new())), auth);
/// // Usually you wouldn't bind this to a variable, but keep calling *CallBuilders*
/// // like `services_disable(...)`, `services_enable(...)` and `services_list(...)`
/// // to build up your call.
/// let rb = hub.projects();
/// # }
/// ```
...
impl<'a, C, A> ProjectMethods<'a, C, A> {
    ...
    pub fn services_enable(&self, request: EnableServiceRequest, name: &str) -> ProjectServiceEnableCall<'a, C, A> {
        ProjectServiceEnableCall {
            hub: self.hub,
            _request: request,
    ...
    ///              - projects/my-project
    pub fn services_list(&self, parent: &str) -> ProjectServiceListCall<'a, C, A> {
    ...
    pub fn services_disable(&self, request: DisableServiceRequest, name: &str) -> ProjectServiceDisableCall<'a, C, A> {
        ProjectServiceDisableCall {
            hub: self.hub,
            _request: request,
            _name: name.to_string(),
            _delegate: Default::default(),
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.services().search()
///              .page_token("sed")
///              .page_size(-85)
///              .doit();
/// # }
...
impl<'a, C, A> ServiceSearchCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, SearchServicesResponse)> {
        ...
        dlg.begin(MethodInfo { id: "serviceuser.services.search",
        ...
        let mut url = self.hub._base_url.clone() + "v1/services:search";
...
/// Operation<response: google.protobuf.Empty>
///
/// A builder for the *services.enable* method supported by a *project* resource.
...
/// # }
/// ```
pub struct ProjectServiceEnableCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectServiceEnableCall<'a, C, A> {}

impl<'a, C, A> ProjectServiceEnableCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "serviceuser.projects.services.enable",
    ...
    pub fn request(mut self, new_value: EnableServiceRequest) -> ProjectServiceEnableCall<'a, C, A> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectServiceEnableCall<'a, C, A> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectServiceEnableCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProjectServiceEnableCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectServiceEnableCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct ProjectServiceListCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectServiceListCall<'a, C, A> {}

impl<'a, C, A> ProjectServiceListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListEnabledServicesResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{ContentType, ContentLength, Authorization, Bearer, UserAgent, Location};
        let mut dd = DefaultDelegate;
        ...
        dlg.begin(MethodInfo { id: "serviceuser.projects.services.list",
                               http_method: hyper::method::Method::Get });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectServiceListCall<'a, C, A> {
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ProjectServiceListCall<'a, C, A> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// Requested size of the next page of data.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProjectServiceListCall<'a, C, A> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectServiceListCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProjectServiceListCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectServiceListCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// Operation<response: google.protobuf.Empty>
///
/// A builder for the *services.disable* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_serviceuser1 as serviceuser1;
/// use serviceuser1::DisableServiceRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use serviceuser1::ServiceUser;
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().services_disable(req, "name")
///              .doit();
/// # }
/// ```
pub struct ProjectServiceDisableCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectServiceDisableCall<'a, C, A> {}

impl<'a, C, A> ProjectServiceDisableCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "serviceuser.projects.services.disable",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity((4 + self._additional_params.len()));
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: DisableServiceRequest) -> ProjectServiceDisableCall<'a, C, A> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectServiceDisableCall<'a, C, A> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectServiceDisableCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProjectServiceDisableCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectServiceDisableCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
