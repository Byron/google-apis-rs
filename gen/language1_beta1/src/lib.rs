...
//! This documentation was generated from *Cloud Natural Language* crate version *7.0.0+20220218*, where *20220218* is the exact revision of the *language:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
