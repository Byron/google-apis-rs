...
//! This documentation was generated from *Cloud Natural Language* crate version *1.0.10+20190623*, where *20190623* is the exact revision of the *language:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.10*.
//! 
