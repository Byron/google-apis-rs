...
pub struct InstanceGroupManagerAbandonInstanceCall<'a, S>
   ...
   pub(super) _request: InstanceGroupManagersAbandonInstancesRequest,
   pub(super) _project: String,
   pub(super) _zone: String,
   pub(super) _instance_group_manager: String,
...
pub struct InstanceGroupManagerDeleteInstanceCall<'a, S>
   ...
   pub(super) hub: &'a Replicapool<S>,
   pub(super) _request: InstanceGroupManagersDeleteInstancesRequest,
   pub(super) _project: String,
   pub(super) _zone: String,
   pub(super) _instance_group_manager: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct InstanceGroupManagerInsertCall<'a, S>
   ...
   pub(super) hub: &'a Replicapool<S>,
   pub(super) _request: InstanceGroupManager,
   pub(super) _project: String,
   pub(super) _zone: String,
   pub(super) _size: i32,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct InstanceGroupManagerRecreateInstanceCall<'a, S>
   ...
   pub(super) hub: &'a Replicapool<S>,
   pub(super) _request: InstanceGroupManagersRecreateInstancesRequest,
   pub(super) _project: String,
   pub(super) _zone: String,
   pub(super) _instance_group_manager: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct InstanceGroupManagerSetInstanceTemplateCall<'a, S>
   ...
   pub(super) hub: &'a Replicapool<S>,
   pub(super) _request: InstanceGroupManagersSetInstanceTemplateRequest,
   pub(super) _project: String,
   pub(super) _zone: String,
   pub(super) _instance_group_manager: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct InstanceGroupManagerSetTargetPoolCall<'a, S>
   ...
   pub(super) hub: &'a Replicapool<S>,
   pub(super) _request: InstanceGroupManagersSetTargetPoolsRequest,
   pub(super) _project: String,
   pub(super) _zone: String,
   pub(super) _instance_group_manager: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
