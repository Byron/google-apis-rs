...
This documentation was generated from *groupssettings* crate version *0.1.0+20140428*, where *20140428* is the exact revision of the *groupssettings:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.0*.
...
let mut req: Groups = Default::default();
...
[decodable](http://byron.github.io/google-apis-rs/google-groupssettings1/trait.ResponseResult.html) via json. Optionals are used to indicate that partial requests are responses are valid.
Most optionals are are considered [Parts](http://byron.github.io/google-apis-rs/google-groupssettings1/trait.Part.html) which are identifyable by name, which will be sent to 
