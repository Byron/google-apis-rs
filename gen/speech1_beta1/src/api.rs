...
impl common::RequestValue for AsyncRecognizeRequest {}
...
impl common::RequestValue for SyncRecognizeRequest {}
...
impl common::ResponseResult for SyncRecognizeResponse {}
...
impl<'a, C> SpeechMethods<'a, C> {
    ...
    pub fn asyncrecognize(
        &self,
        request: AsyncRecognizeRequest,
    ) -> SpeechAsyncrecognizeCall<'a, C> {
...
impl<'a, C> common::CallBuilder for SpeechAsyncrecognizeCall<'a, C> {}

impl<'a, C> SpeechAsyncrecognizeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> SpeechAsyncrecognizeCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> SpeechAsyncrecognizeCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> SpeechAsyncrecognizeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for SpeechSyncrecognizeCall<'a, C> {}

impl<'a, C> SpeechSyncrecognizeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SyncRecognizeResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> SpeechSyncrecognizeCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> SpeechSyncrecognizeCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> SpeechSyncrecognizeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
