...
extern crate mime;
extern crate strsim;
extern crate google_ml1_beta1 as api;
...
impl<'n> Engine<'n> {
    ...
    fn _projects_jobs_cancel(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudMlV1beta1__CancelJobRequest = json::value::from_value(object).unwrap();
    ...
    fn _projects_jobs_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudMlV1beta1__Job = json::value::from_value(object).unwrap();
    ...
    fn _projects_models_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudMlV1beta1__Model = json::value::from_value(object).unwrap();
    ...
    fn _projects_models_versions_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudMlV1beta1__Version = json::value::from_value(object).unwrap();
    ...
    fn _projects_models_versions_set_default(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudMlV1beta1__SetDefaultVersionRequest = json::value::from_value(object).unwrap();
    ...
    fn _projects_operations_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_predict(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudMlV1beta1__PredictRequest = json::value::from_value(object).unwrap();
            ...
            ("projects", Some(opt)) => {
                match opt.subcommand() {
                    ...
                    ("operations-delete", Some(opt)) => {
                        call_result = self._projects_operations_delete(opt, dry_run, &mut err);
                    },
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "ml1-beta1-secret.json",
    ...
    let arg_data = [
        ...
        Authorization: requires `Viewer` role on the specified project."##),
            ...
            ("jobs-cancel",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_jobs-cancel",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        Authorization: requires `Editor` role on the parent project."##),
            ...
            ("jobs-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_jobs-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The project name.
        ...
        Authorization: requires `Editor` role on the specified project."##),
            ...
            ("jobs-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_jobs-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        Authorization: requires `Viewer` role on the parent project."##),
            ...
            ("jobs-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_jobs-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        been deployed)."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_models-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the model.
        ...
        versions."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_models-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        of the model unless it is the only remaining version."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_models-versions-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        be retrieved in batches (called pages):"##),
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_models-versions-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        setting manually using this method."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_models-versions-set-default",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        corresponding to `Code.CANCELLED`."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_operations-cancel",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        `google.rpc.Code.UNIMPLEMENTED`."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_operations-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        service."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_operations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        to use different resource name schemes, such as `users/*/operations`."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ml1_beta1_cli/projects_operations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The name of the operation collection."##),
                     Some(true),
                     Some(false)),
