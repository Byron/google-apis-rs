...
//! This documentation was generated from *datastore* crate version *0.1.11+20151008*, where *20151008* is the exact revision of the *datastore:v1beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.11*.
//! 
