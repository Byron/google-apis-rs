...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations workloads updates apply organizations](OrganizationLocationWorkloadUpdateApplyCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for GoogleCloudAssuredworkloadsV1ApplyWorkloadUpdateRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations workloads enable compliance updates organizations](OrganizationLocationWorkloadEnableComplianceUpdateCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::ResponseResult for GoogleCloudAssuredworkloadsV1EnableComplianceUpdatesResponse {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations workloads updates list organizations](OrganizationLocationWorkloadUpdateListCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct GoogleCloudAssuredworkloadsV1ListWorkloadUpdatesResponse {
    ...
    #[serde(rename = "workloadUpdates")]
    pub workload_updates: Option<Vec<GoogleCloudAssuredworkloadsV1WorkloadUpdate>>,
}

impl common::ResponseResult for GoogleCloudAssuredworkloadsV1ListWorkloadUpdatesResponse {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1OrgPolicy {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1OrgPolicyPolicyRule {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1OrgPolicyPolicyRuleStringValues {}
...
pub struct GoogleCloudAssuredworkloadsV1OrgPolicyUpdate {
    ...
    #[serde(rename = "suggestedPolicy")]
    pub suggested_policy: Option<GoogleCloudAssuredworkloadsV1OrgPolicy>,
}

impl common::Part for GoogleCloudAssuredworkloadsV1OrgPolicyUpdate {}
...
pub struct GoogleCloudAssuredworkloadsV1UpdateDetails {
    ...
    #[serde(rename = "orgPolicyUpdate")]
    pub org_policy_update: Option<GoogleCloudAssuredworkloadsV1OrgPolicyUpdate>,
}

impl common::Part for GoogleCloudAssuredworkloadsV1UpdateDetails {}
...
pub struct GoogleCloudAssuredworkloadsV1Workload {
    ...
    #[serde(rename = "partnerServicesBillingAccount")]
...
pub struct GoogleCloudAssuredworkloadsV1WorkloadPartnerPermissions {
    ...
    #[serde(rename = "accessTransparencyLogsSupportCaseViewer")]
...
impl common::Part for GoogleCloudAssuredworkloadsV1WorkloadUpdate {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1WorkloadWorkloadOptions {}
...
/// * [locations workloads updates apply organizations](OrganizationLocationWorkloadUpdateApplyCall) (response)
...
impl<'a, C> OrganizationMethods<'a, C> {
    ...
    pub fn locations_workloads_updates_apply(
        &self,
    ...
    pub fn locations_workloads_updates_list(
        &self,
        parent: &str,
    ...
    ///
    /// * `name` - Required. The `name` field is used to identify the workload. Format: organizations/{org_id}/locations/{location_id}/workloads/{workload_id}
    pub fn locations_workloads_enable_compliance_updates(
        &self,
        name: &str,
...
/// This endpoint creates a new operation to apply the given update.
///
/// A builder for the *locations.workloads.updates.apply* method supported by a *organization* resource.
/// It is not used directly, but through a [`OrganizationMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_assuredworkloads1 as assuredworkloads1;
/// use assuredworkloads1::api::GoogleCloudAssuredworkloadsV1ApplyWorkloadUpdateRequest;
/// # async fn dox() {
/// # use assuredworkloads1::{Assuredworkloads, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = GoogleCloudAssuredworkloadsV1ApplyWorkloadUpdateRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.organizations().locations_workloads_updates_apply(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct OrganizationLocationWorkloadUpdateApplyCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
    _request: GoogleCloudAssuredworkloadsV1ApplyWorkloadUpdateRequest,
    _name: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadUpdateApplyCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadUpdateApplyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudAssuredworkloadsV1ApplyWorkloadUpdateRequest,
    ) -> OrganizationLocationWorkloadUpdateApplyCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationLocationWorkloadUpdateApplyCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationWorkloadUpdateApplyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadUpdateApplyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// This endpoint lists all updates for the given workload.
///
/// A builder for the *locations.workloads.updates.list* method supported by a *organization* resource.
/// It is not used directly, but through a [`OrganizationMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.organizations().locations_workloads_updates_list("parent")
///              .page_token("gubergren")
///              .page_size(-75)
///              .doit().await;
/// # }
/// ```
pub struct OrganizationLocationWorkloadUpdateListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadUpdateListCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadUpdateListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/updates";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> OrganizationLocationWorkloadUpdateListCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationWorkloadUpdateListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadUpdateListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// This endpoint enables Assured Workloads service to offer compliance updates for the folder based assured workload. It sets up an Assured Workloads Service Agent, having permissions to read compliance controls (for example: Org Policies) applied on the workload. The caller must have `resourcemanager.folders.getIamPolicy` and `resourcemanager.folders.setIamPolicy` permissions on the assured workload folder.
///
/// A builder for the *locations.workloads.enableComplianceUpdates* method supported by a *organization* resource.
/// It is not used directly, but through a [`OrganizationMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.organizations().locations_workloads_enable_compliance_updates("name")
///              .doit().await;
/// # }
/// ```
pub struct OrganizationLocationWorkloadEnableComplianceUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadEnableComplianceUpdateCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadEnableComplianceUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+name}:enableComplianceUpdates";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadEnableComplianceUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
