...
use google_recommender1_beta1::{api, Error, oauth2, client::chrono, FieldMask};
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    async fn _billing_accounts_locations_recommenders_recommendations_mark_dismissed(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudRecommenderV1beta1MarkRecommendationDismissedRequest = json::value::from_value(object).unwrap();
