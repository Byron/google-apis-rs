...
//! This documentation was generated from *Smart Device Management* crate version *3.0.0+20220302*, where *20220302* is the exact revision of the *smartdevicemanagement:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.0*.
//! 
