...
//! This documentation was generated from *Smart Device Management* crate version *2.0.5+20210319*, where *20210319* is the exact revision of the *smartdevicemanagement:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.5*.
//! 
