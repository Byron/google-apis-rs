...
//! This documentation was generated from *Smart Device Management* crate version *7.0.0+20251201*, where *20251201* is the exact revision of the *smartdevicemanagement:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
