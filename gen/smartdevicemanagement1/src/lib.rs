...
//! This documentation was generated from *Smart Device Management* crate version *8.0.0+20251014*, where *20251014* is the exact revision of the *smartdevicemanagement:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
