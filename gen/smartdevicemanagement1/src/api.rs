...
impl<C> common::Hub for SmartDeviceManagement<C> {}

impl<'a, C> SmartDeviceManagement<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> SmartDeviceManagement<C> {
...
impl common::ResponseResult for GoogleHomeEnterpriseSdmV1Device {}
...
impl common::RequestValue for GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest {}
...
impl common::ResponseResult for GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandResponse {}
...
impl common::ResponseResult for GoogleHomeEnterpriseSdmV1ListDevicesResponse {}
...
impl common::ResponseResult for GoogleHomeEnterpriseSdmV1ListRoomsResponse {}
...
impl common::ResponseResult for GoogleHomeEnterpriseSdmV1ListStructuresResponse {}
...
impl common::Part for GoogleHomeEnterpriseSdmV1ParentRelation {}
...
impl common::ResponseResult for GoogleHomeEnterpriseSdmV1Room {}
...
impl common::ResponseResult for GoogleHomeEnterpriseSdmV1Structure {}
...
impl<'a, C> common::CallBuilder for EnterpriseDeviceExecuteCommandCall<'a, C> {}

impl<'a, C> EnterpriseDeviceExecuteCommandCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub fn request(
        mut self,
        new_value: GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest,
    ) -> EnterpriseDeviceExecuteCommandCall<'a, C> {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> EnterpriseDeviceExecuteCommandCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> EnterpriseDeviceExecuteCommandCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> EnterpriseDeviceExecuteCommandCall<'a, C> {
        self._scopes.clear();
        self
    }
}
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleHomeEnterpriseSdmV1Device)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
...
impl<'a, C> common::CallBuilder for EnterpriseStructureRoomGetCall<'a, C> {}

impl<'a, C> EnterpriseStructureRoomGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleHomeEnterpriseSdmV1Room)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> EnterpriseStructureRoomGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> EnterpriseStructureRoomGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> EnterpriseStructureRoomGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for EnterpriseStructureRoomListCall<'a, C> {}

impl<'a, C> EnterpriseStructureRoomListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleHomeEnterpriseSdmV1ListRoomsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> EnterpriseStructureRoomListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> EnterpriseStructureRoomListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> EnterpriseStructureRoomListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for EnterpriseStructureGetCall<'a, C> {}

impl<'a, C> EnterpriseStructureGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleHomeEnterpriseSdmV1Structure)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> EnterpriseStructureGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> EnterpriseStructureGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> EnterpriseStructureGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> EnterpriseStructureGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for EnterpriseStructureListCall<'a, C> {}

impl<'a, C> EnterpriseStructureListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> EnterpriseStructureListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> EnterpriseStructureListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> EnterpriseStructureListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
