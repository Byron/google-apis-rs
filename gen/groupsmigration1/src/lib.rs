...
//! This documentation was generated from *Groups Migration* crate version *0.1.10+20140416*, where *20140416* is the exact revision of the *groupsmigration:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.10*.
//! 
