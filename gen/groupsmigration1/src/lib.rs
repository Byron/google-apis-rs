...
//! This documentation was generated from *Groups Migration* crate version *1.0.2+20140416*, where *20140416* is the exact revision of the *groupsmigration:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.2*.
//! 
