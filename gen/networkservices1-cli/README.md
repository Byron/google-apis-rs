...
This documentation was generated from the *NetworkServices* API at revision *20251203*. The CLI is at version *7.0.0*.

```bash
networkservices1 [options]
        projects
                locations-authz-extensions-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-authz-extensions-delete <name> [-p <v>]... [-o <out>]
                locations-authz-extensions-get <name> [-p <v>]... [-o <out>]
                locations-authz-extensions-list <parent> [-p <v>]... [-o <out>]
                locations-authz-extensions-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-gateways-route-views-get <name> [-p <v>]... [-o <out>]
                locations-gateways-route-views-list <parent> [-p <v>]... [-o <out>]
                ...
                locations-lb-edge-extensions-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-lb-edge-extensions-delete <name> [-p <v>]... [-o <out>]
                locations-lb-edge-extensions-get <name> [-p <v>]... [-o <out>]
                locations-lb-edge-extensions-list <parent> [-p <v>]... [-o <out>]
                locations-lb-edge-extensions-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-meshes-route-views-get <name> [-p <v>]... [-o <out>]
                locations-meshes-route-views-list <parent> [-p <v>]... [-o <out>]
                ...
                locations-service-bindings-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-wasm-plugins-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-wasm-plugins-delete <name> [-p <v>]... [-o <out>]
                locations-wasm-plugins-get <name> [-p <v>]... [-o <out>]
                locations-wasm-plugins-list <parent> [-p <v>]... [-o <out>]
                locations-wasm-plugins-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-wasm-plugins-versions-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-wasm-plugins-versions-delete <name> [-p <v>]... [-o <out>]
                locations-wasm-plugins-versions-get <name> [-p <v>]... [-o <out>]
                locations-wasm-plugins-versions-list <parent> [-p <v>]... [-o <out>]
