...
You may alter the way an `doit()` method is called by providing a [delegate](https://docs.rs/google-mirror1/7.0.0+20190424/google_mirror1/common::Delegate) to the
