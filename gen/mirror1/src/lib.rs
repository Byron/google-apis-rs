...
//! This documentation was generated from *mirror* crate version *0.1.9+20150720*, where *20150720* is the exact revision of the *mirror:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.9*.
//! 
