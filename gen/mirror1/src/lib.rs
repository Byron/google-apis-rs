...
//! This documentation was generated from *mirror* crate version *6.0.0+20190424*, where *20190424* is the exact revision of the *mirror:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
//! Everything else about the *mirror* *v1* API can be found at the
//! [official documentation site](https://developers.google.com/glass).
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/mirror1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Mirror) ...
//!
//! * [accounts](api::Account)
//!  * [*insert*](api::AccountInsertCall)
//! * [contacts](api::Contact)
//!  * [*delete*](api::ContactDeleteCall), [*get*](api::ContactGetCall), [*insert*](api::ContactInsertCall), [*list*](api::ContactListCall), [*patch*](api::ContactPatchCall) and [*update*](api::ContactUpdateCall)
//! * [locations](api::Location)
//!  * [*get*](api::LocationGetCall) and [*list*](api::LocationListCall)
//! * [settings](api::Setting)
//!  * [*get*](api::SettingGetCall)
//! * [subscriptions](api::Subscription)
//!  * [*delete*](api::SubscriptionDeleteCall), [*insert*](api::SubscriptionInsertCall), [*list*](api::SubscriptionListCall) and [*update*](api::SubscriptionUpdateCall)
//! * timeline
//!  * [*attachments delete*](api::TimelineAttachmentDeleteCall), [*attachments get*](api::TimelineAttachmentGetCall), [*attachments insert*](api::TimelineAttachmentInsertCall), [*attachments list*](api::TimelineAttachmentListCall), [*delete*](api::TimelineDeleteCall), [*get*](api::TimelineGetCall), [*insert*](api::TimelineInsertCall), [*list*](api::TimelineListCall), [*patch*](api::TimelinePatchCall) and [*update*](api::TimelineUpdateCall)
//!
//!
//! Upload supported by ...
//!
//! * [*attachments insert timeline*](api::TimelineAttachmentInsertCall)
//! * [*insert timeline*](api::TimelineInsertCall)
//! * [*update timeline*](api::TimelineUpdateCall)
//!
//! Download supported by ...
//!
//! * [*attachments get timeline*](api::TimelineAttachmentGetCall)
//!
//!
//!
