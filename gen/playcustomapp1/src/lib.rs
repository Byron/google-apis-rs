...
//! This documentation was generated from *playcustomapp* crate version *5.0.3+20240304*, where *20240304* is the exact revision of the *playcustomapp:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
