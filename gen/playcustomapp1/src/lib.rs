...
//! This documentation was generated from *playcustomapp* crate version *5.0.3+20230123*, where *20230123* is the exact revision of the *playcustomapp:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
