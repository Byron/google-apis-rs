...
//! This documentation was generated from *playcustomapp* crate version *2.0.4+20210331*, where *20210331* is the exact revision of the *playcustomapp:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.4*.
//! 
