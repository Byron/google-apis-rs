...
//! This documentation was generated from *playcustomapp* crate version *6.0.0+20240625*, where *20240625* is the exact revision of the *playcustomapp:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
