...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations sign ssh public key projects](ProjectLocationSignSshPublicKeyCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyRequest {
    ...
    #[serde(rename = "appEngineInstance")]
...
impl common::RequestValue for GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations sign ssh public key projects](ProjectLocationSignSshPublicKeyCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse {
...
impl common::ResponseResult
    for GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse
{
}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [projects provision posix account users](UserProjectProvisionPosixAccountCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::ResponseResult for PosixAccount {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [projects provision posix account users](UserProjectProvisionPosixAccountCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for ProvisionPosixAccountRequest {}
...
/// // like `locations_sign_ssh_public_key(...)`
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_sign_ssh_public_key(
        &self,
        request: GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyRequest,
        parent: &str,
    ) -> ProjectLocationSignSshPublicKeyCall<'a, C> {
        ProjectLocationSignSshPublicKeyCall {
            hub: self.hub,
            _request: request,
...
/// Signs an SSH public key for a user to authenticate to a virtual machine on Google Compute Engine.
///
/// A builder for the *locations.signSshPublicKey* method supported by a *project* resource.
...
/// # extern crate hyper_rustls;
/// # extern crate google_oslogin1_beta as oslogin1_beta;
/// use oslogin1_beta::api::GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyRequest;
/// # async fn dox() {
/// # use oslogin1_beta::{CloudOSLogin, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_sign_ssh_public_key(req, "parent")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationSignSshPublicKeyCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudOSLogin<C>,
    _request: GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyRequest,
    _parent: String,
...
impl<'a, C> common::CallBuilder for ProjectLocationSignSshPublicKeyCall<'a, C> {}

impl<'a, C> ProjectLocationSignSshPublicKeyCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyRequest,
    ) -> ProjectLocationSignSshPublicKeyCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationSignSshPublicKeyCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationSignSshPublicKeyCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationSignSshPublicKeyCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationSignSshPublicKeyCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationSignSshPublicKeyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Create a POSIX account if it doesn't exist.
///
/// A builder for the *projects.provisionPosixAccount* method supported by a *user* resource.
/// It is not used directly, but through a [`UserMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_oslogin1_beta as oslogin1_beta;
/// use oslogin1_beta::api::ProvisionPosixAccountRequest;
/// # async fn dox() {
/// # use oslogin1_beta::{CloudOSLogin, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ProvisionPosixAccountRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.users().projects_provision_posix_account(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct UserProjectProvisionPosixAccountCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudOSLogin<C>,
    _request: ProvisionPosixAccountRequest,
    _name: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for UserProjectProvisionPosixAccountCall<'a, C> {}

impl<'a, C> UserProjectProvisionPosixAccountCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, PosixAccount)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: ProvisionPosixAccountRequest,
    ) -> UserProjectProvisionPosixAccountCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> UserProjectProvisionPosixAccountCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserProjectProvisionPosixAccountCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserProjectProvisionPosixAccountCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserProjectProvisionPosixAccountCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserProjectProvisionPosixAccountCall<'a, C> {
        self._scopes.clear();
        self
    }
}
