...
pub struct ControllerDebuggeeBreakpointListCall<'a, S>
   ...
   pub(super) _wait_token: Option<String>,
   pub(super) _success_on_timeout: Option<bool>,
   pub(super) _agent_id: Option<String>,
...
pub struct ControllerDebuggeeBreakpointUpdateCall<'a, S>
   ...
   pub(super) hub: &'a CloudDebugger<S>,
   pub(super) _request: UpdateActiveBreakpointRequest,
   pub(super) _debuggee_id: String,
...
pub struct ControllerDebuggeeRegisterCall<'a, S>
   ...
   pub(super) hub: &'a CloudDebugger<S>,
   pub(super) _request: RegisterDebuggeeRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct DebuggerDebuggeeBreakpointDeleteCall<'a, S>
   ...
   pub(super) hub: &'a CloudDebugger<S>,
   pub(super) _debuggee_id: String,
   pub(super) _breakpoint_id: String,
...
pub struct DebuggerDebuggeeBreakpointListCall<'a, S>
   ...
   pub(super) _debuggee_id: String,
   pub(super) _wait_token: Option<String>,
   pub(super) _strip_results: Option<bool>,
...
pub struct DebuggerDebuggeeListCall<'a, S>
   ...
   pub(super) hub: &'a CloudDebugger<S>,
   pub(super) _project: Option<String>,
   pub(super) _include_inactive: Option<bool>,
   pub(super) _client_version: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
