...
//! This documentation was generated from *Cloud Debugger* crate version *1.0.11+20190614*, where *20190614* is the exact revision of the *clouddebugger:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.11*.
//! 
