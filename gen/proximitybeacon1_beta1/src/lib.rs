...
//! This documentation was generated from *proximitybeacon* crate version *1.0.2+20160429*, where *20160429* is the exact revision of the *proximitybeacon:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.2*.
//! 
