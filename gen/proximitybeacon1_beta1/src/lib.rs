...
//! This documentation was generated from *proximitybeacon* crate version *0.1.13+20150729*, where *20150729* is the exact revision of the *proximitybeacon:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.13*.
//! 
