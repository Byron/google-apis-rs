...
pub struct PageDeleteCall<'a, S>
   ...
   pub(super) _use_trash: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct PageInsertCall<'a, S>
   ...
   pub(super) hub: &'a Blogger<S>,
   pub(super) _request: Page,
   pub(super) _blog_id: String,
   pub(super) _is_draft: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct PagePatchCall<'a, S>
   ...
   pub(super) _blog_id: String,
   pub(super) _page_id: String,
   pub(super) _revert: Option<bool>,
   pub(super) _publish: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct PostPublishCall<'a, S>
   ...
   pub(super) _blog_id: String,
   pub(super) _post_id: String,
   pub(super) _publish_date: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
