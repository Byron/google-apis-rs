...
//! 
//! * partners
//!  * [*products list*](api::PartnerProductListCall), [*promotions list*](api::PartnerPromotionListCall), [*subscriptions cancel*](api::PartnerSubscriptionCancelCall), [*subscriptions create*](api::PartnerSubscriptionCreateCall), [*subscriptions entitle*](api::PartnerSubscriptionEntitleCall), [*subscriptions extend*](api::PartnerSubscriptionExtendCall), [*subscriptions get*](api::PartnerSubscriptionGetCall), [*subscriptions provision*](api::PartnerSubscriptionProvisionCall) and [*subscriptions undo cancel*](api::PartnerSubscriptionUndoCancelCall)
//! 
//! 
//! 
//! 
