...
//! This documentation was generated from *sasportal* crate version *7.0.0+20251221*, where *20251221* is the exact revision of the *sasportal:v1alpha1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
