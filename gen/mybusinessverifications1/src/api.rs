...
pub struct GenerateInstantVerificationTokenRequest {
    ...
    /// The location identifier associated with an unverified listing. This is the location id generated at the time that the listing was originally created. It is the final portion of a location resource name as generated by the Google My Business API. Note: the caller must be an owner or manager of this listing in order to generate a verification token. See the [location resource](https://developers.google.com/my-business/reference/rest/v4/accounts.locations) documentation for more information.
    #[serde(rename = "locationId")]
    pub location_id: Option<String>,
}

impl common::RequestValue for GenerateInstantVerificationTokenRequest {}
...
impl common::Part for LocationData {}
...
pub struct VerifyLocationRequest {
    ...
    #[serde(rename = "trustedPartnerToken")]
...
impl<'a, C> VerificationTokenMethods<'a, C> {
    ...
    pub fn generate(
        &self,
        request: GenerateInstantVerificationTokenRequest,
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusinessverifications1 as mybusinessverifications1;
/// use mybusinessverifications1::api::GenerateInstantVerificationTokenRequest;
/// # async fn dox() {
/// # use mybusinessverifications1::{MyBusinessVerifications, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = GenerateInstantVerificationTokenRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
...
{
    hub: &'a MyBusinessVerifications<C>,
    _request: GenerateInstantVerificationTokenRequest,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
}
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GenerateInstantVerificationTokenResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: GenerateInstantVerificationTokenRequest,
    ) -> VerificationTokenGenerateCall<'a, C> {
        self._request = new_value;
        self
    }
