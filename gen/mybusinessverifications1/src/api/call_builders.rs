...
pub struct LocationVerificationCompleteCall<'a, S>
   ...
   pub(super) _request: CompleteVerificationRequest,
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, CompleteVerificationResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessverifications.locations.verifications.complete",
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListVerificationsResponse)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "mybusinessverifications.locations.verifications.list",
...
pub struct LocationFetchVerificationOptionCall<'a, S>
   ...
   pub(super) hub: &'a MyBusinessVerifications<S>,
   pub(super) _request: FetchVerificationOptionsRequest,
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, FetchVerificationOptionsResponse)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "mybusinessverifications.locations.fetchVerificationOptions",
                               http_method: hyper::Method::POST });
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, VoiceOfMerchantState)> {
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::{ToParts, url::Params};
        use std::borrow::Cow;
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "mybusinessverifications.locations.getVoiceOfMerchantState",
                               http_method: hyper::Method::GET });
...
pub struct LocationVerifyCall<'a, S>
   ...
   pub(super) hub: &'a MyBusinessVerifications<S>,
   pub(super) _request: VerifyLocationRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, VerifyLocationResponse)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "mybusinessverifications.locations.verify",
                               http_method: hyper::Method::POST });
...
pub struct VerificationTokenGenerateCall<'a, S>
   ...
   pub(super) hub: &'a MyBusinessVerifications<S>,
   pub(super) _request: GenerateVerificationTokenRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
}
