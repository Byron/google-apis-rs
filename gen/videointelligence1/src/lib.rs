...
//! This documentation was generated from *Cloud Video Intelligence* crate version *1.0.11+20190626*, where *20190626* is the exact revision of the *videointelligence:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.11*.
//! 
