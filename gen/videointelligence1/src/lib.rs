...
//! This documentation was generated from *Cloud Video Intelligence* crate version *2.0.3+20210325*, where *20210325* is the exact revision of the *videointelligence:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.3*.
//! 
