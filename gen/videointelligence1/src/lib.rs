...
//! This documentation was generated from *Cloud Video Intelligence* crate version *5.0.2+20230119*, where *20230119* is the exact revision of the *videointelligence:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2*.
//! 
