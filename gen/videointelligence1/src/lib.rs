...
impl<'a, C, A> OperationMethods<'a, C, A> {
    ...
    pub fn cancel(&self, request: GoogleLongrunning_CancelOperationRequest, name: &str) -> OperationCancelCall<'a, C, A> {
        OperationCancelCall {
            hub: self.hub,
            _request: request,
            _name: name.to_string(),
...
impl<'a, C, A> OperationListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleLongrunning_ListOperationsResponse)> {
        ...
        dlg.begin(MethodInfo { id: "videointelligence.operations.list",
...
impl<'a, C, A> OperationCancelCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleLongrunning_CancelOperationRequest) -> OperationCancelCall<'a, C, A> {
