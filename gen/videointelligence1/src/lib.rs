...
//! This documentation was generated from *Cloud Video Intelligence* crate version *5.0.3+20240118*, where *20240118* is the exact revision of the *videointelligence:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
