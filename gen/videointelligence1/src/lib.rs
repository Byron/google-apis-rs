...
//! This documentation was generated from *Cloud Video Intelligence* crate version *8.0.0+20250724*, where *20250724* is the exact revision of the *videointelligence:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
