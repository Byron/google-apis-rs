...
impl<C> common::Hub for Cloudlatencytest<C> {}
...
impl common::RequestValue for AggregatedStats {}
...
impl common::ResponseResult for AggregatedStatsReply {}
...
impl common::Part for DoubleValue {}
...
impl common::RequestValue for Stats {}
...
impl common::ResponseResult for StatsReply {}
...
impl common::Part for StringValue {}
...
impl<'a, C> common::MethodsBuilder for StatscollectionMethods<'a, C> {}
...
impl<'a, C> StatscollectionMethods<'a, C> {
    ...
    pub fn updateaggregatedstats(
        &self,
        request: AggregatedStats,
    ) -> StatscollectionUpdateaggregatedstatCall<'a, C> {
...
impl<'a, C> common::CallBuilder for StatscollectionUpdateaggregatedstatCall<'a, C> {}

impl<'a, C> StatscollectionUpdateaggregatedstatCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, AggregatedStatsReply)> {
        use std::borrow::Cow;
        ...
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::MonitoringReadonly.as_ref().to_string());
        }
    ...
    pub fn add_scope<St>(mut self, scope: St) -> StatscollectionUpdateaggregatedstatCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> StatscollectionUpdateaggregatedstatCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> StatscollectionUpdateaggregatedstatCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for StatscollectionUpdatestatCall<'a, C> {}

impl<'a, C> StatscollectionUpdatestatCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, StatsReply)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> StatscollectionUpdatestatCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> StatscollectionUpdatestatCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> StatscollectionUpdatestatCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> StatscollectionUpdatestatCall<'a, C> {
        self._scopes.clear();
        self
    }
}
