...
pub struct ProjectIndexCreateCall<'a, S>
   ...
   pub(super) _request: GoogleDatastoreAdminV1Index,
...
pub struct ProjectExportCall<'a, S>
   ...
   pub(super) hub: &'a Datastore<S>,
   pub(super) _request: GoogleDatastoreAdminV1ExportEntitiesRequest,
   pub(super) _project_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectImportCall<'a, S>
   ...
   pub(super) hub: &'a Datastore<S>,
   pub(super) _request: GoogleDatastoreAdminV1ImportEntitiesRequest,
   pub(super) _project_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
