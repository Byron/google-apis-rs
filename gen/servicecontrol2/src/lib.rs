...
//! This documentation was generated from *Service Control* crate version *6.0.0+20240607*, where *20240607* is the exact revision of the *servicecontrol:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
