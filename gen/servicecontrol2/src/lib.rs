...
//! This documentation was generated from *Service Control* crate version *8.0.0+20250925*, where *20250925* is the exact revision of the *servicecontrol:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
