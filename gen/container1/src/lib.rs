...
//! This documentation was generated from *Container* crate version *5.0.4+20240214*, where *20240214* is the exact revision of the *container:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.4*.
//! 
