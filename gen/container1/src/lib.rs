...
//! This documentation was generated from *Container* crate version *6.0.0+20240608*, where *20240608* is the exact revision of the *container:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
