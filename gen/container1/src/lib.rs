...
//! This documentation was generated from *Container* crate version *3.0.2+20220215*, where *20220215* is the exact revision of the *container:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
