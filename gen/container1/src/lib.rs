...
//! This documentation was generated from *container* crate version *1.0.1+20160421*, where *20160421* is the exact revision of the *container:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.1*.
//! 
