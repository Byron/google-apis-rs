...
//! This documentation was generated from *Dialogflow* crate version *7.0.0+20251027*, where *20251027* is the exact revision of the *dialogflow:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
