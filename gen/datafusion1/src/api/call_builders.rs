...
pub struct ProjectLocationInstanceDnsPeeringCreateCall<'a, S>
   ...
   pub(super) _request: DnsPeering,
   pub(super) _parent: String,
   pub(super) _dns_peering_id: Option<String>,
...
pub struct ProjectLocationInstanceCreateCall<'a, S>
   ...
   pub(super) _parent: String,
   pub(super) _instance_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ProjectLocationInstanceRestartCall<'a, S>
   ...
   pub(super) hub: &'a DataFusion<S>,
   pub(super) _request: RestartInstanceRequest,
   pub(super) _name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectLocationVersionListCall<'a, S>
   ...
   pub(super) _page_token: Option<String>,
   pub(super) _page_size: Option<i32>,
   pub(super) _latest_patch_only: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ProjectLocationListCall<'a, S>
   ...
   pub(super) _page_token: Option<String>,
   pub(super) _page_size: Option<i32>,
   pub(super) _include_unrevealed_locations: Option<bool>,
   pub(super) _filter: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
