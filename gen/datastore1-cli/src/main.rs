            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "aggregation-query.nested-query.find-nearest.query-vector.entity-value.key.partition-id.database-id" => Some(("aggregationQuery.nestedQuery.findNearest.queryVector.entityValue.key.partitionId.databaseId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    ...
                    "aggregation-query.nested-query.find-nearest.query-vector.key-value.partition-id.database-id" => Some(("aggregationQuery.nestedQuery.findNearest.queryVector.keyValue.partitionId.databaseId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["aggregation-query", "allow-literals", "analyze", "blob-value", "boolean-value", "composite-filter", "database-id", "distance-measure", "distance-result-property", "distance-threshold", "double-value", "end-cursor", "entity-value", "exclude-from-indexes", "explain-options", "filter", "find-nearest", "geo-point-value", "gql-query", "integer-value", "key", "key-value", "latitude", "limit", "longitude", "meaning", "name", "namespace-id", "nested-query", "new-transaction", "null-value", "offset", "op", "partition-id", "previous-transaction", "project-id", "property", "property-filter", "query-string", "query-vector", "read-consistency", "read-only", "read-options", "read-time", "read-write", "start-cursor", "string-value", "timestamp-value", "transaction", "value", "vector-property"]);
    ...
    async fn _projects_run_query(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "query.find-nearest.query-vector.entity-value.key.partition-id.database-id" => {
                    Some((
                        "query.findNearest.queryVector.entityValue.key.partitionId.databaseId",
                        JsonTypeInfo {
                            jtype: JsonType::String,
                            ctype: ComplexType::Pod,
                        },
                ...
                "query.find-nearest.query-vector.key-value.partition-id.database-id" => Some((
                    "query.findNearest.queryVector.keyValue.partitionId.databaseId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
