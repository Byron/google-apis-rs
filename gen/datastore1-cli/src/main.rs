...
fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'allocate-ids', 'begin-transaction', 'commit', 'lookup', 'operations-cancel', 'operations-delete', 'operations-get', 'operations-list', 'reserve-ids', 'rollback' and 'run-query'", vec![
            ("allocate-ids",
