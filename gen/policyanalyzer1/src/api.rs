...
impl<'a, S> PolicyAnalyzer<S> {
    ...
    pub fn new<A: 'static + client::Authy>(client: hyper::Client<S, hyper::body::Body>, auth: A) -> PolicyAnalyzer<S> {
        PolicyAnalyzer {
            client,
            auth: Box::new(auth),
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub fn add_scope<T, St>(mut self, scope: T) -> ProjectLocationActivityTypeActivityQueryCall<'a, S>
