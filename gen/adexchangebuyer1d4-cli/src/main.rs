...
use google_adexchangebuyer1d4::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _accounts_patch(
            ...
            .iter()
        {
            ...
            {
                "apply-pretargeting-to-non-guaranteed-deals" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec![
                            "apply-pretargeting-to-non-guaranteed-deals",
                            "cookie-matching-nid",
                            "cookie-matching-url",
                            "id",
                            "kind",
            ...
            .iter()
        {
            ...
            match key {
                "confirm-unsafe-account-change" => {
                    call = call.confirm_unsafe_account_change(
                        value
                            .map(|v| {
                                arg_from_str(v, err, "confirm-unsafe-account-change", "boolean")
                            })
                            .unwrap_or(false),
                    );
                }
    ...
    async fn _creatives_add_deal(
        ...
        let deal_id: i64 = arg_from_str(
            &opt.value_of("deal-id").unwrap_or(""),
            err,
            "<deal-id>",
            "int64",
        );
        let mut call = self.hub.creatives().add_deal(
            account_id,
            opt.value_of("buyer-creative-id").unwrap_or(""),
            deal_id,
        );
        for parg in opt
            .values_of("v")
    ...
    async fn _creatives_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "creative-status-identity-type" => Some((
    ...
    async fn _creatives_list_deals(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .creatives()
            .list_deals(account_id, opt.value_of("buyer-creative-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _creatives_remove_deal(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self.hub.creatives().remove_deal(
            account_id,
            opt.value_of("buyer-creative-id").unwrap_or(""),
            deal_id,
        );
    ...
    async fn _marketplacedeals_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["deal-ids", "proposal-revision-number", "update-action"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::DeleteOrderDealsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .marketplacedeals()
            .delete(request, opt.value_of("proposal-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _marketplacedeals_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["proposal-revision-number", "update-action"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::AddOrderDealsRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .marketplacedeals()
            .insert(request, opt.value_of("proposal-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _marketplacedeals_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .marketplacedeals()
            .list(opt.value_of("proposal-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _marketplacedeals_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "proposal.billed-buyer.account-id" => Some((
                ...
                "proposal.buyer.account-id" => Some((
                ...
                "proposal.buyer-private-data.reference-id" => Some((
                    "proposal.buyerPrivateData.referenceId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "proposal.buyer-private-data.reference-payload" => Some((
                    "proposal.buyerPrivateData.referencePayload",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "proposal.dbm-advertiser-ids" => Some((
                    "proposal.dbmAdvertiserIds",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "proposal.has-buyer-signed-off" => Some((
                    "proposal.hasBuyerSignedOff",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "proposal.has-seller-signed-off" => Some((
                    "proposal.hasSellerSignedOff",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "proposal.inventory-source" => Some((
                    "proposal.inventorySource",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "proposal.is-renegotiating" => Some((
                ...
                "proposal.is-setup-complete" => Some((
                ...
                "proposal.last-updater-or-commentor-role" => Some((
                ...
                "proposal.private-auction-id" => Some((
                ...
                "proposal.revision-time-ms" => Some((
                    "proposal.revisionTimeMs",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "proposal.seller.account-id" => Some((
                ...
                "proposal.seller.sub-account-id" => Some((
        ...
        let mut request: api::EditAllOrderDealsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .marketplacedeals()
            .update(request, opt.value_of("proposal-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _marketplacenotes_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AddOrderNotesRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .marketplacenotes()
            .insert(request, opt.value_of("proposal-id").unwrap_or(""));
    ...
    async fn _marketplacenotes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _marketplaceprivateauction_updateproposal(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "note.proposal-revision-number" => Some((
        ...
        let mut request: api::UpdatePrivateAuctionProposalRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .marketplaceprivateauction()
            .updateproposal(request, opt.value_of("private-auction-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _pretargeting_config_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "user-identifier-data-required" => Some((
    ...
    async fn _products_get(
        ...
        let mut call = self
            .hub
            .products()
            .get(opt.value_of("product-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _proposals_get(
        ...
        let mut call = self
            .hub
            .proposals()
            .get(opt.value_of("proposal-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _proposals_insert(
        ...
        let mut request: api::CreateOrdersRequest = serde_json::value::from_value(object).unwrap();
    ...
    async fn _proposals_patch(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "buyer-private-data.reference-payload" => Some((
        ...
        let revision_number: i64 = arg_from_str(
            &opt.value_of("revision-number").unwrap_or(""),
            err,
            "<revision-number>",
            "int64",
        );
        let mut call = self.hub.proposals().patch(
            request,
            opt.value_of("proposal-id").unwrap_or(""),
            revision_number,
            opt.value_of("update-action").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _proposals_setupcomplete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .proposals()
            .setupcomplete(opt.value_of("proposal-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _proposals_update(
        ...
        let mut call = self.hub.proposals().update(
            request,
            opt.value_of("proposal-id").unwrap_or(""),
            revision_number,
            opt.value_of("update-action").unwrap_or(""),
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ...
            ("marketplacedeals", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("marketplacedeals".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("marketplacenotes", Some(opt)) => match opt.subcommand() {
                ("insert", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("marketplacenotes".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("marketplaceprivateauction", Some(opt)) => match opt.subcommand() {
                ("updateproposal", Some(opt)) => {
                    call_result = self
                        ._marketplaceprivateauction_updateproposal(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "marketplaceprivateauction".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("proposals", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("proposals".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("pubprofiles", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._pubprofiles_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("pubprofiles".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "adexchangebuyer1d4-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/adexchangebuyer1d4", config_dir))
        .build()
        .await
        .unwrap();
