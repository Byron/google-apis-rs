...
/// // Values shown here are possibly random and not representative !
/// let mut req: StyleSetting = Default::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
...
impl<'a, C, NC, A> StyleUpdateCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, StyleSetting)> {
        ...
        }
        {
            ...
            for param_name in ["tableId", "styleId"].iter() {
                for (index, &(ref name, _)) in params.iter().rev().enumerate() {
                    if name == param_name {
                        indices_for_removal.push(params.len() - index - 1);
                        break;
...
impl<'a, C, NC, A> TaskDeleteCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<hyper::client::Response> {
        ...
        {
            let mut indices_for_removal: Vec<usize> = Vec::with_capacity(2);
            for param_name in ["tableId", "taskId"].iter() {
                for (index, &(ref name, _)) in params.iter().rev().enumerate() {
                    if name == param_name {
                        indices_for_removal.push(params.len() - index - 1);
                        break;
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req: Column = Default::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
...
impl<'a, C, NC, A> ColumnUpdateCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Column)> {
        ...
        {
            let mut indices_for_removal: Vec<usize> = Vec::with_capacity(2);
            for param_name in ["tableId", "columnId"].iter() {
                for (index, &(ref name, _)) in params.iter().rev().enumerate() {
                    if name == param_name {
                        indices_for_removal.push(params.len() - index - 1);
                        break;
...
impl<'a, C, NC, A> TemplateUpdateCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Template)> {
        ...
        {
            let mut indices_for_removal: Vec<usize> = Vec::with_capacity(2);
            for param_name in ["tableId", "templateId"].iter() {
                for (index, &(ref name, _)) in params.iter().rev().enumerate() {
                    if name == param_name {
                        indices_for_removal.push(params.len() - index - 1);
                        break;
...
impl<'a, C, NC, A> TableReplaceRowCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    fn doit<RS>(mut self, mut reader: RS, reader_mime_type: mime::Mime, protocol: &'static str) -> Result<(hyper::client::Response, Task)>
        ...
        let mut url = if protocol == "simple" {
                "https://www.googleapis.com/upload/fusiontables/v2/tables/{tableId}/replace".to_string()
            } else if protocol == "resumable" {
                "https://www.googleapis.com/resumable/upload/fusiontables/v2/tables/{tableId}/replace".to_string()
            } else { 
                unreachable!() 
        };
...
impl<'a, C, NC, A> TableImportRowCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    fn doit<RS>(mut self, mut reader: RS, reader_mime_type: mime::Mime, protocol: &'static str) -> Result<(hyper::client::Response, Import)>
        ...
        let mut url = if protocol == "simple" {
                "https://www.googleapis.com/upload/fusiontables/v2/tables/{tableId}/import".to_string()
            } else if protocol == "resumable" {
                "https://www.googleapis.com/resumable/upload/fusiontables/v2/tables/{tableId}/import".to_string()
            } else { 
                unreachable!() 
        };
        params.push(("uploadType", protocol.to_string()));
...
impl<'a, C, NC, A> TableImportTableCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    fn doit<RS>(mut self, mut reader: RS, reader_mime_type: mime::Mime, protocol: &'static str) -> Result<(hyper::client::Response, Table)>
        ...
        let mut url = if protocol == "simple" {
                "https://www.googleapis.com/upload/fusiontables/v2/tables/import".to_string()
            } else if protocol == "resumable" {
                "https://www.googleapis.com/resumable/upload/fusiontables/v2/tables/import".to_string()
            } else { 
                unreachable!() 
        };
        params.push(("uploadType", protocol.to_string()));
