...
//! This documentation was generated from *siteVerification* crate version *1.0.7+20161114*, where *20161114* is the exact revision of the *siteVerification:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.7*.
//! 
