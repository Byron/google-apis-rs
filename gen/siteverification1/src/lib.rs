...
//! This documentation was generated from *siteVerification* crate version *0.1.15+20160228*, where *20160228* is the exact revision of the *siteVerification:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.15*.
//! 
