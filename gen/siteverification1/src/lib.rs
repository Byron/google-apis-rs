...
//! This documentation was generated from *siteVerification* crate version *1.0.2+20160228*, where *20160228* is the exact revision of the *siteVerification:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.2*.
//! 
