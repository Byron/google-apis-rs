...
//! This documentation was generated from *siteVerification* crate version *1.0.7+20180830*, where *20180830* is the exact revision of the *siteVerification:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.7*.
//! 
