...
//! This documentation was generated from *siteVerification* crate version *5.0.3+20191119*, where *20191119* is the exact revision of the *siteVerification:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
