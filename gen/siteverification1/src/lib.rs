...
//! This documentation was generated from *siteVerification* crate version *3.0.2+20191119*, where *20191119* is the exact revision of the *siteVerification:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
