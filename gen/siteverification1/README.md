...
[decodable](http://byron.github.io/google-apis-rs/google-siteverification1/trait.ResponseResult.html) via json. Optionals are used to indicate that partial requests are responses are valid.
Most optionals are are considered [Parts](http://byron.github.io/google-apis-rs/google-siteverification1/trait.Part.html) which are identifyable by name, which will be sent to 
