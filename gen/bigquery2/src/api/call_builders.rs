...
pub struct DatasetDeleteCall<'a, S>
   ...
   pub(super) _delete_contents: Option<bool>,
...
pub struct JobCancelCall<'a, S>
   ...
   pub(super) hub: &'a Bigquery<S>,
   pub(super) _project_id: String,
   pub(super) _job_id: String,
   pub(super) _location: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct JobGetQueryResultCall<'a, S>
   ...
   pub(super) _project_id: String,
   pub(super) _job_id: String,
   pub(super) _timeout_ms: Option<u32>,
   pub(super) _start_index: Option<u64>,
   pub(super) _page_token: Option<String>,
   pub(super) _max_results: Option<u32>,
   pub(super) _location: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct JobListCall<'a, S>
   ...
   pub(super) _max_results: Option<u32>,
   pub(super) _max_creation_time: Option<u64>,
   pub(super) _all_users: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct JobQueryCall<'a, S>
   ...
   pub(super) hub: &'a Bigquery<S>,
   pub(super) _request: QueryRequest,
   pub(super) _project_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct TabledataInsertAllCall<'a, S>
   ...
   pub(super) hub: &'a Bigquery<S>,
   pub(super) _request: TableDataInsertAllRequest,
   pub(super) _project_id: String,
   pub(super) _dataset_id: String,
   pub(super) _table_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct TablePatchCall<'a, S>
   ...
   pub(super) _dataset_id: String,
   pub(super) _table_id: String,
   pub(super) _autodetect_schema: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
