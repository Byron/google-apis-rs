...
use google_mybusinesslodging1::{api, Error, oauth2};
...
async fn main() {
        ...
        ("locations", "methods: 'get-lodging', 'lodging-get-google-updated' and 'update-lodging'", vec![
            ...
            ("lodging-get-google-updated",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Google identifier for this location in the form: `accounts/{account_id}/locations/{location_id}/lodging`"##),
                     Some(true),
                     Some(false)),
    ...
    let mut app = App::new("mybusinesslodging1")
           ...
           .about("The My Business Lodging API enables managing lodging business information on Google.")
