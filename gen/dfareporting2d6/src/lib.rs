...
//! This documentation was generated from *dfareporting* crate version *0.1.14+20160803*, where *20160803* is the exact revision of the *dfareporting:v2.6* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.14*.
//! 
