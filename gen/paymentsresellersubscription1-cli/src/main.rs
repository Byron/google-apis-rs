...
struct Engine<'n, S> {
    opt: ArgMatches<'n>,
    hub: api::PaymentsResellerSubscription<S>,
    gp: Vec<&'static str>,
...
{
    async fn _partners_products_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.partners().products_list(opt.value_of("parent").unwrap_or(""));
    ...
    async fn _partners_promotions_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.partners().promotions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    async fn _partners_subscriptions_cancel(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "cancel-immediately" => Some(("cancelImmediately", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    "cancellation-reason" => Some(("cancellationReason", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["cancel-immediately", "cancellation-reason"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::GoogleCloudPaymentsResellerSubscriptionV1CancelSubscriptionRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.partners().subscriptions_cancel(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _partners_subscriptions_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "cancellation-details.reason" => Some(("cancellationDetails.reason", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "create-time" => Some(("createTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "cycle-end-time" => Some(("cycleEndTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "end-user-entitled" => Some(("endUserEntitled", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    "free-trial-end-time" => Some(("freeTrialEndTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "name" => Some(("name", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "partner-user-token" => Some(("partnerUserToken", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    ...
                    "service-location.region-code" => Some(("serviceLocation.regionCode", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
        ...
        let mut request: api::GoogleCloudPaymentsResellerSubscriptionV1Subscription = json::value::from_value(object).unwrap();
        let mut call = self.hub.partners().subscriptions_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "subscription-id" => {
    ...
    async fn _partners_subscriptions_entitle(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::GoogleCloudPaymentsResellerSubscriptionV1EntitleSubscriptionRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.partners().subscriptions_entitle(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _partners_subscriptions_extend(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "extension.duration.count" => Some(("extension.duration.count", JsonTypeInfo { jtype: JsonType::Int, ctype: ComplexType::Pod })),
                    "extension.duration.unit" => Some(("extension.duration.unit", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "extension.partner-user-token" => Some(("extension.partnerUserToken", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "request-id" => Some(("requestId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["count", "duration", "extension", "partner-user-token", "request-id", "unit"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::GoogleCloudPaymentsResellerSubscriptionV1ExtendSubscriptionRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.partners().subscriptions_extend(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _partners_subscriptions_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.partners().subscriptions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _partners_subscriptions_provision(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::GoogleCloudPaymentsResellerSubscriptionV1Subscription = json::value::from_value(object).unwrap();
        let mut call = self.hub.partners().subscriptions_provision(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "subscription-id" => {
    ...
    async fn _partners_subscriptions_undo_cancel(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::GoogleCloudPaymentsResellerSubscriptionV1UndoCancelSubscriptionRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.partners().subscriptions_undo_cancel(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
            ...
            ("partners", Some(opt)) => {
                match opt.subcommand() {
                    ...
                    ("subscriptions-cancel", Some(opt)) => {
                        call_result = self._partners_subscriptions_cancel(opt, dry_run, &mut err).await;
                    },
                    ("subscriptions-create", Some(opt)) => {
                        call_result = self._partners_subscriptions_create(opt, dry_run, &mut err).await;
                    },
                    ("subscriptions-entitle", Some(opt)) => {
                        call_result = self._partners_subscriptions_entitle(opt, dry_run, &mut err).await;
                    },
                    ("subscriptions-extend", Some(opt)) => {
                        call_result = self._partners_subscriptions_extend(opt, dry_run, &mut err).await;
                    },
                    ("subscriptions-get", Some(opt)) => {
                        call_result = self._partners_subscriptions_get(opt, dry_run, &mut err).await;
                    },
                    ("subscriptions-provision", Some(opt)) => {
                        call_result = self._partners_subscriptions_provision(opt, dry_run, &mut err).await;
                    },
                    ("subscriptions-undo-cancel", Some(opt)) => {
                        call_result = self._partners_subscriptions_undo_cancel(opt, dry_run, &mut err).await;
                    },
                    _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: S) -> Result<Engine<'n, S>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "paymentsresellersubscription1-secret.json",
        ...
        let auth = oauth2::InstalledFlowAuthenticator::with_client(
            ...
            client.clone(),
        ).persist_tokens_to_disk(format!("{}/paymentsresellersubscription1", config_dir)).build().await.unwrap();
