...
use google_videointelligence1_beta1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    async fn _videos_annotate(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "video-context.safe-search-detection-model" => Some((
                ...
                "video-context.label-detection-model" => Some((
                ...
                "video-context.shot-change-detection-model" => Some((
                ...
                "video-context.label-detection-mode" => Some((
                ...
                "video-context.stationary-camera" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "location-id",
                            "output-uri",
                            "safe-search-detection-model",
                            "shot-change-detection-model",
                            "stationary-camera",
                            "video-context",
                        ],
                    );
        ...
        let mut request: api::GoogleCloudVideointelligenceV1beta1_AnnotateVideoRequest =
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "videointelligence1-beta1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/videointelligence1-beta1", config_dir))
        .build()
        .await
        .unwrap();
