...
impl<'n, 'a> Engine<'n, 'a> {
    ...
    fn _sitemaps_get(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.sitemaps().get(opt.value_of("site-url").unwrap_or(""), opt.value_of("feedpath").unwrap_or(""));
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _sitemaps_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.sitemaps().list(opt.value_of("site-url").unwrap_or(""));
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "sitemap-index" => {
    ...
    fn _sitemaps_submit(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.sitemaps().submit(opt.value_of("site-url").unwrap_or(""), opt.value_of("feedpath").unwrap_or(""));
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _sites_add(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _sites_delete(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.sites().delete(opt.value_of("site-url").unwrap_or(""));
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _urlcrawlerrorscounts_query(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["category", "platform", "latest-counts-only"]
                                                            ));
                    }
                }
            }
    ...
    fn _urlcrawlerrorssamples_get(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _urlcrawlerrorssamples_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _urlcrawlerrorssamples_mark_as_fixed(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        match self.opt.subcommand() {
            ("sitemaps", Some(opt)) => {
                match opt.subcommand() {
                    ("delete", Some(opt)) => {
                        call_result = self._sitemaps_delete(opt, dry_run, &mut err);
                    },
                    ("get", Some(opt)) => {
                        call_result = self._sitemaps_get(opt, dry_run, &mut err);
                    },
                    ("list", Some(opt)) => {
                        call_result = self._sitemaps_list(opt, dry_run, &mut err);
                    },
                    ("submit", Some(opt)) => {
                        call_result = self._sitemaps_submit(opt, dry_run, &mut err);
                    },
                    _ => {
                        err.issues.push(CLIError::MissingMethodError("sitemaps".to_string()));
                        writeln!(io::stderr(), "{}\n", opt.usage()).ok();
                    }
                }
            },
            ("sites", Some(opt)) => {
                match opt.subcommand() {
                    ("add", Some(opt)) => {
                        call_result = self._sites_add(opt, dry_run, &mut err);
                    },
                    ("delete", Some(opt)) => {
                        call_result = self._sites_delete(opt, dry_run, &mut err);
                    },
                    ("get", Some(opt)) => {
    ...
    let arg_data = [
        ("sitemaps", "methods: 'delete', 'get', 'list' and 'submit'", vec![
            ("delete",  
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_webmasters3_cli/sitemaps_delete",
                  vec![
                    (Some(r##"site-url"##),
                     None,
            ...
            ("get",  
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_webmasters3_cli/sitemaps_get",
                  vec![
                    (Some(r##"site-url"##),
                     None,
                     Some(r##"The site's URL, including protocol, for example 'http://www.example.com/'"##),
            ...
            ("submit",  
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_webmasters3_cli/sitemaps_submit",
                  vec![
                    (Some(r##"site-url"##),
                     None,
                     Some(r##"The site's URL, including protocol, for example 'http://www.example.com/'"##),
        ...
        ("sites", "methods: 'add', 'delete', 'get' and 'list'", vec![
            ("add",  
                    Some(r##"Adds a site to the set of the user's sites in Webmaster Tools."##),
                    "Details at http://byron.github.io/google-apis-rs/google_webmasters3_cli/sites_add",
                  vec![
                    (Some(r##"site-url"##),
                     None,
            ...
            ("delete",  
                    Some(r##"Removes a site from the set of the user's Webmaster Tools sites."##),
                    "Details at http://byron.github.io/google-apis-rs/google_webmasters3_cli/sites_delete",
                  vec![
                    (Some(r##"site-url"##),
                     None,
                     Some(r##"The site's URL, including protocol, for example 'http://www.example.com/'"##),
            ...
            ("get",  
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_webmasters3_cli/sites_get",
                  vec![
                    (Some(r##"site-url"##),
                     None,
                     Some(r##"The site's URL, including protocol, for example 'http://www.example.com/'"##),
