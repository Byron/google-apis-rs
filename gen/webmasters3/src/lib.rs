...
//! This documentation was generated from *webmasters* crate version *5.0.3+20190428*, where *20190428* is the exact revision of the *webmasters:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/webmasters3).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](Webmasters) ... 
//! 
//! * searchanalytics
...
//!     ).build().await.unwrap();
//! let mut hub = Webmasters::new(hyper::Client::builder().build(hyper_rustls::HttpsConnectorBuilder::new().with_native_roots().https_or_http().enable_http1().build()), auth);
