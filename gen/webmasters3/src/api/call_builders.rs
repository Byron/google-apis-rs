...
pub struct SearchanalyticQueryCall<'a, S>
   ...
   pub(super) hub: &'a Webmasters<S>,
   pub(super) _request: SearchAnalyticsQueryRequest,
   pub(super) _site_url: String,
...
pub struct SitemapListCall<'a, S>
   ...
   pub(super) hub: &'a Webmasters<S>,
   pub(super) _site_url: String,
   pub(super) _sitemap_index: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
