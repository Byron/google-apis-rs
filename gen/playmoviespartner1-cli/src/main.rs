...
use google_playmoviespartner1::{api, yup_oauth2, Error};
...
{
    async fn _accounts_avails_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().avails_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("avail-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _accounts_avails_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .avails_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_orders_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().orders_get(
            opt.value_of("account-id").unwrap_or(""),
    ...
    async fn _accounts_orders_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .orders_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_store_infos_country_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().store_infos_country_get(
            opt.value_of("account-id").unwrap_or(""),
    ...
    async fn _accounts_store_infos_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .store_infos_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("accounts", Some(opt)) => match opt.subcommand() {
                ...
                ("store-infos-country-get", Some(opt)) => {
                    call_result = self
                        ._accounts_store_infos_country_get(opt, dry_run, &mut err)
                        .await;
                }
                ("store-infos-list", Some(opt)) => {
                    call_result = self
                        ._accounts_store_infos_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "playmoviespartner1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/playmoviespartner1", config_dir))
        .build()
        .await
        .unwrap();
