...
This documentation was generated from *replicapoolupdater* crate version *0.1.0+20150129*, where *20150129* is the exact revision of the *replicapoolupdater:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.0*.
...
[decodable](http://byron.github.io/google-apis-rs/google-replicapoolupdater1_beta1/trait.ResponseResult.html) via json. Optionals are used to indicate that partial requests are responses are valid.
Most optionals are are considered [Parts](http://byron.github.io/google-apis-rs/google-replicapoolupdater1_beta1/trait.Part.html) which are identifyable by name, which will be sent to 
