...
impl<'a, C, A> ProjectGetConfigCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleCloudMlV1beta1__GetConfigResponse)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1beta1/{+name}:getConfig";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
impl<'a, C, A> ProjectModelCreateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleCloudMlV1beta1__Model)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1beta1/{+parent}/models";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
impl<'a, C, A> ProjectModelVersionSetDefaultCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleCloudMlV1beta1__Version)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1beta1/{+name}:setDefault";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
