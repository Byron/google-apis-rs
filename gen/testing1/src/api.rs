...
pub struct AndroidModel {
    ...
    #[serde(rename = "accessDeniedReasons")]
...
pub struct ApkManifest {
    ...
    #[serde(rename = "usesPermissionTags")]
...
pub struct ApkSplits {
    ...
    #[serde(rename = "bundleSplits")]
    pub bundle_splits: Option<Vec<FileReference>>,
}

impl common::Part for ApkSplits {}
...
impl common::Part for UsesPermissionTag {}
...
impl<'a, C> TestEnvironmentCatalogMethods<'a, C> {
    ...
    pub fn get(&self, environment_type: &str) -> TestEnvironmentCatalogGetCall<'a, C> {
        TestEnvironmentCatalogGetCall {
            ...
            _include_viewable_models: Default::default(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
            _scopes: Default::default(),
        }
    ...
    C: 'a,
{
    ...
    _include_viewable_models: Option<bool>,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
}
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, TestEnvironmentCatalog)> {
        ...
        if let Some(value) = self._include_viewable_models.as_ref() {
            params.push("includeViewableModels", value.to_string());
        }
    ...
    ///
    /// Sets the *include viewable models* query property to the given value.
    pub fn include_viewable_models(
        mut self,
        new_value: bool,
    ) -> TestEnvironmentCatalogGetCall<'a, C> {
        self._include_viewable_models = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    /// while executing the actual API request.
