...
use google_pagespeedonline5::{api, Error};
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::PagespeedInsights<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>
    >,
    gp: Vec<&'static str>,
