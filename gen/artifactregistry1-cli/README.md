...
This documentation was generated from the *Artifact Registry* API at revision *20251209*. The CLI is at version *7.0.0*.
...
artifactregistry1 [options]
        projects
                ...
                locations-repositories-attachments-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-repositories-attachments-delete <name> [-p <v>]... [-o <out>]
                locations-repositories-attachments-get <name> [-p <v>]... [-o <out>]
                locations-repositories-attachments-list <parent> [-p <v>]... [-o <out>]
                ...
                locations-repositories-export-artifact <repository> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-repositories-files-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-repositories-files-upload <parent> (-r <kv>)... (-u simple -f <file> [-m <mime>]) [-p <v>]... [-o <out>]
                ...
                locations-repositories-packages-versions-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-repositories-rules-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-repositories-rules-delete <name> [-p <v>]... [-o <out>]
                locations-repositories-rules-get <name> [-p <v>]... [-o <out>]
                locations-repositories-rules-list <parent> [-p <v>]... [-o <out>]
                locations-repositories-rules-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
