...
use google_artifactregistry1::{api, Error};
    ...
    let arg_data = [
        ("operations", "methods: 'cancel', 'delete', 'get' and 'list'", vec![
            ("cancel",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_artifactregistry1_cli/operations_cancel",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_artifactregistry1_cli/operations_delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_artifactregistry1_cli/operations_get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_artifactregistry1_cli/operations_list",
                  vec![
                    (Some(r##"v"##),
                     Some(r##"p"##),
                     Some(r##"Set various optional parameters, matching the key=value form"##),
        ...
        ("projects", "methods: 'locations-repositories-docker-images-list'", vec![
