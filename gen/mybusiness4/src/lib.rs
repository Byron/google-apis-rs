...
//! This documentation was generated from *My Business* crate version *3.0.0+0*, where *0* is the exact revision of the *mybusiness:v4* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.0*.
//! 
