...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/websecurityscanner1).
//! # Features
//! 
...
//! 
//! * **[Hub](struct.WebSecurityScanner.html)**
...
/// Central instance to access all WebSecurityScanner related resource activities
///
/// # Examples
///
...
/// ```
/// 
pub struct WebSecurityScanner<C, A> {
    client: RefCell<C>,
    auth: RefCell<A>,
    _user_agent: String,
    _base_url: String,
...
impl<'a, C, A> Hub for WebSecurityScanner<C, A> {}

impl<'a, C, A> WebSecurityScanner<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> WebSecurityScanner<C, A> {
        WebSecurityScanner {
            client: RefCell::new(client),
            auth: RefCell::new(authenticator),
            _user_agent: "google-api-rust-client/1.0.8".to_string(),
            _base_url: "https://websecurityscanner.googleapis.com/".to_string(),
            _root_url: "https://websecurityscanner.googleapis.com/".to_string(),
        }
    }
    ...
    /// It defaults to `https://websecurityscanner.googleapis.com/`.
    ///
