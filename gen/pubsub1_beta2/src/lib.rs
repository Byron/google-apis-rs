...
//! This documentation was generated from *pubsub* crate version *0.1.10+20150526*, where *20150526* is the exact revision of the *pubsub:v1beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.10*.
//! 
