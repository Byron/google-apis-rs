...
//! This documentation was generated from *Chrome Management* crate version *3.0.2+20220305*, where *20220305* is the exact revision of the *chromemanagement:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
...
//!     ).build().await.unwrap();
//! let mut hub = ChromeManagement::new(hyper::Client::builder().build(hyper_rustls::HttpsConnector::with_native_roots().https_or_http().enable_http1().enable_http2().build()), auth);
