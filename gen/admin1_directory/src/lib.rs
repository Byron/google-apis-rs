...
//! This documentation was generated from *directory* crate version *0.1.14+20160323*, where *20160323* is the exact revision of the *admin:directory_v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.14*.
//! 
