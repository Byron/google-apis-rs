...
pub struct ProjectNoteBatchCreateCall<'a, S>
   ...
   pub(super) hub: &'a ContainerAnalysis<S>,
   pub(super) _request: BatchCreateNotesRequest,
...
pub struct ProjectNoteCreateCall<'a, S>
   ...
   pub(super) hub: &'a ContainerAnalysis<S>,
   pub(super) _request: Note,
   pub(super) _parent: String,
   pub(super) _note_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ProjectOccurrenceBatchCreateCall<'a, S>
   ...
   pub(super) hub: &'a ContainerAnalysis<S>,
   pub(super) _request: BatchCreateOccurrencesRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
