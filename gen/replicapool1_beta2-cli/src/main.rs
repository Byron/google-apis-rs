...
use google_replicapool1_beta2::{api, yup_oauth2, Error};
...
{
    async fn _instance_group_managers_abandon_instances(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::InstanceGroupManagersAbandonInstancesRequest =
        ...
        let mut call = self.hub.instance_group_managers().abandon_instances(
            ...
            opt.value_of("instance-group-manager").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _instance_group_managers_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.instance_group_managers().delete(
            opt.value_of("project").unwrap_or(""),
            opt.value_of("zone").unwrap_or(""),
            opt.value_of("instance-group-manager").unwrap_or(""),
        );
    ...
    async fn _instance_group_managers_delete_instances(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::InstanceGroupManagersDeleteInstancesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.instance_group_managers().delete_instances(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("zone").unwrap_or(""),
            opt.value_of("instance-group-manager").unwrap_or(""),
    ...
    async fn _instance_group_managers_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.instance_group_managers().get(
            opt.value_of("project").unwrap_or(""),
            opt.value_of("zone").unwrap_or(""),
            opt.value_of("instance-group-manager").unwrap_or(""),
        );
    ...
    async fn _instance_group_managers_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _instance_group_managers_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.instance_group_managers().list(
            opt.value_of("project").unwrap_or(""),
            opt.value_of("zone").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _instance_group_managers_recreate_instances(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::InstanceGroupManagersRecreateInstancesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.instance_group_managers().recreate_instances(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("zone").unwrap_or(""),
            opt.value_of("instance-group-manager").unwrap_or(""),
    ...
    async fn _instance_group_managers_resize(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _instance_group_managers_set_instance_template(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::InstanceGroupManagersSetInstanceTemplateRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.instance_group_managers().set_instance_template(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("zone").unwrap_or(""),
            opt.value_of("instance-group-manager").unwrap_or(""),
    ...
    async fn _instance_group_managers_set_target_pools(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["fingerprint", "target-pools"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::InstanceGroupManagersSetTargetPoolsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.instance_group_managers().set_target_pools(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("zone").unwrap_or(""),
            opt.value_of("instance-group-manager").unwrap_or(""),
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("instance-group-managers", Some(opt)) => match opt.subcommand() {
                ("abandon-instances", Some(opt)) => {
                    call_result = self
                        ._instance_group_managers_abandon_instances(opt, dry_run, &mut err)
                        .await;
                }
                ("delete", Some(opt)) => {
                    call_result = self
                        ._instance_group_managers_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("delete-instances", Some(opt)) => {
                    call_result = self
                        ._instance_group_managers_delete_instances(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                    call_result = self
                        ._instance_group_managers_get(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                    call_result = self
                        ._instance_group_managers_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                    call_result = self
                        ._instance_group_managers_list(opt, dry_run, &mut err)
                        .await;
                }
                ("recreate-instances", Some(opt)) => {
                    call_result = self
                        ._instance_group_managers_recreate_instances(opt, dry_run, &mut err)
                        .await;
                }
                ("resize", Some(opt)) => {
                    call_result = self
                        ._instance_group_managers_resize(opt, dry_run, &mut err)
                        .await;
                }
                ("set-instance-template", Some(opt)) => {
                    call_result = self
                        ._instance_group_managers_set_instance_template(opt, dry_run, &mut err)
                        .await;
                }
                ("set-target-pools", Some(opt)) => {
                    call_result = self
                        ._instance_group_managers_set_target_pools(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "replicapool1-beta2-secret.json",
