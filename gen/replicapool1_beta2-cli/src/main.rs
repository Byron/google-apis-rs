...
extern crate hyper;
extern crate mime;
extern crate google_replicapool1_beta2 as api;
...
impl Engine {
    ...
    fn _instance_group_managers_delete(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
    ...
    fn _instance_group_managers_get(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
    ...
    fn _instance_group_managers_insert(&self, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for kvarg in self.opt.arg_kv.iter() {
            ...
            match &field_name.to_string()[..] {
                ...
                "base-instance-name" => {
                        request.base_instance_name = Some(value.unwrap_or("").to_string());
                    },
                "fingerprint" => {
    ...
    fn _instance_group_managers_list(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
    ...
    fn _instance_group_managers_resize(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
        let size: i32 = arg_from_str(&self.opt.arg_size, err, "<size>", "integer");
    ...
    fn _doit(&self, dry_run: bool) -> (Option<api::Error>, Option<InvalidOptionsError>) {
        ...
        if self.opt.cmd_instance_group_managers {
            if self.opt.cmd_abandon_instances {
                call_result = self._instance_group_managers_abandon_instances(dry_run, &mut err);
            } else if self.opt.cmd_delete {
                call_result = self._instance_group_managers_delete(dry_run, &mut err);
            } else if self.opt.cmd_delete_instances {
                call_result = self._instance_group_managers_delete_instances(dry_run, &mut err);
            } else if self.opt.cmd_get {
                call_result = self._instance_group_managers_get(dry_run, &mut err);
            } else if self.opt.cmd_insert {
                call_result = self._instance_group_managers_insert(dry_run, &mut err);
            } else if self.opt.cmd_list {
                call_result = self._instance_group_managers_list(dry_run, &mut err);
            } else if self.opt.cmd_recreate_instances {
                call_result = self._instance_group_managers_recreate_instances(dry_run, &mut err);
            } else if self.opt.cmd_resize {
                call_result = self._instance_group_managers_resize(dry_run, &mut err);
            } else if self.opt.cmd_set_instance_template {
                call_result = self._instance_group_managers_set_instance_template(dry_run, &mut err);
            } else if self.opt.cmd_set_target_pools {
                call_result = self._instance_group_managers_set_target_pools(dry_run, &mut err);
            } else {
                unreachable!();
            }
        }
