...
//! This documentation was generated from *Cloud Run* crate version *1.0.9+20190624*, where *20190624* is the exact revision of the *run:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.9*.
//! 
