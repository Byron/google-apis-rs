...
extern crate mime;
extern crate strsim;
extern crate google_freebase1_sandbox as api;
...
impl<'n> Engine<'n> {
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "freebase1-sandbox-secret.json",
        ...
        let auth = Authenticator::new(  &secret, DefaultAuthenticatorDelegate,
                                        ...
                                        JsonTokenStorage {
                                          program_name: "freebase1-sandbox",
    ...
    let arg_data = [
        ("methods", "methods: 'reconcile' and 'search'", vec![
            ("reconcile",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_freebase1_sandbox_cli/methods_reconcile",
                  vec![
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("search",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_freebase1_sandbox_cli/methods_search",
                  vec![
                    (Some(r##"v"##),
                     Some(r##"p"##),
                     Some(r##"Set various optional parameters, matching the key=value form"##),
