...
pub struct AchievementIncrementCall<'a, S>
   ...
   pub(super) _steps_to_increment: i32,
   pub(super) _request_id: Option<i64>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AchievementUpdateMultipleCall<'a, S>
   ...
   pub(super) hub: &'a Games<S>,
   pub(super) _request: AchievementUpdateMultipleRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct EventRecordCall<'a, S>
   ...
   pub(super) hub: &'a Games<S>,
   pub(super) _request: EventRecordRequest,
   pub(super) _language: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct PlayerGetCall<'a, S>
   ...
   pub(super) hub: &'a Games<S>,
   pub(super) _player_id: String,
   pub(super) _player_id_consistency_token: Option<String>,
   pub(super) _language: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct RevisionCheckCall<'a, S>
   ...
   pub(super) hub: &'a Games<S>,
   pub(super) _client_revision: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ScoreSubmitCall<'a, S>
   ...
   pub(super) hub: &'a Games<S>,
   pub(super) _leaderboard_id: String,
   pub(super) _score: i64,
   pub(super) _score_tag: Option<String>,
   pub(super) _language: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ScoreSubmitMultipleCall<'a, S>
   ...
   pub(super) hub: &'a Games<S>,
   pub(super) _request: PlayerScoreSubmissionList,
   pub(super) _language: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
