...
//! This documentation was generated from *doubleclicksearch* crate version *0.1.15+20160831*, where *20160831* is the exact revision of the *doubleclicksearch:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.15*.
//! 
