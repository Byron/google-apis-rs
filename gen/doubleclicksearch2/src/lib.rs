...
//! This documentation was generated from *doubleclicksearch* crate version *1.0.2+20161108*, where *20161108* is the exact revision of the *doubleclicksearch:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.2*.
//! 
