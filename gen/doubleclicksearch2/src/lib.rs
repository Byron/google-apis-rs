...
//! This documentation was generated from *Doubleclicksearch* crate version *8.0.0+20251024*, where *20251024* is the exact revision of the *doubleclicksearch:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
