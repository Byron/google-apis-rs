...
//! This documentation was generated from *doubleclicksearch* crate version *1.0.11+20190625*, where *20190625* is the exact revision of the *doubleclicksearch:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.11*.
//! 
