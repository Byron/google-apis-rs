...
//! This documentation was generated from *doubleclicksearch* crate version *0.1.0+20150224*, where *20150224* is the exact revision of the *doubleclicksearch:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.0*.
//! 
