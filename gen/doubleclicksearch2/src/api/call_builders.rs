...
pub struct ConversionGetCall<'a, S>
   ...
   pub(super) _agency_id: i64,
   pub(super) _advertiser_id: i64,
   pub(super) _engine_account_id: i64,
   pub(super) _end_date: i32,
   pub(super) _row_count: i32,
   pub(super) _start_date: i32,
   pub(super) _start_row: u32,
   pub(super) _customer_id: Option<String>,
   pub(super) _criterion_id: Option<i64>,
   pub(super) _campaign_id: Option<i64>,
   pub(super) _ad_id: Option<i64>,
   pub(super) _ad_group_id: Option<i64>,
...
pub struct ConversionGetByCustomerIdCall<'a, S>
   ...
   pub(super) _start_date: i32,
   pub(super) _start_row: u32,
   pub(super) _engine_account_id: Option<i64>,
   pub(super) _criterion_id: Option<i64>,
   pub(super) _campaign_id: Option<i64>,
   pub(super) _agency_id: Option<i64>,
...
pub struct ConversionInsertCall<'a, S>
   ...
   pub(super) hub: &'a Doubleclicksearch<S>,
   pub(super) _request: ConversionList,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ConversionUpdateAvailabilityCall<'a, S>
   ...
   pub(super) hub: &'a Doubleclicksearch<S>,
   pub(super) _request: UpdateAvailabilityRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ReportGenerateCall<'a, S>
   ...
   pub(super) hub: &'a Doubleclicksearch<S>,
   pub(super) _request: ReportRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ReportGetFileCall<'a, S>
   ...
   pub(super) hub: &'a Doubleclicksearch<S>,
   pub(super) _report_id: String,
   pub(super) _report_fragment: i32,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
