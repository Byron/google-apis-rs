...
//! This documentation was generated from *TPU* crate version *7.0.0+20251130*, where *20251130* is the exact revision of the *tpu:v1alpha1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
