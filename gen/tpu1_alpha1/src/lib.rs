...
//! This documentation was generated from *TPU* crate version *8.0.0+20251005*, where *20251005* is the exact revision of the *tpu:v1alpha1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
