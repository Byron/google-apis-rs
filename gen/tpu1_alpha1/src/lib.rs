...
//! This documentation was generated from *TPU* crate version *5.0.5+20240613*, where *20240613* is the exact revision of the *tpu:v1alpha1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.5*.
//! 
