...
impl<'n> Engine<'n> {
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        ...
        let auth = Authenticator::new(  &secret, DefaultAuthenticatorDelegate,
                                        ...
                                        JsonTokenStorage {
                                          program_name: "prod-tt-sasportal1-alpha1",
    ...
    let arg_data = [
        ...
        customer/1/nodes/2."##),
            ...
            ("devices-bulk",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_prod_tt_sasportal1_alpha1_cli/customers_devices-bulk",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        customer/1/nodes/2."##),
            ...
            ("devices-bulk",
                    Some(r##"Creates a device under a node or customer. Returned devices are unordered."##),
                    "Details at http://byron.github.io/google-apis-rs/google_prod_tt_sasportal1_alpha1_cli/nodes_devices-bulk",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The name of the parent resource."##),
        ...
        customer/1/nodes/2."##),
            ...
            ("nodes-devices-bulk",
                    Some(r##"Creates a device under a node or customer. Returned devices are unordered."##),
                    "Details at http://byron.github.io/google-apis-rs/google_prod_tt_sasportal1_alpha1_cli/nodes_nodes-devices-bulk",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The name of the parent resource."##),
