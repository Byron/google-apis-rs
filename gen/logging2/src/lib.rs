...
//! This documentation was generated from *Logging* crate version *4.0.1+20220225*, where *20220225* is the exact revision of the *logging:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v4.0.1*.
//! 
