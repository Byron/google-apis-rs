...
//! This documentation was generated from *Logging* crate version *7.0.0+20251202*, where *20251202* is the exact revision of the *logging:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
...
//! let r = hub.folders().locations_log_scopes_delete(...).doit().await
...
//! let r = hub.organizations().locations_log_scopes_delete(...).doit().await
...
//! let r = hub.projects().locations_log_scopes_delete(...).doit().await
