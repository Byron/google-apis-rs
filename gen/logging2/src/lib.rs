...
//! This documentation was generated from *Logging* crate version *2.0.3+20210325*, where *20210325* is the exact revision of the *logging:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.3*.
//! 
