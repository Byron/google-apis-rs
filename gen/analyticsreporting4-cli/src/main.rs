...
use google_analyticsreporting4::{api, Error};
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::AnalyticsReporting<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>
    >,
    gp: Vec<&'static str>,
