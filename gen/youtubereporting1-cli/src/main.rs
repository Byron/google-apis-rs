...
use google_youtubereporting1::{api, Error};
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::YouTubeReporting<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>
    >,
    gp: Vec<&'static str>,
