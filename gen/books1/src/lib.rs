...
//! This documentation was generated from *books* crate version *0.1.15+20160823*, where *20160823* is the exact revision of the *books:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.15*.
//! 
