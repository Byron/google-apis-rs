...
fn main() {
    ...
    let arg_data = [
        ("spreadsheets", "methods: 'batch-update', 'create', 'developer-metadata-get', 'developer-metadata-search', 'get', 'get-by-data-filter', 'sheets-copy-to', 'values-append', 'values-batch-clear', 'values-batch-clear-by-data-filter', 'values-batch-get', 'values-batch-get-by-data-filter', 'values-batch-update', 'values-batch-update-by-data-filter', 'values-clear', 'values-get' and 'values-update'", vec![
            ("batch-update",
                    Some(r##"Applies one or more updates to the spreadsheet.
        ...
        should reflect your changes."##),
            ...
            ("developer-metadata-get",
                    Some(r##"Returns the developer metadata with the specified ID.
        ...
        unique metadataId."##),
            ...
            ("developer-metadata-search",
                    Some(r##"Returns all developer metadata matching the specified DataFilter.
        ...
        developer metadata associated with locations intersecting that region."##),
            ...
            ("get",
                    Some(r##"Returns the spreadsheet at the given ID.
        ...
        * Set the includeGridData
        ...
        fields of the spreadsheet that you want."##),
            ...
            ("sheets-copy-to",
                    Some(r##"Copies a single sheet from a spreadsheet to another spreadsheet.
        Returns the properties of the newly created sheet."##),
            ...
            ("values-append",
                    Some(r##"Appends values to a spreadsheet. The input range is used to search for
        ...
        to."##),
                  ...
                  vec![
                    ...
                    (Some(r##"range"##),
                     None,
                     Some(r##"The A1 notation of a range to search for a logical table of data.
        Values will be appended after the last row of the table."##),
            ...
            ("values-batch-clear",
                    Some(r##"Clears one or more ranges of values from a spreadsheet.
        ...
        of the cell (such as formatting, data validation, etc..) are kept."##),
            ...
            ("values-batch-get",
                    Some(r##"Returns one or more ranges of values from a spreadsheet.
        The caller must specify the spreadsheet ID and one or more ranges."##),
            ...
            ("values-batch-get-by-data-filter",
                    Some(r##"Returns one or more ranges of values that match the specified data filters.
        The caller must specify the spreadsheet ID and one or more
        ...
        the request will be returned."##),
            ...
            ("values-batch-update",
                    Some(r##"Sets values in one or more ranges of a spreadsheet.
        The caller must specify the spreadsheet ID,
        ...
        DataFilterValueRanges."##),
            ...
            ("values-clear",
                    Some(r##"Clears values from a spreadsheet.
        ...
        formatting, data validation, etc..) are kept."##),
                  ...
                  vec![
                    ...
                    (Some(r##"range"##),
                     None,
                     Some(r##"The A1 notation of the values to clear."##),
                     Some(true),
                     Some(false)),
            ...
            ("values-get",
                    Some(r##"Returns a range of values from a spreadsheet.
        The caller must specify the spreadsheet ID and a range."##),
                  ...
                  vec![
                    ...
                    (Some(r##"range"##),
                     None,
                     Some(r##"The A1 notation of the values to retrieve."##),
                     Some(true),
                     Some(false)),
            ...
            ("values-update",
                    Some(r##"Sets values in a range of a spreadsheet.
        The caller must specify the spreadsheet ID, range, and
        a valueInputOption."##),
