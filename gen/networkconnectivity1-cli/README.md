...
This documentation was generated from the *networkconnectivity* API at revision *20251209*. The CLI is at version *7.0.0*.

```bash
networkconnectivity1 [options]
        projects
                locations-check-consumer-config <location> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-get <name> [-p <v>]... [-o <out>]
                locations-global-hubs-accept-spoke <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-global-hubs-accept-spoke-update <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-global-hubs-query-status <name> [-p <v>]... [-o <out>]
                locations-global-hubs-reject-spoke <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-global-hubs-reject-spoke-update <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-multicloud-data-transfer-configs-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-configs-delete <name> [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-configs-destinations-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-configs-destinations-delete <name> [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-configs-destinations-get <name> [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-configs-destinations-list <parent> [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-configs-destinations-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-configs-get <name> [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-configs-list <parent> [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-configs-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-supported-services-get <name> [-p <v>]... [-o <out>]
                locations-multicloud-data-transfer-supported-services-list <parent> [-p <v>]... [-o <out>]
