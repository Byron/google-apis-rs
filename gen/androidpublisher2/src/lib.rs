...
//! This documentation was generated from *Android Publisher* crate version *8.0.0+20200331*, where *20200331* is the exact revision of the *androidpublisher:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
