...
impl Engine {
    fn _tasklists_delete(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
        let mut call = self.hub.tasklists().delete(&self.opt.arg_tasklist);
    ...
    fn _tasklists_get(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
        let mut call = self.hub.tasklists().get(&self.opt.arg_tasklist);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "alt"
    ...
    fn _tasklists_insert(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::TaskList = Default::default();
    ...
    fn _tasklists_list(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
    ...
    fn _tasklists_patch(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::TaskList = Default::default();
        let mut call = self.hub.tasklists().patch(&request, &self.opt.arg_tasklist);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "alt"
    ...
    fn _tasklists_update(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::TaskList = Default::default();
        let mut call = self.hub.tasklists().update(&request, &self.opt.arg_tasklist);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "alt"
    ...
    fn _tasks_clear(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
        let mut call = self.hub.tasks().clear(&self.opt.arg_tasklist);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "alt"
    ...
    fn _tasks_delete(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
        let mut call = self.hub.tasks().delete(&self.opt.arg_tasklist, &self.opt.arg_task);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "alt"
    ...
    fn _tasks_get(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
        let mut call = self.hub.tasks().get(&self.opt.arg_tasklist, &self.opt.arg_task);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "alt"
    ...
    fn _tasks_insert(&self, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut call = self.hub.tasks().insert(&request, &self.opt.arg_tasklist);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "previous" => {
    ...
    fn _tasks_list(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
        let mut call = self.hub.tasks().list(&self.opt.arg_tasklist);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "updated-min" => {
    ...
    fn _tasks_move(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
        let mut call = self.hub.tasks().move_(&self.opt.arg_tasklist, &self.opt.arg_task);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "previous" => {
    ...
    fn _tasks_patch(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::Task = Default::default();
        let mut call = self.hub.tasks().patch(&request, &self.opt.arg_tasklist, &self.opt.arg_task);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "alt"
    ...
    fn _tasks_update(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::Task = Default::default();
        let mut call = self.hub.tasks().update(&request, &self.opt.arg_tasklist, &self.opt.arg_task);
        for parg in self.opt.arg_v.iter() {
            let (key, value) = parse_kv_arg(&*parg, err);
            match key {
                "alt"
    ...
    fn _doit(&self, dry_run: bool) -> (Option<api::Error>, Option<InvalidOptionsError>) {
        ...
        if self.opt.cmd_tasklists {
            if self.opt.cmd_delete {
                call_result = self._tasklists_delete(dry_run, &mut err);
            } else if self.opt.cmd_get {
                call_result = self._tasklists_get(dry_run, &mut err);
            } else if self.opt.cmd_insert {
                call_result = self._tasklists_insert(dry_run, &mut err);
            } else if self.opt.cmd_list {
                call_result = self._tasklists_list(dry_run, &mut err);
            } else if self.opt.cmd_patch {
                call_result = self._tasklists_patch(dry_run, &mut err);
            } else if self.opt.cmd_update {
                call_result = self._tasklists_update(dry_run, &mut err);
            } else {
                unreachable!();
            }
        } else if self.opt.cmd_tasks {
            if self.opt.cmd_clear {
                call_result = self._tasks_clear(dry_run, &mut err);
                ...
                call_result = self._tasks_move(dry_run, &mut err);
            } else if self.opt.cmd_patch {
    ...
    fn new(opt: Options) -> Result<Engine, InvalidOptionsError> {
        ...
        let engine = Engine {
            opt: opt,
            hub: api::TasksHub::new(hyper::Client::new(), auth),
        };
