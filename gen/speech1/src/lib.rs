...
//! This documentation was generated from *Speech* crate version *1.0.14+20200625*, where *20200625* is the exact revision of the *speech:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.14*.
//! 
...
impl<'a, C, A> SpeechLongrunningrecognizeCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> SpeechLongrunningrecognizeCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
...
impl<'a, C, A> SpeechRecognizeCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> SpeechRecognizeCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
