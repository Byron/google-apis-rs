...
//! This documentation was generated from *Speech* crate version *1.0.11+20190627*, where *20190627* is the exact revision of the *speech:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.11*.
//! 
