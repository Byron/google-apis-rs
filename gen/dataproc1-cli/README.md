...
This documentation was generated from the *Dataproc* API at revision *20251203*. The CLI is at version *7.0.0*.
...
dataproc1 [options]
        projects
                ...
                locations-batches-spark-applications-access <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-access-environment-info <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-access-job <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-access-sql-plan <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-access-sql-query <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-access-stage-attempt <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-access-stage-rdd-graph <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-search <parent> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-search-executor-stage-summary <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-search-executors <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-search-jobs <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-search-sql-queries <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-search-stage-attempt-tasks <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-search-stage-attempts <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-search-stages <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-summarize-executors <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-summarize-jobs <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-summarize-stage-attempt-tasks <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-summarize-stages <name> [-p <v>]... [-o <out>]
                locations-batches-spark-applications-write <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-sessions-spark-applications-access <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-access-environment-info <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-access-job <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-access-sql-plan <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-access-sql-query <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-access-stage-attempt <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-access-stage-rdd-graph <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-search <parent> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-search-executor-stage-summary <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-search-executors <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-search-jobs <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-search-sql-queries <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-search-stage-attempt-tasks <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-search-stage-attempts <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-search-stages <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-summarize-executors <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-summarize-jobs <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-summarize-stage-attempt-tasks <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-summarize-stages <name> [-p <v>]... [-o <out>]
                locations-sessions-spark-applications-write <name> (-r <kv>)... [-p <v>]... [-o <out>]
