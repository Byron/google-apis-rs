...
Find the source code [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/networkconnectivity1_alpha1-cli).

# Usage

This documentation was generated from the *networkconnectivity* API at revision *20210324*. The CLI is at version *2.0.0*.
...
networkconnectivity1-alpha1 [options]
        projects
                ...
                locations-policy-based-routes-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-policy-based-routes-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-policy-based-routes-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
