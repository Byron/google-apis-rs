...
The [delegate trait](https://docs.rs/google-recommender1/5.0.2-beta-1+20230108/google_recommender1/client::Delegate) is default-implemented, allowing you to customize it with minimal effort.
