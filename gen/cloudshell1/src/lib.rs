...
//! * users
//!  * [*environments add public key*](api::UserEnvironmentAddPublicKeyCall), [*environments authorize*](api::UserEnvironmentAuthorizeCall), [*environments generate access token*](api::UserEnvironmentGenerateAccessTokenCall), [*environments get*](api::UserEnvironmentGetCall), [*environments remove public key*](api::UserEnvironmentRemovePublicKeyCall) and [*environments start*](api::UserEnvironmentStartCall)
//!
//!
//!
//!
