...
impl common::RequestValue for GoogleCloudBillingBudgetsV1Budget {}
impl common::ResponseResult for GoogleCloudBillingBudgetsV1Budget {}
...
impl common::Part for GoogleCloudBillingBudgetsV1BudgetAmount {}
...
impl common::Part for GoogleCloudBillingBudgetsV1CustomPeriod {}
...
impl common::Part for GoogleCloudBillingBudgetsV1Filter {}
...
impl common::Part for GoogleCloudBillingBudgetsV1LastPeriodAmount {}
...
impl common::ResponseResult for GoogleCloudBillingBudgetsV1ListBudgetsResponse {}
...
impl common::Part for GoogleCloudBillingBudgetsV1NotificationsRule {}
...
impl common::Part for GoogleCloudBillingBudgetsV1ThresholdRule {}
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleCloudBillingBudgetsV1Budget)> {
        use std::borrow::Cow;
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudBillingBudgetsV1Budget,
    ) -> BillingAccountBudgetCreateCall<'a, C> {
