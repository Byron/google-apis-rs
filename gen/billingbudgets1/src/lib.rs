...
//! This documentation was generated from *CloudBillingBudget* crate version *2.0.5+20210326*, where *20210326* is the exact revision of the *billingbudgets:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.5*.
//! 
