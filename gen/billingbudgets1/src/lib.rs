...
//! This documentation was generated from *CloudBillingBudget* crate version *5.0.3+20240225*, where *20240225* is the exact revision of the *billingbudgets:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
