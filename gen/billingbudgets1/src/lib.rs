...
//! This documentation was generated from *CloudBillingBudget* crate version *3.1.0+20220227*, where *20220227* is the exact revision of the *billingbudgets:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.1.0*.
//! 
