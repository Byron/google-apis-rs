...
//! This documentation was generated from *CloudBillingBudget* crate version *5.0.2-beta-1+20230117*, where *20230117* is the exact revision of the *billingbudgets:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2-beta-1*.
//! 
