...
//! This documentation was generated from *CloudBillingBudget* crate version *4.0.1+20220227*, where *20220227* is the exact revision of the *billingbudgets:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v4.0.1*.
//! 
