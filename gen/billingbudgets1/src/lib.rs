...
//! This documentation was generated from *CloudBillingBudget* crate version *7.0.0+20251214*, where *20251214* is the exact revision of the *billingbudgets:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
