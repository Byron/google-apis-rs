...
//! This documentation was generated from *admin* crate version *0.1.11+20150303*, where *20150303* is the exact revision of the *admin:email_migration_v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.11*.
//! 
