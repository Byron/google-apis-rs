...
//! This documentation was generated from *Surveys* crate version *1.0.3+20161103*, where *20161103* is the exact revision of the *surveys:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.3*.
