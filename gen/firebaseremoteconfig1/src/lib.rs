...
//! This documentation was generated from *Firebase Remote Config* crate version *5.0.2-beta-1+20171129*, where *20171129* is the exact revision of the *firebaseremoteconfig:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2-beta-1*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/firebaseremoteconfig1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](FirebaseRemoteConfig) ... 
//! 
//! * projects
//!  * [*get remote config*](api::ProjectGetRemoteConfigCall) and [*update remote config*](api::ProjectUpdateRemoteConfigCall)
//! 
//! 
//! 
//! 
...
pub use api::FirebaseRemoteConfig;
