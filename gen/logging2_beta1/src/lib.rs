...
//! This documentation was generated from *logging* crate version *0.1.15+20160322*, where *20160322* is the exact revision of the *logging:v2beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.15*.
//! 
