...
//! This documentation was generated from *Comment Analyzer* crate version *1.0.14+20200405*, where *20200405* is the exact revision of the *commentanalyzer:v1alpha1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.14*.
//! 
...
impl<'a, C, A> CommentAnalyzeCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> CommentAnalyzeCall<'a, C, A> {
...
impl<'a, C, A> CommentSuggestscoreCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> CommentSuggestscoreCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
