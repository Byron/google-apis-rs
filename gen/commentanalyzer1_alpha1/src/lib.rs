...
//! This documentation was generated from *Comment Analyzer* crate version *1.0.11+20190616*, where *20190616* is the exact revision of the *commentanalyzer:v1alpha1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.11*.
//! 
