...
impl<'a, C> client::Hub for CommentAnalyzer<C> {}

impl<'a, C> CommentAnalyzer<C>
    where  C: BorrowMut<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>> {

    pub fn new(client: C, authenticator: oauth2::authenticator::Authenticator<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>>) -> CommentAnalyzer<C> {
        CommentAnalyzer {
...
impl<'a, C> CommentMethods<'a, C> {
    ...
    ///
    /// * `request` - No description provided.
    pub fn suggestscore(&self, request: SuggestCommentScoreRequest) -> CommentSuggestscoreCall<'a, C> {
...
impl<'a, C> client::CallBuilder for CommentAnalyzeCall<'a, C> {}

impl<'a, C> CommentAnalyzeCall<'a, C> where C: BorrowMut<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>> {
    ...
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> CommentAnalyzeCall<'a, C> {
    ...
    pub fn add_scope<T, S>(mut self, scope: T) -> CommentAnalyzeCall<'a, C>
...
impl<'a, C> client::CallBuilder for CommentSuggestscoreCall<'a, C> {}

impl<'a, C> CommentSuggestscoreCall<'a, C> where C: BorrowMut<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: SuggestCommentScoreRequest) -> CommentSuggestscoreCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> CommentSuggestscoreCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> CommentSuggestscoreCall<'a, C>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
