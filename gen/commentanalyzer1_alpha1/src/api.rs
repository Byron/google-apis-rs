...
impl<C> common::Hub for CommentAnalyzer<C> {}

impl<'a, C> CommentAnalyzer<C> {
...
impl common::RequestValue for AnalyzeCommentRequest {}
...
impl common::ResponseResult for AnalyzeCommentResponse {}
...
impl common::Part for ArticleAndParentComment {}
...
impl common::Part for AttributeParameters {}
...
impl common::Part for AttributeScores {}
...
impl common::Part for SpanScore {}
...
impl common::RequestValue for SuggestCommentScoreRequest {}
...
impl common::ResponseResult for SuggestCommentScoreResponse {}
...
impl common::Part for TextEntry {}
...
impl<'a, C> CommentMethods<'a, C> {
    ...
    pub fn analyze(&self, request: AnalyzeCommentRequest) -> CommentAnalyzeCall<'a, C> {
        CommentAnalyzeCall {
            hub: self.hub,
            _request: request,
    ...
    pub fn suggestscore(
        &self,
        request: SuggestCommentScoreRequest,
    ) -> CommentSuggestscoreCall<'a, C> {
...
/// # }
/// ```
pub struct CommentAnalyzeCall<'a, C>
where
    C: 'a,
{
    hub: &'a CommentAnalyzer<C>,
...
impl<'a, C> common::CallBuilder for CommentAnalyzeCall<'a, C> {}

impl<'a, C> CommentAnalyzeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, AnalyzeCommentResponse)> {
        use std::borrow::Cow;
        ...
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::UserinfoEmail.as_ref().to_string());
        }
    ...
    pub fn request(mut self, new_value: AnalyzeCommentRequest) -> CommentAnalyzeCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> CommentAnalyzeCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> CommentAnalyzeCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> CommentAnalyzeCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> CommentAnalyzeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct CommentSuggestscoreCall<'a, C>
where
    C: 'a,
{
    hub: &'a CommentAnalyzer<C>,
...
impl<'a, C> common::CallBuilder for CommentSuggestscoreCall<'a, C> {}

impl<'a, C> CommentSuggestscoreCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SuggestCommentScoreResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: SuggestCommentScoreRequest,
    ) -> CommentSuggestscoreCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> CommentSuggestscoreCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> CommentSuggestscoreCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> CommentSuggestscoreCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> CommentSuggestscoreCall<'a, C> {
        self._scopes.clear();
        self
    }
}
