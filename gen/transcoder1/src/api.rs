...
pub struct InputAttributes {
    ...
    #[serde(rename = "trackDefinitions")]
    pub track_definitions: Option<Vec<TrackDefinition>>,
}

impl common::Part for InputAttributes {}
...
impl common::Part for TrackDefinition {}
