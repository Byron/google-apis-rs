...
use google_fusiontables2::{api, yup_oauth2, Error};
...
{
    async fn _column_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.column().delete(
            opt.value_of("table-id").unwrap_or(""),
            opt.value_of("column-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _column_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.column().get(
            opt.value_of("table-id").unwrap_or(""),
            opt.value_of("column-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _column_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "base-column.table-index" => Some((
                    "baseColumn.tableIndex",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::Column = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .column()
            .insert(request, opt.value_of("table-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _column_list(
        ...
        let mut call = self
            .hub
            .column()
            .list(opt.value_of("table-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _column_patch(
        ...
        let mut request: api::Column = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.column().patch(
            request,
            opt.value_of("table-id").unwrap_or(""),
            opt.value_of("column-id").unwrap_or(""),
        );
            ...
            .iter()
        {
            ...
            match key {
                "typed" => {
                    call = call.typed(
                        value
                            .map(|v| arg_from_str(v, err, "typed", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "hdrs" => {
                    call = call.hdrs(
                        value
                            .map(|v| arg_from_str(v, err, "hdrs", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _style_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let style_id: i32 = arg_from_str(
        ...
        let mut call = self
            .hub
            .style()
            .delete(opt.value_of("table-id").unwrap_or(""), style_id);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _style_get(
        ...
        let mut call = self
            .hub
            .style()
            .get(opt.value_of("table-id").unwrap_or(""), style_id);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _style_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "marker-options.icon-styler.column-name" => Some((
                ...
                "marker-options.icon-styler.gradient.max" => Some((
                ...
                "marker-options.icon-styler.gradient.min" => Some((
                ...
                "marker-options.icon-styler.kind" => Some((
                ...
                "polygon-options.fill-color" => Some((
                ...
                "polygon-options.fill-color-styler.column-name" => Some((
                ...
                "polygon-options.fill-color-styler.gradient.max" => Some((
                ...
                "polygon-options.fill-color-styler.gradient.min" => Some((
                ...
                "polygon-options.fill-color-styler.kind" => Some((
                ...
                "polygon-options.fill-opacity" => Some((
                ...
                "polygon-options.stroke-color" => Some((
                ...
                "polygon-options.stroke-color-styler.column-name" => Some((
                ...
                "polygon-options.stroke-color-styler.gradient.max" => Some((
                ...
                "polygon-options.stroke-color-styler.gradient.min" => Some((
                ...
                "polygon-options.stroke-color-styler.kind" => Some((
                ...
                "polygon-options.stroke-opacity" => Some((
                ...
                "polygon-options.stroke-weight" => Some((
                ...
                "polygon-options.stroke-weight-styler.column-name" => Some((
                ...
                "polygon-options.stroke-weight-styler.gradient.max" => Some((
                ...
                "polygon-options.stroke-weight-styler.gradient.min" => Some((
                ...
                "polygon-options.stroke-weight-styler.kind" => Some((
                ...
                "polyline-options.stroke-color" => Some((
                ...
                "polyline-options.stroke-color-styler.column-name" => Some((
                ...
                "polyline-options.stroke-color-styler.gradient.max" => Some((
                ...
                "polyline-options.stroke-color-styler.gradient.min" => Some((
                ...
                "polyline-options.stroke-color-styler.kind" => Some((
                ...
                "polyline-options.stroke-opacity" => Some((
                ...
                "polyline-options.stroke-weight" => Some((
                ...
                "polyline-options.stroke-weight-styler.column-name" => Some((
                ...
                "polyline-options.stroke-weight-styler.gradient.max" => Some((
                ...
                "polyline-options.stroke-weight-styler.gradient.min" => Some((
                ...
                "polyline-options.stroke-weight-styler.kind" => Some((
        ...
        let mut request: api::StyleSetting = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .style()
            .insert(request, opt.value_of("table-id").unwrap_or(""));
    ...
    async fn _style_patch(
        ...
        let mut call =
            self.hub
                .style()
                .patch(request, opt.value_of("table-id").unwrap_or(""), style_id);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _style_update(
        ...
        let mut call =
            self.hub
                .style()
                .update(request, opt.value_of("table-id").unwrap_or(""), style_id);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _table_copy(
        ...
        let mut call = self
            .hub
            .table()
            .copy(opt.value_of("table-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "copy-presentation" => {
                    call = call.copy_presentation(
                        value
                            .map(|v| arg_from_str(v, err, "copy-presentation", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _table_delete(
        ...
        let mut call = self
            .hub
            .table()
            .delete(opt.value_of("table-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _table_import_rows(
        ...
        let mut call = self
            .hub
            .table()
            .import_rows(opt.value_of("table-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "start-line" => {
                    call = call.start_line(
                        value
                            .map(|v| arg_from_str(v, err, "start-line", "int32"))
                            .unwrap_or(-0),
                    );
                }
                "is-strict" => {
                    call = call.is_strict(
                        value
                            .map(|v| arg_from_str(v, err, "is-strict", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "end-line" => {
                    call = call.end_line(
                        value
                            .map(|v| arg_from_str(v, err, "end-line", "int32"))
                            .unwrap_or(-0),
                    );
                }
                "encoding" => {
    ...
    async fn _table_import_table(
        ...
        let mut call = self
            .hub
            .table()
            .import_table(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _table_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "column-properties-json-schema" => Some((
                ...
                "table-properties-json-schema" => Some((
    ...
    async fn _table_patch(
        ...
        let mut call = self
            .hub
            .table()
            .patch(request, opt.value_of("table-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            ...
            match key {
                "replace-view-definition" => {
                    call = call.replace_view_definition(
                        value
                            .map(|v| arg_from_str(v, err, "replace-view-definition", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _table_refetch_sheet(
        ...
        let mut call = self
            .hub
            .table()
            .refetch_sheet(opt.value_of("table-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _table_replace_rows(
        ...
        let mut call = self
            .hub
            .table()
            .replace_rows(opt.value_of("table-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _table_update(
        ...
        let mut call = self
            .hub
            .table()
            .update(request, opt.value_of("table-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _task_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.task().delete(
            opt.value_of("table-id").unwrap_or(""),
    ...
    async fn _task_get(
        ...
        let mut call = self.hub.task().get(
            opt.value_of("table-id").unwrap_or(""),
            opt.value_of("task-id").unwrap_or(""),
        );
        for parg in opt
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["max-results", "page-token", "start-index"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _template_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let template_id: i32 = arg_from_str(
        ...
        let mut call = self
            .hub
            .template()
            .delete(opt.value_of("table-id").unwrap_or(""), template_id);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _template_get(
        ...
        let mut call = self
            .hub
            .template()
            .get(opt.value_of("table-id").unwrap_or(""), template_id);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _template_insert(
        ...
        let mut request: api::Template = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .template()
            .insert(request, opt.value_of("table-id").unwrap_or(""));
    ...
    async fn _template_patch(
        ...
        let mut call =
            self.hub
                .template()
                .patch(request, opt.value_of("table-id").unwrap_or(""), template_id);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("column", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("column".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("query", Some(opt)) => match opt.subcommand() {
                ("sql", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("query".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("style", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("style".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("table", Some(opt)) => match opt.subcommand() {
                ("copy", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("table".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("task", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("task".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("template", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("template".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "fusiontables2-secret.json",
