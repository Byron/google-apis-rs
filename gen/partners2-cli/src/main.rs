...
use google_partners2::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
            ...
            .iter()
        {
            ...
            match key {
                ...
                "request-metadata-traffic-source-traffic-source-id" => {
                    call =
                        call.request_metadata_traffic_source_traffic_source_id(value.unwrap_or(""));
                }
    ...
    async fn _client_messages_log(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "request-metadata.user-overrides.ip-address" => Some((
                ...
                "request-metadata.user-overrides.user-id" => Some((
                ...
                "request-metadata.partners-session-id" => Some((
                ...
                "request-metadata.experiment-ids" => Some((
                ...
                "request-metadata.traffic-source.traffic-source-id" => Some((
                ...
                "request-metadata.traffic-source.traffic-sub-id" => Some((
        ...
        let mut request: api::LogMessageRequest = serde_json::value::from_value(object).unwrap();
    ...
    async fn _companies_get(
        ...
        let mut call = self
            .hub
            .companies()
            .get(opt.value_of("company-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _companies_leads_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "lead.min-monthly-budget.currency-code" => Some((
                    "lead.minMonthlyBudget.currencyCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "lead.min-monthly-budget.nanos" => Some((
                    "lead.minMonthlyBudget.nanos",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "lead.min-monthly-budget.units" => Some((
                    "lead.minMonthlyBudget.units",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "lead.given-name" => Some((
                    "lead.givenName",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "lead.adwords-customer-id" => Some((
                    "lead.adwordsCustomerId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "lead.create-time" => Some((
                    "lead.createTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "recaptcha-challenge.id" => Some((
                    "recaptchaChallenge.id",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "recaptcha-challenge.response" => Some((
                    "recaptchaChallenge.response",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::CreateLeadRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .companies()
            .leads_create(request, opt.value_of("company-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            ...
            .iter()
        {
            ...
            match key {
                ...
                "min-monthly-budget-units" => {
                    call = call.min_monthly_budget_units(
                        value
                            .map(|v| arg_from_str(v, err, "min-monthly-budget-units", "int64"))
                            .unwrap_or(-0),
                    );
                }
                "min-monthly-budget-nanos" => {
                    call = call.min_monthly_budget_nanos(
                        value
                            .map(|v| arg_from_str(v, err, "min-monthly-budget-nanos", "int32"))
                            .unwrap_or(-0),
                    );
                }
                ...
                "max-monthly-budget-units" => {
                    call = call.max_monthly_budget_units(
                        value
                            .map(|v| arg_from_str(v, err, "max-monthly-budget-units", "int64"))
                            .unwrap_or(-0),
                    );
                }
                "max-monthly-budget-nanos" => {
                    call = call.max_monthly_budget_nanos(
                        value
                            .map(|v| arg_from_str(v, err, "max-monthly-budget-nanos", "int32"))
                            .unwrap_or(-0),
                    );
                }
    ...
    async fn _methods_get_partnersstatus(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _methods_update_companies(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "converted-min-monthly-budget.currency-code" => Some((
                    "convertedMinMonthlyBudget.currencyCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "converted-min-monthly-budget.nanos" => Some((
                    "convertedMinMonthlyBudget.nanos",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "converted-min-monthly-budget.units" => Some((
                    "convertedMinMonthlyBudget.units",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "primary-adwords-manager-account-id" => Some((
                ...
                "public-profile.profile-image" => Some((
                ...
                "public-profile.display-name" => Some((
                ...
                "public-profile.display-image-url" => Some((
                    "publicProfile.displayImageUrl",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "public-profile.id" => Some((
                    "publicProfile.id",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "original-min-monthly-budget.currency-code" => Some((
                    "originalMinMonthlyBudget.currencyCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "original-min-monthly-budget.nanos" => Some((
                    "originalMinMonthlyBudget.nanos",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "original-min-monthly-budget.units" => Some((
                    "originalMinMonthlyBudget.units",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "primary-location.administrative-area" => Some((
                    "primaryLocation.administrativeArea",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-location.locality" => Some((
                ...
                "primary-location.lat-lng.latitude" => Some((
                    "primaryLocation.latLng.latitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-location.lat-lng.longitude" => Some((
                    "primaryLocation.latLng.longitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-location.region-code" => Some((
                    "primaryLocation.regionCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-location.dependent-locality" => Some((
                    "primaryLocation.dependentLocality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-location.address" => Some((
                ...
                "primary-location.postal-code" => Some((
                ...
                "primary-location.sorting-code" => Some((
                    "primaryLocation.sortingCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-location.language-code" => Some((
                    "primaryLocation.languageCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-location.address-line" => Some((
                ...
                "auto-approval-email-domains" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "address-line",
                            "administrative-area",
                            "auto-approval-email-domains",
                            "badge-authority-in-awn",
                            "badge-tier",
                            "company-types",
                            ...
                            "postal-code",
                            "primary-adwords-manager-account-id",
    ...
    async fn _methods_update_leads(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "min-monthly-budget.currency-code" => Some((
        ...
        let mut request: api::Lead = serde_json::value::from_value(object).unwrap();
    ...
    async fn _offers_history_list(
            ...
            .iter()
        {
            ...
            match key {
                ...
                "entire-company" => {
                    call = call.entire_company(
                        value
                            .map(|v| arg_from_str(v, err, "entire-company", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _user_events_log(
        ...
        let mut request: api::LogUserEventRequest = serde_json::value::from_value(object).unwrap();
    ...
    async fn _users_create_company_relation(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "primary-address.administrative-area" => Some((
                    "primaryAddress.administrativeArea",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-address.locality" => Some((
                ...
                "primary-address.lat-lng.latitude" => Some((
                    "primaryAddress.latLng.latitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-address.lat-lng.longitude" => Some((
                    "primaryAddress.latLng.longitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-address.region-code" => Some((
                ...
                "primary-address.dependent-locality" => Some((
                    "primaryAddress.dependentLocality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-address.address" => Some((
                ...
                "primary-address.postal-code" => Some((
                ...
                "primary-address.sorting-code" => Some((
                    "primaryAddress.sortingCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-address.language-code" => Some((
                    "primaryAddress.languageCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "primary-address.address-line" => Some((
        ...
        let mut request: api::CompanyRelation = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .users()
            .create_company_relation(request, opt.value_of("user-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _users_delete_company_relation(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .users()
            .delete_company_relation(opt.value_of("user-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _users_update_profile(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "address.lat-lng.longitude" => Some((
                ...
                "address.dependent-locality" => Some((
                ...
                "email-opt-ins.market-comm" => Some((
                    "emailOptIns.marketComm",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "email-opt-ins.special-offers" => Some((
                    "emailOptIns.specialOffers",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "email-opt-ins.performance-suggestions" => Some((
                    "emailOptIns.performanceSuggestions",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "email-opt-ins.physical-mail" => Some((
                    "emailOptIns.physicalMail",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "email-opt-ins.phone-contact" => Some((
                    "emailOptIns.phoneContact",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::UserProfile = serde_json::value::from_value(object).unwrap();
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("analytics", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._analytics_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("analytics".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("client-messages", Some(opt)) => match opt.subcommand() {
                ("log", Some(opt)) => {
                    call_result = self._client_messages_log(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("client-messages".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("companies", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("companies".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("leads", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._leads_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("leads".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("methods", Some(opt)) => match opt.subcommand() {
                ("get-partnersstatus", Some(opt)) => {
                    call_result = self
                        ._methods_get_partnersstatus(opt, dry_run, &mut err)
                        .await;
                }
            ...
            ("offers", Some(opt)) => match opt.subcommand() {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("offers".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("user-events", Some(opt)) => match opt.subcommand() {
                ("log", Some(opt)) => {
                    call_result = self._user_events_log(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("user-events".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("user-states", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._user_states_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("user-states".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("users", Some(opt)) => match opt.subcommand() {
                ("create-company-relation", Some(opt)) => {
                    call_result = self
                        ._users_create_company_relation(opt, dry_run, &mut err)
                        .await;
                }
                ("delete-company-relation", Some(opt)) => {
                    call_result = self
                        ._users_delete_company_relation(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "partners2-secret.json",
