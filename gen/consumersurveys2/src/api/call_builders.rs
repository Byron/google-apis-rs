...
pub struct MobileapppanelGetCall<'a, S>
   ...
   pub(super) hub: &'a ConsumerSurveys<S>,
   pub(super) _panel_id: String,
...
pub struct MobileapppanelUpdateCall<'a, S>
   ...
   pub(super) hub: &'a ConsumerSurveys<S>,
   pub(super) _request: MobileAppPanel,
   pub(super) _panel_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ResultGetCall<'a, S>
   ...
   pub(super) hub: &'a ConsumerSurveys<S>,
   pub(super) _request: ResultsGetRequest,
   pub(super) _survey_url_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct SurveyStartCall<'a, S>
   ...
   pub(super) hub: &'a ConsumerSurveys<S>,
   pub(super) _request: SurveysStartRequest,
   pub(super) _resource_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
