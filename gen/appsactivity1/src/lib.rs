...
//! This documentation was generated from *appsactivity* crate version *0.1.11+20150723*, where *20150723* is the exact revision of the *appsactivity:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.11*.
//! 
