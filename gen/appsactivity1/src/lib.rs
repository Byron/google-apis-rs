...
//! This documentation was generated from *appsactivity* crate version *0.1.14+20160129*, where *20160129* is the exact revision of the *appsactivity:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.14*.
//! 
