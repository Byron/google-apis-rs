...
//! This documentation was generated from *dfareporting* crate version *0.1.13+20160323*, where *20160323* is the exact revision of the *dfareporting:v2.3* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.13*.
//! 
