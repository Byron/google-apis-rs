...
//! This documentation was generated from *dfareporting* crate version *1.0.3+20160803*, where *20160803* is the exact revision of the *dfareporting:v2.3* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.3*.
//! 
