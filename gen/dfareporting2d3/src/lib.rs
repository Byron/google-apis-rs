...
//! This documentation was generated from *dfareporting* crate version *0.1.11+20151109*, where *20151109* is the exact revision of the *dfareporting:v2.3* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.11*.
//! 
