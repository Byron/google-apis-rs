...
pub struct ProjectSiteChannelReleaseCreateCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseHosting<S>,
   pub(super) _request: Release,
   pub(super) _parent: String,
   pub(super) _version_name: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ProjectSiteVersionCloneCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseHosting<S>,
   pub(super) _request: CloneVersionRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectSiteVersionCreateCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseHosting<S>,
   pub(super) _request: Version,
   pub(super) _parent: String,
   pub(super) _version_id: Option<String>,
   pub(super) _size_bytes: Option<i64>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ProjectSiteVersionPopulateFileCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseHosting<S>,
   pub(super) _request: PopulateVersionFilesRequest,
   pub(super) _parent: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ProjectSiteCreateCall<'a, S>
   ...
   pub(super) hub: &'a FirebaseHosting<S>,
   pub(super) _request: Site,
   pub(super) _parent: String,
   pub(super) _site_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
