...
/// Central instance to access all ResourceSettings related resource activities
///
/// # Examples
///
...
impl<C> common::Hub for ResourceSettings<C> {}

impl<'a, C> ResourceSettings<C> {
    ...
    /// It defaults to `https://resourcesettings.googleapis.com/`.
    ///
...
impl common::ResponseResult for GoogleCloudResourcesettingsV1ListSettingsResponse {}
...
impl common::RequestValue for GoogleCloudResourcesettingsV1Setting {}
impl common::ResponseResult for GoogleCloudResourcesettingsV1Setting {}
...
impl common::Part for GoogleCloudResourcesettingsV1SettingMetadata {}
...
pub struct GoogleCloudResourcesettingsV1Value {
    ...
    pub duration_value: Option<chrono::Duration>,
...
impl common::Part for GoogleCloudResourcesettingsV1Value {}
...
impl common::Part for GoogleCloudResourcesettingsV1ValueEnumValue {}
...
impl common::Part for GoogleCloudResourcesettingsV1ValueStringMap {}
...
impl common::Part for GoogleCloudResourcesettingsV1ValueStringSet {}
...
impl<'a, C> FolderMethods<'a, C> {
    ...
    pub fn settings_get(&self, name: &str) -> FolderSettingGetCall<'a, C> {
    ...
    pub fn settings_list(&self, parent: &str) -> FolderSettingListCall<'a, C> {
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    ///
    /// * `name` - Required. The name of the setting to get. See Setting for naming requirements.
    pub fn settings_get(&self, name: &str) -> ProjectSettingGetCall<'a, C> {
    ...
    ///
    /// * `parent` - Required. The project, folder, or organization that is the parent resource for this setting. Must be in one of the following forms: * `projects/{project_number}` * `projects/{project_id}` * `folders/{folder_id}` * `organizations/{organization_id}`
    pub fn settings_list(&self, parent: &str) -> ProjectSettingListCall<'a, C> {
...
/// Returns a specified setting. Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the setting does not exist.
///
/// A builder for the *settings.get* method supported by a *folder* resource.
...
/// # }
/// ```
pub struct FolderSettingGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a ResourceSettings<C>,
...
impl<'a, C> common::CallBuilder for FolderSettingGetCall<'a, C> {}

impl<'a, C> FolderSettingGetCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleCloudResourcesettingsV1Setting)> {
        use std::borrow::Cow;
    ...
    pub fn name(mut self, new_value: &str) -> FolderSettingGetCall<'a, C> {
    ...
    pub fn view(mut self, new_value: &str) -> FolderSettingGetCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> FolderSettingGetCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> FolderSettingGetCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> FolderSettingGetCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> FolderSettingGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists all the settings that are available on the Cloud resource `parent`.
///
/// A builder for the *settings.list* method supported by a *folder* resource.
/// It is not used directly, but through a [`FolderMethods`] instance.
///
/// # Example
///
...
/// # }
/// ```
pub struct FolderSettingListCall<'a, C>
where
    C: 'a,
{
    hub: &'a ResourceSettings<C>,
...
impl<'a, C> common::CallBuilder for FolderSettingListCall<'a, C> {}

impl<'a, C> FolderSettingListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/settings";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> FolderSettingListCall<'a, C> {
    ...
    ///
    /// Sets the *view* query property to the given value.
    pub fn view(mut self, new_value: &str) -> FolderSettingListCall<'a, C> {
        self._view = Some(new_value.to_string());
        self
    }
    /// Unused. A page token used to retrieve the next page.
    ...
    pub fn page_token(mut self, new_value: &str) -> FolderSettingListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> FolderSettingListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> FolderSettingListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> FolderSettingListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> FolderSettingListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> FolderSettingListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Updates a specified setting. Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the setting does not exist. Returns a `google.rpc.Status` with `google.rpc.Code.FAILED_PRECONDITION` if the setting is flagged as read only. Returns a `google.rpc.Status` with `google.rpc.Code.ABORTED` if the etag supplied in the request does not match the persisted etag of the setting value. On success, the response will contain only `name`, `local_value` and `etag`. The `metadata` and `effective_value` cannot be updated through this API. Note: the supplied setting will perform a full overwrite of the `local_value` field.
///
/// A builder for the *settings.patch* method supported by a *folder* resource.
/// It is not used directly, but through a [`FolderMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_resourcesettings1 as resourcesettings1;
/// use resourcesettings1::api::GoogleCloudResourcesettingsV1Setting;
/// # async fn dox() {
/// # use resourcesettings1::{ResourceSettings, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // Values shown here are possibly random and not representative !
/// let mut req = GoogleCloudResourcesettingsV1Setting::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.folders().settings_patch(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct FolderSettingPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a ResourceSettings<C>,
...
impl<'a, C> common::CallBuilder for FolderSettingPatchCall<'a, C> {}

impl<'a, C> FolderSettingPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudResourcesettingsV1Setting,
    ) -> FolderSettingPatchCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> FolderSettingPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> FolderSettingPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> FolderSettingPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> FolderSettingPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> FolderSettingPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Returns a specified setting. Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the setting does not exist.
///
/// A builder for the *settings.get* method supported by a *organization* resource.
...
/// # }
/// ```
pub struct OrganizationSettingGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a ResourceSettings<C>,
...
impl<'a, C> common::CallBuilder for OrganizationSettingGetCall<'a, C> {}

impl<'a, C> OrganizationSettingGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationSettingGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The SettingView for this request.
    ///
    /// Sets the *view* query property to the given value.
    pub fn view(mut self, new_value: &str) -> OrganizationSettingGetCall<'a, C> {
        self._view = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> OrganizationSettingGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationSettingGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationSettingGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationSettingGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationSettingGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists all the settings that are available on the Cloud resource `parent`.
///
/// A builder for the *settings.list* method supported by a *organization* resource.
/// It is not used directly, but through a [`OrganizationMethods`] instance.
///
/// # Example
///
...
/// # }
/// ```
pub struct OrganizationSettingListCall<'a, C>
where
    C: 'a,
{
    hub: &'a ResourceSettings<C>,
...
impl<'a, C> common::CallBuilder for OrganizationSettingListCall<'a, C> {}

impl<'a, C> OrganizationSettingListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> OrganizationSettingListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The SettingView for this request.
    ///
    /// Sets the *view* query property to the given value.
    pub fn view(mut self, new_value: &str) -> OrganizationSettingListCall<'a, C> {
        self._view = Some(new_value.to_string());
        self
    }
    /// Unused. A page token used to retrieve the next page.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> OrganizationSettingListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// Unused. The size of the page to be returned.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> OrganizationSettingListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> OrganizationSettingListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationSettingListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationSettingListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationSettingListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationSettingListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Updates a specified setting. Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the setting does not exist. Returns a `google.rpc.Status` with `google.rpc.Code.FAILED_PRECONDITION` if the setting is flagged as read only. Returns a `google.rpc.Status` with `google.rpc.Code.ABORTED` if the etag supplied in the request does not match the persisted etag of the setting value. On success, the response will contain only `name`, `local_value` and `etag`. The `metadata` and `effective_value` cannot be updated through this API. Note: the supplied setting will perform a full overwrite of the `local_value` field.
///
/// A builder for the *settings.patch* method supported by a *organization* resource.
/// It is not used directly, but through a [`OrganizationMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.organizations().settings_patch(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct OrganizationSettingPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a ResourceSettings<C>,
...
impl<'a, C> common::CallBuilder for OrganizationSettingPatchCall<'a, C> {}

impl<'a, C> OrganizationSettingPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationSettingPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationSettingPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationSettingPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationSettingPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationSettingPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Returns a specified setting. Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the setting does not exist.
///
/// A builder for the *settings.get* method supported by a *project* resource.
...
/// # }
/// ```
pub struct ProjectSettingGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a ResourceSettings<C>,
...
impl<'a, C> common::CallBuilder for ProjectSettingGetCall<'a, C> {}

impl<'a, C> ProjectSettingGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectSettingGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The SettingView for this request.
    ///
    /// Sets the *view* query property to the given value.
    pub fn view(mut self, new_value: &str) -> ProjectSettingGetCall<'a, C> {
        self._view = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectSettingGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectSettingGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectSettingGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectSettingGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists all the settings that are available on the Cloud resource `parent`.
///
/// A builder for the *settings.list* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # }
/// ```
pub struct ProjectSettingListCall<'a, C>
where
    C: 'a,
{
    hub: &'a ResourceSettings<C>,
...
impl<'a, C> common::CallBuilder for ProjectSettingListCall<'a, C> {}

impl<'a, C> ProjectSettingListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectSettingListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The SettingView for this request.
    ///
    /// Sets the *view* query property to the given value.
    pub fn view(mut self, new_value: &str) -> ProjectSettingListCall<'a, C> {
        self._view = Some(new_value.to_string());
        self
    }
    /// Unused. A page token used to retrieve the next page.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ProjectSettingListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// Unused. The size of the page to be returned.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProjectSettingListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectSettingListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectSettingListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectSettingListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectSettingListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Updates a specified setting. Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the setting does not exist. Returns a `google.rpc.Status` with `google.rpc.Code.FAILED_PRECONDITION` if the setting is flagged as read only. Returns a `google.rpc.Status` with `google.rpc.Code.ABORTED` if the etag supplied in the request does not match the persisted etag of the setting value. On success, the response will contain only `name`, `local_value` and `etag`. The `metadata` and `effective_value` cannot be updated through this API. Note: the supplied setting will perform a full overwrite of the `local_value` field.
///
/// A builder for the *settings.patch* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().settings_patch(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectSettingPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a ResourceSettings<C>,
...
impl<'a, C> common::CallBuilder for ProjectSettingPatchCall<'a, C> {}

impl<'a, C> ProjectSettingPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectSettingPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectSettingPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectSettingPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectSettingPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectSettingPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
