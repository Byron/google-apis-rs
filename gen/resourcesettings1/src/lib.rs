...
//! This documentation was generated from *Resource Settings* crate version *8.0.0+20240625*, where *20240625* is the exact revision of the *resourcesettings:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
