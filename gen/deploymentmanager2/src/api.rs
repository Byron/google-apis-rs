...
impl common::Part for ErrorInfo {}
...
pub struct FirewallPolicyRuleOperationMetadata {
    ...
    #[serde(rename = "allocatedPriority")]
    pub allocated_priority: Option<i32>,
}

impl common::Part for FirewallPolicyRuleOperationMetadata {}
...
impl common::Part for LocalizedMessage {}
...
pub struct Operation {
    ...
    /// no description provided
    #[serde(rename = "firewallPolicyRuleOperationMetadata")]
    ...
    #[serde(rename = "setAutoscalerLinkOperationMetadata")]
...
impl common::Part for QuotaExceededInfo {}
...
impl common::NestedType for OperationErrorErrorsErrorDetails {}
impl common::Part for OperationErrorErrorsErrorDetails {}
...
impl common::NestedType for ResourceUpdateErrorErrorsErrorDetails {}
impl common::Part for ResourceUpdateErrorErrorsErrorDetails {}
...
impl<'a, C> DeploymentMethods<'a, C> {
    ...
    pub fn delete(&self, project: &str, deployment: &str) -> DeploymentDeleteCall<'a, C> {
        DeploymentDeleteCall {
            ...
            _project: project.to_string(),
            _deployment: deployment.to_string(),
            _header_bypass_billing_filter: Default::default(),
    ...
    C: 'a,
{
    ...
    _project: String,
    _deployment: String,
    _header_bypass_billing_filter: Option<bool>,
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("project", self._project);
        params.push("deployment", self._deployment);
        if let Some(value) = self._header_bypass_billing_filter.as_ref() {
            params.push("header.bypassBillingFilter", value.to_string());
        }
    ...
    ///
    /// Sets the *header.bypass billing filter* query property to the given value.
    pub fn header_bypass_billing_filter(mut self, new_value: bool) -> DeploymentDeleteCall<'a, C> {
        self._header_bypass_billing_filter = Some(new_value);
        self
    }
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Deployment)> {
        ...
        for &field in ["alt", "project", "deployment", "header.bypassBillingFilter"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(common::Error::FieldClash(field));
            }
    ...
    ///
    /// Sets the *header.bypass billing filter* query property to the given value.
    pub fn header_bypass_billing_filter(mut self, new_value: bool) -> DeploymentGetCall<'a, C> {
        self._header_bypass_billing_filter = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *header.bypass billing filter* query property to the given value.
    pub fn header_bypass_billing_filter(
        mut self,
        new_value: bool,
    ) -> DeploymentGetIamPolicyCall<'a, C> {
        self._header_bypass_billing_filter = Some(new_value);
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *header.bypass billing filter* query property to the given value.
    pub fn header_bypass_billing_filter(mut self, new_value: bool) -> DeploymentInsertCall<'a, C> {
        self._header_bypass_billing_filter = Some(new_value);
        self
    }
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *header.bypass billing filter* query property to the given value.
    pub fn header_bypass_billing_filter(mut self, new_value: bool) -> DeploymentPatchCall<'a, C> {
        self._header_bypass_billing_filter = Some(new_value);
        self
    }
    /// Sets the policy to use for deleting resources.
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, TestPermissionsResponse)> {
        ...
        for &field in ["alt", "project", "resource", "header.bypassBillingFilter"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(common::Error::FieldClash(field));
            }
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *header.bypass billing filter* query property to the given value.
    pub fn header_bypass_billing_filter(mut self, new_value: bool) -> DeploymentUpdateCall<'a, C> {
        self._header_bypass_billing_filter = Some(new_value);
        self
    }
    /// Sets the policy to use for deleting resources.
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *header.bypass billing filter* query property to the given value.
    pub fn header_bypass_billing_filter(mut self, new_value: bool) -> ManifestGetCall<'a, C> {
        self._header_bypass_billing_filter = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        for &field in ["alt", "project", "operation", "header.bypassBillingFilter"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(common::Error::FieldClash(field));
            }
    ...
    ///
    /// Sets the *header.bypass billing filter* query property to the given value.
    pub fn header_bypass_billing_filter(mut self, new_value: bool) -> OperationGetCall<'a, C> {
        self._header_bypass_billing_filter = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *header.bypass billing filter* query property to the given value.
    pub fn header_bypass_billing_filter(mut self, new_value: bool) -> ResourceGetCall<'a, C> {
        self._header_bypass_billing_filter = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
