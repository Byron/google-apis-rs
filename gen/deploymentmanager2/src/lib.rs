...
//! This documentation was generated from *Deployment Manager* crate version *7.0.0+20251205*, where *20251205* is the exact revision of the *deploymentmanager:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
