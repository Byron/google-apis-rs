...
//! This documentation was generated from *Deployment Manager* crate version *0.1.13+20160406*, where *20160406* is the exact revision of the *deploymentmanager:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.13*.
//! 
