...
//! This documentation was generated from *Vault* crate version *6.0.0+20240617*, where *20240617* is the exact revision of the *vault:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
