...
//! This documentation was generated from *Vault* crate version *7.0.0+20251209*, where *20251209* is the exact revision of the *vault:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
//! Everything else about the *Vault* *v1* API can be found at the
//! [official documentation site](https://developers.google.com/workspace/vault).
