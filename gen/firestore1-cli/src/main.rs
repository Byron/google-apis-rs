...
{
    async fn _projects_databases_backup_schedules_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::GoogleFirestoreAdminV1BackupSchedule = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().databases_backup_schedules_create(request, opt.value_of("parent").unwrap_or(""));
    ...
    async fn _projects_databases_backup_schedules_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().databases_backup_schedules_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_databases_backup_schedules_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().databases_backup_schedules_get(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_databases_backup_schedules_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().databases_backup_schedules_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_databases_backup_schedules_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::GoogleFirestoreAdminV1BackupSchedule = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().databases_backup_schedules_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "update-mask" => {
    ...
    async fn _projects_databases_collection_groups_fields_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_databases_collection_groups_fields_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_databases_collection_groups_fields_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "name" => Some(("name", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "ttl-config.state" => Some(("ttlConfig.state", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["ancestor-field", "index-config", "name", "reverting", "state", "ttl-config", "uses-ancestor-config"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
    ...
    async fn _projects_databases_collection_groups_indexes_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "api-scope" => Some(("apiScope", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "name" => Some(("name", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "query-scope" => Some(("queryScope", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "state" => Some(("state", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["api-scope", "name", "query-scope", "state"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
    ...
    async fn _projects_databases_collection_groups_indexes_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_databases_collection_groups_indexes_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_databases_collection_groups_indexes_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_databases_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::GoogleFirestoreAdminV1Database = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().databases_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "database-id" => {
    ...
    async fn _projects_databases_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().databases_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "etag" => {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "snapshot-time" => Some(("snapshotTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["collection-ids", "namespace-ids", "output-uri-prefix", "snapshot-time"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
    ...
    async fn _projects_databases_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().databases_get(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "namespace-ids" => Some(("namespaceIds", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Vec })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["collection-ids", "input-uri-prefix", "namespace-ids"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
    ...
    async fn _projects_databases_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().databases_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_databases_operations_cancel(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_databases_operations_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_databases_operations_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_databases_operations_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _projects_databases_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::GoogleFirestoreAdminV1Database = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().databases_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "update-mask" => {
    ...
    async fn _projects_databases_restore(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::GoogleFirestoreAdminV1RestoreDatabaseRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().databases_restore(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
            ...
            ("projects", Some(opt)) => {
                match opt.subcommand() {
                    ("databases-backup-schedules-create", Some(opt)) => {
                        call_result = self._projects_databases_backup_schedules_create(opt, dry_run, &mut err).await;
                    },
                    ("databases-backup-schedules-delete", Some(opt)) => {
                        call_result = self._projects_databases_backup_schedules_delete(opt, dry_run, &mut err).await;
                    },
                    ("databases-backup-schedules-get", Some(opt)) => {
                        call_result = self._projects_databases_backup_schedules_get(opt, dry_run, &mut err).await;
                    },
                    ("databases-backup-schedules-list", Some(opt)) => {
                        call_result = self._projects_databases_backup_schedules_list(opt, dry_run, &mut err).await;
                    },
                    ...
                    ("databases-collection-groups-fields-list", Some(opt)) => {
                        call_result = self._projects_databases_collection_groups_fields_list(opt, dry_run, &mut err).await;
                    },
                    ("databases-collection-groups-fields-patch", Some(opt)) => {
                        call_result = self._projects_databases_collection_groups_fields_patch(opt, dry_run, &mut err).await;
                    },
                    ("databases-collection-groups-indexes-create", Some(opt)) => {
                        call_result = self._projects_databases_collection_groups_indexes_create(opt, dry_run, &mut err).await;
                    },
                    ("databases-collection-groups-indexes-delete", Some(opt)) => {
                        call_result = self._projects_databases_collection_groups_indexes_delete(opt, dry_run, &mut err).await;
                    },
                    ("databases-collection-groups-indexes-get", Some(opt)) => {
                        call_result = self._projects_databases_collection_groups_indexes_get(opt, dry_run, &mut err).await;
                    },
                    ("databases-collection-groups-indexes-list", Some(opt)) => {
                        call_result = self._projects_databases_collection_groups_indexes_list(opt, dry_run, &mut err).await;
                    },
                    ("databases-create", Some(opt)) => {
                        call_result = self._projects_databases_create(opt, dry_run, &mut err).await;
                    },
                    ("databases-delete", Some(opt)) => {
                        call_result = self._projects_databases_delete(opt, dry_run, &mut err).await;
                    },
                    ...
                    ("databases-operations-cancel", Some(opt)) => {
                        call_result = self._projects_databases_operations_cancel(opt, dry_run, &mut err).await;
                    },
                    ("databases-operations-delete", Some(opt)) => {
                        call_result = self._projects_databases_operations_delete(opt, dry_run, &mut err).await;
                    },
                    ("databases-operations-get", Some(opt)) => {
                        call_result = self._projects_databases_operations_get(opt, dry_run, &mut err).await;
                    },
                    ("databases-operations-list", Some(opt)) => {
                        call_result = self._projects_databases_operations_list(opt, dry_run, &mut err).await;
                    },
                    ("databases-patch", Some(opt)) => {
                        call_result = self._projects_databases_patch(opt, dry_run, &mut err).await;
                    },
                    ("databases-restore", Some(opt)) => {
                        call_result = self._projects_databases_restore(opt, dry_run, &mut err).await;
                    },
    ...
    async fn new(opt: ArgMatches<'n>, connector: S) -> Result<Engine<'n, S>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "firestore1-secret.json",
        ...
        let auth = oauth2::InstalledFlowAuthenticator::with_client(
            ...
            client.clone(),
        ).persist_tokens_to_disk(format!("{}/firestore1", config_dir)).build().await.unwrap();
