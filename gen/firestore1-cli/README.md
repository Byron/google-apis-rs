...
Find the source code [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/firestore1-cli).

# Usage

This documentation was generated from the *Firestore* API at revision *20190419*. The CLI is at version *1.0.12*.
