...
//! This documentation was generated from *Tag Manager* crate version *7.0.0+20251210*, where *20251210* is the exact revision of the *tagmanager:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
...
//! let r = hub.accounts().containers_workspaces_templates_import_from_gallery(...).doit().await
...
//! let r = hub.accounts().containers_workspaces_bulk_update(...).doit().await
