...
You may alter the way an `doit()` method is called by providing a [delegate](https://docs.rs/google-tagmanager2/4.0.1+20220301/google_tagmanager2/client::Delegate) to the 
