...
//! This documentation was generated from *Secret Manager* crate version *5.0.5+20240621*, where *20240621* is the exact revision of the *secretmanager:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.5*.
//! 
