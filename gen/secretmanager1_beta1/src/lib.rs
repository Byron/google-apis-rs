...
//! This documentation was generated from *Secret Manager* crate version *8.0.0+20251020*, where *20251020* is the exact revision of the *secretmanager:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
