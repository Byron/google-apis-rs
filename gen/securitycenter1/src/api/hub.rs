...
/// ```
#[derive(Clone)]
pub struct SecurityCommandCenter<S> {
...
impl<'a, S> client::Hub for SecurityCommandCenter<S> {}

impl<'a, S> SecurityCommandCenter<S> {

    pub fn new<A: 'static + client::GetToken>(client: hyper::Client<S, hyper::body::Body>, auth: A) -> SecurityCommandCenter<S> {
