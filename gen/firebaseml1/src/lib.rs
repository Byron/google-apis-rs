...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/firebaseml1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.FirebaseML.html) ... 
//! 
...
impl<'a, C, A> Hub for FirebaseML<C, A> {}

impl<'a, C, A> FirebaseML<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> FirebaseML<C, A> {
        FirebaseML {
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_firebaseml1 as firebaseml1;
/// use firebaseml1::CancelOperationRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use firebaseml1::FirebaseML;
...
impl<'a, C, A> OperationCancelCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Empty)> {
        ...
        dlg.begin(MethodInfo { id: "firebaseml.operations.cancel",
...
impl<'a, C, A> OperationListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListOperationsResponse)> {
        ...
        dlg.begin(MethodInfo { id: "firebaseml.operations.list",
...
impl<'a, C, A> OperationDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Empty)> {
        ...
        dlg.begin(MethodInfo { id: "firebaseml.operations.delete",
