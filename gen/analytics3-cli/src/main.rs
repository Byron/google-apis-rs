...
use google_analytics3::{api, yup_oauth2, Error};
...
{
    async fn _data_ga_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.data().ga_get(
            opt.value_of("ids").unwrap_or(""),
            opt.value_of("start-date").unwrap_or(""),
            opt.value_of("end-date").unwrap_or(""),
            opt.value_of("metrics").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            ...
            match key {
                "start-index" => {
                    call = call.start_index(
                        value
                            .map(|v| arg_from_str(v, err, "start-index", "int32"))
                            .unwrap_or(-0),
                    );
                }
                "sort" => {
                ...
                "include-empty-rows" => {
                    call = call.include_empty_rows(
                        value
                            .map(|v| arg_from_str(v, err, "include-empty-rows", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "filters" => {
    ...
    async fn _data_mcf_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.data().mcf_get(
            opt.value_of("ids").unwrap_or(""),
            opt.value_of("start-date").unwrap_or(""),
            opt.value_of("end-date").unwrap_or(""),
            opt.value_of("metrics").unwrap_or(""),
    ...
    async fn _data_realtime_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.data().realtime_get(
            opt.value_of("ids").unwrap_or(""),
            opt.value_of("metrics").unwrap_or(""),
        );
        for parg in opt
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["dimensions", "filters", "max-results", "sort"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _management_account_summaries_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _management_account_user_links_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().account_user_links_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("link-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_account_user_links_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "entity.profile-ref.account-id" => Some((
                ...
                "entity.profile-ref.internal-web-property-id" => Some((
                ...
                "entity.profile-ref.web-property-id" => Some((
                ...
                "entity.web-property-ref.account-id" => Some((
                ...
                "entity.web-property-ref.href" => Some((
                ...
                "entity.web-property-ref.id" => Some((
                ...
                "entity.web-property-ref.internal-web-property-id" => Some((
                ...
                "entity.web-property-ref.kind" => Some((
                ...
                "entity.web-property-ref.name" => Some((
        ...
        let mut request: api::EntityUserLink = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .management()
            .account_user_links_insert(request, opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _management_account_user_links_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .management()
            .account_user_links_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _management_account_user_links_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EntityUserLink = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().account_user_links_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("link-id").unwrap_or(""),
        );
    ...
    async fn _management_accounts_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _management_client_id_hash_client_id(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["client-id", "kind", "web-property-id"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::HashClientIdRequest = serde_json::value::from_value(object).unwrap();
    ...
    async fn _management_custom_data_sources_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().custom_data_sources_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_custom_dimensions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().custom_dimensions_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("custom-dimension-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_custom_dimensions_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CustomDimension = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().custom_dimensions_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
    ...
    async fn _management_custom_dimensions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().custom_dimensions_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _management_custom_dimensions_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            match key {
                "ignore-custom-data-source-links" => {
                    call = call.ignore_custom_data_source_links(
                        value
                            .map(|v| {
                                arg_from_str(v, err, "ignore-custom-data-source-links", "boolean")
                            })
                            .unwrap_or(false),
                    );
                }
    ...
    async fn _management_custom_dimensions_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CustomDimension = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().custom_dimensions_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("custom-dimension-id").unwrap_or(""),
    ...
    async fn _management_custom_metrics_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().custom_metrics_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("custom-metric-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_custom_metrics_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CustomMetric = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().custom_metrics_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
    ...
    async fn _management_custom_metrics_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().custom_metrics_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _management_custom_metrics_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CustomMetric = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().custom_metrics_patch(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("custom-metric-id").unwrap_or(""),
    ...
    async fn _management_custom_metrics_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _management_experiments_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().experiments_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
            opt.value_of("experiment-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_experiments_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().experiments_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
            opt.value_of("experiment-id").unwrap_or(""),
    ...
    async fn _management_experiments_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "minimum-experiment-length-in-days" => Some((
                ...
                "rewrite-variation-urls-as-original" => Some((
        ...
        let mut request: api::Experiment = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().experiments_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_experiments_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().experiments_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
        );
    ...
    async fn _management_experiments_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _management_experiments_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Experiment = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().experiments_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_filters_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().filters_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("filter-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_filters_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().filters_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("filter-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _management_filters_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "advanced-details.case-sensitive" => Some((
                ...
                "advanced-details.extract-a" => Some((
                ...
                "advanced-details.extract-b" => Some((
                ...
                "advanced-details.field-a-index" => Some((
                ...
                "advanced-details.field-a-required" => Some((
                ...
                "advanced-details.field-b-index" => Some((
                ...
                "advanced-details.field-b-required" => Some((
                ...
                "advanced-details.output-constructor" => Some((
                ...
                "advanced-details.output-to-field" => Some((
                ...
                "advanced-details.output-to-field-index" => Some((
                ...
                "advanced-details.override-output-field" => Some((
                ...
                "exclude-details.case-sensitive" => Some((
                ...
                "exclude-details.expression-value" => Some((
                ...
                "exclude-details.field-index" => Some((
                ...
                "exclude-details.match-type" => Some((
                ...
                "include-details.case-sensitive" => Some((
                ...
                "include-details.expression-value" => Some((
                ...
                "include-details.field-index" => Some((
                ...
                "include-details.match-type" => Some((
                ...
                "lowercase-details.field-index" => Some((
                ...
                "search-and-replace-details.case-sensitive" => Some((
                ...
                "search-and-replace-details.field" => Some((
                ...
                "search-and-replace-details.field-index" => Some((
                ...
                "search-and-replace-details.replace-string" => Some((
                ...
                "search-and-replace-details.search-string" => Some((
                ...
                "uppercase-details.field-index" => Some((
        ...
        let mut call = self
            .hub
            .management()
            .filters_insert(request, opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _management_filters_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .management()
            .filters_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _management_filters_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Filter = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().filters_patch(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("filter-id").unwrap_or(""),
        );
    ...
    async fn _management_filters_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Filter = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().filters_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("filter-id").unwrap_or(""),
        );
    ...
    async fn _management_goals_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().goals_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
            opt.value_of("goal-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_goals_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "event-details.use-event-value" => Some((
                ...
                "url-destination-details.case-sensitive" => Some((
                ...
                "url-destination-details.first-step-required" => Some((
                ...
                "url-destination-details.match-type" => Some((
                ...
                "url-destination-details.url" => Some((
                ...
                "visit-num-pages-details.comparison-type" => Some((
                ...
                "visit-num-pages-details.comparison-value" => Some((
                ...
                "visit-time-on-site-details.comparison-type" => Some((
                ...
                "visit-time-on-site-details.comparison-value" => Some((
        ...
        let mut request: api::Goal = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().goals_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_goals_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().goals_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
        );
    ...
    async fn _management_goals_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Goal = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().goals_patch(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_goals_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Goal = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().goals_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_profile_filter_links_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().profile_filter_links_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
            opt.value_of("link-id").unwrap_or(""),
    ...
    async fn _management_profile_filter_links_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().profile_filter_links_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
            opt.value_of("link-id").unwrap_or(""),
    ...
    async fn _management_profile_filter_links_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "profile-ref.internal-web-property-id" => Some((
                ...
                "profile-ref.web-property-id" => Some((
        ...
        let mut request: api::ProfileFilterLink = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().profile_filter_links_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_profile_filter_links_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().profile_filter_links_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
        );
    ...
    async fn _management_profile_filter_links_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ProfileFilterLink = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().profile_filter_links_patch(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_profile_filter_links_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _management_profile_user_links_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().profile_user_links_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
            opt.value_of("link-id").unwrap_or(""),
    ...
    async fn _management_profile_user_links_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EntityUserLink = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().profile_user_links_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_profile_user_links_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().profile_user_links_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
        );
    ...
    async fn _management_profile_user_links_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EntityUserLink = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().profile_user_links_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_profiles_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().profiles_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
        );
    ...
    async fn _management_profiles_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().profiles_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
        );
    ...
    async fn _management_profiles_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "enhanced-e-commerce-tracking" => Some((
                ...
                "site-search-category-parameters" => Some((
                ...
                "site-search-query-parameters" => Some((
                ...
                "strip-site-search-category-parameters" => Some((
                ...
                "strip-site-search-query-parameters" => Some((
    ...
    async fn _management_profiles_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().profiles_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _management_profiles_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Profile = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().profiles_patch(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_profiles_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Profile = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().profiles_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_remarketing_audience_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().remarketing_audience_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("remarketing-audience-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_remarketing_audience_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().remarketing_audience_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("remarketing-audience-id").unwrap_or(""),
        );
    ...
    async fn _management_remarketing_audience_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "audience-definition.include-conditions.days-to-look-back" => Some((
                ...
                "audience-definition.include-conditions.is-smart-list" => Some((
                ...
                "audience-definition.include-conditions.kind" => Some((
                ...
                "audience-definition.include-conditions.membership-duration-days" => Some((
                ...
                "audience-definition.include-conditions.segment" => Some((
                ...
                "state-based-audience-definition.exclude-conditions.exclusion-duration" => Some((
                ...
                "state-based-audience-definition.exclude-conditions.segment" => Some((
                ...
                "state-based-audience-definition.include-conditions.days-to-look-back" => Some((
                ...
                "state-based-audience-definition.include-conditions.is-smart-list" => Some((
                ...
                "state-based-audience-definition.include-conditions.kind" => Some((
                ...
                "state-based-audience-definition.include-conditions.membership-duration-days" => {
                    Some((
                ...
                "state-based-audience-definition.include-conditions.segment" => Some((
        ...
        let mut request: api::RemarketingAudience = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().remarketing_audience_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
    ...
    async fn _management_remarketing_audience_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().remarketing_audience_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _management_remarketing_audience_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RemarketingAudience = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().remarketing_audience_patch(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("remarketing-audience-id").unwrap_or(""),
    ...
    async fn _management_remarketing_audience_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RemarketingAudience = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().remarketing_audience_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("remarketing-audience-id").unwrap_or(""),
    ...
    async fn _management_segments_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _management_unsampled_reports_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().unsampled_reports_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
            opt.value_of("unsampled-report-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_unsampled_reports_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().unsampled_reports_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
            opt.value_of("unsampled-report-id").unwrap_or(""),
    ...
    async fn _management_unsampled_reports_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "cloud-storage-download-details.bucket-id" => Some((
                ...
                "cloud-storage-download-details.object-id" => Some((
                ...
                "drive-download-details.document-id" => Some((
        ...
        let mut request: api::UnsampledReport = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().unsampled_reports_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
    ...
    async fn _management_unsampled_reports_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().unsampled_reports_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("profile-id").unwrap_or(""),
        );
    ...
    async fn _management_uploads_delete_upload_data(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["custom-data-import-uids"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::AnalyticsDataimportDeleteUploadDataRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().uploads_delete_upload_data(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("custom-data-source-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_uploads_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().uploads_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("custom-data-source-id").unwrap_or(""),
            opt.value_of("upload-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_uploads_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().uploads_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("custom-data-source-id").unwrap_or(""),
        );
    ...
    async fn _management_uploads_upload_data(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().uploads_upload_data(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("custom-data-source-id").unwrap_or(""),
        );
    ...
    async fn _management_web_property_ad_words_links_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().web_property_ad_words_links_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("web-property-ad-words-link-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _management_web_property_ad_words_links_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().web_property_ad_words_links_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("web-property-ad-words-link-id").unwrap_or(""),
        );
    ...
    async fn _management_web_property_ad_words_links_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EntityAdWordsLink = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().web_property_ad_words_links_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
    ...
    async fn _management_web_property_ad_words_links_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().web_property_ad_words_links_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _management_web_property_ad_words_links_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EntityAdWordsLink = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().web_property_ad_words_links_patch(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("web-property-ad-words-link-id").unwrap_or(""),
    ...
    async fn _management_web_property_ad_words_links_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EntityAdWordsLink = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().web_property_ad_words_links_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("web-property-ad-words-link-id").unwrap_or(""),
    ...
    async fn _management_webproperties_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().webproperties_get(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _management_webproperties_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "data-retention-reset-on-new-activity" => Some((
        ...
        let mut request: api::Webproperty = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .management()
            .webproperties_insert(request, opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _management_webproperties_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .management()
            .webproperties_list(opt.value_of("account-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _management_webproperties_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Webproperty = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().webproperties_patch(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
    ...
    async fn _management_webproperties_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Webproperty = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().webproperties_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
    ...
    async fn _management_webproperty_user_links_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().webproperty_user_links_delete(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("link-id").unwrap_or(""),
        );
    ...
    async fn _management_webproperty_user_links_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EntityUserLink = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().webproperty_user_links_insert(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
    ...
    async fn _management_webproperty_user_links_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.management().webproperty_user_links_list(
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _management_webproperty_user_links_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EntityUserLink = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.management().webproperty_user_links_update(
            request,
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("web-property-id").unwrap_or(""),
            opt.value_of("link-id").unwrap_or(""),
    ...
    async fn _metadata_columns_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .metadata()
            .columns_list(opt.value_of("report-type").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _provisioning_create_account_ticket(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "account.child-link.type" => Some((
                    "account.childLink.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "account.created" => Some((
                    "account.created",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "account.permissions.effective" => Some((
                ...
                "profile.bot-filtering-enabled" => Some((
                ...
                "profile.child-link.href" => Some((
                    "profile.childLink.href",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "profile.child-link.type" => Some((
                    "profile.childLink.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "profile.created" => Some((
                    "profile.created",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "profile.e-commerce-tracking" => Some((
                ...
                "profile.enhanced-e-commerce-tracking" => Some((
                ...
                "profile.exclude-query-parameters" => Some((
                ...
                "profile.internal-web-property-id" => Some((
                    "profile.internalWebPropertyId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "profile.parent-link.href" => Some((
                    "profile.parentLink.href",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "profile.parent-link.type" => Some((
                    "profile.parentLink.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "profile.permissions.effective" => Some((
                ...
                "profile.site-search-category-parameters" => Some((
                ...
                "profile.site-search-query-parameters" => Some((
                ...
                "profile.strip-site-search-category-parameters" => Some((
                ...
                "profile.strip-site-search-query-parameters" => Some((
                ...
                "webproperty.child-link.href" => Some((
                    "webproperty.childLink.href",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "webproperty.child-link.type" => Some((
                    "webproperty.childLink.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "webproperty.created" => Some((
                    "webproperty.created",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "webproperty.data-retention-reset-on-new-activity" => Some((
                ...
                "webproperty.data-retention-ttl" => Some((
                ...
                "webproperty.default-profile-id" => Some((
                    "webproperty.defaultProfileId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "webproperty.industry-vertical" => Some((
                    "webproperty.industryVertical",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "webproperty.internal-web-property-id" => Some((
                    "webproperty.internalWebPropertyId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "webproperty.kind" => Some((
                    "webproperty.kind",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "webproperty.parent-link.href" => Some((
                    "webproperty.parentLink.href",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "webproperty.parent-link.type" => Some((
                    "webproperty.parentLink.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "webproperty.permissions.effective" => Some((
                ...
                "webproperty.profile-count" => Some((
                    "webproperty.profileCount",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "webproperty.self-link" => Some((
                    "webproperty.selfLink",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "webproperty.starred" => Some((
                    "webproperty.starred",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
        ...
        let mut request: api::AccountTicket = serde_json::value::from_value(object).unwrap();
    ...
    async fn _provisioning_create_account_tree(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AccountTreeRequest = serde_json::value::from_value(object).unwrap();
    ...
    async fn _user_deletion_user_deletion_request_upsert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UserDeletionRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .user_deletion()
            .user_deletion_request_upsert(request);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("data", Some(opt)) => match opt.subcommand() {
                ("ga-get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("data".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("management", Some(opt)) => match opt.subcommand() {
                ("account-summaries-list", Some(opt)) => {
                    call_result = self
                        ._management_account_summaries_list(opt, dry_run, &mut err)
                        .await;
                }
                ("account-user-links-delete", Some(opt)) => {
                    call_result = self
                        ._management_account_user_links_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("account-user-links-insert", Some(opt)) => {
                    call_result = self
                        ._management_account_user_links_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("account-user-links-list", Some(opt)) => {
                    call_result = self
                        ._management_account_user_links_list(opt, dry_run, &mut err)
                        .await;
                }
                ("account-user-links-update", Some(opt)) => {
                    call_result = self
                        ._management_account_user_links_update(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("client-id-hash-client-id", Some(opt)) => {
                    call_result = self
                        ._management_client_id_hash_client_id(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-data-sources-list", Some(opt)) => {
                    call_result = self
                        ._management_custom_data_sources_list(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-dimensions-get", Some(opt)) => {
                    call_result = self
                        ._management_custom_dimensions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-dimensions-insert", Some(opt)) => {
                    call_result = self
                        ._management_custom_dimensions_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-dimensions-list", Some(opt)) => {
                    call_result = self
                        ._management_custom_dimensions_list(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-dimensions-patch", Some(opt)) => {
                    call_result = self
                        ._management_custom_dimensions_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-dimensions-update", Some(opt)) => {
                    call_result = self
                        ._management_custom_dimensions_update(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-metrics-get", Some(opt)) => {
                    call_result = self
                        ._management_custom_metrics_get(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-metrics-insert", Some(opt)) => {
                    call_result = self
                        ._management_custom_metrics_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-metrics-list", Some(opt)) => {
                    call_result = self
                        ._management_custom_metrics_list(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-metrics-patch", Some(opt)) => {
                    call_result = self
                        ._management_custom_metrics_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-metrics-update", Some(opt)) => {
                    call_result = self
                        ._management_custom_metrics_update(opt, dry_run, &mut err)
                        .await;
                }
                ("experiments-delete", Some(opt)) => {
                    call_result = self
                        ._management_experiments_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("experiments-get", Some(opt)) => {
                    call_result = self
                        ._management_experiments_get(opt, dry_run, &mut err)
                        .await;
                }
                ("experiments-insert", Some(opt)) => {
                    call_result = self
                        ._management_experiments_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("experiments-list", Some(opt)) => {
                    call_result = self
                        ._management_experiments_list(opt, dry_run, &mut err)
                        .await;
                }
                ("experiments-patch", Some(opt)) => {
                    call_result = self
                        ._management_experiments_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("experiments-update", Some(opt)) => {
                    call_result = self
                        ._management_experiments_update(opt, dry_run, &mut err)
                        .await;
                }
                ("filters-delete", Some(opt)) => {
                    call_result = self
                        ._management_filters_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("filters-insert", Some(opt)) => {
                    call_result = self
                        ._management_filters_insert(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("filters-update", Some(opt)) => {
                    call_result = self
                        ._management_filters_update(opt, dry_run, &mut err)
                        .await;
                }
                ("goals-get", Some(opt)) => {
                ...
                ("profile-filter-links-delete", Some(opt)) => {
                    call_result = self
                        ._management_profile_filter_links_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("profile-filter-links-get", Some(opt)) => {
                    call_result = self
                        ._management_profile_filter_links_get(opt, dry_run, &mut err)
                        .await;
                }
                ("profile-filter-links-insert", Some(opt)) => {
                    call_result = self
                        ._management_profile_filter_links_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("profile-filter-links-list", Some(opt)) => {
                    call_result = self
                        ._management_profile_filter_links_list(opt, dry_run, &mut err)
                        .await;
                }
                ("profile-filter-links-patch", Some(opt)) => {
                    call_result = self
                        ._management_profile_filter_links_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("profile-filter-links-update", Some(opt)) => {
                    call_result = self
                        ._management_profile_filter_links_update(opt, dry_run, &mut err)
                        .await;
                }
                ("profile-user-links-delete", Some(opt)) => {
                    call_result = self
                        ._management_profile_user_links_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("profile-user-links-insert", Some(opt)) => {
                    call_result = self
                        ._management_profile_user_links_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("profile-user-links-list", Some(opt)) => {
                    call_result = self
                        ._management_profile_user_links_list(opt, dry_run, &mut err)
                        .await;
                }
                ("profile-user-links-update", Some(opt)) => {
                    call_result = self
                        ._management_profile_user_links_update(opt, dry_run, &mut err)
                        .await;
                }
                ("profiles-delete", Some(opt)) => {
                    call_result = self
                        ._management_profiles_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("profiles-insert", Some(opt)) => {
                    call_result = self
                        ._management_profiles_insert(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("profiles-patch", Some(opt)) => {
                    call_result = self
                        ._management_profiles_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("profiles-update", Some(opt)) => {
                    call_result = self
                        ._management_profiles_update(opt, dry_run, &mut err)
                        .await;
                }
                ("remarketing-audience-delete", Some(opt)) => {
                    call_result = self
                        ._management_remarketing_audience_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("remarketing-audience-get", Some(opt)) => {
                    call_result = self
                        ._management_remarketing_audience_get(opt, dry_run, &mut err)
                        .await;
                }
                ("remarketing-audience-insert", Some(opt)) => {
                    call_result = self
                        ._management_remarketing_audience_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("remarketing-audience-list", Some(opt)) => {
                    call_result = self
                        ._management_remarketing_audience_list(opt, dry_run, &mut err)
                        .await;
                }
                ("remarketing-audience-patch", Some(opt)) => {
                    call_result = self
                        ._management_remarketing_audience_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("remarketing-audience-update", Some(opt)) => {
                    call_result = self
                        ._management_remarketing_audience_update(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("unsampled-reports-delete", Some(opt)) => {
                    call_result = self
                        ._management_unsampled_reports_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("unsampled-reports-get", Some(opt)) => {
                    call_result = self
                        ._management_unsampled_reports_get(opt, dry_run, &mut err)
                        .await;
                }
                ("unsampled-reports-insert", Some(opt)) => {
                    call_result = self
                        ._management_unsampled_reports_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("unsampled-reports-list", Some(opt)) => {
                    call_result = self
                        ._management_unsampled_reports_list(opt, dry_run, &mut err)
                        .await;
                }
                ("uploads-delete-upload-data", Some(opt)) => {
                    call_result = self
                        ._management_uploads_delete_upload_data(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("uploads-upload-data", Some(opt)) => {
                    call_result = self
                        ._management_uploads_upload_data(opt, dry_run, &mut err)
                        .await;
                }
                ("web-property-ad-words-links-delete", Some(opt)) => {
                    call_result = self
                        ._management_web_property_ad_words_links_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("web-property-ad-words-links-get", Some(opt)) => {
                    call_result = self
                        ._management_web_property_ad_words_links_get(opt, dry_run, &mut err)
                        .await;
                }
                ("web-property-ad-words-links-insert", Some(opt)) => {
                    call_result = self
                        ._management_web_property_ad_words_links_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("web-property-ad-words-links-list", Some(opt)) => {
                    call_result = self
                        ._management_web_property_ad_words_links_list(opt, dry_run, &mut err)
                        .await;
                }
                ("web-property-ad-words-links-patch", Some(opt)) => {
                    call_result = self
                        ._management_web_property_ad_words_links_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("web-property-ad-words-links-update", Some(opt)) => {
                    call_result = self
                        ._management_web_property_ad_words_links_update(opt, dry_run, &mut err)
                        .await;
                }
                ("webproperties-get", Some(opt)) => {
                    call_result = self
                        ._management_webproperties_get(opt, dry_run, &mut err)
                        .await;
                }
                ("webproperties-insert", Some(opt)) => {
                    call_result = self
                        ._management_webproperties_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("webproperties-list", Some(opt)) => {
                    call_result = self
                        ._management_webproperties_list(opt, dry_run, &mut err)
                        .await;
                }
                ("webproperties-patch", Some(opt)) => {
                    call_result = self
                        ._management_webproperties_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("webproperties-update", Some(opt)) => {
                    call_result = self
                        ._management_webproperties_update(opt, dry_run, &mut err)
                        .await;
                }
                ("webproperty-user-links-delete", Some(opt)) => {
                    call_result = self
                        ._management_webproperty_user_links_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("webproperty-user-links-insert", Some(opt)) => {
                    call_result = self
                        ._management_webproperty_user_links_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("webproperty-user-links-list", Some(opt)) => {
                    call_result = self
                        ._management_webproperty_user_links_list(opt, dry_run, &mut err)
                        .await;
                }
                ("webproperty-user-links-update", Some(opt)) => {
                    call_result = self
                        ._management_webproperty_user_links_update(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("management".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("metadata", Some(opt)) => match opt.subcommand() {
                ("columns-list", Some(opt)) => {
                    call_result = self._metadata_columns_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("metadata".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("provisioning", Some(opt)) => match opt.subcommand() {
                ("create-account-ticket", Some(opt)) => {
                    call_result = self
                        ._provisioning_create_account_ticket(opt, dry_run, &mut err)
                        .await;
                }
                ("create-account-tree", Some(opt)) => {
                    call_result = self
                        ._provisioning_create_account_tree(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("provisioning".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("user-deletion", Some(opt)) => match opt.subcommand() {
                ("user-deletion-request-upsert", Some(opt)) => {
                    call_result = self
                        ._user_deletion_user_deletion_request_upsert(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("user-deletion".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "analytics3-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/analytics3", config_dir))
        .build()
        .await
        .unwrap();
