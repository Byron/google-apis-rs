...
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.CloudBillingBudget.html) ... 
//! 
//! * billing accounts
//!  * [*budgets create*](struct.BillingAccountBudgetCreateCall.html), [*budgets delete*](struct.BillingAccountBudgetDeleteCall.html), [*budgets get*](struct.BillingAccountBudgetGetCall.html), [*budgets list*](struct.BillingAccountBudgetListCall.html) and [*budgets patch*](struct.BillingAccountBudgetPatchCall.html)
//! 
//! 
//! 
//! 
...
//! 
//! * **[Hub](struct.CloudBillingBudget.html)**
...
/// # }
/// ```
pub struct CloudBillingBudget<C, A> {
    client: RefCell<C>,
    auth: RefCell<A>,
    _user_agent: String,
    _base_url: String,
...
impl<'a, C, A> Hub for CloudBillingBudget<C, A> {}

impl<'a, C, A> CloudBillingBudget<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> CloudBillingBudget<C, A> {
        CloudBillingBudget {
...
impl Part for GoogleCloudBillingBudgetsV1beta1AllUpdatesRule {}
...
impl Part for GoogleCloudBillingBudgetsV1beta1LastPeriodAmount {}
...
/// 
/// * [budgets delete billing accounts](struct.BillingAccountBudgetDeleteCall.html) (response)
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl Part for GoogleCloudBillingBudgetsV1beta1ThresholdRule {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [budgets list billing accounts](struct.BillingAccountBudgetListCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl ResponseResult for GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse {}
...
impl Part for GoogleCloudBillingBudgetsV1beta1Filter {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [budgets patch billing accounts](struct.BillingAccountBudgetPatchCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl RequestValue for GoogleCloudBillingBudgetsV1beta1UpdateBudgetRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [budgets get billing accounts](struct.BillingAccountBudgetGetCall.html) (response)
/// * [budgets patch billing accounts](struct.BillingAccountBudgetPatchCall.html) (response)
/// * [budgets create billing accounts](struct.BillingAccountBudgetCreateCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl ResponseResult for GoogleCloudBillingBudgetsV1beta1Budget {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [budgets create billing accounts](struct.BillingAccountBudgetCreateCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl RequestValue for GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest {}
...
impl Part for GoogleCloudBillingBudgetsV1beta1BudgetAmount {}
...
impl<'a, C, A> BillingAccountMethods<'a, C, A> {
    ...
    ///            `billingAccounts/{billingAccountId}/budgets/{budgetId}`.
    pub fn budgets_delete(&self, name: &str) -> BillingAccountBudgetDeleteCall<'a, C, A> {
    ...
    ///            `billingAccounts/{billingAccountId}/budgets/{budgetId}`.
    pub fn budgets_get(&self, name: &str) -> BillingAccountBudgetGetCall<'a, C, A> {
    ...
    ///            The resource name implies the scope of a budget. Values are of the form
    ///            `billingAccounts/{billingAccountId}/budgets/{budgetId}`.
    pub fn budgets_patch(&self, request: GoogleCloudBillingBudgetsV1beta1UpdateBudgetRequest, name: &str) -> BillingAccountBudgetPatchCall<'a, C, A> {
    ...
    ///
    /// * `request` - No description provided.
    /// * `parent` - Required. The name of the billing account to create the budget in. Values
    ///              are of the form `billingAccounts/{billingAccountId}`.
    pub fn budgets_create(&self, request: GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest, parent: &str) -> BillingAccountBudgetCreateCall<'a, C, A> {
    ...
    ///              are of the form `billingAccounts/{billingAccountId}`.
    pub fn budgets_list(&self, parent: &str) -> BillingAccountBudgetListCall<'a, C, A> {
...
/// # }
/// ```
pub struct BillingAccountBudgetDeleteCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for BillingAccountBudgetDeleteCall<'a, C, A> {}

impl<'a, C, A> BillingAccountBudgetDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleProtobufEmpty)> {
        ...
        dlg.begin(MethodInfo { id: "billingbudgets.billingAccounts.budgets.delete",
    ...
    pub fn name(mut self, new_value: &str) -> BillingAccountBudgetDeleteCall<'a, C, A> {
    ...
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> BillingAccountBudgetDeleteCall<'a, C, A> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountBudgetDeleteCall<'a, C, A>
                                                        where T: AsRef<str> {
    ...
    pub fn add_scope<T, S>(mut self, scope: T) -> BillingAccountBudgetDeleteCall<'a, C, A>
...
/// # }
/// ```
pub struct BillingAccountBudgetGetCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for BillingAccountBudgetGetCall<'a, C, A> {}

impl<'a, C, A> BillingAccountBudgetGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleCloudBillingBudgetsV1beta1Budget)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{ContentType, ContentLength, Authorization, Bearer, UserAgent, Location};
        let mut dd = DefaultDelegate;
        ...
        dlg.begin(MethodInfo { id: "billingbudgets.billingAccounts.budgets.get",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> BillingAccountBudgetGetCall<'a, C, A> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> BillingAccountBudgetGetCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountBudgetGetCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> BillingAccountBudgetGetCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct BillingAccountBudgetPatchCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for BillingAccountBudgetPatchCall<'a, C, A> {}

impl<'a, C, A> BillingAccountBudgetPatchCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleCloudBillingBudgetsV1beta1Budget)> {
        ...
        dlg.begin(MethodInfo { id: "billingbudgets.billingAccounts.budgets.patch",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleCloudBillingBudgetsV1beta1UpdateBudgetRequest) -> BillingAccountBudgetPatchCall<'a, C, A> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> BillingAccountBudgetPatchCall<'a, C, A> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> BillingAccountBudgetPatchCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountBudgetPatchCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> BillingAccountBudgetPatchCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_billingbudgets1_beta1 as billingbudgets1_beta1;
/// use billingbudgets1_beta1::GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use billingbudgets1_beta1::CloudBillingBudget;
...
/// # }
/// ```
pub struct BillingAccountBudgetCreateCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for BillingAccountBudgetCreateCall<'a, C, A> {}

impl<'a, C, A> BillingAccountBudgetCreateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleCloudBillingBudgetsV1beta1Budget)> {
        ...
        dlg.begin(MethodInfo { id: "billingbudgets.billingAccounts.budgets.create",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest) -> BillingAccountBudgetCreateCall<'a, C, A> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> BillingAccountBudgetCreateCall<'a, C, A> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> BillingAccountBudgetCreateCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountBudgetCreateCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> BillingAccountBudgetCreateCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct BillingAccountBudgetListCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for BillingAccountBudgetListCall<'a, C, A> {}

impl<'a, C, A> BillingAccountBudgetListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{ContentType, ContentLength, Authorization, Bearer, UserAgent, Location};
        let mut dd = DefaultDelegate;
        ...
        dlg.begin(MethodInfo { id: "billingbudgets.billingAccounts.budgets.list",
                               http_method: hyper::method::Method::Get });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> BillingAccountBudgetListCall<'a, C, A> {
        self._parent = new_value.to_string();
        self
    }
    ...
    pub fn page_token(mut self, new_value: &str) -> BillingAccountBudgetListCall<'a, C, A> {
    ...
    pub fn page_size(mut self, new_value: i32) -> BillingAccountBudgetListCall<'a, C, A> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn Delegate) -> BillingAccountBudgetListCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountBudgetListCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> BillingAccountBudgetListCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
