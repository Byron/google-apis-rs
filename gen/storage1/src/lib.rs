...
//! This documentation was generated from *storage* crate version *3.0.2+20220228*, where *20220228* is the exact revision of the *storage:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
