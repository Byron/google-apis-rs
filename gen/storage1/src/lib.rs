...
//! This documentation was generated from *storage* crate version *0.1.11+20151229*, where *20151229* is the exact revision of the *storage:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.11*.
//! 
