...
//!              .max_bytes_rewritten_per_call(-93)
//!              .if_source_metageneration_not_match(-37)
//!              .if_source_metageneration_match(-12)
//!              .if_source_generation_not_match(-16)
//!              .if_source_generation_match(-57)
//!              .if_metageneration_not_match(-50)
//!              .if_metageneration_match(-50)
