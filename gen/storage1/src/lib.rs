...
//! This documentation was generated from *storage* crate version *7.0.0+20251218*, where *20251218* is the exact revision of the *storage:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
