...
//! This documentation was generated from *storage* crate version *3.1.0+20220228*, where *20220228* is the exact revision of the *storage:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.1.0*.
//! 
