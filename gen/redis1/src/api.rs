...
pub struct AutomatedBackupConfig {
    ...
    #[serde(rename = "automatedBackupMode")]
    pub automated_backup_mode: Option<String>,
    /// Optional. Trigger automated backups at a fixed frequency.
    #[serde(rename = "fixedFrequencySchedule")]
...
impl common::Part for AutomatedBackupConfig {}
...
///
/// * [locations backup collections backups get projects](ProjectLocationBackupCollectionBackupGetCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct Backup {
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations clusters backup projects](ProjectLocationClusterBackupCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for BackupClusterRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations backup collections get projects](ProjectLocationBackupCollectionGetCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::ResponseResult for BackupCollection {}
...
impl common::Part for BackupFile {}
...
pub struct Cluster {
    ...
    #[serde(rename = "allowFewerZonesDeployment")]
    ...
    #[serde(rename = "asyncClusterEndpointsDeletionEnabled")]
    ...
    #[serde(rename = "automatedBackupConfig")]
    ...
    #[serde(rename = "effectiveMaintenanceVersion")]
    ...
    #[serde(rename = "managedBackupSource")]
    ...
    #[serde(rename = "ondemandMaintenance")]
    ...
    #[serde(rename = "pscServiceAttachments")]
    ...
    #[serde(rename = "simulateMaintenanceEvent")]
...
impl common::Part for ClusterEndpoint {}
...
impl common::Part for ClusterMaintenancePolicy {}
...
impl common::Part for ClusterMaintenanceSchedule {}
...
impl common::Part for ClusterWeeklyMaintenanceWindow {}
...
pub struct ConnectionDetail {
    ...
    #[serde(rename = "pscAutoConnection")]
    ...
    #[serde(rename = "pscConnection")]
    pub psc_connection: Option<PscConnection>,
}

impl common::Part for ConnectionDetail {}
...
impl common::Part for CrossClusterReplicationConfig {}
...
pub struct EncryptionInfo {
    ...
    #[serde(rename = "kmsKeyPrimaryState")]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations backup collections backups export projects](ProjectLocationBackupCollectionBackupExportCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for ExportBackupRequest {}
...
impl common::Part for FixedFrequencySchedule {}
...
impl common::Part for GcsBackupSource {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations backup collections list projects](ProjectLocationBackupCollectionListCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct ListBackupCollectionsResponse {
    ...
    #[serde(rename = "backupCollections")]
...
impl common::ResponseResult for ListBackupCollectionsResponse {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations backup collections backups list projects](ProjectLocationBackupCollectionBackupListCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::Part for ManagedBackupSource {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations backup collections backups delete projects](ProjectLocationBackupCollectionBackupDeleteCall) (response)
/// * [locations backup collections backups export projects](ProjectLocationBackupCollectionBackupExportCall) (response)
/// * [locations clusters backup projects](ProjectLocationClusterBackupCall) (response)
...
/// * [locations clusters reschedule cluster maintenance projects](ProjectLocationClusterRescheduleClusterMaintenanceCall) (response)
...
impl common::Part for PscAutoConnection {}
...
impl common::Part for PscServiceAttachment {}
...
impl common::Part for RemoteCluster {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations clusters reschedule cluster maintenance projects](ProjectLocationClusterRescheduleClusterMaintenanceCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for RescheduleClusterMaintenanceRequest {}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    /// # Arguments
    ///
    /// * `name` - Required. Redis backup resource name using the form: `projects/{project_id}/locations/{location_id}/backupCollections/{backup_collection_id}/backups/{backup_id}`
    pub fn locations_backup_collections_backups_delete(
        &self,
        name: &str,
    ) -> ProjectLocationBackupCollectionBackupDeleteCall<'a, C> {
        ProjectLocationBackupCollectionBackupDeleteCall {
            hub: self.hub,
    ...
    /// * `name` - Required. Redis backup resource name using the form: `projects/{project_id}/locations/{location_id}/backupCollections/{backup_collection_id}/backups/{backup_id}`
    pub fn locations_backup_collections_backups_export(
        &self,
        request: ExportBackupRequest,
        name: &str,
    ) -> ProjectLocationBackupCollectionBackupExportCall<'a, C> {
        ProjectLocationBackupCollectionBackupExportCall {
            hub: self.hub,
            _request: request,
            _name: name.to_string(),
            _delegate: Default::default(),
    ...
    ///
    /// * `name` - Required. Redis backup resource name using the form: `projects/{project_id}/locations/{location_id}/backupCollections/{backup_collection_id}/backups/{backup_id}`
    pub fn locations_backup_collections_backups_get(
        &self,
        name: &str,
    ) -> ProjectLocationBackupCollectionBackupGetCall<'a, C> {
        ProjectLocationBackupCollectionBackupGetCall {
            hub: self.hub,
            _name: name.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
    ...
    /// # Arguments
    ///
    /// * `parent` - Required. The resource name of the backupCollection using the form: `projects/{project_id}/locations/{location_id}/backupCollections/{backup_collection_id}`
    pub fn locations_backup_collections_backups_list(
        &self,
        parent: &str,
    ) -> ProjectLocationBackupCollectionBackupListCall<'a, C> {
        ProjectLocationBackupCollectionBackupListCall {
            hub: self.hub,
    ...
    /// # Arguments
    ///
    /// * `name` - Required. Redis backupCollection resource name using the form: `projects/{project_id}/locations/{location_id}/backupCollections/{backup_collection_id}` where `location_id` refers to a Google Cloud region.
    pub fn locations_backup_collections_get(
        &self,
        name: &str,
    ) -> ProjectLocationBackupCollectionGetCall<'a, C> {
        ProjectLocationBackupCollectionGetCall {
            hub: self.hub,
            _name: name.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
    ...
    /// # Arguments
    ///
    /// * `parent` - Required. The resource name of the backupCollection location using the form: `projects/{project_id}/locations/{location_id}` where `location_id` refers to a Google Cloud region.
    pub fn locations_backup_collections_list(
        &self,
        parent: &str,
    ) -> ProjectLocationBackupCollectionListCall<'a, C> {
        ProjectLocationBackupCollectionListCall {
            hub: self.hub,
            _parent: parent.to_string(),
            _page_token: Default::default(),
            _page_size: Default::default(),
    ...
    ///
    /// * `request` - No description provided.
    /// * `name` - Required. Redis cluster resource name using the form: `projects/{project_id}/locations/{location_id}/clusters/{cluster_id}` where `location_id` refers to a Google Cloud region.
    pub fn locations_clusters_backup(
        &self,
        request: BackupClusterRequest,
        name: &str,
    ) -> ProjectLocationClusterBackupCall<'a, C> {
        ProjectLocationClusterBackupCall {
            hub: self.hub,
            _request: request,
            _name: name.to_string(),
            _delegate: Default::default(),
    ...
    ///
    /// * `request` - No description provided.
    /// * `parent` - Required. The resource name of the cluster location using the form: `projects/{project_id}/locations/{location_id}` where `location_id` refers to a Google Cloud region.
    ...
    /// # Arguments
    ///
    /// * `name` - Required. Redis cluster certificate authority resource name using the form: `projects/{project_id}/locations/{location_id}/clusters/{cluster_id}/certificateAuthority` where `location_id` refers to a Google Cloud region.
    ...
    ///
    /// * `request` - No description provided.
    /// * `name` - Required. Redis Cluster instance resource name using the form: `projects/{project_id}/locations/{location_id}/clusters/{cluster_id}` where `location_id` refers to a Google Cloud region.
    pub fn locations_clusters_reschedule_cluster_maintenance(
        &self,
        request: RescheduleClusterMaintenanceRequest,
        name: &str,
    ) -> ProjectLocationClusterRescheduleClusterMaintenanceCall<'a, C> {
        ProjectLocationClusterRescheduleClusterMaintenanceCall {
            hub: self.hub,
            _request: request,
            _name: name.to_string(),
            _delegate: Default::default(),
...
/// Deletes a specific backup.
///
/// A builder for the *locations.backupCollections.backups.delete* method supported by a *project* resource.
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_backup_collections_backups_delete("name")
///              .request_id("amet.")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationBackupCollectionBackupDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationBackupCollectionBackupDeleteCall<'a, C> {}

impl<'a, C> ProjectLocationBackupCollectionBackupDeleteCall<'a, C>
where
    C: common::Connector,
{
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationBackupCollectionBackupDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Exports a specific backup to a customer target Cloud Storage URI.
///
/// A builder for the *locations.backupCollections.backups.export* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_redis1 as redis1;
/// use redis1::api::ExportBackupRequest;
/// # async fn dox() {
/// # use redis1::{CloudRedis, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ExportBackupRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_backup_collections_backups_export(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationBackupCollectionBackupExportCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationBackupCollectionBackupExportCall<'a, C> {}

impl<'a, C> ProjectLocationBackupCollectionBackupExportCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationBackupCollectionBackupExportCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Gets the details of a specific backup.
///
/// A builder for the *locations.backupCollections.backups.get* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_backup_collections_backups_get("name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationBackupCollectionBackupGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationBackupCollectionBackupGetCall<'a, C> {}

impl<'a, C> ProjectLocationBackupCollectionBackupGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationBackupCollectionBackupGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationBackupCollectionBackupGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationBackupCollectionBackupGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists all backups owned by a backup collection.
///
/// A builder for the *locations.backupCollections.backups.list* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_backup_collections_backups_list("parent")
///              .page_token("Lorem")
///              .page_size(-12)
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationBackupCollectionBackupListCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationBackupCollectionBackupListCall<'a, C> {}

impl<'a, C> ProjectLocationBackupCollectionBackupListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationBackupCollectionBackupListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Get a backup collection.
///
/// A builder for the *locations.backupCollections.get* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_backup_collections_get("name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationBackupCollectionGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationBackupCollectionGetCall<'a, C> {}

impl<'a, C> ProjectLocationBackupCollectionGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, BackupCollection)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationBackupCollectionGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationBackupCollectionGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationBackupCollectionGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationBackupCollectionGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationBackupCollectionGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists all backup collections owned by a consumer project in either the specified location (region) or all locations. If `location_id` is specified as `-` (wildcard), then all regions available to the project are queried, and the results are aggregated.
///
/// A builder for the *locations.backupCollections.list* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_backup_collections_list("parent")
///              .page_token("ea")
///              .page_size(-55)
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationBackupCollectionListCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationBackupCollectionListCall<'a, C> {}

impl<'a, C> ProjectLocationBackupCollectionListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, ListBackupCollectionsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/backupCollections";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationBackupCollectionListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// Optional. The `next_page_token` value returned from a previous [ListBackupCollections] request, if any.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationBackupCollectionListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// Optional. The maximum number of items to return. If not specified, a default value of 1000 will be used by the service. Regardless of the page_size value, the response may include a partial list and a caller should only rely on response's `next_page_token` to determine if there are more clusters left to be queried.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationBackupCollectionListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationBackupCollectionListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationBackupCollectionListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationBackupCollectionListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationBackupCollectionListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Backup Redis Cluster. If this is the first time a backup is being created, a backup collection will be created at the backend, and this backup belongs to this collection. Both collection and backup will have a resource name. Backup will be executed for each shard. A replica (primary if nonHA) will be selected to perform the execution. Backup call will be rejected if there is an ongoing backup or update operation. Be aware that during preview, if the cluster's internal software version is too old, critical update will be performed before actual backup. Once the internal software version is updated to the minimum version required by the backup feature, subsequent backups will not require critical update. After preview, there will be no critical update needed for backup.
///
/// A builder for the *locations.clusters.backup* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_redis1 as redis1;
/// use redis1::api::BackupClusterRequest;
/// # async fn dox() {
/// # use redis1::{CloudRedis, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = BackupClusterRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_clusters_backup(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationClusterBackupCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
    _request: BackupClusterRequest,
    _name: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationClusterBackupCall<'a, C> {}

impl<'a, C> ProjectLocationClusterBackupCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+name}:backup";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: BackupClusterRequest,
    ) -> ProjectLocationClusterBackupCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationClusterBackupCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationClusterBackupCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationClusterBackupCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationClusterBackupCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationClusterBackupCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Reschedules upcoming maintenance event.
///
/// A builder for the *locations.clusters.rescheduleClusterMaintenance* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_redis1 as redis1;
/// use redis1::api::RescheduleClusterMaintenanceRequest;
/// # async fn dox() {
/// # use redis1::{CloudRedis, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = RescheduleClusterMaintenanceRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_clusters_reschedule_cluster_maintenance(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationClusterRescheduleClusterMaintenanceCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
    _request: RescheduleClusterMaintenanceRequest,
    _name: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationClusterRescheduleClusterMaintenanceCall<'a, C> {}

impl<'a, C> ProjectLocationClusterRescheduleClusterMaintenanceCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+name}:rescheduleClusterMaintenance";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: RescheduleClusterMaintenanceRequest,
    ) -> ProjectLocationClusterRescheduleClusterMaintenanceCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationClusterRescheduleClusterMaintenanceCall<'a, C> {
        self._scopes.clear();
        self
    }
}
