...
//! This documentation was generated from *Cloud Redis* crate version *1.0.10+20190628*, where *20190628* is the exact revision of the *redis:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.10*.
//! 
