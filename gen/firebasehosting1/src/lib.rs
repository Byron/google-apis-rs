...
//! This documentation was generated from *Firebase Hosting* crate version *8.0.0+20251026*, where *20251026* is the exact revision of the *firebasehosting:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
