...
//! This documentation was generated from *Firebase Hosting* crate version *7.0.0+20251214*, where *20251214* is the exact revision of the *firebasehosting:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
