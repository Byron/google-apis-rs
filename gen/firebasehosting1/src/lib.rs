...
//! This documentation was generated from *Firebase Hosting* crate version *3.0.2+20220212*, where *20220212* is the exact revision of the *firebasehosting:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
