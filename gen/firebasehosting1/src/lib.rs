...
//! This documentation was generated from *Firebase Hosting* crate version *5.0.2+20230123*, where *20230123* is the exact revision of the *firebasehosting:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2*.
//! 
