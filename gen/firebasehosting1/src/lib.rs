...
//! This documentation was generated from *Firebase Hosting* crate version *2.0.3+20210315*, where *20210315* is the exact revision of the *firebasehosting:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.3*.
//! 
