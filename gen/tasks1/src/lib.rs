...
//! This documentation was generated from *Tasks* crate version *8.0.0+20251028*, where *20251028* is the exact revision of the *tasks:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
//! Everything else about the *Tasks* *v1* API can be found at the
//! [official documentation site](https://developers.google.com/workspace/tasks/).
