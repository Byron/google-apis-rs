...
//! This documentation was generated from *tasks* crate version *1.0.3+20141121*, where *20141121* is the exact revision of the *tasks:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.3*.
//! 
