...
//! This documentation was generated from *reports* crate version *0.1.9+20150429*, where *20150429* is the exact revision of the *admin:reports_v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.9*.
//! 
