...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [decode pc integrity token](MethodDecodePcIntegrityTokenCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [decode pc integrity token](MethodDecodePcIntegrityTokenCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [write device recall](DeviceRecallWriteCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [write device recall](DeviceRecallWriteCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
/// A builder providing access to all methods supported on *deviceRecall* resources.
...
/// let mut hub = PlayIntegrity::new(client, auth);
/// // Usually you wouldn't bind this to a variable, but keep calling *CallBuilders*
/// // like `decode_integrity_token(...)` and `decode_pc_integrity_token(...)`
/// // to build up your call.
/// let rb = hub.methods();
/// # }
/// ```
...
/// Writes recall bits for the device where Play Integrity API token is obtained. The endpoint is available to select Play partners in an early access program (EAP).
///
/// A builder for the *write* method supported by a *deviceRecall* resource.
/// It is not used directly, but through a [`DeviceRecallMethods`] instance.
///
/// # Example
///
...
/// Decodes the PC integrity token and returns the PC token payload.
///
/// A builder for the *decodePcIntegrityToken* method.
/// It is not used directly, but through a [`MethodMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_playintegrity1 as playintegrity1;
/// use playintegrity1::api::DecodePcIntegrityTokenRequest;
/// # async fn dox() {
/// # use playintegrity1::{PlayIntegrity, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = DecodePcIntegrityTokenRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.methods().decode_pc_integrity_token(req, "packageName")
///              .doit().await;
/// # }
/// ```
