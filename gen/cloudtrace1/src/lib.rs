...
//! This documentation was generated from *cloudtrace* crate version *0.1.9+20150825*, where *20150825* is the exact revision of the *cloudtrace:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.9*.
//! 
...
//! 
//! * [get discovery](struct.MethodGetDiscoveryCall.html)
//! 
//! 
//! 
