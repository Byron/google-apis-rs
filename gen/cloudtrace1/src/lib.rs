...
//! This documentation was generated from *Cloud Trace* crate version *8.0.0+20251017*, where *20251017* is the exact revision of the *cloudtrace:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
