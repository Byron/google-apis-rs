...
//! This documentation was generated from *Cloud Trace* crate version *1.0.9+20190622*, where *20190622* is the exact revision of the *cloudtrace:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.9*.
//! 
