...
//! This documentation was generated from *Dataproc* crate version *1.0.10+20190620*, where *20190620* is the exact revision of the *dataproc:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.10*.
//! 
