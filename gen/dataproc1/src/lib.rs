...
//! This documentation was generated from *Dataproc* crate version *3.0.2+20220224*, where *20220224* is the exact revision of the *dataproc:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
...
//!     ).build().await.unwrap();
//! let mut hub = Dataproc::new(hyper::Client::builder().build(hyper_rustls::HttpsConnector::with_native_roots().https_or_http().enable_http1().enable_http2().build()), auth);
