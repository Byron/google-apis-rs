...
//! This documentation was generated from *dataproc* crate version *1.0.2+20161102*, where *20161102* is the exact revision of the *dataproc:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.2*.
//! 
