...
This documentation was generated from the *Cloud Dataplex* API at revision *20251203*. The CLI is at version *7.0.0*.

```bash
dataplex1 [options]
        organizations
                locations-encryption-configs-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-encryption-configs-delete <name> [-p <v>]... [-o <out>]
                locations-encryption-configs-get <name> [-p <v>]... [-o <out>]
                locations-encryption-configs-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-encryption-configs-list <parent> [-p <v>]... [-o <out>]
                locations-encryption-configs-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-encryption-configs-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-encryption-configs-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
        ...
        projects
                ...
                locations-change-requests-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-change-requests-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-change-requests-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-data-products-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-data-products-data-assets-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-data-products-data-assets-delete <name> [-p <v>]... [-o <out>]
                locations-data-products-data-assets-get <name> [-p <v>]... [-o <out>]
                locations-data-products-data-assets-list <parent> [-p <v>]... [-o <out>]
                locations-data-products-data-assets-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-data-products-delete <name> [-p <v>]... [-o <out>]
                locations-data-products-get <name> [-p <v>]... [-o <out>]
                locations-data-products-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-data-products-list <parent> [-p <v>]... [-o <out>]
                locations-data-products-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-data-products-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-data-products-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-entry-groups-entry-links-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-entry-groups-entry-links-delete <name> [-p <v>]... [-o <out>]
                locations-entry-groups-entry-links-get <name> [-p <v>]... [-o <out>]
                ...
                locations-entry-link-types-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-entry-link-types-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-entry-link-types-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-glossaries-categories-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-glossaries-categories-delete <name> [-p <v>]... [-o <out>]
                locations-glossaries-categories-get <name> [-p <v>]... [-o <out>]
                locations-glossaries-categories-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-glossaries-categories-list <parent> [-p <v>]... [-o <out>]
                locations-glossaries-categories-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-glossaries-categories-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-glossaries-categories-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-glossaries-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-glossaries-list <parent> [-p <v>]... [-o <out>]
                locations-glossaries-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-glossaries-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-glossaries-terms-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-glossaries-terms-delete <name> [-p <v>]... [-o <out>]
                locations-glossaries-terms-get <name> [-p <v>]... [-o <out>]
                locations-glossaries-terms-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-glossaries-terms-list <parent> [-p <v>]... [-o <out>]
                locations-glossaries-terms-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-glossaries-terms-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-glossaries-terms-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-glossaries-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-metadata-jobs-cancel <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-metadata-jobs-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-metadata-jobs-get <name> [-p <v>]... [-o <out>]
                locations-metadata-jobs-list <parent> [-p <v>]... [-o <out>]
                locations-operations-cancel <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-operations-delete <name> [-p <v>]... [-o <out>]
                locations-operations-get <name> [-p <v>]... [-o <out>]
                locations-operations-list <name> [-p <v>]... [-o <out>]
