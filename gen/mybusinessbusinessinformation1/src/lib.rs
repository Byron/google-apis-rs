...
//! This documentation was generated from *My Business Business Information* crate version *7.0.0+20251210*, where *20251210* is the exact revision of the *mybusinessbusinessinformation:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
