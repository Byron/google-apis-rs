...
impl<'a, S> CampaignMethods<'a, S> {
    ...
    /// * `request` - No description provided.
    /// * `profileId` - User profile ID associated with this request.
    /// * `defaultLandingPageName` - Default landing page name for this new campaign. Must be less than 256 characters long.
    /// * `defaultLandingPageUrl` - Default landing page URL for this new campaign.
    pub fn insert(&self, request: Campaign, profile_id: i64, default_landing_page_name: &str, default_landing_page_url: &str) -> CampaignInsertCall<'a, S> {
        CampaignInsertCall {
            hub: self.hub,
            _request: request,
            _profile_id: profile_id,
            _default_landing_page_name: default_landing_page_name.to_string(),
            _default_landing_page_url: default_landing_page_url.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
            _scopes: Default::default(),
        }
...
/// # }
/// ```
pub struct DirectorySiteContactMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Dfareporting<S>,
}

impl<'a, S> client::MethodsBuilder for DirectorySiteContactMethods<'a, S> {}

impl<'a, S> DirectorySiteContactMethods<'a, S> {
    ...
    pub fn get(&self, profile_id: i64, id: i64) -> DirectorySiteContactGetCall<'a, S> {
    ...
    ///
    /// * `profileId` - User profile ID associated with this request.
    pub fn list(&self, profile_id: i64) -> DirectorySiteContactListCall<'a, S> {
...
/// // like `delete(...)`, `get(...)`, `insert(...)`, `list(...)`, `patch(...)` and `update(...)`
/// // to build up your call.
/// let rb = hub.landing_pages();
/// # }
/// ```
pub struct LandingPageMethods<'a, S>
    where S: 'a {

   pub(super) hub: &'a Dfareporting<S>,
}

impl<'a, S> client::MethodsBuilder for LandingPageMethods<'a, S> {}

impl<'a, S> LandingPageMethods<'a, S> {
    ...
    /// * `id` - Landing page ID.
    pub fn delete(&self, profile_id: i64, campaign_id: i64, id: i64) -> LandingPageDeleteCall<'a, S> {
    ...
    /// * `campaignId` - Landing page campaign ID.
    /// * `id` - Landing page ID.
    pub fn get(&self, profile_id: i64, campaign_id: i64, id: i64) -> LandingPageGetCall<'a, S> {
        LandingPageGetCall {
            hub: self.hub,
            _profile_id: profile_id,
            _campaign_id: campaign_id,
    ...
    /// * `profileId` - User profile ID associated with this request.
    /// * `campaignId` - Landing page campaign ID.
    pub fn insert(&self, request: LandingPage, profile_id: i64, campaign_id: i64) -> LandingPageInsertCall<'a, S> {
    ...
    /// * `profileId` - User profile ID associated with this request.
    /// * `campaignId` - Landing page campaign ID.
    pub fn list(&self, profile_id: i64, campaign_id: i64) -> LandingPageListCall<'a, S> {
        LandingPageListCall {
            hub: self.hub,
            _profile_id: profile_id,
            _campaign_id: campaign_id,
    ...
    /// * `campaignId` - Landing page campaign ID.
    /// * `id` - Landing page ID.
    pub fn patch(&self, request: LandingPage, profile_id: i64, campaign_id: i64, id: i64) -> LandingPagePatchCall<'a, S> {
    ...
    /// * `profileId` - User profile ID associated with this request.
    /// * `campaignId` - Landing page campaign ID.
    pub fn update(&self, request: LandingPage, profile_id: i64, campaign_id: i64) -> LandingPageUpdateCall<'a, S> {
...
impl<'a, S> RemarketingListShareMethods<'a, S> {
    ...
    /// * `profileId` - User profile ID associated with this request.
    /// * `remarketingListId` - Remarketing list ID.
    pub fn patch(&self, request: RemarketingListShare, profile_id: i64, remarketing_list_id: i64) -> RemarketingListSharePatchCall<'a, S> {
