...
//! This documentation was generated from *Display Video* crate version *3.0.2+20220303*, where *20220303* is the exact revision of the *displayvideo:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
