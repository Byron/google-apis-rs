...
//! This documentation was generated from *Display Video* crate version *5.0.3+20230119*, where *20230119* is the exact revision of the *displayvideo:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
