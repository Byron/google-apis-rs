...
//! This documentation was generated from *Display Video* crate version *2.0.0+20210325*, where *20210325* is the exact revision of the *displayvideo:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.0*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/displayvideo1).
//! # Features
//! 
