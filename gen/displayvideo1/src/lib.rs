...
//! This documentation was generated from *Display Video* crate version *5.0.3+20240229*, where *20240229* is the exact revision of the *displayvideo:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
