...
* [interconnect groups](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroup)
 * [*create members*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroupCreateMemberCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroupDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroupGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroupGetIamPolicyCall), [*get operational status*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroupGetOperationalStatuCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroupInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroupListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroupPatchCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroupSetIamPolicyCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGroupTestIamPermissionCall)
* [interconnect locations](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectLocation)
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectLocationGetCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectLocationListCall)
* [interconnect remote locations](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectRemoteLocation)
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectRemoteLocationGetCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectRemoteLocationListCall)
* [interconnects](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::Interconnect)
 * [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGetCall), [*get diagnostics*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGetDiagnosticCall), [*get macsec config*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectGetMacsecConfigCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectPatchCall) and [*set labels*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::InterconnectSetLabelCall)
* [license codes](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseCode)
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseCodeGetCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseCodeTestIamPermissionCall)
* [licenses](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::License)
 * [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseListCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseSetIamPolicyCall), [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseTestIamPermissionCall) and [*update*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::LicenseUpdateCall)
* [machine images](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineImage)
 * [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineImageDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineImageGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineImageGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineImageInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineImageListCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineImageSetIamPolicyCall), [*set labels*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineImageSetLabelCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineImageTestIamPermissionCall)
* [machine types](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineType)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineTypeAggregatedListCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineTypeGetCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::MachineTypeListCall)
* [network attachments](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAttachment)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAttachmentAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAttachmentDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAttachmentGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAttachmentGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAttachmentInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAttachmentListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAttachmentPatchCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAttachmentSetIamPolicyCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAttachmentTestIamPermissionCall)
* [network edge security services](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEdgeSecurityService)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEdgeSecurityServiceAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEdgeSecurityServiceDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEdgeSecurityServiceGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEdgeSecurityServiceInsertCall) and [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEdgeSecurityServicePatchCall)
* [network endpoint groups](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEndpointGroup)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEndpointGroupAggregatedListCall), [*attach network endpoints*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEndpointGroupAttachNetworkEndpointCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEndpointGroupDeleteCall), [*detach network endpoints*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEndpointGroupDetachNetworkEndpointCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEndpointGroupGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEndpointGroupInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEndpointGroupListCall), [*list network endpoints*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEndpointGroupListNetworkEndpointCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkEndpointGroupTestIamPermissionCall)
* network firewall policies
 * [*add association*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyAddAssociationCall), [*add packet mirroring rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyAddPacketMirroringRuleCall), [*add rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyAddRuleCall), [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyAggregatedListCall), [*clone rules*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyCloneRuleCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyGetCall), [*get association*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyGetAssociationCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyGetIamPolicyCall), [*get packet mirroring rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyGetPacketMirroringRuleCall), [*get rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyGetRuleCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyPatchCall), [*patch packet mirroring rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyPatchPacketMirroringRuleCall), [*patch rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyPatchRuleCall), [*remove association*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyRemoveAssociationCall), [*remove packet mirroring rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyRemovePacketMirroringRuleCall), [*remove rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyRemoveRuleCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicySetIamPolicyCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkFirewallPolicyTestIamPermissionCall)
* [network profiles](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkProfile)
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkProfileGetCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkProfileListCall)
* [networks](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::Network)
 * [*add peering*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkAddPeeringCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkGetCall), [*get effective firewalls*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkGetEffectiveFirewallCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkListCall), [*list peering routes*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkListPeeringRouteCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkPatchCall), [*remove peering*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkRemovePeeringCall), [*request remove peering*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkRequestRemovePeeringCall), [*switch to custom mode*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkSwitchToCustomModeCall) and [*update peering*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NetworkUpdatePeeringCall)
* [node groups](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroup)
 * [*add nodes*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupAddNodeCall), [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupDeleteCall), [*delete nodes*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupDeleteNodeCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupListCall), [*list nodes*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupListNodeCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupPatchCall), [*perform maintenance*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupPerformMaintenanceCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupSetIamPolicyCall), [*set node template*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupSetNodeTemplateCall), [*simulate maintenance event*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupSimulateMaintenanceEventCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeGroupTestIamPermissionCall)
* [node templates](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTemplate)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTemplateAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTemplateDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTemplateGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTemplateGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTemplateInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTemplateListCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTemplateSetIamPolicyCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTemplateTestIamPermissionCall)
* [node types](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeType)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTypeAggregatedListCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTypeGetCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::NodeTypeListCall)
* organization security policies
 * [*add association*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyAddAssociationCall), [*add rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyAddRuleCall), [*copy rules*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyCopyRuleCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyGetCall), [*get association*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyGetAssociationCall), [*get rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyGetRuleCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyListCall), [*list associations*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyListAssociationCall), [*list preconfigured expression sets*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyListPreconfiguredExpressionSetCall), [*move*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyMoveCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyPatchCall), [*patch rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyPatchRuleCall), [*remove association*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyRemoveAssociationCall) and [*remove rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::OrganizationSecurityPolicyRemoveRuleCall)
* [packet mirrorings](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PacketMirroring)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PacketMirroringAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PacketMirroringDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PacketMirroringGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PacketMirroringInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PacketMirroringListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PacketMirroringPatchCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PacketMirroringTestIamPermissionCall)
* [preview features](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PreviewFeature)
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PreviewFeatureGetCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PreviewFeatureListCall) and [*update*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PreviewFeatureUpdateCall)
* [projects](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::Project)
 * [*disable xpn host*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectDisableXpnHostCall), [*disable xpn resource*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectDisableXpnResourceCall), [*enable xpn host*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectEnableXpnHostCall), [*enable xpn resource*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectEnableXpnResourceCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectGetCall), [*get xpn host*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectGetXpnHostCall), [*get xpn resources*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectGetXpnResourceCall), [*list xpn hosts*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectListXpnHostCall), [*move disk*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectMoveDiskCall), [*move instance*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectMoveInstanceCall), [*set cloud armor tier*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectSetCloudArmorTierCall), [*set common instance metadata*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectSetCommonInstanceMetadataCall), [*set default network tier*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectSetDefaultNetworkTierCall) and [*set usage export bucket*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ProjectSetUsageExportBucketCall)
* [public advertised prefixes](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicAdvertisedPrefix)
 * [*announce*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicAdvertisedPrefixAnnounceCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicAdvertisedPrefixDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicAdvertisedPrefixGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicAdvertisedPrefixInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicAdvertisedPrefixListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicAdvertisedPrefixPatchCall) and [*withdraw*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicAdvertisedPrefixWithdrawCall)
* [public delegated prefixes](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicDelegatedPrefix)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicDelegatedPrefixAggregatedListCall), [*announce*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicDelegatedPrefixAnnounceCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicDelegatedPrefixDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicDelegatedPrefixGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicDelegatedPrefixInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicDelegatedPrefixListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicDelegatedPrefixPatchCall) and [*withdraw*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::PublicDelegatedPrefixWithdrawCall)
* region autoscalers
 * [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionAutoscalerDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionAutoscalerGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionAutoscalerInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionAutoscalerListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionAutoscalerPatchCall) and [*update*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionAutoscalerUpdateCall)
* region backend services
 * [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceGetCall), [*get health*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceGetHealthCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceListCall), [*list usable*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceListUsableCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServicePatchCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceSetIamPolicyCall), [*set security policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceSetSecurityPolicyCall), [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceTestIamPermissionCall) and [*update*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionBackendServiceUpdateCall)
* region commitments
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionCommitmentAggregatedListCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionCommitmentGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionCommitmentInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionCommitmentListCall) and [*update*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionCommitmentUpdateCall)
* region disk types
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskTypeGetCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskTypeListCall)
* region disks
 * [*add resource policies*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskAddResourcePolicyCall), [*bulk insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskBulkInsertCall), [*create snapshot*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskCreateSnapshotCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskListCall), [*remove resource policies*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskRemoveResourcePolicyCall), [*resize*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskResizeCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskSetIamPolicyCall), [*set labels*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskSetLabelCall), [*start async replication*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskStartAsyncReplicationCall), [*stop async replication*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskStopAsyncReplicationCall), [*stop group async replication*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskStopGroupAsyncReplicationCall), [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskTestIamPermissionCall) and [*update*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionDiskUpdateCall)
* region health check services
 * [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionHealthCheckServiceDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionHealthCheckServiceGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionHealthCheckServiceInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionHealthCheckServiceListCall) and [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionHealthCheckServicePatchCall)
...
* region url maps
 * [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionUrlMapDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionUrlMapGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionUrlMapInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionUrlMapListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionUrlMapPatchCall), [*update*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionUrlMapUpdateCall) and [*validate*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionUrlMapValidateCall)
* region zones
 * [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionZoneListCall)
* [regions](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::Region)
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionGetCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RegionListCall)
* [reservation blocks](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationBlock)
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationBlockGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationBlockGetIamPolicyCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationBlockListCall), [*perform maintenance*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationBlockPerformMaintenanceCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationBlockSetIamPolicyCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationBlockTestIamPermissionCall)
* [reservation sub blocks](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationSubBlock)
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationSubBlockGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationSubBlockGetIamPolicyCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationSubBlockListCall), [*perform maintenance*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationSubBlockPerformMaintenanceCall), [*report faulty*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationSubBlockReportFaultyCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationSubBlockSetIamPolicyCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationSubBlockTestIamPermissionCall)
* [reservations](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::Reservation)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationListCall), [*perform maintenance*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationPerformMaintenanceCall), [*resize*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationResizeCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationSetIamPolicyCall), [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationTestIamPermissionCall) and [*update*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ReservationUpdateCall)
* [resource policies](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ResourcePolicy)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ResourcePolicyAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ResourcePolicyDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ResourcePolicyGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ResourcePolicyGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ResourcePolicyInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ResourcePolicyListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ResourcePolicyPatchCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ResourcePolicySetIamPolicyCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ResourcePolicyTestIamPermissionCall)
* [routers](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::Router)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterDeleteCall), [*delete route policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterDeleteRoutePolicyCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterGetCall), [*get nat ip info*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterGetNatIpInfoCall), [*get nat mapping info*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterGetNatMappingInfoCall), [*get route policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterGetRoutePolicyCall), [*get router status*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterGetRouterStatuCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterListCall), [*list bgp routes*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterListBgpRouteCall), [*list route policies*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterListRoutePolicyCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterPatchCall), [*patch route policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterPatchRoutePolicyCall), [*preview*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterPreviewCall), [*update*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterUpdateCall) and [*update route policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouterUpdateRoutePolicyCall)
* [routes](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::Route)
 * [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouteDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouteGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouteInsertCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::RouteListCall)
* [security policies](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicy)
 * [*add rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyAddRuleCall), [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyGetCall), [*get rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyGetRuleCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyListCall), [*list preconfigured expression sets*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyListPreconfiguredExpressionSetCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyPatchCall), [*patch rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyPatchRuleCall), [*remove rule*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicyRemoveRuleCall) and [*set labels*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SecurityPolicySetLabelCall)
* [service attachments](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ServiceAttachment)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ServiceAttachmentAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ServiceAttachmentDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ServiceAttachmentGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ServiceAttachmentGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ServiceAttachmentInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ServiceAttachmentListCall), [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ServiceAttachmentPatchCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ServiceAttachmentSetIamPolicyCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ServiceAttachmentTestIamPermissionCall)
* snapshot settings
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SnapshotSettingGetCall) and [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SnapshotSettingPatchCall)
* [snapshots](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::Snapshot)
 * [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SnapshotDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SnapshotGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SnapshotGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SnapshotInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SnapshotListCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SnapshotSetIamPolicyCall), [*set labels*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SnapshotSetLabelCall) and [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SnapshotTestIamPermissionCall)
* [ssl certificates](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslCertificate)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslCertificateAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslCertificateDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslCertificateGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslCertificateInsertCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslCertificateListCall)
* [ssl policies](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslPolicy)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslPolicyAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslPolicyDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslPolicyGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslPolicyInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslPolicyListCall), [*list available features*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslPolicyListAvailableFeatureCall) and [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::SslPolicyPatchCall)
* [storage pool types](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolType)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolTypeAggregatedListCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolTypeGetCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolTypeListCall)
* [storage pools](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePool)
 * [*aggregated list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolAggregatedListCall), [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolGetCall), [*get iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolGetIamPolicyCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolListCall), [*list disks*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolListDiskCall), [*set iam policy*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolSetIamPolicyCall), [*test iam permissions*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolTestIamPermissionCall) and [*update*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::StoragePoolUpdateCall)
* [subnetworks](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::Subnetwork)
...
* [target grpc proxies](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::TargetGrpcProxy)
 * [*delete*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::TargetGrpcProxyDeleteCall), [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::TargetGrpcProxyGetCall), [*insert*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::TargetGrpcProxyInsertCall), [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::TargetGrpcProxyListCall) and [*patch*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::TargetGrpcProxyPatchCall)
* [target http proxies](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::TargetHttpProxy)
...
* [zones](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::Zone)
 * [*get*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ZoneGetCall) and [*list*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/api::ZoneListCall)
...
* **[Hub](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/Compute)**
    * a central object to maintain state and allow accessing all *Activities*
    * creates [*Method Builders*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::MethodsBuilder) which in turn
      allow access to individual [*Call Builders*](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::CallBuilder)
* **[Resources](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::Resource)**
    * primary types that you can apply *Activities* to
    * a collection of properties and *Parts*
    * **[Parts](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::Part)**
        * a collection of properties
        * never directly used in *Activities*
* **[Activities](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::CallBuilder)**
...
All errors produced by the system are provided either as [Result](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::Result) enumeration as return value of
the doit() methods, or handed as possibly intermediate results to either the
[Hub Delegate](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::Delegate), or the [Authenticator Delegate](https://docs.rs/yup-oauth2/*/yup_oauth2/trait.AuthenticatorDelegate.html).

When delegates handle errors or intermediate values, they may have a chance to instruct the system to retry. This
makes the system potentially resilient to all kinds of errors.

## Uploads and Downloads
If a method supports downloads, the response body, which is part of the [Result](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::Result), should be
read by you to obtain the media.
If such a method also supports a [Response Result](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::ResponseResult), it will return that by default.
...
You may alter the way an `doit()` method is called by providing a [delegate](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::Delegate) to the
[Method Builder](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::CallBuilder) before making the final `doit()` call.
Respective methods will be called to provide progress information, as well as determine whether the system should
retry on failure.

The [delegate trait](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::Delegate) is default-implemented, allowing you to customize it with minimal effort.

## Optional Parts in Server-Requests

All structures provided by this library are made to be [encodable](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::RequestValue) and
[decodable](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::ResponseResult) via *json*. Optionals are used to indicate that partial requests are responses
are valid.
Most optionals are are considered [Parts](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::Part) which are identifiable by name, which will be sent to
the server to indicate either the set parts of the request or the desired parts in the response.

## Builder Arguments

Using [method builders](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::CallBuilder), you are able to prepare an action call by repeatedly calling it's methods.
These will always take a single argument, for which the following statements are true.

* [PODs][wiki-pod] are handed by copy
* strings are passed as `&str`
* [request values](https://docs.rs/google-compute1/7.0.0+20251019/google_compute1/common::RequestValue) are moved
