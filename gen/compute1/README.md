...
This documentation was generated from *compute* crate version *0.1.15+20160908*, where *20160908* is the exact revision of the *compute:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.15*.
...
* [https health checks](http://byron.github.io/google-apis-rs/google_compute1/struct.HttpsHealthCheck.html)
...
* [instance group managers](http://byron.github.io/google-apis-rs/google_compute1/struct.InstanceGroupManager.html)
...
* [request values](http://byron.github.io/google-apis-rs/google_compute1/trait.RequestValue.html) are moved
