...
//! * [health checks](struct.HealthCheck.html)
//!  * [*delete*](struct.HealthCheckDeleteCall.html), [*get*](struct.HealthCheckGetCall.html), [*insert*](struct.HealthCheckInsertCall.html), [*list*](struct.HealthCheckListCall.html), [*patch*](struct.HealthCheckPatchCall.html) and [*update*](struct.HealthCheckUpdateCall.html)
...
//!  * [*delete*](struct.ImageDeleteCall.html), [*deprecate*](struct.ImageDeprecateCall.html), [*get*](struct.ImageGetCall.html), [*get from family*](struct.ImageGetFromFamilyCall.html), [*insert*](struct.ImageInsertCall.html) and [*list*](struct.ImageListCall.html)
...
//!  * [*delete*](struct.UrlMapDeleteCall.html), [*get*](struct.UrlMapGetCall.html), [*insert*](struct.UrlMapInsertCall.html), [*invalidate cache*](struct.UrlMapInvalidateCacheCall.html), [*list*](struct.UrlMapListCall.html), [*patch*](struct.UrlMapPatchCall.html), [*update*](struct.UrlMapUpdateCall.html) and [*validate*](struct.UrlMapValidateCall.html)
