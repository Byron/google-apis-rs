...
//! This documentation was generated from *analytics* crate version *3.0.2+20190807*, where *20190807* is the exact revision of the *analytics:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
...
//! use analytics3::{Analytics, oauth2, hyper, hyper_rustls};
//! 
