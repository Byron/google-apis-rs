...
//! This documentation was generated from *YouTube Analytics* crate version *1.0.7+20181010*, where *20181010* is the exact revision of the *youtubeAnalytics:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.7*.
//! 
