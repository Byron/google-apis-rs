...
extern crate mime;
extern crate strsim;
extern crate google_file1_beta1 as api;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::CloudFilestore<hyper::Client, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client>>,
    gp: Vec<&'static str>,
...
impl<'n> Engine<'n> {
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "file1-beta1-secret.json",
...
fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'locations-get', 'locations-instances-create', 'locations-instances-delete', 'locations-instances-get', 'locations-instances-list', 'locations-instances-patch', 'locations-list', 'locations-operations-cancel', 'locations-operations-delete', 'locations-operations-get' and 'locations-operations-list'", vec![
            ("locations-get",
        ...
        projects/{project_id}/locations/{location}/instances/{instance_id}."##),
            ...
            ("locations-instances-list",
                    Some(r##"Lists all instances in a project for either a specified location
