...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'locations-backups-create', 'locations-backups-delete', 'locations-backups-get', 'locations-backups-list', 'locations-backups-patch', 'locations-get', 'locations-instances-create', 'locations-instances-delete', 'locations-instances-get', 'locations-instances-list', 'locations-instances-patch', 'locations-instances-pause-replica', 'locations-instances-promote-replica', 'locations-instances-restore', 'locations-instances-resume-replica', 'locations-instances-revert', 'locations-instances-shares-create', 'locations-instances-shares-delete', 'locations-instances-shares-get', 'locations-instances-shares-list', 'locations-instances-shares-patch', 'locations-instances-snapshots-create', 'locations-instances-snapshots-delete', 'locations-instances-snapshots-get', 'locations-instances-snapshots-list', 'locations-instances-snapshots-patch', 'locations-list', 'locations-operations-cancel', 'locations-operations-delete', 'locations-operations-get' and 'locations-operations-list'", vec![
            ...
            ("locations-instances-pause-replica",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-pause-replica",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-instances-resume-replica",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-resume-replica",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the instance, in the format `projects/{project_id}/locations/{location_id}/instances/{instance_id}`."##),
