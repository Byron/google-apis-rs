...
{
    async fn _projects_locations_connection_profiles_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::ConnectionProfile = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_connection_profiles_create(request, opt.value_of("parent").unwrap_or(""));
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           ...
                                                                           v.extend(["connection-profile-id", "force", "request-id", "validate-only"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    async fn _projects_locations_connection_profiles_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_connection_profiles_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "request-id" => {
    ...
    async fn _projects_locations_connection_profiles_discover(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::DiscoverConnectionProfileRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_connection_profiles_discover(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_connection_profiles_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_connection_profiles_get(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_connection_profiles_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_connection_profiles_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    async fn _projects_locations_connection_profiles_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::ConnectionProfile = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_connection_profiles_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "validate-only" => {
    ...
    async fn _projects_locations_fetch_static_ips(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_fetch_static_ips(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    async fn _projects_locations_private_connections_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "create-time" => Some(("createTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "display-name" => Some(("displayName", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "error.details" => Some(("error.details", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Map })),
                    "error.error-time" => Some(("error.errorTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "error.error-uuid" => Some(("error.errorUuid", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "error.message" => Some(("error.message", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "error.reason" => Some(("error.reason", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "labels" => Some(("labels", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Map })),
                    "name" => Some(("name", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "state" => Some(("state", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "update-time" => Some(("updateTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "vpc-peering-config.subnet" => Some(("vpcPeeringConfig.subnet", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "vpc-peering-config.vpc" => Some(("vpcPeeringConfig.vpc", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["create-time", "details", "display-name", "error", "error-time", "error-uuid", "labels", "message", "name", "reason", "state", "subnet", "update-time", "vpc", "vpc-peering-config"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::PrivateConnection = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_private_connections_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "request-id" => {
    ...
    async fn _projects_locations_private_connections_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_private_connections_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "request-id" => {
    ...
    async fn _projects_locations_private_connections_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_private_connections_get(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_private_connections_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_private_connections_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    async fn _projects_locations_private_connections_routes_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "create-time" => Some(("createTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "destination-address" => Some(("destinationAddress", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "destination-port" => Some(("destinationPort", JsonTypeInfo { jtype: JsonType::Int, ctype: ComplexType::Pod })),
                    "display-name" => Some(("displayName", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "labels" => Some(("labels", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Map })),
                    "name" => Some(("name", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "update-time" => Some(("updateTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["create-time", "destination-address", "destination-port", "display-name", "labels", "name", "update-time"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut call = self.hub.projects().locations_private_connections_routes_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "route-id" => {
    ...
    async fn _projects_locations_private_connections_routes_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_private_connections_routes_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "request-id" => {
    ...
    async fn _projects_locations_private_connections_routes_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_private_connections_routes_get(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_private_connections_routes_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_private_connections_routes_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    async fn _projects_locations_streams_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Stream = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_streams_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "validate-only" => {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["force", "request-id", "stream-id", "validate-only"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    async fn _projects_locations_streams_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_streams_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "request-id" => {
    ...
    async fn _projects_locations_streams_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_streams_get(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_streams_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_streams_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    async fn _projects_locations_streams_objects_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_streams_objects_get(opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_streams_objects_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_streams_objects_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    async fn _projects_locations_streams_objects_lookup(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "source-object-identifier.mysql-identifier.database" => Some(("sourceObjectIdentifier.mysqlIdentifier.database", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
        ...
        let mut request: api::LookupStreamObjectRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_streams_objects_lookup(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_streams_objects_start_backfill_job(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::StartBackfillJobRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_streams_objects_start_backfill_job(request, opt.value_of("object").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_streams_objects_stop_backfill_job(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::StopBackfillJobRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_streams_objects_stop_backfill_job(request, opt.value_of("object").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_streams_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Stream = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_streams_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "validate-only" => {
            ...
            ("projects", Some(opt)) => {
                match opt.subcommand() {
                    ("locations-connection-profiles-create", Some(opt)) => {
                        call_result = self._projects_locations_connection_profiles_create(opt, dry_run, &mut err).await;
                    },
                    ("locations-connection-profiles-delete", Some(opt)) => {
                        call_result = self._projects_locations_connection_profiles_delete(opt, dry_run, &mut err).await;
                    },
                    ("locations-connection-profiles-discover", Some(opt)) => {
                        call_result = self._projects_locations_connection_profiles_discover(opt, dry_run, &mut err).await;
                    },
                    ("locations-connection-profiles-get", Some(opt)) => {
                        call_result = self._projects_locations_connection_profiles_get(opt, dry_run, &mut err).await;
                    },
                    ("locations-connection-profiles-list", Some(opt)) => {
                        call_result = self._projects_locations_connection_profiles_list(opt, dry_run, &mut err).await;
                    },
                    ("locations-connection-profiles-patch", Some(opt)) => {
                        call_result = self._projects_locations_connection_profiles_patch(opt, dry_run, &mut err).await;
                    },
                    ("locations-fetch-static-ips", Some(opt)) => {
                        call_result = self._projects_locations_fetch_static_ips(opt, dry_run, &mut err).await;
                    },
                    ...
                    ("locations-private-connections-create", Some(opt)) => {
                        call_result = self._projects_locations_private_connections_create(opt, dry_run, &mut err).await;
                    },
                    ("locations-private-connections-delete", Some(opt)) => {
                        call_result = self._projects_locations_private_connections_delete(opt, dry_run, &mut err).await;
                    },
                    ("locations-private-connections-get", Some(opt)) => {
                        call_result = self._projects_locations_private_connections_get(opt, dry_run, &mut err).await;
                    },
                    ("locations-private-connections-list", Some(opt)) => {
                        call_result = self._projects_locations_private_connections_list(opt, dry_run, &mut err).await;
                    },
                    ("locations-private-connections-routes-create", Some(opt)) => {
                        call_result = self._projects_locations_private_connections_routes_create(opt, dry_run, &mut err).await;
                    },
                    ("locations-private-connections-routes-delete", Some(opt)) => {
                        call_result = self._projects_locations_private_connections_routes_delete(opt, dry_run, &mut err).await;
                    },
                    ("locations-private-connections-routes-get", Some(opt)) => {
                        call_result = self._projects_locations_private_connections_routes_get(opt, dry_run, &mut err).await;
                    },
                    ("locations-private-connections-routes-list", Some(opt)) => {
                        call_result = self._projects_locations_private_connections_routes_list(opt, dry_run, &mut err).await;
                    },
                    ("locations-streams-create", Some(opt)) => {
                        call_result = self._projects_locations_streams_create(opt, dry_run, &mut err).await;
                    },
                    ("locations-streams-delete", Some(opt)) => {
                        call_result = self._projects_locations_streams_delete(opt, dry_run, &mut err).await;
                    },
                    ("locations-streams-get", Some(opt)) => {
                        call_result = self._projects_locations_streams_get(opt, dry_run, &mut err).await;
                    },
                    ("locations-streams-list", Some(opt)) => {
                        call_result = self._projects_locations_streams_list(opt, dry_run, &mut err).await;
                    },
                    ("locations-streams-objects-get", Some(opt)) => {
                        call_result = self._projects_locations_streams_objects_get(opt, dry_run, &mut err).await;
                    },
                    ("locations-streams-objects-list", Some(opt)) => {
                        call_result = self._projects_locations_streams_objects_list(opt, dry_run, &mut err).await;
                    },
                    ("locations-streams-objects-lookup", Some(opt)) => {
                        call_result = self._projects_locations_streams_objects_lookup(opt, dry_run, &mut err).await;
                    },
                    ("locations-streams-objects-start-backfill-job", Some(opt)) => {
                        call_result = self._projects_locations_streams_objects_start_backfill_job(opt, dry_run, &mut err).await;
                    },
                    ("locations-streams-objects-stop-backfill-job", Some(opt)) => {
                        call_result = self._projects_locations_streams_objects_stop_backfill_job(opt, dry_run, &mut err).await;
                    },
    ...
    async fn new(opt: ArgMatches<'n>, connector: S) -> Result<Engine<'n, S>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "datastream1-secret.json",
