...
//! This documentation was generated from *spectrum* crate version *1.0.11+20170306*, where *20170306* is the exact revision of the *spectrum:v1explorer* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.11*.
//! 
