...
//! This documentation was generated from *spectrum* crate version *5.0.2-beta-1+20170306*, where *20170306* is the exact revision of the *spectrum:v1explorer* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2-beta-1*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/spectrum1_explorer).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](Spectrum) ... 
//! 
//! * paws
//!  * [*get spectrum*](api::PawGetSpectrumCall), [*get spectrum batch*](api::PawGetSpectrumBatchCall), [*init*](api::PawInitCall), [*notify spectrum use*](api::PawNotifySpectrumUseCall), [*register*](api::PawRegisterCall) and [*verify device*](api::PawVerifyDeviceCall)
//! 
//! 
//! 
//! 
