...
impl<C> common::Hub for Spectrum<C> {}

impl<'a, C> Spectrum<C> {
    pub fn new<A: 'static + common::GetToken>(client: common::Client<C>, auth: A) -> Spectrum<C> {
        Spectrum {
            client,
            auth: Box::new(auth),
    ...
    pub fn paws(&'a self) -> PawMethods<'a, C> {
        PawMethods { hub: self }
    }
...
impl common::Part for AntennaCharacteristics {}
...
impl common::Part for DatabaseSpec {}
...
impl common::Part for DbUpdateSpec {}
...
impl common::Part for DeviceCapabilities {}
...
impl common::Part for DeviceDescriptor {}
...
impl common::Part for DeviceOwner {}
...
impl common::Part for DeviceValidity {}
...
impl common::Part for EventTime {}
...
impl common::Part for FrequencyRange {}
...
impl common::Part for GeoLocationEllipse {}
...
impl common::Part for GeoLocationPoint {}
...
impl common::Part for GeoLocationPolygon {}
...
impl common::Part for GeoSpectrumSchedule {}
...
impl common::RequestValue for PawsGetSpectrumBatchRequest {}
...
impl common::ResponseResult for PawsGetSpectrumBatchResponse {}
...
impl common::RequestValue for PawsGetSpectrumRequest {}
...
impl common::ResponseResult for PawsGetSpectrumResponse {}
...
impl common::RequestValue for PawsInitRequest {}
...
impl common::ResponseResult for PawsInitResponse {}
...
impl common::RequestValue for PawsNotifySpectrumUseRequest {}
...
impl common::ResponseResult for PawsNotifySpectrumUseResponse {}
...
impl common::RequestValue for PawsRegisterRequest {}
...
impl common::ResponseResult for PawsRegisterResponse {}
...
impl common::RequestValue for PawsVerifyDeviceRequest {}
...
impl common::ResponseResult for PawsVerifyDeviceResponse {}
...
impl common::Part for RulesetInfo {}
...
impl common::Part for SpectrumMessage {}
...
impl common::Part for SpectrumSchedule {}
...
impl common::Part for VcardAddress {}
...
impl common::Part for VcardTelephone {}
...
impl common::Part for VcardTypedText {}
...
impl<'a, C> common::MethodsBuilder for PawMethods<'a, C> {}

impl<'a, C> PawMethods<'a, C> {
    ...
    pub fn get_spectrum(&self, request: PawsGetSpectrumRequest) -> PawGetSpectrumCall<'a, C> {
        PawGetSpectrumCall {
            hub: self.hub,
            _request: request,
    ...
    ///
    /// * `request` - No description provided.
    pub fn init(&self, request: PawsInitRequest) -> PawInitCall<'a, C> {
        PawInitCall {
            hub: self.hub,
            _request: request,
            _delegate: Default::default(),
    ...
    ///
    /// * `request` - No description provided.
    pub fn register(&self, request: PawsRegisterRequest) -> PawRegisterCall<'a, C> {
        PawRegisterCall {
            hub: self.hub,
            _request: request,
            _delegate: Default::default(),
    ...
    ///
    /// * `request` - No description provided.
    pub fn verify_device(&self, request: PawsVerifyDeviceRequest) -> PawVerifyDeviceCall<'a, C> {
        PawVerifyDeviceCall {
            hub: self.hub,
            _request: request,
            _delegate: Default::default(),
...
/// # }
/// ```
pub struct PawGetSpectrumCall<'a, C>
where
    C: 'a,
{
    hub: &'a Spectrum<C>,
...
impl<'a, C> common::CallBuilder for PawGetSpectrumCall<'a, C> {}

impl<'a, C> PawGetSpectrumCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, PawsGetSpectrumResponse)> {
        use std::borrow::Cow;
    ...
    pub fn request(mut self, new_value: PawsGetSpectrumRequest) -> PawGetSpectrumCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> PawGetSpectrumCall<'a, C>
    where
        T: AsRef<str>,
    {
...
/// # }
/// ```
pub struct PawGetSpectrumBatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a Spectrum<C>,
...
impl<'a, C> common::CallBuilder for PawGetSpectrumBatchCall<'a, C> {}

impl<'a, C> PawGetSpectrumBatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, PawsGetSpectrumBatchResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: PawsGetSpectrumBatchRequest,
    ) -> PawGetSpectrumBatchCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// * *quotaUser* (query-string) - Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
    /// * *userIp* (query-string) - IP address of the site where the request originates. Use this if you want to enforce per-user limits.
    pub fn param<T>(mut self, name: T, value: T) -> PawGetSpectrumBatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
impl<'a, C> common::CallBuilder for PawInitCall<'a, C> {}

impl<'a, C> PawInitCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, PawsInitResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: PawsInitRequest) -> PawInitCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> PawInitCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
    /// * *userIp* (query-string) - IP address of the site where the request originates. Use this if you want to enforce per-user limits.
    pub fn param<T>(mut self, name: T, value: T) -> PawInitCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PawNotifySpectrumUseCall<'a, C>
where
    C: 'a,
{
    hub: &'a Spectrum<C>,
...
impl<'a, C> common::CallBuilder for PawNotifySpectrumUseCall<'a, C> {}

impl<'a, C> PawNotifySpectrumUseCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, PawsNotifySpectrumUseResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: PawsNotifySpectrumUseRequest,
    ) -> PawNotifySpectrumUseCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// * *quotaUser* (query-string) - Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
    /// * *userIp* (query-string) - IP address of the site where the request originates. Use this if you want to enforce per-user limits.
    pub fn param<T>(mut self, name: T, value: T) -> PawNotifySpectrumUseCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PawRegisterCall<'a, C>
where
    C: 'a,
{
    hub: &'a Spectrum<C>,
...
impl<'a, C> common::CallBuilder for PawRegisterCall<'a, C> {}

impl<'a, C> PawRegisterCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, PawsRegisterResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: PawsRegisterRequest) -> PawRegisterCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> PawRegisterCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
    /// * *userIp* (query-string) - IP address of the site where the request originates. Use this if you want to enforce per-user limits.
    pub fn param<T>(mut self, name: T, value: T) -> PawRegisterCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PawVerifyDeviceCall<'a, C>
where
    C: 'a,
{
    hub: &'a Spectrum<C>,
...
impl<'a, C> common::CallBuilder for PawVerifyDeviceCall<'a, C> {}

impl<'a, C> PawVerifyDeviceCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, PawsVerifyDeviceResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: PawsVerifyDeviceRequest) -> PawVerifyDeviceCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
    /// * *userIp* (query-string) - IP address of the site where the request originates. Use this if you want to enforce per-user limits.
    pub fn param<T>(mut self, name: T, value: T) -> PawVerifyDeviceCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
