...
impl Engine {
    fn _relyingparty_create_auth_uri(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::IdentitytoolkitRelyingpartyCreateAuthUriRequest = Default::default();
    ...
    fn _relyingparty_delete_account(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::IdentitytoolkitRelyingpartyDeleteAccountRequest = Default::default();
    ...
    fn _relyingparty_download_account(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::IdentitytoolkitRelyingpartyDownloadAccountRequest = Default::default();
    ...
    fn _relyingparty_get_account_info(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::IdentitytoolkitRelyingpartyGetAccountInfoRequest = Default::default();
    ...
    fn _relyingparty_get_oob_confirmation_code(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::Relyingparty = Default::default();
    ...
    fn _relyingparty_reset_password(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::IdentitytoolkitRelyingpartyResetPasswordRequest = Default::default();
    ...
    fn _relyingparty_set_account_info(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::IdentitytoolkitRelyingpartySetAccountInfoRequest = Default::default();
    ...
    fn _relyingparty_upload_account(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::IdentitytoolkitRelyingpartyUploadAccountRequest = Default::default();
    ...
    fn _relyingparty_verify_assertion(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::IdentitytoolkitRelyingpartyVerifyAssertionRequest = Default::default();
    ...
    fn _relyingparty_verify_password(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::IdentitytoolkitRelyingpartyVerifyPasswordRequest = Default::default();
    ...
    fn new(opt: Options) -> Result<Engine, InvalidOptionsError> {
        ...
        let engine = Engine {
            opt: opt,
            hub: api::IdentityToolkit::new(hyper::Client::new(), auth),
        };
