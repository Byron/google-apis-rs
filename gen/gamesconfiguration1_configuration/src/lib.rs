...
//! This documentation was generated from *Games Configuration* crate version *0.1.11+20160224*, where *20160224* is the exact revision of the *gamesConfiguration:v1configuration* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.11*.
//! 
