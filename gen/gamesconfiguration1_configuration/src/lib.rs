...
//! This documentation was generated from *Games Configuration* crate version *0.1.11+20160126*, where *20160126* is the exact revision of the *gamesConfiguration:v1configuration* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.11*.
//! 
