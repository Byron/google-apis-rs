...
impl<C> common::Hub for GamesConfiguration<C> {}

impl<'a, C> GamesConfiguration<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> GamesConfiguration<C> {
        GamesConfiguration {
            client,
            auth: Box::new(auth),
...
impl common::RequestValue for AchievementConfiguration {}
impl common::Resource for AchievementConfiguration {}
impl common::ResponseResult for AchievementConfiguration {}
...
impl common::Part for AchievementConfigurationDetail {}
...
impl common::ResponseResult for AchievementConfigurationListResponse {}
...
impl common::Part for GamesNumberAffixConfiguration {}
...
impl common::Part for GamesNumberFormatConfiguration {}
...
impl common::RequestValue for LeaderboardConfiguration {}
impl common::Resource for LeaderboardConfiguration {}
impl common::ResponseResult for LeaderboardConfiguration {}
...
impl common::Part for LeaderboardConfigurationDetail {}
...
impl common::ResponseResult for LeaderboardConfigurationListResponse {}
...
impl common::Part for LocalizedStringBundle {}
...
impl<'a, C> common::MethodsBuilder for AchievementConfigurationMethods<'a, C> {}
...
impl<'a, C> AchievementConfigurationMethods<'a, C> {
    ...
    pub fn insert(
        ...
        application_id: &str,
    ) -> AchievementConfigurationInsertCall<'a, C> {
    ...
    pub fn update(
        ...
        request: AchievementConfiguration,
        achievement_id: &str,
    ) -> AchievementConfigurationUpdateCall<'a, C> {
...
impl<'a, C> common::MethodsBuilder for LeaderboardConfigurationMethods<'a, C> {}
...
impl<'a, C> LeaderboardConfigurationMethods<'a, C> {
    ...
    pub fn insert(
        ...
        application_id: &str,
    ) -> LeaderboardConfigurationInsertCall<'a, C> {
    ...
    pub fn update(
        ...
        request: LeaderboardConfiguration,
        leaderboard_id: &str,
    ) -> LeaderboardConfigurationUpdateCall<'a, C> {
...
impl<'a, C> common::CallBuilder for AchievementConfigurationDeleteCall<'a, C> {}

impl<'a, C> AchievementConfigurationDeleteCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<common::Response> {
        ...
        let mut url =
            self.hub._base_url.clone() + "games/v1configuration/achievements/{achievementId}";
    ...
    ) -> AchievementConfigurationDeleteCall<'a, C> {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> AchievementConfigurationDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AchievementConfigurationDeleteCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> AchievementConfigurationDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for AchievementConfigurationGetCall<'a, C> {}

impl<'a, C> AchievementConfigurationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, AchievementConfiguration)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> AchievementConfigurationGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AchievementConfigurationGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AchievementConfigurationGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AchievementConfigurationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for AchievementConfigurationInsertCall<'a, C> {}

impl<'a, C> AchievementConfigurationInsertCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: AchievementConfiguration,
    ) -> AchievementConfigurationInsertCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AchievementConfigurationInsertCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AchievementConfigurationInsertCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AchievementConfigurationInsertCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for AchievementConfigurationListCall<'a, C> {}

impl<'a, C> AchievementConfigurationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, AchievementConfigurationListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> AchievementConfigurationListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AchievementConfigurationListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AchievementConfigurationListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AchievementConfigurationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for AchievementConfigurationUpdateCall<'a, C> {}

impl<'a, C> AchievementConfigurationUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AchievementConfigurationUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AchievementConfigurationUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AchievementConfigurationUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for LeaderboardConfigurationDeleteCall<'a, C> {}

impl<'a, C> LeaderboardConfigurationDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<common::Response> {
        ...
        let mut url =
            self.hub._base_url.clone() + "games/v1configuration/leaderboards/{leaderboardId}";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::Androidpublisher.as_ref().to_string());
        }
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> LeaderboardConfigurationDeleteCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> LeaderboardConfigurationDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> LeaderboardConfigurationDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> LeaderboardConfigurationDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for LeaderboardConfigurationGetCall<'a, C> {}

impl<'a, C> LeaderboardConfigurationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, LeaderboardConfiguration)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> LeaderboardConfigurationGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> LeaderboardConfigurationGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> LeaderboardConfigurationGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> LeaderboardConfigurationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for LeaderboardConfigurationInsertCall<'a, C> {}

impl<'a, C> LeaderboardConfigurationInsertCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: LeaderboardConfiguration,
    ) -> LeaderboardConfigurationInsertCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> LeaderboardConfigurationInsertCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> LeaderboardConfigurationInsertCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> LeaderboardConfigurationInsertCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for LeaderboardConfigurationListCall<'a, C> {}

impl<'a, C> LeaderboardConfigurationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, LeaderboardConfigurationListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> LeaderboardConfigurationListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> LeaderboardConfigurationListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> LeaderboardConfigurationListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> LeaderboardConfigurationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for LeaderboardConfigurationUpdateCall<'a, C> {}

impl<'a, C> LeaderboardConfigurationUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> LeaderboardConfigurationUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> LeaderboardConfigurationUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> LeaderboardConfigurationUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
