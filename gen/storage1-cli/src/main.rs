...
impl Engine {
    ...
    fn _bucket_access_controls_insert(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::BucketAccessControl = Default::default();
        ...
        for kvarg in self.opt.arg_kv.iter() {
            ...
            match &field_name.to_string()[..] {
                ...
                "project-team.project-number" => {
                        ...
                        request.project_team.as_mut().unwrap().project_number = value.unwrap_or("").to_string();
                    },
                "project-team.team" => {
                        request_project_team_init(&mut request);
                        request.project_team.as_mut().unwrap().team = value.unwrap_or("").to_string();
                    },
                "email" => {
                        request_project_team_init(&mut request);
    ...
    fn _buckets_insert(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::Bucket = Default::default();
        ...
        for kvarg in self.opt.arg_kv.iter() {
            ...
            match &field_name.to_string()[..] {
                "website.not-found-page" => {
                        ...
                        request.website.as_mut().unwrap().not_found_page = value.unwrap_or("").to_string();
                    },
                "website.main-page-suffix" => {
                        request_website_init(&mut request);
                        request.website.as_mut().unwrap().main_page_suffix = value.unwrap_or("").to_string();
                    },
                "self-link" => {
                        request_website_init(&mut request);
                        request.self_link = Some(value.unwrap_or("").to_string());
                ...
                "logging.log-object-prefix" => {
                        ...
                        request.logging.as_mut().unwrap().log_object_prefix = value.unwrap_or("").to_string();
                    },
                "logging.log-bucket" => {
                        request_logging_init(&mut request);
                        request.logging.as_mut().unwrap().log_bucket = value.unwrap_or("").to_string();
                    },
                "name" => {
                        request_logging_init(&mut request);
                ...
                "owner.entity-id" => {
                        ...
                        request.owner.as_mut().unwrap().entity_id = value.unwrap_or("").to_string();
                    },
                "owner.entity" => {
                        request_owner_init(&mut request);
                        request.owner.as_mut().unwrap().entity = value.unwrap_or("").to_string();
                    },
                "id" => {
                        request_owner_init(&mut request);
                        request.id = Some(value.unwrap_or("").to_string());
                ...
                "versioning.enabled" => {
                        ...
                        request.versioning.as_mut().unwrap().enabled = arg_from_str(value.unwrap_or("false"), err, "versioning.enabled", "boolean");
                    },
                "storage-class" => {
                        request_versioning_init(&mut request);
    ...
    fn _default_object_access_controls_insert(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::ObjectAccessControl = Default::default();
    ...
    fn _objects_compose(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::ComposeRequest = Default::default();
        ...
        for parg in self.opt.arg_v.iter() {
            ...
            match key {
                ...
                "encryption-key-hash" => {
                    call = call.encryption_key_hash(value.unwrap_or(""));
                },
                "encryption-key" => {
                    call = call.encryption_key(value.unwrap_or(""));
                },
                "encryption-algorithm" => {
                    call = call.encryption_algorithm(value.unwrap_or(""));
                },
        ...
        for kvarg in self.opt.arg_kv.iter() {
            ...
            match &field_name.to_string()[..] {
                ...
                "destination.owner.entity-id" => {
                        ...
                        request.destination.as_mut().unwrap().owner.as_mut().unwrap().entity_id = value.unwrap_or("").to_string();
                    },
                "destination.owner.entity" => {
                        request_destination_owner_init(&mut request);
                        request.destination.as_mut().unwrap().owner.as_mut().unwrap().entity = value.unwrap_or("").to_string();
                    },
                ...
                "destination.metadata" => {
                        ...
                        request.destination.as_mut().unwrap().metadata.as_mut().unwrap().push(value.unwrap_or("").to_string());
                    },
                "destination.updated" => {
                        request_destination_owner_init(&mut request);
    ...
    fn _objects_copy(&self, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Option<api::Error> {
            let mut request: api::Object = Default::default();
        let mut download_mode = false;
        ...
        for kvarg in self.opt.arg_kv.iter() {
            ...
            match &field_name.to_string()[..] {
                ...
                "metadata" => {
                        ...
                        request.metadata.as_mut().unwrap().push(value.unwrap_or("").to_string());
                    },
                "updated" => {
                        request_owner_init(&mut request);
    ...
    fn new(opt: Options) -> Result<Engine, InvalidOptionsError> {
        ...
        let engine = Engine {
            opt: opt,
            hub: api::Storage::new(hyper::Client::new(), auth),
        };
