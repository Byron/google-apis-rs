...
use google_storage1::{api, yup_oauth2, Error};
...
{
    async fn _anywhere_caches_disable(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.anywhere_caches().disable(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("anywhere-cache-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _anywhere_caches_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.anywhere_caches().get(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("anywhere-cache-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _anywhere_caches_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AnywhereCache = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .anywhere_caches()
            .insert(request, opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _anywhere_caches_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .anywhere_caches()
            .list(opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _anywhere_caches_pause(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.anywhere_caches().pause(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("anywhere-cache-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _anywhere_caches_resume(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.anywhere_caches().resume(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("anywhere-cache-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _anywhere_caches_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AnywhereCache = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.anywhere_caches().update(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("anywhere-cache-id").unwrap_or(""),
        );
    ...
    async fn _bucket_access_controls_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.bucket_access_controls().delete(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("entity").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _bucket_access_controls_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.bucket_access_controls().get(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("entity").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _bucket_access_controls_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "project-team.project-number" => Some((
        ...
        let mut request: api::BucketAccessControl = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
    ...
    async fn _bucket_access_controls_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _bucket_access_controls_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BucketAccessControl = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.bucket_access_controls().patch(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("entity").unwrap_or(""),
        );
    ...
    async fn _bucket_access_controls_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BucketAccessControl = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.bucket_access_controls().update(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("entity").unwrap_or(""),
        );
    ...
    async fn _buckets_delete(
        ...
        let mut call = self
            .hub
            .buckets()
            .delete(opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _buckets_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .buckets()
            .get_iam_policy(opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["options-requested-policy-version", "user-project"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _buckets_get_storage_layout(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .buckets()
            .get_storage_layout(opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _buckets_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "autoclass.terminal-storage-class" => Some((
                ...
                "autoclass.terminal-storage-class-update-time" => Some((
                ...
                "custom-placement-config.data-locations" => Some((
                ...
                "hierarchical-namespace.enabled" => Some((
                ...
                "iam-configuration.bucket-policy-only.enabled" => Some((
                ...
                "iam-configuration.bucket-policy-only.locked-time" => Some((
                ...
                "iam-configuration.public-access-prevention" => Some((
                ...
                "iam-configuration.uniform-bucket-level-access.enabled" => Some((
                ...
                "iam-configuration.uniform-bucket-level-access.locked-time" => Some((
                ...
                "logging.log-object-prefix" => Some((
                ...
                "retention-policy.effective-time" => Some((
                ...
                "retention-policy.is-locked" => Some((
                ...
                "retention-policy.retention-period" => Some((
                ...
                "soft-delete-policy.effective-time" => Some((
        ...
        let mut request: api::Bucket = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .buckets()
            ...
            .iter()
        {
            ...
            match key {
                ...
                "enable-object-retention" => {
                    call = call.enable_object_retention(
                        value
                            .map(|v| arg_from_str(v, err, "enable-object-retention", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _buckets_lock_retention_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _buckets_operations_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.buckets().operations_cancel(
            opt.value_of("bucket").unwrap_or(""),
    ...
    async fn _buckets_operations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.buckets().operations_get(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("operation-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _buckets_operations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .buckets()
            .operations_list(opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _buckets_patch(
        ...
        let mut call = self
            .hub
            .buckets()
            .patch(request, opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _buckets_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["etag", "kind", "resource-id", "version"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut call = self
            .hub
            .buckets()
            .set_iam_policy(request, opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _buckets_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.buckets().test_iam_permissions(
            opt.value_of("bucket").unwrap_or(""),
            &opt.values_of("permissions")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
                .map(|&v| v.to_string())
    ...
    async fn _buckets_update(
        ...
        let mut call = self
            .hub
            .buckets()
            .update(request, opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _default_object_access_controls_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.default_object_access_controls().delete(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("entity").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _default_object_access_controls_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.default_object_access_controls().get(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("entity").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _default_object_access_controls_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ObjectAccessControl = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
    ...
    async fn _default_object_access_controls_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _default_object_access_controls_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _default_object_access_controls_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ObjectAccessControl = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.default_object_access_controls().update(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("entity").unwrap_or(""),
        );
    ...
    async fn _folders_delete(
        ...
        let mut call = self.hub.folders().delete(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("folder").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["if-metageneration-match", "if-metageneration-not-match"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _folders_get(
        ...
        let mut call = self.hub.folders().get(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("folder").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _folders_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "pending-rename-info.operation-id" => Some((
                    "pendingRenameInfo.operationId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
    ...
    async fn _folders_rename(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.folders().rename(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("source-folder").unwrap_or(""),
            opt.value_of("destination-folder").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _managed_folders_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.managed_folders().delete(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("managed-folder").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            ...
            .iter()
        {
            ...
            match key {
                ...
                "allow-non-empty" => {
                    call = call.allow_non_empty(
                        value
                            .map(|v| arg_from_str(v, err, "allow-non-empty", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _managed_folders_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.managed_folders().get(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("managed-folder").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _managed_folders_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.managed_folders().get_iam_policy(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("managed-folder").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _managed_folders_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ManagedFolder = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .managed_folders()
            .insert(request, opt.value_of("bucket").unwrap_or(""));
    ...
    async fn _managed_folders_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _managed_folders_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Policy = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.managed_folders().set_iam_policy(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("managed-folder").unwrap_or(""),
        );
    ...
    async fn _managed_folders_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.managed_folders().test_iam_permissions(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("managed-folder").unwrap_or(""),
            &opt.values_of("permissions")
                .map(|i| i.collect())
    ...
    async fn _notifications_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.notifications().delete(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("notification").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _notifications_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.notifications().get(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("notification").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _notifications_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Notification = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .notifications()
            .insert(request, opt.value_of("bucket").unwrap_or(""));
    ...
    async fn _object_access_controls_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.object_access_controls().delete(
            opt.value_of("bucket").unwrap_or(""),
    ...
    async fn _object_access_controls_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.object_access_controls().get(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
            opt.value_of("entity").unwrap_or(""),
        );
    ...
    async fn _object_access_controls_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ObjectAccessControl = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.object_access_controls().insert(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
        );
    ...
    async fn _object_access_controls_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.object_access_controls().list(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _object_access_controls_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ObjectAccessControl = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.object_access_controls().patch(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
            opt.value_of("entity").unwrap_or(""),
    ...
    async fn _object_access_controls_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ObjectAccessControl = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.object_access_controls().update(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
            opt.value_of("entity").unwrap_or(""),
    ...
    async fn _objects_bulk_restore(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BulkRestoreObjectsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .objects()
            .bulk_restore(request, opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _objects_compose(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "destination.cache-control" => Some((
                ...
                "destination.component-count" => Some((
                ...
                "destination.content-disposition" => Some((
                ...
                "destination.content-encoding" => Some((
                ...
                "destination.content-language" => Some((
                ...
                "destination.custom-time" => Some((
                    "destination.customTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "destination.customer-encryption.encryption-algorithm" => Some((
                ...
                "destination.customer-encryption.key-sha256" => Some((
                ...
                "destination.event-based-hold" => Some((
                ...
                "destination.hard-delete-time" => Some((
                    "destination.hardDeleteTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "destination.metageneration" => Some((
                ...
                "destination.owner.entity-id" => Some((
                ...
                "destination.retention.retain-until-time" => Some((
                    "destination.retention.retainUntilTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "destination.retention-expiration-time" => Some((
                ...
                "destination.soft-delete-time" => Some((
                    "destination.softDeleteTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "destination.storage-class" => Some((
                ...
                "destination.temporary-hold" => Some((
        ...
        let mut request: api::ComposeRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.objects().compose(
            request,
            opt.value_of("destination-bucket").unwrap_or(""),
    ...
    async fn _objects_copy(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "customer-encryption.encryption-algorithm" => Some((
                ...
                "customer-encryption.key-sha256" => Some((
                ...
                "retention.retain-until-time" => Some((
                ...
                "retention-expiration-time" => Some((
        ...
        let mut request: api::Object = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.objects().copy(
            request,
            opt.value_of("source-bucket").unwrap_or(""),
            ...
            .iter()
        {
            ...
            match key {
                ...
                "source-generation" => {
                    call = call.source_generation(
                        value
                            .map(|v| arg_from_str(v, err, "source-generation", "int64"))
                            .unwrap_or(-0),
                    );
                }
                "projection" => {
    ...
    async fn _objects_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.objects().delete(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _objects_get(
        ...
        let mut call = self.hub.objects().get(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _objects_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.objects().get_iam_policy(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
        );
        for parg in opt
            ...
            .iter()
        {
            ...
            match key {
                "versions" => {
                    call = call.versions(
                        value
                            .map(|v| arg_from_str(v, err, "versions", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "user-project" => {
                ...
                "include-trailing-delimiter" => {
                    call = call.include_trailing_delimiter(
                        value
                            .map(|v| arg_from_str(v, err, "include-trailing-delimiter", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "include-folders-as-prefixes" => {
                    call = call.include_folders_as_prefixes(
                        value
                            .map(|v| arg_from_str(v, err, "include-folders-as-prefixes", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "end-offset" => {
    ...
    async fn _objects_patch(
        ...
        let mut request: api::Object = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.objects().patch(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
        );
            ...
            .iter()
        {
            ...
            match key {
                ...
                "override-unlocked-retention" => {
                    call = call.override_unlocked_retention(
                        value
                            .map(|v| arg_from_str(v, err, "override-unlocked-retention", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "if-metageneration-not-match" => {
    ...
    async fn _objects_restore(
            ...
            .iter()
        {
            ...
            match key {
                ...
                "copy-source-acl" => {
                    call = call.copy_source_acl(
                        value
                            .map(|v| arg_from_str(v, err, "copy-source-acl", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _objects_rewrite(
        ...
        let mut request: api::Object = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.objects().rewrite(
            request,
            opt.value_of("source-bucket").unwrap_or(""),
            opt.value_of("source-object").unwrap_or(""),
            opt.value_of("destination-bucket").unwrap_or(""),
            ...
            .iter()
        {
            ...
            match key {
                ...
                "max-bytes-rewritten-per-call" => {
                    call = call.max_bytes_rewritten_per_call(
                        value
                            .map(|v| arg_from_str(v, err, "max-bytes-rewritten-per-call", "int64"))
                            .unwrap_or(-0),
                    );
                }
                "if-source-metageneration-not-match" => {
    ...
    async fn _objects_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Policy = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.objects().set_iam_policy(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
        );
    ...
    async fn _objects_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.objects().test_iam_permissions(
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
            &opt.values_of("permissions")
                .map(|i| i.collect())
    ...
    async fn _objects_update(
        ...
        let mut request: api::Object = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.objects().update(
            request,
            opt.value_of("bucket").unwrap_or(""),
            opt.value_of("object").unwrap_or(""),
        );
    ...
    async fn _objects_watch_all(
        ...
        let mut call = self
            .hub
            .objects()
            .watch_all(request, opt.value_of("bucket").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_hmac_keys_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().hmac_keys_create(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("service-account-email").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_hmac_keys_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().hmac_keys_delete(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("access-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_hmac_keys_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().hmac_keys_get(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("access-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_hmac_keys_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .hmac_keys_list(opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "show-deleted-keys" => {
                    call = call.show_deleted_keys(
                        value
                            .map(|v| arg_from_str(v, err, "show-deleted-keys", "boolean"))
                            .unwrap_or(false),
                    );
                }
    ...
    async fn _projects_hmac_keys_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::HmacKeyMetadata = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().hmac_keys_update(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("access-id").unwrap_or(""),
        );
    ...
    async fn _projects_service_account_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .service_account_get(opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("anywhere-caches", Some(opt)) => match opt.subcommand() {
                ("disable", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("anywhere-caches".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("bucket-access-controls", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                    call_result = self
                        ._bucket_access_controls_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                    call_result = self
                        ._bucket_access_controls_get(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                    call_result = self
                        ._bucket_access_controls_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                    call_result = self
                        ._bucket_access_controls_list(opt, dry_run, &mut err)
                        .await;
                }
                ("patch", Some(opt)) => {
                    call_result = self
                        ._bucket_access_controls_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                    call_result = self
                        ._bucket_access_controls_update(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "bucket-access-controls".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("buckets", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                ("get-storage-layout", Some(opt)) => {
                    call_result = self
                        ._buckets_get_storage_layout(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                ...
                ("test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._buckets_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("buckets".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("default-object-access-controls", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                    call_result = self
                        ._default_object_access_controls_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                    call_result = self
                        ._default_object_access_controls_get(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                    call_result = self
                        ._default_object_access_controls_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                    call_result = self
                        ._default_object_access_controls_list(opt, dry_run, &mut err)
                        .await;
                }
                ("patch", Some(opt)) => {
                    call_result = self
                        ._default_object_access_controls_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                    call_result = self
                        ._default_object_access_controls_update(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "default-object-access-controls".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("managed-folders", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                ("get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._managed_folders_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                ...
                ("set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._managed_folders_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._managed_folders_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("managed-folders".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("notifications", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("notifications".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("object-access-controls", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                    call_result = self
                        ._object_access_controls_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                    call_result = self
                        ._object_access_controls_get(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                    call_result = self
                        ._object_access_controls_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                    call_result = self
                        ._object_access_controls_list(opt, dry_run, &mut err)
                        .await;
                }
                ("patch", Some(opt)) => {
                    call_result = self
                        ._object_access_controls_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                    call_result = self
                        ._object_access_controls_update(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "object-access-controls".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("objects", Some(opt)) => match opt.subcommand() {
                ...
                ("test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._objects_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("objects".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("projects", Some(opt)) => match opt.subcommand() {
                ("hmac-keys-create", Some(opt)) => {
                    call_result = self
                        ._projects_hmac_keys_create(opt, dry_run, &mut err)
                        .await;
                }
                ("hmac-keys-delete", Some(opt)) => {
                    call_result = self
                        ._projects_hmac_keys_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("hmac-keys-update", Some(opt)) => {
                    call_result = self
                        ._projects_hmac_keys_update(opt, dry_run, &mut err)
                        .await;
                }
                ("service-account-get", Some(opt)) => {
                    call_result = self
                        ._projects_service_account_get(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "storage1-secret.json",
