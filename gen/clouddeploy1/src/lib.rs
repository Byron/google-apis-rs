...
//! This documentation was generated from *Cloud Deploy* crate version *5.0.5+20240614*, where *20240614* is the exact revision of the *clouddeploy:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.5*.
//! 
