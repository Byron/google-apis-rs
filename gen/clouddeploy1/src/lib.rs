...
//! This documentation was generated from *Cloud Deploy* crate version *7.0.0+20251203*, where *20251203* is the exact revision of the *clouddeploy:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
...
//! let r = hub.projects().locations_deploy_policies_create(...).doit().await
//! let r = hub.projects().locations_deploy_policies_delete(...).doit().await
//! let r = hub.projects().locations_deploy_policies_patch(...).doit().await
...
//!              .validate_only(true)
//!              .starting_phase_id("amet.")
//!              .rollout_id("duo")
//!              .request_id("ipsum")
//!              .add_override_deploy_policy("gubergren")
//!              .doit().await;
//!
//! match result {
//!     Err(e) => match e {
