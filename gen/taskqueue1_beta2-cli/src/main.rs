...
use google_taskqueue1_beta2::{api, Error};
...
impl<'n> Engine<'n> {
    async fn _taskqueues_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _tasks_lease(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        match self.opt.subcommand() {
            ("taskqueues", Some(opt)) => {
                match opt.subcommand() {
                    ("get", Some(opt)) => {
                        call_result = self._taskqueues_get(opt, dry_run, &mut err).await;
                    },
                    _ => {
                        err.issues.push(CLIError::MissingMethodError("taskqueues".to_string()));
                        writeln!(io::stderr(), "{}\n", opt.usage()).ok();
                    }
                }
            },
            ("tasks", Some(opt)) => {
                match opt.subcommand() {
                    ...
                    ("lease", Some(opt)) => {
                        call_result = self._tasks_lease(opt, dry_run, &mut err).await;
                    },
                    ("list", Some(opt)) => {
    ...
    async fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "taskqueue1-beta2-secret.json",
        ...
        ).persist_tokens_to_disk(format!("{}/taskqueue1-beta2", config_dir)).build().await.unwrap();
        ...
        ("taskqueues", "methods: 'get'", vec![
            ("get",
                  ...
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project under which the queue lies."##),
                     Some(true),
                     Some(false)),
        
                    (Some(r##"taskqueue"##),
                     None,
                     Some(r##"The id of the taskqueue to get the properties of."##),
                     Some(true),
                     Some(false)),
        ...
        ("tasks", "methods: 'delete', 'get', 'insert', 'lease', 'list', 'patch' and 'update'", vec![
            ("delete",
                  ...
                  vec![
                    ...
                    (Some(r##"taskqueue"##),
                     None,
                     Some(r##"The taskqueue to delete a task from."##),
                     Some(true),
                     Some(false)),
        
                    (Some(r##"task"##),
                     None,
                     Some(r##"The id of the task to delete."##),
                     Some(true),
                     Some(false)),
            ...
            ("get",
                  ...
                  vec![
                    ...
                    (Some(r##"taskqueue"##),
                     None,
                     Some(r##"The taskqueue in which the task belongs."##),
                     Some(true),
                     Some(false)),
        
                    (Some(r##"task"##),
                     None,
                     Some(r##"The task to get properties of."##),
                     Some(true),
                     Some(false)),
            ...
            ("insert",
                  ...
                  vec![
                    ...
                    (Some(r##"taskqueue"##),
                     None,
                     Some(r##"The taskqueue to insert the task into"##),
                     Some(true),
                     Some(false)),
            ...
            ("lease",
                  ...
                  vec![
                    ...
                    (Some(r##"taskqueue"##),
                     None,
                     Some(r##"The taskqueue to lease a task from."##),
                     Some(true),
                     Some(false)),
        
                    (Some(r##"num-tasks"##),
                     None,
                     Some(r##"The number of tasks to lease."##),
                     Some(true),
                     Some(false)),
        
                    (Some(r##"lease-secs"##),
                     None,
                     Some(r##"The lease in seconds."##),
                     Some(true),
                     Some(false)),
            ...
            ("list",
                  ...
                  vec![
                    ...
                    (Some(r##"taskqueue"##),
                     None,
                     Some(r##"The id of the taskqueue to list tasks from."##),
                     Some(true),
                     Some(false)),
            ...
            ("patch",
                  ...
                  vec![
                    ...
                    (Some(r##"new-lease-seconds"##),
                     None,
                     Some(r##"The new lease in seconds."##),
                     Some(true),
                     Some(false)),
