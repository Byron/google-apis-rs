...
extern crate mime;
extern crate strsim;
extern crate google_cloudscheduler1_beta1 as api;
...
impl<'n> Engine<'n> {
    ...
    fn _projects_locations_jobs_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_locations_jobs_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_locations_jobs_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_locations_jobs_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_locations_jobs_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_locations_jobs_pause(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_locations_jobs_resume(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _projects_locations_jobs_run(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
            ...
            ("projects", Some(opt)) => {
                match opt.subcommand() {
                    ...
                    ("locations-jobs-create", Some(opt)) => {
                        call_result = self._projects_locations_jobs_create(opt, dry_run, &mut err);
                    },
                    ("locations-jobs-delete", Some(opt)) => {
                        call_result = self._projects_locations_jobs_delete(opt, dry_run, &mut err);
                    },
                    ("locations-jobs-get", Some(opt)) => {
                        call_result = self._projects_locations_jobs_get(opt, dry_run, &mut err);
                    },
                    ("locations-jobs-list", Some(opt)) => {
                        call_result = self._projects_locations_jobs_list(opt, dry_run, &mut err);
                    },
                    ("locations-jobs-patch", Some(opt)) => {
                        call_result = self._projects_locations_jobs_patch(opt, dry_run, &mut err);
                    },
                    ("locations-jobs-pause", Some(opt)) => {
                        call_result = self._projects_locations_jobs_pause(opt, dry_run, &mut err);
                    },
                    ("locations-jobs-resume", Some(opt)) => {
                        call_result = self._projects_locations_jobs_resume(opt, dry_run, &mut err);
                    },
                    ("locations-jobs-run", Some(opt)) => {
                        call_result = self._projects_locations_jobs_run(opt, dry_run, &mut err);
                    },
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "cloudscheduler1-beta1-secret.json",
        ...
        let auth = Authenticator::new(  &secret, DefaultAuthenticatorDelegate,
                                        ...
                                        JsonTokenStorage {
                                          program_name: "cloudscheduler1-beta1",
    ...
    let arg_data = [
        ...
        until a successful response is received."##),
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Optionally caller-specified in CreateJob, after
        ...
        * `JOB_ID` can contain only letters ([A-Za-z]), numbers ([0-9]),
        ...
        `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`."##),
            ...
            ("locations-jobs-run",
                    Some(r##"Forces a job to run now.
