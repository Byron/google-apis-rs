    ...
    C: apis_common::Connector,
{
    ...
    async fn _projects_locations_delete_events(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delete_events(opt.value_of("project-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_events_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_events_list(opt.value_of("project-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_group_stats_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_group_stats_list(opt.value_of("project-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_groups_get(
        ...
        let mut call = self
            .hub
            .projects()
            .locations_groups_get(opt.value_of("group-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_groups_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_groups_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ...
                ("locations-delete-events", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delete_events(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-events-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_events_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-group-stats-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_group_stats_list(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-groups-update", Some(opt)) => {
                    call_result = self
                        ._projects_locations_groups_update(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'delete-events', 'events-list', 'events-report', 'group-stats-list', 'groups-get', 'groups-update', 'locations-delete-events', 'locations-events-list', 'locations-group-stats-list', 'locations-groups-get' and 'locations-groups-update'", vec![
            ("delete-events",
            ...
            ("locations-delete-events",
                    Some(r##"Deletes all error events of a given project."##),
                    "Details at http://byron.github.io/google-apis-rs/google_clouderrorreporting1_beta1_cli/projects_locations-delete-events",
                  vec![
                    (Some(r##"project-name"##),
                     None,
                     Some(r##"Required. The resource name of the Google Cloud Platform project. Written as `projects/{projectID}` or `projects/{projectID}/locations/{location}`, where `{projectID}` is the [Google Cloud Platform project ID](https://support.google.com/cloud/answer/6158840) and `{location}` is a Cloud region. Examples: `projects/my-project-123`, `projects/my-project-123/locations/global`. For a list of supported locations, see [Supported Regions](https://cloud.google.com/logging/docs/region-support). `global` is the default when unspecified."##),
            ...
            ("locations-events-list",
                    Some(r##"Lists the specified events."##),
                    "Details at http://byron.github.io/google-apis-rs/google_clouderrorreporting1_beta1_cli/projects_locations-events-list",
                  vec![
                    (Some(r##"project-name"##),
                     None,
                     Some(r##"Required. The resource name of the Google Cloud Platform project. Written as `projects/{projectID}` or `projects/{projectID}/locations/{location}`, where `{projectID}` is the [Google Cloud Platform project ID](https://support.google.com/cloud/answer/6158840) and `{location}` is a Cloud region. Examples: `projects/my-project-123`, `projects/my-project-123/locations/global`. For a list of supported locations, see [Supported Regions](https://cloud.google.com/logging/docs/region-support). `global` is the default when unspecified."##),
            ...
            ("locations-group-stats-list",
                    Some(r##"Lists the specified groups."##),
                    "Details at http://byron.github.io/google-apis-rs/google_clouderrorreporting1_beta1_cli/projects_locations-group-stats-list",
                  vec![
                    (Some(r##"project-name"##),
                     None,
                     Some(r##"Required. The resource name of the Google Cloud Platform project. Written as `projects/{projectID}` or `projects/{projectNumber}`, where `{projectID}` and `{projectNumber}` can be found in the [Google Cloud console](https://support.google.com/cloud/answer/6158840). It may also include a location, such as `projects/{projectID}/locations/{location}` where `{location}` is a cloud region. Examples: `projects/my-project-123`, `projects/5551234`, `projects/my-project-123/locations/us-central1`, `projects/5551234/locations/us-central1`. For a list of supported locations, see [Supported Regions](https://cloud.google.com/logging/docs/region-support). `global` is the default when unspecified. Use `-` as a wildcard to request group stats from all regions."##),
            ...
            ("locations-groups-get",
                    Some(r##"Get the specified group."##),
                    "Details at http://byron.github.io/google-apis-rs/google_clouderrorreporting1_beta1_cli/projects_locations-groups-get",
                  vec![
                    (Some(r##"group-name"##),
                     None,
                     Some(r##"Required. The group resource name. Written as either `projects/{projectID}/groups/{group_id}` or `projects/{projectID}/locations/{location}/groups/{group_id}`. Call groupStats.list to return a list of groups belonging to this project. Examples: `projects/my-project-123/groups/my-group`, `projects/my-project-123/locations/global/groups/my-group` In the group resource name, the `group_id` is a unique identifier for a particular error group. The identifier is derived from key parts of the error-log content and is treated as Service Data. For information about how Service Data is handled, see [Google Cloud Privacy Notice](https://cloud.google.com/terms/cloud-privacy-notice). For a list of supported locations, see [Supported Regions](https://cloud.google.com/logging/docs/region-support). `global` is the default when unspecified."##),
            ...
            ("locations-groups-update",
                    Some(r##"Replace the data for the specified group. Fails if the group does not exist."##),
                    "Details at http://byron.github.io/google-apis-rs/google_clouderrorreporting1_beta1_cli/projects_locations-groups-update",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The group resource name. Written as `projects/{projectID}/groups/{group_id}` or `projects/{projectID}/locations/{location}/groups/{group_id}` Examples: `projects/my-project-123/groups/my-group`, `projects/my-project-123/locations/us-central1/groups/my-group` In the group resource name, the `group_id` is a unique identifier for a particular error group. The identifier is derived from key parts of the error-log content and is treated as Service Data. For information about how Service Data is handled, see [Google Cloud Privacy Notice](https://cloud.google.com/terms/cloud-privacy-notice). For a list of supported locations, see [Supported Regions](https://cloud.google.com/logging/docs/region-support). `global` is the default when unspecified."##),
