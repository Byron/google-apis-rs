...
use google_reseller1_sandbox::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    async fn _customers_get(
        ...
        let mut call = self
            .hub
            .customers()
            .get(opt.value_of("customer-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _customers_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "postal-address.address-line1" => Some((
                ...
                "postal-address.address-line2" => Some((
                ...
                "postal-address.address-line3" => Some((
                ...
                "postal-address.contact-name" => Some((
                ...
                "postal-address.country-code" => Some((
                ...
                "postal-address.organization-name" => Some((
                ...
                "postal-address.postal-code" => Some((
        ...
        let mut request: api::Customer = serde_json::value::from_value(object).unwrap();
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["customer-auth-token"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _customers_patch(
        ...
        let mut call = self
            .hub
            .customers()
            .patch(request, opt.value_of("customer-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _customers_update(
        ...
        let mut call = self
            .hub
            .customers()
            .update(request, opt.value_of("customer-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _subscriptions_activate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.subscriptions().activate(
    ...
    async fn _subscriptions_change_plan(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "seats.licensed-number-of-seats" => Some((
                ...
                "seats.maximum-number-of-seats" => Some((
        ...
        let mut request: api::ChangePlanRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.subscriptions().change_plan(
            request,
            opt.value_of("customer-id").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
        );
    ...
    async fn _subscriptions_change_renewal_settings(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RenewalSettings = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.subscriptions().change_renewal_settings(
            request,
            opt.value_of("customer-id").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
        );
    ...
    async fn _subscriptions_change_seats(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Seats = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.subscriptions().change_seats(
            request,
            opt.value_of("customer-id").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
        );
    ...
    async fn _subscriptions_delete(
        ...
        let mut call = self.hub.subscriptions().delete(
            opt.value_of("customer-id").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
            opt.value_of("deletion-type").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _subscriptions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.subscriptions().get(
            opt.value_of("customer-id").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _subscriptions_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "plan.commitment-interval.end-time" => Some((
                ...
                "plan.commitment-interval.start-time" => Some((
                ...
                "renewal-settings.renewal-type" => Some((
                ...
                "transfer-info.minimum-transferable-seats" => Some((
                ...
                "transfer-info.transferability-expiration-time" => Some((
                ...
                "trial-settings.is-in-trial" => Some((
                ...
                "trial-settings.trial-end-time" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "suspension-reasons",
                            "transfer-info",
                            "transferability-expiration-time",
                            "trial-end-time",
                            "trial-settings",
                        ],
                    );
        ...
        let mut call = self
            .hub
            .subscriptions()
            .insert(request, opt.value_of("customer-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _subscriptions_start_paid_service(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.subscriptions().start_paid_service(
            opt.value_of("customer-id").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _subscriptions_suspend(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.subscriptions().suspend(
            opt.value_of("customer-id").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
        );
        for parg in opt
        ...
        match self.opt.subcommand() {
            ...
            ("subscriptions", Some(opt)) => match opt.subcommand() {
                ...
                ("change-plan", Some(opt)) => {
                    call_result = self
                        ._subscriptions_change_plan(opt, dry_run, &mut err)
                        .await;
                }
                ("change-renewal-settings", Some(opt)) => {
                    call_result = self
                        ._subscriptions_change_renewal_settings(opt, dry_run, &mut err)
                        .await;
                }
                ("change-seats", Some(opt)) => {
                    call_result = self
                        ._subscriptions_change_seats(opt, dry_run, &mut err)
                        .await;
                }
                ("delete", Some(opt)) => {
                ...
                ("start-paid-service", Some(opt)) => {
                    call_result = self
                        ._subscriptions_start_paid_service(opt, dry_run, &mut err)
                        .await;
                }
                ("suspend", Some(opt)) => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "reseller1-sandbox-secret.json",
