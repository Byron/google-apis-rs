...
//! This documentation was generated from *YouTube Reporting* crate version *0.1.14+20160315*, where *20160315* is the exact revision of the *youtubereporting:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.14*.
//! 
