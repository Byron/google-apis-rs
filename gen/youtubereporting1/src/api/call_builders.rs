...
pub struct JobReportListCall<'a, S>
   ...
   pub(super) hub: &'a YouTubeReporting<S>,
   pub(super) _job_id: String,
   pub(super) _start_time_before: Option<client::chrono::DateTime<client::chrono::offset::Utc>>,
   pub(super) _start_time_at_or_after: Option<client::chrono::DateTime<client::chrono::offset::Utc>>,
   pub(super) _page_token: Option<String>,
   pub(super) _page_size: Option<i32>,
   pub(super) _on_behalf_of_content_owner: Option<String>,
   pub(super) _created_after: Option<client::chrono::DateTime<client::chrono::offset::Utc>>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct JobListCall<'a, S>
   ...
   pub(super) _page_size: Option<i32>,
   pub(super) _on_behalf_of_content_owner: Option<String>,
   pub(super) _include_system_managed: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
