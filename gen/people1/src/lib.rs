...
//! This documentation was generated from *People Service* crate version *6.0.0+20240625*, where *20240625* is the exact revision of the *people:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
