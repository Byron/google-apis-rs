...
//! This documentation was generated from *People Service* crate version *1.0.11+20190702*, where *20190702* is the exact revision of the *people:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.11*.
//! 
