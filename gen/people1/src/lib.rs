...
//! This documentation was generated from *people* crate version *1.0.1+20160210*, where *20160210* is the exact revision of the *people:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.1*.
//! 
