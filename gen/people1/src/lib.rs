...
//! This documentation was generated from *people* crate version *1.0.4+20160210*, where *20160210* is the exact revision of the *people:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.4*.
//! 
...
/// Central instance to access all People related resource activities
///
/// # Examples
///
...
/// # }
/// ```
pub struct People<C, A> {
    client: RefCell<C>,
    auth: RefCell<A>,
    _user_agent: String,
}

impl<'a, C, A> Hub for People<C, A> {}

impl<'a, C, A> People<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> People<C, A> {
        People {
...
/// It is not used directly, but through the `People` hub.
///
/// # Example
///
...
impl<'a, C, A> PeopleMethods<'a, C, A> {
    ...
    /// # Arguments
    ///
    /// * `resourceName` - The resource name of the person to provide information about. - To get information about the authenticated user, specify `people/me`. - To get information about any user, specify the resource name that identifies the user, such as the resource names returned by [`people.connections.list`](/people/api/rest/v1/people.connections/list).
...
impl<'a, C, A> PeopleGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Person)> {
        ...
        let mut url = "https://people.googleapis.com/v1/{+resourceName}".to_string();
...
///              .sync_token("justo")
///              .sort_order("amet.")
///              .request_mask_include_field("erat")
///              .page_token("labore")
///              .page_size(-9)
///              .doit();
/// # }
...
impl<'a, C, A> PeopleConnectionListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListConnectionsResponse)> {
        ...
        for &field in ["alt", "resourceName", "syncToken", "sortOrder", "requestMask.includeField", "pageToken", "pageSize"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(Error::FieldClash(field));
            }
        ...
        let mut url = "https://people.googleapis.com/v1/{+resourceName}/connections".to_string();
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::ContactReadonly.as_ref().to_string(), ());
        }
...
impl<'a, C, A> PeopleGetBatchGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GetPeopleResponse)> {
        ...
        let mut url = "https://people.googleapis.com/v1/people:batchGet".to_string();
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::ContactReadonly.as_ref().to_string(), ());
        }
