...
//! This documentation was generated from *People Service* crate version *7.0.0+20251221*, where *20251221* is the exact revision of the *people:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
