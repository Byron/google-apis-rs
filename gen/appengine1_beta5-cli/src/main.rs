...
use google_appengine1_beta5::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
            ...
            .iter()
        {
            ...
            match key {
                "ensure-resources-exist" => {
                    call = call.ensure_resources_exist(
                        value
                            .map(|v| arg_from_str(v, err, "ensure-resources-exist", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
            ...
            .iter()
        {
            ...
            match key {
                "mask" => {
                    call = call.mask(
                        value
                            .map(|v| arg_from_str(v, err, "mask", "google-fieldmask"))
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["allocations", "id", "name", "shard-by", "split"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
    ...
    async fn _apps_services_versions_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "automatic-scaling.disk-utilization.target-read-bytes-per-sec" => Some((
                    "automaticScaling.diskUtilization.targetReadBytesPerSec",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "automatic-scaling.disk-utilization.target-read-ops-per-sec" => Some((
                    "automaticScaling.diskUtilization.targetReadOpsPerSec",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "automatic-scaling.disk-utilization.target-write-bytes-per-sec" => Some((
                    "automaticScaling.diskUtilization.targetWriteBytesPerSec",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "automatic-scaling.disk-utilization.target-write-ops-per-sec" => Some((
                    "automaticScaling.diskUtilization.targetWriteOpsPerSec",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                ...
                "automatic-scaling.network-utilization.target-received-bytes-per-sec" => Some((
                    "automaticScaling.networkUtilization.targetReceivedBytesPerSec",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "automatic-scaling.network-utilization.target-received-packets-per-sec" => Some((
                    "automaticScaling.networkUtilization.targetReceivedPacketsPerSec",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "automatic-scaling.network-utilization.target-sent-bytes-per-sec" => Some((
                    "automaticScaling.networkUtilization.targetSentBytesPerSec",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "automatic-scaling.network-utilization.target-sent-packets-per-sec" => Some((
                    "automaticScaling.networkUtilization.targetSentPacketsPerSec",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                ...
                "automatic-scaling.request-utilization.target-request-count-per-sec" => Some((
                    "automaticScaling.requestUtilization.targetRequestCountPerSec",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "target-read-bytes-per-sec",
                            "target-read-ops-per-sec",
                            "target-received-bytes-per-sec",
                            "target-received-packets-per-sec",
                            "target-request-count-per-sec",
                            "target-sent-bytes-per-sec",
                            "target-sent-packets-per-sec",
                            "target-utilization",
                            "target-write-bytes-per-sec",
                            "target-write-ops-per-sec",
                            "threadsafe",
                            "timeout",
                            "unhealthy-threshold",
                            "url",
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "appengine1-beta5-secret.json",
...
async fn main() {
    ...
    let arg_data = [
        ...
        location - The region (https://cloud.google.com/appengine/docs/locations) where you want the App Engine application located.For more information about App Engine applications, see Managing Projects, Applications, and Billing (https://cloud.google.com/appengine/docs/python/console/)."##),
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_create",
                  vec![
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_get",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
            ...
            ("locations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_locations-get",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_locations-list",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
            ...
            ("operations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_operations-get",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
            ...
            ("operations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_operations-list",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
        ...
        default_cookie_expiration (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta5/apps#Application.FIELDS.default_cookie_expiration)"##),
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_patch",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
            ...
            ("services-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-delete",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
            ...
            ("services-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-get",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
                     Some(r##"Part of `name`. Name of the resource requested. Example: apps/myapp/services/default."##),
            ...
            ("services-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-list",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
            ...
            ("services-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-patch",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
            ...
            ("services-versions-create",
                    Some(r##"Deploys new code and resource files to a new version."##),
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-versions-create",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
                     Some(r##"Part of `name`. Name of the resource to update. For example: "apps/myapp/services/default"."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"services-id"##),
                     None,
            ...
            ("services-versions-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-versions-delete",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
            ...
            ("services-versions-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-versions-get",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
                     Some(r##"Part of `name`. Name of the resource requested. Example: apps/myapp/services/default/versions/v1."##),
            ...
            ("services-versions-instances-debug",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-versions-instances-debug",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
            ...
            ("services-versions-instances-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-versions-instances-delete",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
                     Some(r##"Part of `name`. Name of the resource requested. For example: "apps/myapp/services/default/versions/v1/instances/instance-1"."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"services-id"##),
                     None,
            ...
            ("services-versions-instances-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-versions-instances-get",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
                     Some(r##"Part of `name`. Name of the resource requested. Example: apps/myapp/services/default/versions/v1/instances/instance-1."##),
            ...
            ("services-versions-instances-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-versions-instances-list",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
                     Some(r##"Part of `name`. Name of the resource requested. Example: apps/myapp/services/default/versions/v1."##),
            ...
            ("services-versions-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-versions-list",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
                     Some(r##"Part of `name`. Name of the resource requested. Example: apps/myapp/services/default."##),
        ...
        automatic_scaling.max_idle_instances (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta5/apps.services.versions#Version.FIELDS.automatic_scaling):  For Version resources that use automatic scaling and run in the App  Engine standard environment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-versions-patch",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
