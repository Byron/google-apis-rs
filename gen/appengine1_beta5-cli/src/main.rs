...
fn main() {
    ...
    let arg_data = [
        ("apps", "methods: 'get', 'operations-get', 'operations-list', 'services-delete', 'services-get', 'services-list', 'services-patch', 'services-versions-create', 'services-versions-delete', 'services-versions-get', 'services-versions-list' and 'services-versions-patch'", vec![
            ("get",
            ...
            ("services-delete",
                    Some(r##"Deletes a service and all enclosed versions."##),
                    "Details at http://byron.github.io/google-apis-rs/google_appengine1_beta5_cli/apps_services-delete",
                  vec![
                    (Some(r##"apps-id"##),
                     None,
                     Some(r##"Part of `name`. Name of the resource requested. For example: "apps/myapp/services/default"."##),
                     Some(true),
                     Some(false)),
            ...
            ("services-get",
                    Some(r##"Gets the current configuration of the service."##),
            ...
            ("services-versions-delete",
                  ...
                  vec![
                    (Some(r##"apps-id"##),
                     None,
                     Some(r##"Part of `name`. Name of the resource requested. For example: "apps/myapp/services/default/versions/v1"."##),
                     Some(true),
                     Some(false)),
            ...
            ("services-versions-patch",
                  ...
                  vec![
                    (Some(r##"apps-id"##),
                     None,
                     Some(r##"Part of `name`. Name of the resource to update. For example: "apps/myapp/services/default/versions/1"."##),
                     Some(true),
                     Some(false)),
