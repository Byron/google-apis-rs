...
//! This documentation was generated from *Apigee* crate version *3.0.2+20220301*, where *20220301* is the exact revision of the *apigee:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
...
//!     ).build().await.unwrap();
//! let mut hub = Apigee::new(hyper::Client::builder().build(hyper_rustls::HttpsConnector::with_native_roots().https_or_http().enable_http1().enable_http2().build()), auth);
