...
//! This documentation was generated from *Apigee* crate version *8.0.0+20251027*, where *20251027* is the exact revision of the *apigee:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
...
//! use apigee1::api::GoogleCloudApigeeV1DnsZone;
...
//! let mut req = GoogleCloudApigeeV1DnsZone::default();
//!
//! // You can configure optional parameters by calling the respective setters at will, and
//! // execute the final call using `doit()`.
//! // Values shown here are possibly random and not representative !
//! let result = hub.organizations().dns_zones_create(req, "parent")
//!              .dns_zone_id("ipsum")
//!              .doit().await;
//!
//! match result {
