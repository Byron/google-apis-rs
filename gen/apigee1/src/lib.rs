...
//! This documentation was generated from *Apigee* crate version *5.0.3+20240222*, where *20240222* is the exact revision of the *apigee:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
