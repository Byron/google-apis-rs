...
//! This documentation was generated from *Apigee* crate version *5.0.2+20230104*, where *20230104* is the exact revision of the *apigee:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2*.
//! 
