...
pub struct DnsKeyGetCall<'a, S>
   ...
   pub(super) _location: String,
   pub(super) _managed_zone: String,
   pub(super) _dns_key_id: String,
   pub(super) _digest_type: Option<String>,
   pub(super) _client_operation_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ManagedZoneCreateCall<'a, S>
   ...
   pub(super) hub: &'a Dns<S>,
   pub(super) _request: ManagedZone,
   pub(super) _project: String,
   pub(super) _location: String,
   pub(super) _client_operation_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct ManagedZoneGetIamPolicyCall<'a, S>
   ...
   pub(super) hub: &'a Dns<S>,
   pub(super) _request: GoogleIamV1GetIamPolicyRequest,
...
pub struct ManagedZoneListCall<'a, S>
   ...
   pub(super) _page_token: Option<String>,
   pub(super) _max_results: Option<i32>,
   pub(super) _dns_name: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ResourceRecordSetCreateCall<'a, S>
   ...
   pub(super) hub: &'a Dns<S>,
   pub(super) _request: ResourceRecordSet,
   pub(super) _project: String,
   pub(super) _location: String,
   pub(super) _managed_zone: String,
   pub(super) _client_operation_id: Option<String>,
...
pub struct ResponsePolicyCreateCall<'a, S>
   ...
   pub(super) hub: &'a Dns<S>,
   pub(super) _request: ResponsePolicy,
   pub(super) _project: String,
   pub(super) _location: String,
   pub(super) _client_operation_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct ResponsePolicyDeleteCall<'a, S>
   ...
   pub(super) _project: String,
   pub(super) _location: String,
   pub(super) _response_policy: String,
   pub(super) _client_operation_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct ResponsePolicyRuleCreateCall<'a, S>
   ...
   pub(super) hub: &'a Dns<S>,
   pub(super) _request: ResponsePolicyRule,
   pub(super) _project: String,
   pub(super) _location: String,
   pub(super) _response_policy: String,
   pub(super) _client_operation_id: Option<String>,
...
pub struct ResponsePolicyRuleDeleteCall<'a, S>
   ...
   pub(super) _location: String,
   pub(super) _response_policy: String,
   pub(super) _response_policy_rule: String,
   pub(super) _client_operation_id: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
