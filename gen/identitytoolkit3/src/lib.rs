...
//! This documentation was generated from *Identity Toolkit* crate version *0.1.7+20150406*, where *20150406* is the exact revision of the *identitytoolkit:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.7*.
//! 
