...
//! This documentation was generated from *Cloud Healthcare* crate version *5.0.3+20240228*, where *20240228* is the exact revision of the *healthcare:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
