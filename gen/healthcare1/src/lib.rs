...
//! This documentation was generated from *Cloud Healthcare* crate version *7.0.0+20251211*, where *20251211* is the exact revision of the *healthcare:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
