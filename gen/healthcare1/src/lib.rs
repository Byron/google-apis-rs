...
//! This documentation was generated from *Cloud Healthcare* crate version *3.0.2+20220223*, where *20220223* is the exact revision of the *healthcare:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
