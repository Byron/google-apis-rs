...
//! This documentation was generated from *drive* crate version *1.0.3+20161212*, where *20161212* is the exact revision of the *drive:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.3*.
//! 
