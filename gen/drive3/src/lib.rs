...
//! This documentation was generated from *drive* crate version *5.0.5+20240604*, where *20240604* is the exact revision of the *drive:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.5*.
//! 
