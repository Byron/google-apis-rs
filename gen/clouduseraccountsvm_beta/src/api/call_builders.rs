...
pub struct GroupAddMemberCall<'a, S>
   ...
   pub(super) hub: &'a CloudUserAccounts<S>,
   pub(super) _request: GroupsAddMemberRequest,
   pub(super) _project: String,
   pub(super) _group_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct GroupRemoveMemberCall<'a, S>
   ...
   pub(super) hub: &'a CloudUserAccounts<S>,
   pub(super) _request: GroupsRemoveMemberRequest,
   pub(super) _project: String,
   pub(super) _group_name: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct LinuxGetAuthorizedKeysViewCall<'a, S>
   ...
   pub(super) _user: String,
   pub(super) _instance: String,
   pub(super) _login: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
