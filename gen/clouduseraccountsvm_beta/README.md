...
This documentation was generated from *Cloud User Accounts* crate version *0.1.11+20150924*, where *20150924* is the exact revision of the *clouduseraccounts:vm_beta* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.11*.
