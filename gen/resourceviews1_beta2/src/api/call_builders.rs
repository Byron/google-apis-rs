...
pub struct ZoneViewAddResourceCall<'a, S>
   ...
   pub(super) hub: &'a Resourceviews<S>,
   pub(super) _request: ZoneViewsAddResourcesRequest,
   pub(super) _project: String,
   pub(super) _zone: String,
   pub(super) _resource_view: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ZoneViewGetServiceCall<'a, S>
   ...
   pub(super) _zone: String,
   pub(super) _resource_view: String,
   pub(super) _resource_name: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ZoneViewInsertCall<'a, S>
   ...
   pub(super) hub: &'a Resourceviews<S>,
   pub(super) _request: ResourceView,
   pub(super) _project: String,
   pub(super) _zone: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
...
pub struct ZoneViewRemoveResourceCall<'a, S>
   ...
   pub(super) hub: &'a Resourceviews<S>,
   pub(super) _request: ZoneViewsRemoveResourcesRequest,
   pub(super) _project: String,
   pub(super) _zone: String,
   pub(super) _resource_view: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
...
pub struct ZoneViewSetServiceCall<'a, S>
   ...
   pub(super) hub: &'a Resourceviews<S>,
   pub(super) _request: ZoneViewsSetServiceRequest,
   pub(super) _project: String,
   pub(super) _zone: String,
   pub(super) _resource_view: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
