...
//! This documentation was generated from *resourceviews* crate version *1.0.0+20160512*, where *20160512* is the exact revision of the *resourceviews:v1beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.0*.
//! 
