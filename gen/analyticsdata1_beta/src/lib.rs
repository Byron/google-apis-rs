...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/analyticsdata1_beta).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](AnalyticsData) ... 
//! 
//! * properties
//!  * [*batch run pivot reports*](api::PropertyBatchRunPivotReportCall), [*batch run reports*](api::PropertyBatchRunReportCall), [*get metadata*](api::PropertyGetMetadataCall), [*run pivot report*](api::PropertyRunPivotReportCall), [*run realtime report*](api::PropertyRunRealtimeReportCall) and [*run report*](api::PropertyRunReportCall)
//! 
//! 
//! 
//! 
