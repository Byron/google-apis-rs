...
pub struct PropertyBatchRunPivotReportCall<'a, S>
   ...
   pub(super) _request: BatchRunPivotReportsRequest,
   pub(super) _property: String,
...
pub struct PropertyBatchRunReportCall<'a, S>
   ...
   pub(super) hub: &'a AnalyticsData<S>,
   pub(super) _request: BatchRunReportsRequest,
   pub(super) _property: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct PropertyCheckCompatibilityCall<'a, S>
   ...
   pub(super) hub: &'a AnalyticsData<S>,
   pub(super) _request: CheckCompatibilityRequest,
   pub(super) _property: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct PropertyRunPivotReportCall<'a, S>
   ...
   pub(super) hub: &'a AnalyticsData<S>,
   pub(super) _request: RunPivotReportRequest,
   pub(super) _property: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct PropertyRunRealtimeReportCall<'a, S>
   ...
   pub(super) hub: &'a AnalyticsData<S>,
   pub(super) _request: RunRealtimeReportRequest,
   pub(super) _property: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct PropertyRunReportCall<'a, S>
   ...
   pub(super) hub: &'a AnalyticsData<S>,
   pub(super) _request: RunReportRequest,
   pub(super) _property: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
