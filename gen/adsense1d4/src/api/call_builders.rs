...
pub struct AccountAdclientGetAdCodeCall<'a, S>
   ...
   pub(super) _tag_partner: Option<String>,
...
pub struct AccountReportGenerateCall<'a, S>
   ...
   pub(super) _use_timezone_reporting: Option<bool>,
   pub(super) _start_index: Option<i32>,
   ...
   pub(super) _currency: Option<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AccountSavedadstyleGetCall<'a, S>
   ...
   pub(super) hub: &'a AdSense<S>,
   pub(super) _account_id: String,
   pub(super) _saved_ad_style_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ReportGenerateCall<'a, S>
   ...
   pub(super) _dimension: Vec<String>,
   pub(super) _currency: Option<String>,
   pub(super) _account_id: Vec<String>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
