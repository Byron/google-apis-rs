...
//! This documentation was generated from *AdSense* crate version *0.1.8+20150617*, where *20150617* is the exact revision of the *adsense:v1.4* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.8*.
//! 
