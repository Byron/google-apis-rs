...
//! This documentation was generated from *AdSense* crate version *1.0.9+20190703*, where *20190703* is the exact revision of the *adsense:v1.4* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.9*.
//! 
