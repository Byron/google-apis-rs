...
use google_privateca1_beta1::{api, Error};
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::CertificateAuthorityService<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>
    >,
    gp: Vec<&'static str>,
