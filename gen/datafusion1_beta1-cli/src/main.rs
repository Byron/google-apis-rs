...
extern crate mime;
extern crate strsim;
extern crate google_datafusion1_beta1 as api;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::DataFusion<hyper::Client, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client>>,
    gp: Vec<&'static str>,
...
impl<'n> Engine<'n> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["create-time", "description", "display-name", "enable-stackdriver-logging", "enable-stackdriver-monitoring", "ip-allocation", "labels", "name", "network", "network-config", "options", "private-instance", "service-account", "service-endpoint", "state", "state-message", "type", "update-time", "version", "zone"]);
    ...
    fn _projects_locations_instances_restart(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
            ...
            ("projects", Some(opt)) => {
                match opt.subcommand() {
                    ...
                    ("locations-instances-restart", Some(opt)) => {
                        call_result = self._projects_locations_instances_restart(opt, dry_run, &mut err);
                    },
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "datafusion1-beta1-secret.json",
        ...
        let auth = Authenticator::new(  &secret, DefaultAuthenticatorDelegate,
                                        ...
                                        JsonTokenStorage {
                                          program_name: "datafusion1-beta1",
    ...
    let arg_data = [
        ...
        are queried, and the results are aggregated."##),
            ...
            ("locations-instances-patch",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Output only. The name of this instance is in the form of
        projects/{project}/locations/{location}/instances/{instance}."##),
                     Some(true),
                     Some(false)),
            ...
            ("locations-instances-restart",
                    Some(r##"Restart a single Data Fusion instance.
        At the end of an operation instance is fully restarted."##),
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Name of the Data Fusion instance which need to be restarted in the form of
        projects/{project}/locations/{location}/instances/{instance}"##),
                     Some(true),
                     Some(false)),
        ...
        See the operation documentation for the appropriate value for this field."##),
            ...
            ("locations-instances-upgrade",
                    Some(r##"Upgrade a single Data Fusion instance.
        At the end of an operation instance is fully upgraded."##),
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Name of the Data Fusion instance which need to be upgraded in the form of
        projects/{project}/locations/{location}/instances/{instance}
