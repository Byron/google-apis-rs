...
pub struct AppLocationGetCall<'a, S>
   ...
   pub(super) _locations_id: String,
...
pub struct AppOperationGetCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _apps_id: String,
   pub(super) _operations_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AppServiceVersionInstanceDebugCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _request: DebugInstanceRequest,
   pub(super) _apps_id: String,
   pub(super) _services_id: String,
   pub(super) _versions_id: String,
   pub(super) _instances_id: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AppServiceVersionPatchCall<'a, S>
   ...
   pub(super) _services_id: String,
   pub(super) _versions_id: String,
   pub(super) _mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AppServicePatchCall<'a, S>
   ...
   pub(super) _apps_id: String,
   pub(super) _services_id: String,
   pub(super) _migrate_traffic: Option<bool>,
   pub(super) _mask: Option<client::FieldMask>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct AppCreateCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _request: Application,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct AppGetCall<'a, S>
   ...
   pub(super) hub: &'a Appengine<S>,
   pub(super) _apps_id: String,
   pub(super) _ensure_resources_exist: Option<bool>,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
