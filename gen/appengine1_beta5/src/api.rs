...
pub struct Instance {
    ...
    pub start_timestamp: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1beta5/apps/{appsId}/operations/{operationsId}";
        if self._scopes.is_empty() {
            self._scopes.insert(Scope::Admin.as_ref().to_string());
        }
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1beta5/apps/{appsId}/services/{servicesId}/versions";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    C: common::Connector,
{
    ...
    pub fn mask(mut self, new_value: common::FieldMask) -> AppServiceVersionPatchCall<'a, C> {
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *mask* query property to the given value.
    pub fn mask(mut self, new_value: common::FieldMask) -> AppServicePatchCall<'a, C> {
        self._mask = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *mask* query property to the given value.
    pub fn mask(mut self, new_value: common::FieldMask) -> AppPatchCall<'a, C> {
        self._mask = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
