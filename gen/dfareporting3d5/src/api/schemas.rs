...
pub struct Advertiser {
    ...
    #[serde(rename="measurementPartnerLink")]
...
pub struct MeasurementPartnerAdvertiserLink {
    ...
    pub link_status: Option<MeasurementPartnerAdvertiserLinkLinkStatusEnum>,
    /// Measurement partner used for tag wrapping.
    #[serde(rename="measurementPartner")]
    
    pub measurement_partner: Option<MeasurementPartnerAdvertiserLinkMeasurementPartnerEnum>,
    /// .
    #[serde(rename="partnerAdvertiserId")]
    
    pub partner_advertiser_id: Option<String>,
}

impl client::Part for MeasurementPartnerAdvertiserLink {}
...
pub struct MeasurementPartnerCampaignLink {
    ...
    pub link_status: Option<MeasurementPartnerCampaignLinkLinkStatusEnum>,
    /// Measurement partner used for tag wrapping.
    #[serde(rename="measurementPartner")]
    
    pub measurement_partner: Option<MeasurementPartnerCampaignLinkMeasurementPartnerEnum>,
    /// Partner campaign ID needed for establishing linking with Measurement partner.
    #[serde(rename="partnerCampaignId")]
    
    pub partner_campaign_id: Option<String>,
}

impl client::Part for MeasurementPartnerCampaignLink {}
...
pub struct MeasurementPartnerWrappingData {
    ...
    pub link_status: Option<MeasurementPartnerWrappingDataLinkStatusEnum>,
    /// Measurement partner used for wrapping the placement.
    #[serde(rename="measurementPartner")]
    
    pub measurement_partner: Option<MeasurementPartnerWrappingDataMeasurementPartnerEnum>,
    /// Measurement mode for the wrapped placement.
    #[serde(rename="tagWrappingMode")]
    
    pub tag_wrapping_mode: Option<MeasurementPartnerWrappingDataTagWrappingModeEnum>,
    /// Tag provided by the measurement partner during wrapping.
    #[serde(rename="wrappedTag")]
    
    pub wrapped_tag: Option<String>,
}

impl client::Part for MeasurementPartnerWrappingData {}
...
pub struct Placement {
    ...
    #[serde(rename="partnerWrappingData")]
