...
//! This documentation was generated from *Dfareporting* crate version *6.0.0+20240625*, where *20240625* is the exact revision of the *dfareporting:v3.5* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
