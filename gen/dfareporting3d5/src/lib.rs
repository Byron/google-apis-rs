...
//! This documentation was generated from *Dfareporting* crate version *3.1.0+20220104*, where *20220104* is the exact revision of the *dfareporting:v3.5* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.1.0*.
//! 
