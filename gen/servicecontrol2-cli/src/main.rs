...
use google_servicecontrol2::{api, Error};
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::ServiceControl<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>
    >,
    gp: Vec<&'static str>,
