            ...
            .iter()
        {
            ...
            match key {
                "revoke-existing-roles" => {
                    call = call.revoke_existing_roles(
                        value
                            .map(|v| arg_from_str(v, err, "revoke-existing-roles", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "name" => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["database-roles", "host", "name", "revoke-existing-roles"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    let arg_data = [
        ("backup-runs", "methods: 'delete', 'get', 'insert' and 'list'", vec![
            ...
            ("create-backup",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/backups_create-backup",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("delete-backup",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/backups_delete-backup",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("get-backup",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/backups_get-backup",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("list-backups",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/backups_list-backups",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("update-backup",
                    Some(r##"Updates the retention period and the description of the backup. You can use this API to update final backups only."##),
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/backups_update-backup",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("list-entra-id-certificates",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_list-entra-id-certificates",
                  vec![
                    (Some(r##"project"##),
                     None,
            ...
            ("list-server-certificates",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_list-server-certificates",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Required. Project ID of the project that contains the instance."##),
            ...
            ("rotate-entra-id-certificate",
                    Some(r##"Rotates the Entra Id certificate version to one previously added with the addEntraIdCertificate method."##),
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_rotate-entra-id-certificate",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Required. Project ID of the project that contains the instance."##),
            ...
            ("rotate-server-certificate",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_rotate-server-certificate",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Required. Project ID of the project that contains the instance."##),
            ...
            ("add-entra-id-certificate",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_add-entra-id-certificate",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Required. Project ID of the project that contains the instance."##),
            ...
            ("add-server-certificate",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_add-server-certificate",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Required. Project ID of the project that contains the instance."##),
            ...
            ("execute-sql",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_execute-sql",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Required. Project ID of the project that contains the instance."##),
            ...
            ("point-in-time-restore",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_point-in-time-restore",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("pre-check-major-version-upgrade",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_pre-check-major-version-upgrade",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Required. Project ID of the project that contains the instance."##),
            ...
            ("cancel",
                    Some(r##"Cancels an instance operation that has been performed on an instance. Ordinarily, this method name should be `CancelSqlOperation`."##),
