...
//! This documentation was generated from *dns* crate version *0.1.0+20150114*, where *20150114* is the exact revision of the *dns:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.0*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/dns1_beta1).
//! # Features
//! 
...
/// // Values shown here are possibly random and not representative !
/// let mut req: Change = Default::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
...
impl<'a, C, NC, A> ChangeCreateCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Change)> {
        ...
        let mut url = "https://www.googleapis.com/dns/v1beta1/projects/{project}/managedZones/{managedZone}/changes".to_string();
        ...
        }
        {
            ...
            for param_name in ["project", "managedZone"].iter() {
...
impl<'a, C, NC, A> ChangeListCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ChangesListResponse)> {
        ...
        let mut url = "https://www.googleapis.com/dns/v1beta1/projects/{project}/managedZones/{managedZone}/changes".to_string();
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::NdevClouddnReadonly.as_slice().to_string(), ());
        }
...
impl<'a, C, NC, A> ChangeGetCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Change)> {
        ...
        let mut url = "https://www.googleapis.com/dns/v1beta1/projects/{project}/managedZones/{managedZone}/changes/{changeId}".to_string();
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::NdevClouddnReadonly.as_slice().to_string(), ());
        }
        ...
        }
        {
            ...
            for param_name in ["project", "managedZone", "changeId"].iter() {
                for (index, &(ref name, _)) in params.iter().rev().enumerate() {
                    if name == param_name {
                        indices_for_removal.push(params.len() - index - 1);
                        break;
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req: ManagedZone = Default::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
...
impl<'a, C, NC, A> ManagedZoneCreateCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ManagedZone)> {
        ...
        let mut url = "https://www.googleapis.com/dns/v1beta1/projects/{project}/managedZones".to_string();
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_slice().to_string(), ());
        }
...
impl<'a, C, NC, A> ManagedZoneDeleteCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<hyper::client::Response> {
        ...
        let mut url = "https://www.googleapis.com/dns/v1beta1/projects/{project}/managedZones/{managedZone}".to_string();
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_slice().to_string(), ());
        }
...
impl<'a, C, NC, A> ResourceRecordSetListCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ResourceRecordSetsListResponse)> {
        ...
        let mut url = "https://www.googleapis.com/dns/v1beta1/projects/{project}/managedZones/{managedZone}/rrsets".to_string();
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::NdevClouddnReadonly.as_slice().to_string(), ());
        }
...
impl<'a, C, NC, A> ProjectGetCall<'a, C, NC, A> where NC: hyper::net::NetworkConnector, C: BorrowMut<hyper::Client<NC>>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Project)> {
        ...
        let mut url = "https://www.googleapis.com/dns/v1beta1/projects/{project}".to_string();
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::NdevClouddnReadonly.as_slice().to_string(), ());
        }
