...
use google_spectrum1_explorer::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    async fn _paws_get_spectrum(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "antenna.height-uncertainty" => Some((
                    "antenna.heightUncertainty",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-desc.etsi-en-device-category" => Some((
                    "deviceDesc.etsiEnDeviceCategory",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-desc.etsi-en-device-emissions-class" => Some((
                    "deviceDesc.etsiEnDeviceEmissionsClass",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-desc.etsi-en-device-type" => Some((
                    "deviceDesc.etsiEnDeviceType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-desc.etsi-en-technology-id" => Some((
                    "deviceDesc.etsiEnTechnologyId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-desc.fcc-id" => Some((
                    "deviceDesc.fccId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "device-desc.fcc-tvbd-device-type" => Some((
                    "deviceDesc.fccTvbdDeviceType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-desc.manufacturer-id" => Some((
                    "deviceDesc.manufacturerId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-desc.model-id" => Some((
                    "deviceDesc.modelId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "device-desc.serial-number" => Some((
                ...
                "location.point.center.latitude" => Some((
                ...
                "location.point.center.longitude" => Some((
                ...
                "location.point.orientation" => Some((
                ...
                "location.point.semi-major-axis" => Some((
                    "location.point.semiMajorAxis",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.point.semi-minor-axis" => Some((
                    "location.point.semiMinorAxis",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "master-device-desc.etsi-en-device-category" => Some((
                    "masterDeviceDesc.etsiEnDeviceCategory",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "master-device-desc.etsi-en-device-emissions-class" => Some((
                    "masterDeviceDesc.etsiEnDeviceEmissionsClass",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "master-device-desc.etsi-en-device-type" => Some((
                    "masterDeviceDesc.etsiEnDeviceType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "master-device-desc.etsi-en-technology-id" => Some((
                    "masterDeviceDesc.etsiEnTechnologyId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "master-device-desc.fcc-id" => Some((
                    "masterDeviceDesc.fccId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "master-device-desc.fcc-tvbd-device-type" => Some((
                    "masterDeviceDesc.fccTvbdDeviceType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "master-device-desc.manufacturer-id" => Some((
                    "masterDeviceDesc.manufacturerId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "master-device-desc.model-id" => Some((
                    "masterDeviceDesc.modelId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "master-device-desc.ruleset-ids" => Some((
                    "masterDeviceDesc.rulesetIds",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "master-device-desc.serial-number" => Some((
                    "masterDeviceDesc.serialNumber",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "owner.operator.adr.code" => Some((
                ...
                "owner.operator.adr.country" => Some((
                ...
                "owner.operator.adr.locality" => Some((
                ...
                "owner.operator.adr.region" => Some((
                ...
                "owner.operator.adr.street" => Some((
                ...
                "owner.operator.email.text" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "device-desc",
                            "email",
                            "etsi-en-device-category",
                            "etsi-en-device-emissions-class",
                            "etsi-en-device-type",
                            "etsi-en-technology-id",
                            "fcc-id",
                            "fcc-tvbd-device-type",
                            "fn",
                            "height",
                            "height-type",
                            "height-uncertainty",
        ...
        let mut request: api::PawsGetSpectrumRequest =
    ...
    async fn _paws_get_spectrum_batch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::PawsGetSpectrumBatchRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _paws_init(
        ...
        let mut request: api::PawsInitRequest = serde_json::value::from_value(object).unwrap();
    ...
    async fn _paws_notify_spectrum_use(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::PawsNotifySpectrumUseRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _paws_register(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "device-owner.operator.adr.code" => Some((
                    "deviceOwner.operator.adr.code",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.operator.adr.country" => Some((
                    "deviceOwner.operator.adr.country",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.operator.adr.locality" => Some((
                    "deviceOwner.operator.adr.locality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.operator.adr.pobox" => Some((
                    "deviceOwner.operator.adr.pobox",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.operator.adr.region" => Some((
                    "deviceOwner.operator.adr.region",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.operator.adr.street" => Some((
                    "deviceOwner.operator.adr.street",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.operator.email.text" => Some((
                    "deviceOwner.operator.email.text",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.operator.fn" => Some((
                    "deviceOwner.operator.fn",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.operator.org.text" => Some((
                    "deviceOwner.operator.org.text",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.operator.tel.uri" => Some((
                    "deviceOwner.operator.tel.uri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.owner.adr.code" => Some((
                    "deviceOwner.owner.adr.code",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.owner.adr.country" => Some((
                    "deviceOwner.owner.adr.country",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.owner.adr.locality" => Some((
                    "deviceOwner.owner.adr.locality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.owner.adr.pobox" => Some((
                    "deviceOwner.owner.adr.pobox",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.owner.adr.region" => Some((
                    "deviceOwner.owner.adr.region",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.owner.adr.street" => Some((
                    "deviceOwner.owner.adr.street",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.owner.email.text" => Some((
                    "deviceOwner.owner.email.text",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.owner.fn" => Some((
                    "deviceOwner.owner.fn",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.owner.org.text" => Some((
                    "deviceOwner.owner.org.text",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-owner.owner.tel.uri" => Some((
                    "deviceOwner.owner.tel.uri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::PawsRegisterRequest = serde_json::value::from_value(object).unwrap();
    ...
    async fn _paws_verify_device(
        ...
        let mut request: api::PawsVerifyDeviceRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("paws", Some(opt)) => match opt.subcommand() {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("paws".to_string()));
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "spectrum1-explorer-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/spectrum1-explorer", config_dir))
        .build()
        .await
        .unwrap();
