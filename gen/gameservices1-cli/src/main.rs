...
use google_gameservices1::{api, Error, oauth2, client::chrono, FieldMask};
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'locations-game-server-deployments-get-iam-policy', 'locations-game-server-deployments-set-iam-policy', 'locations-game-server-deployments-test-iam-permissions', 'locations-get', 'locations-list', 'locations-operations-cancel', 'locations-operations-delete', 'locations-operations-get' and 'locations-operations-list'", vec![
