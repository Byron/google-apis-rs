...
//! * projects
//!  * [*add firebase*](api::ProjectAddFirebaseCall), [*add google analytics*](api::ProjectAddGoogleAnalyticCall), [*android apps create*](api::ProjectAndroidAppCreateCall), [*android apps get*](api::ProjectAndroidAppGetCall), [*android apps get config*](api::ProjectAndroidAppGetConfigCall), [*android apps list*](api::ProjectAndroidAppListCall), [*android apps patch*](api::ProjectAndroidAppPatchCall), [*android apps sha create*](api::ProjectAndroidAppShaCreateCall), [*android apps sha delete*](api::ProjectAndroidAppShaDeleteCall), [*android apps sha list*](api::ProjectAndroidAppShaListCall), [*available locations list*](api::ProjectAvailableLocationListCall), [*default location finalize*](api::ProjectDefaultLocationFinalizeCall), [*get*](api::ProjectGetCall), [*get admin sdk config*](api::ProjectGetAdminSdkConfigCall), [*get analytics details*](api::ProjectGetAnalyticsDetailCall), [*ios apps create*](api::ProjectIosAppCreateCall), [*ios apps get*](api::ProjectIosAppGetCall), [*ios apps get config*](api::ProjectIosAppGetConfigCall), [*ios apps list*](api::ProjectIosAppListCall), [*ios apps patch*](api::ProjectIosAppPatchCall), [*list*](api::ProjectListCall), [*patch*](api::ProjectPatchCall), [*remove analytics*](api::ProjectRemoveAnalyticCall), [*search apps*](api::ProjectSearchAppCall), [*web apps create*](api::ProjectWebAppCreateCall), [*web apps get*](api::ProjectWebAppGetCall), [*web apps get config*](api::ProjectWebAppGetConfigCall), [*web apps list*](api::ProjectWebAppListCall) and [*web apps patch*](api::ProjectWebAppPatchCall)
//! 
//! 
//! 
//! 
