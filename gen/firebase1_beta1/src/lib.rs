...
//! This documentation was generated from *Firebase Management* crate version *7.0.0+20251217*, where *20251217* is the exact revision of the *firebase:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
