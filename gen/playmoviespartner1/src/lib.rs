...
//! This documentation was generated from *playmoviespartner* crate version *0.1.10+20150812*, where *20150812* is the exact revision of the *playmoviespartner:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.10*.
//! 
