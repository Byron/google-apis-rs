...
//! This documentation was generated from *fitness* crate version *1.0.7+20170922*, where *20170922* is the exact revision of the *fitness:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.7*.
//! 
