...
//! This documentation was generated from *fitness* crate version *7.0.0+20251222*, where *20251222* is the exact revision of the *fitness:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
