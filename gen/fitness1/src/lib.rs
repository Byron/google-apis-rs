...
//! This documentation was generated from *fitness* crate version *8.0.0+20251028*, where *20251028* is the exact revision of the *fitness:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
