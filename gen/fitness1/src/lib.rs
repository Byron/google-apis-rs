...
//! This documentation was generated from *fitness* crate version *0.1.15+20160801*, where *20160801* is the exact revision of the *fitness:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.15*.
//! 
