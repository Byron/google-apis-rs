...
//! This documentation was generated from *Web Risk* crate version *5.0.4+20240303*, where *20240303* is the exact revision of the *webrisk:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.4*.
//! 
