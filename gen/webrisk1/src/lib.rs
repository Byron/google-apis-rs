...
//! This documentation was generated from *Web Risk* crate version *2.0.0+20210319*, where *20210319* is the exact revision of the *webrisk:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.0*.
//! 
//! Everything else about the *Web Risk* *v1* API can be found at the
//! [official documentation site](https://cloud.google.com/web-risk/).
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/webrisk1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](WebRisk) ... 
//! 
//! * hashes
//!  * [*search*](api::HasheSearchCall)
//! * projects
