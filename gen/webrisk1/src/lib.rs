...
//! This documentation was generated from *Web Risk* crate version *3.0.2+20220226*, where *20220226* is the exact revision of the *webrisk:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.2*.
//! 
