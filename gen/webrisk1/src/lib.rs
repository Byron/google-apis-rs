...
//! This documentation was generated from *Web Risk* crate version *8.0.0+20251019*, where *20251019* is the exact revision of the *webrisk:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
