...
pub struct ContentDeidentifyCall<'a, S>
   ...
   pub(super) _request: GooglePrivacyDlpV2beta1DeidentifyContentRequest,
...
pub struct ContentInspectCall<'a, S>
   ...
   pub(super) hub: &'a DLP<S>,
   pub(super) _request: GooglePrivacyDlpV2beta1InspectContentRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct ContentRedactCall<'a, S>
   ...
   pub(super) hub: &'a DLP<S>,
   pub(super) _request: GooglePrivacyDlpV2beta1RedactContentRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct DataSourceAnalyzeCall<'a, S>
   ...
   pub(super) hub: &'a DLP<S>,
   pub(super) _request: GooglePrivacyDlpV2beta1AnalyzeDataSourceRiskRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
...
pub struct InspectOperationCreateCall<'a, S>
   ...
   pub(super) hub: &'a DLP<S>,
   pub(super) _request: GooglePrivacyDlpV2beta1CreateInspectOperationRequest,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
}
