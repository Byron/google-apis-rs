...
//! This documentation was generated from *YouTube* crate version *5.0.5+20240624*, where *20240624* is the exact revision of the *youtube:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.5*.
//! 
