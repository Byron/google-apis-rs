...
//! This documentation was generated from *YouTube* crate version *1.0.1+20161202*, where *20161202* is the exact revision of the *youtube:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.1*.
//! 
