...
//! This documentation was generated from *YouTube* crate version *6.0.0+20240626*, where *20240626* is the exact revision of the *youtube:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
