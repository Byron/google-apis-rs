...
//! This documentation was generated from *YouTube* crate version *0.1.11+20160222*, where *20160222* is the exact revision of the *youtube:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.11*.
//! 
