...
//! This documentation was generated from *YouTube* crate version *8.0.0+20251029*, where *20251029* is the exact revision of the *youtube:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
...
//! * youtube
//!  * [*v3 live chat messages stream*](api::YoutubeV3LiveChatMessageStreamCall) and [*v3 update comment threads*](api::YoutubeV3UpdateCommentThreadCall)
//!
//!
//! Upload supported by ...
//!
