...
//! This documentation was generated from *YouTube* crate version *7.0.0+20251222*, where *20251222* is the exact revision of the *youtube:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
...
//! * [video trainability](api::VideoTrainability)
//!  * [*get*](api::VideoTrainabilityGetCall)
//! * [videos](api::Video)
...
//! * youtube
//!  * [*v3 live chat messages stream*](api::YoutubeV3LiveChatMessageStreamCall), [*v3 update comment threads*](api::YoutubeV3UpdateCommentThreadCall) and [*v3 videos batch get stats*](api::YoutubeV3VideoBatchGetStatCall)
//!
//!
//! Upload supported by ...
//!
