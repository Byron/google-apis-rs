...
{
    async fn _projects_locations_notes_batch_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_notes_batch_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_notes_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_notes_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_notes_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_notes_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_notes_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_notes_get_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_notes_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_notes_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_notes_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_notes_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_notes_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_notes_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_occurrences_batch_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_occurrences_batch_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_occurrences_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "secret.kind" => Some(("secret.kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    ...
                    "vulnerability.risk.cisa-kev.known-ransomware-campaign-use" => Some(("vulnerability.risk.cisaKev.knownRansomwareCampaignUse", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "vulnerability.risk.epss.percentile" => Some(("vulnerability.risk.epss.percentile", JsonTypeInfo { jtype: JsonType::Float, ctype: ComplexType::Pod })),
                    "vulnerability.risk.epss.score" => Some(("vulnerability.risk.epss.score", JsonTypeInfo { jtype: JsonType::Float, ctype: ComplexType::Pod })),
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["-type", "address", "alias-context", "analysis-completed", "analysis-status", "analysis-status-error", "analysis-type", "architecture", "archive-time", "arguments", "artifact-storage-source-uri", "attack-complexity", "attack-vector", "attestation", "authentication", "availability-impact", "base-resource-url", "base-score", "benchmark-document", "build", "build-definition", "build-finished-on", "build-invocation-id", "build-options", "build-started-on", "build-type", "builder", "builder-config", "builder-version", "cisa-kev", "classification", "cloud-repo", "code", "comments", "completeness", "compliance", "confidentiality-impact", "config", "config-source", "context", "continuous-analysis", "cpe", "cpe-uri", "create-time", "creator", "cve", "cvss-score", "cvss-v2", "cvss-version", "cvssv3", "defined-in-material", "deploy-time", "deployment", "description", "details", "digest", "discovery", "distance", "distribution", "dsse-attestation", "effective-severity", "end-time", "entry-point", "envelope", "environment", "epoch", "epss", "error", "exploitability-score", "expression", "extra-details", "fingerprint", "finished-on", "fix-available", "full-name", "gerrit", "gerrit-project", "git", "host-uri", "id", "identity", "image", "impact-score", "impacts", "in-toto-slsa-provenance-v1", "inclusive", "integrity-impact", "intoto-provenance", "intoto-statement", "invocation", "invocation-id", "justification", "justification-type", "kb-article-ids", "kind", "known-ransomware-campaign-use", "labels", "last-published-timestamp", "last-scan-time", "license", "location", "logs-uri", "long-description", "materials", "message", "metadata", "mime-type", "name", "non-compliance-reason", "note-name", "package", "package-type", "parameters", "parsed-version", "payload", "payload-type", "percentile", "platform", "predicate", "predicate-type", "privileges-required", "project-id", "project-repo-id", "provenance", "provenance-bytes", "recipe", "referrer-id", "remediation", "repo-id", "repo-name", "reproducible", "resource-uri", "revision", "revision-id", "risk", "run-details", "sbom-reference", "sbom-state", "sbom-status", "scope", "score", "secret", "serialized-payload", "severity", "short-description", "slsa-provenance", "slsa-provenance-zero-two", "source-provenance", "start-time", "started-on", "state", "statement", "support-url", "title", "trigger-id", "type", "uid", "undeploy-time", "update-id", "update-time", "upgrade", "uri", "url", "user-email", "user-interaction", "v1-name", "v2-blob", "v2-name", "version", "vex-assessment", "vulnerability", "vulnerability-id", "windows-update"]);
        ...
        let mut call = self
            .hub
            .projects()
            .locations_occurrences_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_occurrences_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_occurrences_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_occurrences_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_occurrences_get_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["filter", "return-partial-success"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _projects_locations_occurrences_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_occurrences_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_occurrences_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_occurrences_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_occurrences_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_occurrences_test_iam_permissions(
                request,
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-notes-batch-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_notes_batch_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-notes-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_notes_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-notes-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_notes_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-notes-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_notes_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-notes-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_notes_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-notes-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_notes_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-notes-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_notes_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-occurrences-batch-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_occurrences_batch_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-occurrences-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_occurrences_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-occurrences-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_occurrences_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-occurrences-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_occurrences_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-occurrences-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_occurrences_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-occurrences-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_occurrences_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-occurrences-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_occurrences_test_iam_permissions(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'locations-notes-batch-create', 'locations-notes-create', 'locations-notes-delete', 'locations-notes-get', 'locations-notes-get-iam-policy', 'locations-notes-list', 'locations-notes-occurrences-list', 'locations-notes-patch', 'locations-notes-set-iam-policy', 'locations-notes-test-iam-permissions', 'locations-occurrences-batch-create', 'locations-occurrences-create', 'locations-occurrences-delete', 'locations-occurrences-get', 'locations-occurrences-get-iam-policy', 'locations-occurrences-get-notes', 'locations-occurrences-get-vulnerability-summary', 'locations-occurrences-list', 'locations-occurrences-patch', 'locations-occurrences-set-iam-policy', 'locations-occurrences-test-iam-permissions', 'locations-resources-export-sbom', 'notes-batch-create', 'notes-create', 'notes-delete', 'notes-get', 'notes-get-iam-policy', 'notes-list', 'notes-occurrences-list', 'notes-patch', 'notes-set-iam-policy', 'notes-test-iam-permissions', 'occurrences-batch-create', 'occurrences-create', 'occurrences-delete', 'occurrences-get', 'occurrences-get-iam-policy', 'occurrences-get-notes', 'occurrences-get-vulnerability-summary', 'occurrences-list', 'occurrences-patch', 'occurrences-set-iam-policy', 'occurrences-test-iam-permissions' and 'resources-export-sbom'", vec![
            ("locations-notes-batch-create",
                    Some(r##"Creates new notes in batch."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-notes-batch-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-notes-create",
                    Some(r##"Creates a new note."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-notes-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-notes-delete",
                    Some(r##"Deletes the specified note."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-notes-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-notes-get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-notes-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-notes-patch",
                    Some(r##"Updates the specified note."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-notes-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the note in the form of `projects/[PROVIDER_ID]/notes/[NOTE_ID]`."##),
            ...
            ("locations-notes-set-iam-policy",
                    Some(r##"Sets the access control policy on the specified note or occurrence. Requires `containeranalysis.notes.setIamPolicy` or `containeranalysis.occurrences.setIamPolicy` permission if the resource is a note or an occurrence, respectively. The resource takes the format `projects/[PROJECT_ID]/notes/[NOTE_ID]` for notes and `projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]` for occurrences."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-notes-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-notes-test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-notes-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-occurrences-batch-create",
                    Some(r##"Creates new occurrences in batch."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-occurrences-batch-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-occurrences-create",
                    Some(r##"Creates a new occurrence."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-occurrences-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-occurrences-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-occurrences-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-occurrences-get-iam-policy",
                    Some(r##"Gets the access control policy for a note or an occurrence resource. Requires `containeranalysis.notes.setIamPolicy` or `containeranalysis.occurrences.setIamPolicy` permission if the resource is a note or occurrence, respectively. The resource takes the format `projects/[PROJECT_ID]/notes/[NOTE_ID]` for notes and `projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]` for occurrences."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-occurrences-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("locations-occurrences-patch",
                    Some(r##"Updates the specified occurrence."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-occurrences-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the occurrence in the form of `projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]`."##),
            ...
            ("locations-occurrences-set-iam-policy",
                    Some(r##"Sets the access control policy on the specified note or occurrence. Requires `containeranalysis.notes.setIamPolicy` or `containeranalysis.occurrences.setIamPolicy` permission if the resource is a note or an occurrence, respectively. The resource takes the format `projects/[PROJECT_ID]/notes/[NOTE_ID]` for notes and `projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]` for occurrences."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-occurrences-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("locations-occurrences-test-iam-permissions",
                    Some(r##"Returns the permissions that a caller has on the specified note or occurrence. Requires list permission on the project (for example, `containeranalysis.notes.list`). The resource takes the format `projects/[PROJECT_ID]/notes/[NOTE_ID]` for notes and `projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]` for occurrences."##),
                    "Details at http://byron.github.io/google-apis-rs/google_containeranalysis1_cli/projects_locations-occurrences-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
    ...
    let mut app = App::new("containeranalysis1")
           ...
           .about("This API is a prerequisite for leveraging Artifact Analysis scanning capabilities in Artifact Registry. In addition, the Container Analysis API is an implementation of the Grafeas API, which enables storing, querying, and retrieval of critical metadata about all of your software artifacts.")
