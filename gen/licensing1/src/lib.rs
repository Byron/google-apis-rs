...
//! This documentation was generated from *licensing* crate version *3.0.0+20220305*, where *20220305* is the exact revision of the *licensing:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v3.0.0*.
//! 
