...
//! This documentation was generated from *licensing* crate version *7.0.0+20251215*, where *20251215* is the exact revision of the *licensing:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
