...
//! This documentation was generated from *licensing* crate version *5.0.2+20230121*, where *20230121* is the exact revision of the *licensing:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2*.
//! 
