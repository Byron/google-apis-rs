...
//! This documentation was generated from *licensing* crate version *1.0.7+20170213*, where *20170213* is the exact revision of the *licensing:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.7*.
//! 
