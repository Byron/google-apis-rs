...
//! This documentation was generated from *licensing* crate version *8.0.0+20251025*, where *20251025* is the exact revision of the *licensing:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
//! Everything else about the *licensing* *v1* API can be found at the
//! [official documentation site](https://developers.google.com/workspace/admin/licensing/).
