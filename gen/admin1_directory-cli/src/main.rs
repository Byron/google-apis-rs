...
impl<'n> Engine<'n> {
    fn _asps_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _asps_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let code_id: i32 = arg_from_str(&opt.value_of("code-id").unwrap_or(""), err, "<code-id>", "integer");
    ...
    fn _asps_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _chromeosdevices_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _chromeosdevices_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "mac-address" => Some(("macAddress", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "last-sync" => Some(("lastSync", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "order-number" => Some(("orderNumber", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "annotated-user" => Some(("annotatedUser", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    ...
                    "will-auto-renew" => Some(("willAutoRenew", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    "ethernet-mac-address" => Some(("ethernetMacAddress", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "meid" => Some(("meid", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "annotated-location" => Some(("annotatedLocation", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    ...
                    "tpm-version-info.vendor-specific" => Some(("tpmVersionInfo.vendorSpecific", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "tpm-version-info.family" => Some(("tpmVersionInfo.family", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "tpm-version-info.firmware-version" => Some(("tpmVersionInfo.firmwareVersion", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
        ...
        let mut request: api::ChromeOsDevice = json::value::from_value(object).unwrap();
    ...
    fn _chromeosdevices_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _customers_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.customers().get(opt.value_of("customer-key").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _customers_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "customer-creation-time" => Some(("customerCreationTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "kind" => Some(("kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "etag" => Some(("etag", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    ...
                    "id" => Some(("id", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["address-line1", "address-line2", "address-line3", "alternate-email", "contact-name", "country-code", "customer-creation-time", "customer-domain", "etag", "id", "kind", "language", "locality", "organization-name", "phone-number", "postal-address", "postal-code", "region"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::Customer = json::value::from_value(object).unwrap();
        let mut call = self.hub.customers().patch(request, opt.value_of("customer-key").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _customers_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::Customer = json::value::from_value(object).unwrap();
        let mut call = self.hub.customers().update(request, opt.value_of("customer-key").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _domain_aliases_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.domain_aliases().delete(opt.value_of("customer").unwrap_or(""), opt.value_of("domain-alias-name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _domain_aliases_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.domain_aliases().get(opt.value_of("customer").unwrap_or(""), opt.value_of("domain-alias-name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _domain_aliases_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "kind" => Some(("kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "verified" => Some(("verified", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    "creation-time" => Some(("creationTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "etag" => Some(("etag", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "domain-alias-name" => Some(("domainAliasName", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "parent-domain-name" => Some(("parentDomainName", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["creation-time", "domain-alias-name", "etag", "kind", "parent-domain-name", "verified"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::DomainAlias = json::value::from_value(object).unwrap();
        let mut call = self.hub.domain_aliases().insert(request, opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _domain_aliases_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.domain_aliases().list(opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "parent-domain-name" => {
                    call = call.parent_domain_name(value.unwrap_or(""));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["parent-domain-name"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _domains_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.domains().delete(opt.value_of("customer").unwrap_or(""), opt.value_of("domain-name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _domains_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.domains().get(opt.value_of("customer").unwrap_or(""), opt.value_of("domain-name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _domains_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["creation-time", "domain-name", "etag", "is-primary", "kind", "verified"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::Domains = json::value::from_value(object).unwrap();
        let mut call = self.hub.domains().insert(request, opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _domains_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.domains().list(opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _groups_aliases_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _groups_aliases_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "alias" => Some(("alias", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "kind" => Some(("kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "etag" => Some(("etag", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
        ...
        let mut request: api::Alias = json::value::from_value(object).unwrap();
    ...
    fn _groups_aliases_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _groups_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _groups_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "non-editable-aliases" => Some(("nonEditableAliases", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Vec })),
                    "kind" => Some(("kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "description" => Some(("description", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "name" => Some(("name", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "admin-created" => Some(("adminCreated", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    "direct-members-count" => Some(("directMembersCount", JsonTypeInfo { jtype: JsonType::Int, ctype: ComplexType::Pod })),
                    "id" => Some(("id", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "etag" => Some(("etag", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
    ...
    fn _groups_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["order-by", "customer", "domain", "max-results", "page-token", "sort-order", "query", "user-key"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _members_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _members_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _members_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "status" => Some(("status", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "kind" => Some(("kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "delivery-settings" => Some(("delivery_settings", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "id" => Some(("id", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "etag" => Some(("etag", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    ...
                    "email" => Some(("email", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["delivery-settings", "email", "etag", "id", "kind", "role", "status", "type"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::Member = json::value::from_value(object).unwrap();
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                "include-derived-membership" => {
                    call = call.include_derived_membership(arg_from_str(value.unwrap_or("false"), err, "include-derived-membership", "boolean"));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["page-token", "include-derived-membership", "max-results", "roles"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _members_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _members_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _mobiledevices_action(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::MobileDeviceAction = json::value::from_value(object).unwrap();
    ...
    fn _mobiledevices_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _mobiledevices_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _mobiledevices_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _notifications_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "notification-id" => Some(("notificationId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "from-address" => Some(("fromAddress", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "is-unread" => Some(("isUnread", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    "subject" => Some(("subject", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
    ...
    fn _notifications_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _orgunits_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.orgunits().delete(opt.value_of("customer-id").unwrap_or(""), &opt.values_of("org-unit-path").map(|i|i.collect()).unwrap_or(Vec::new()).iter().map(|&v| v.to_string()).collect::<Vec<String>>());
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _orgunits_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.orgunits().get(opt.value_of("customer-id").unwrap_or(""), &opt.values_of("org-unit-path").map(|i|i.collect()).unwrap_or(Vec::new()).iter().map(|&v| v.to_string()).collect::<Vec<String>>());
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _orgunits_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "kind" => Some(("kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "parent-org-unit-path" => Some(("parentOrgUnitPath", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "name" => Some(("name", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "etag" => Some(("etag", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "org-unit-path" => Some(("orgUnitPath", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "parent-org-unit-id" => Some(("parentOrgUnitId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "block-inheritance" => Some(("blockInheritance", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
        ...
        let mut request: api::OrgUnit = json::value::from_value(object).unwrap();
    ...
    fn _orgunits_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["type", "org-unit-path"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _orgunits_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::OrgUnit = json::value::from_value(object).unwrap();
        let mut call = self.hub.orgunits().patch(request, opt.value_of("customer-id").unwrap_or(""), &opt.values_of("org-unit-path").map(|i|i.collect()).unwrap_or(Vec::new()).iter().map(|&v| v.to_string()).collect::<Vec<String>>());
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _orgunits_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::OrgUnit = json::value::from_value(object).unwrap();
        let mut call = self.hub.orgunits().update(request, opt.value_of("customer-id").unwrap_or(""), &opt.values_of("org-unit-path").map(|i|i.collect()).unwrap_or(Vec::new()).iter().map(|&v| v.to_string()).collect::<Vec<String>>());
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _privileges_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.privileges().list(opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_buildings_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.resources().buildings_delete(opt.value_of("customer").unwrap_or(""), opt.value_of("building-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_buildings_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.resources().buildings_get(opt.value_of("customer").unwrap_or(""), opt.value_of("building-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_buildings_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Building = json::value::from_value(object).unwrap();
        let mut call = self.hub.resources().buildings_insert(request, opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "coordinates-source" => {
    ...
    fn _resources_buildings_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.resources().buildings_list(opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    fn _resources_buildings_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Building = json::value::from_value(object).unwrap();
        let mut call = self.hub.resources().buildings_patch(request, opt.value_of("customer").unwrap_or(""), opt.value_of("building-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "coordinates-source" => {
    ...
    fn _resources_buildings_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Building = json::value::from_value(object).unwrap();
        let mut call = self.hub.resources().buildings_update(request, opt.value_of("customer").unwrap_or(""), opt.value_of("building-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "coordinates-source" => {
    ...
    fn _resources_calendars_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.resources().calendars_get(opt.value_of("customer").unwrap_or(""), opt.value_of("calendar-resource-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_calendars_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::CalendarResource = json::value::from_value(object).unwrap();
        let mut call = self.hub.resources().calendars_insert(request, opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_calendars_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.resources().calendars_list(opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "query" => {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["order-by", "query", "max-results", "page-token"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _resources_calendars_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::CalendarResource = json::value::from_value(object).unwrap();
        let mut call = self.hub.resources().calendars_patch(request, opt.value_of("customer").unwrap_or(""), opt.value_of("calendar-resource-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_calendars_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::CalendarResource = json::value::from_value(object).unwrap();
        let mut call = self.hub.resources().calendars_update(request, opt.value_of("customer").unwrap_or(""), opt.value_of("calendar-resource-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_features_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.resources().features_delete(opt.value_of("customer").unwrap_or(""), opt.value_of("feature-key").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_features_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.resources().features_get(opt.value_of("customer").unwrap_or(""), opt.value_of("feature-key").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_features_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "name" => Some(("name", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["etags", "kind", "name"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::Feature = json::value::from_value(object).unwrap();
        let mut call = self.hub.resources().features_insert(request, opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_features_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.resources().features_list(opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    fn _resources_features_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Feature = json::value::from_value(object).unwrap();
        let mut call = self.hub.resources().features_patch(request, opt.value_of("customer").unwrap_or(""), opt.value_of("feature-key").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_features_rename(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "new-name" => Some(("newName", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["new-name"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::FeatureRename = json::value::from_value(object).unwrap();
        let mut call = self.hub.resources().features_rename(request, opt.value_of("customer").unwrap_or(""), opt.value_of("old-name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _resources_features_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Feature = json::value::from_value(object).unwrap();
        let mut call = self.hub.resources().features_update(request, opt.value_of("customer").unwrap_or(""), opt.value_of("feature-key").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _role_assignments_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.role_assignments().delete(opt.value_of("customer").unwrap_or(""), opt.value_of("role-assignment-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _role_assignments_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.role_assignments().get(opt.value_of("customer").unwrap_or(""), opt.value_of("role-assignment-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _role_assignments_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "kind" => Some(("kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "role-assignment-id" => Some(("roleAssignmentId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "role-id" => Some(("roleId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "assigned-to" => Some(("assignedTo", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "etag" => Some(("etag", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "scope-type" => Some(("scopeType", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "org-unit-id" => Some(("orgUnitId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["assigned-to", "etag", "kind", "org-unit-id", "role-assignment-id", "role-id", "scope-type"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::RoleAssignment = json::value::from_value(object).unwrap();
        let mut call = self.hub.role_assignments().insert(request, opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _role_assignments_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.role_assignments().list(opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "user-key" => {
                ...
                "role-id" => {
                    call = call.role_id(value.unwrap_or(""));
                },
                "page-token" => {
                    call = call.page_token(value.unwrap_or(""));
                },
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["user-key", "max-results", "page-token", "role-id"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _roles_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.roles().delete(opt.value_of("customer").unwrap_or(""), opt.value_of("role-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _roles_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.roles().get(opt.value_of("customer").unwrap_or(""), opt.value_of("role-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _roles_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "kind" => Some(("kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "role-id" => Some(("roleId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "role-description" => Some(("roleDescription", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "etag" => Some(("etag", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "is-super-admin-role" => Some(("isSuperAdminRole", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    "role-name" => Some(("roleName", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "is-system-role" => Some(("isSystemRole", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["etag", "is-super-admin-role", "is-system-role", "kind", "role-description", "role-id", "role-name"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::Role = json::value::from_value(object).unwrap();
        let mut call = self.hub.roles().insert(request, opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _roles_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.roles().list(opt.value_of("customer").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "page-token" => {
    ...
    fn _roles_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Role = json::value::from_value(object).unwrap();
        let mut call = self.hub.roles().patch(request, opt.value_of("customer").unwrap_or(""), opt.value_of("role-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _roles_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::Role = json::value::from_value(object).unwrap();
        let mut call = self.hub.roles().update(request, opt.value_of("customer").unwrap_or(""), opt.value_of("role-id").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    fn _schemas_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _schemas_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _schemas_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "schema-id" => Some(("schemaId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "schema-name" => Some(("schemaName", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["display-name", "etag", "kind", "schema-id", "schema-name"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        let mut request: api::Schema = json::value::from_value(object).unwrap();
    ...
    fn _schemas_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _schemas_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _schemas_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _tokens_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _tokens_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _tokens_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _users_aliases_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _users_aliases_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _users_aliases_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _users_aliases_watch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["view-type", "custom-field-mask", "projection"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _users_insert(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "is-delegated-admin" => Some(("isDelegatedAdmin", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    "thumbnail-photo-etag" => Some(("thumbnailPhotoEtag", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    ...
                    "kind" => Some(("kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "hash-function" => Some(("hashFunction", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["order-by", "customer", "domain", "projection", "page-token", "custom-field-mask", "max-results", "show-deleted", "sort-order", "query", "view-type", "event"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _users_make_admin(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "status" => Some(("status", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    _ => {
        ...
        let mut request: api::UserMakeAdmin = json::value::from_value(object).unwrap();
    ...
    fn _users_photos_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _users_photos_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _users_photos_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "kind" => Some(("kind", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "photo-data" => Some(("photoData", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
        ...
        let mut request: api::UserPhoto = json::value::from_value(object).unwrap();
    ...
    fn _users_photos_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _users_undelete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::UserUndelete = json::value::from_value(object).unwrap();
    ...
    fn _verification_codes_generate(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _verification_codes_invalidate(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _verification_codes_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _doit(&self, dry_run: bool) -> Result<Result<(), DoitError>, Option<InvalidOptionsError>> {
        ...
        match self.opt.subcommand() {
            ...
            ("domain-aliases", Some(opt)) => {
                match opt.subcommand() {
                    ("delete", Some(opt)) => {
                        call_result = self._domain_aliases_delete(opt, dry_run, &mut err);
                    },
                    ("get", Some(opt)) => {
                        call_result = self._domain_aliases_get(opt, dry_run, &mut err);
                    },
                    ("insert", Some(opt)) => {
                        call_result = self._domain_aliases_insert(opt, dry_run, &mut err);
                    },
                    ("list", Some(opt)) => {
                        call_result = self._domain_aliases_list(opt, dry_run, &mut err);
                    },
                    _ => {
                        err.issues.push(CLIError::MissingMethodError("domain-aliases".to_string()));
                        writeln!(io::stderr(), "{}\n", opt.usage()).ok();
                    }
                }
            },
            ("domains", Some(opt)) => {
                match opt.subcommand() {
                    ("delete", Some(opt)) => {
                        call_result = self._domains_delete(opt, dry_run, &mut err);
                    },
                    ("get", Some(opt)) => {
                        call_result = self._domains_get(opt, dry_run, &mut err);
                    },
                    ("insert", Some(opt)) => {
                        call_result = self._domains_insert(opt, dry_run, &mut err);
                    },
                    ("list", Some(opt)) => {
                        call_result = self._domains_list(opt, dry_run, &mut err);
                    },
                    _ => {
                        err.issues.push(CLIError::MissingMethodError("domains".to_string()));
                        writeln!(io::stderr(), "{}\n", opt.usage()).ok();
                    }
                }
            },
            ...
            ("privileges", Some(opt)) => {
                match opt.subcommand() {
                    ("list", Some(opt)) => {
                        call_result = self._privileges_list(opt, dry_run, &mut err);
                    },
                    _ => {
            ...
            ("resources", Some(opt)) => {
                match opt.subcommand() {
                    ("buildings-delete", Some(opt)) => {
                        call_result = self._resources_buildings_delete(opt, dry_run, &mut err);
                    },
                    ("buildings-get", Some(opt)) => {
                        call_result = self._resources_buildings_get(opt, dry_run, &mut err);
                    },
                    ("buildings-insert", Some(opt)) => {
                        call_result = self._resources_buildings_insert(opt, dry_run, &mut err);
                    },
                    ("buildings-list", Some(opt)) => {
                        call_result = self._resources_buildings_list(opt, dry_run, &mut err);
                    },
                    ("buildings-patch", Some(opt)) => {
                        call_result = self._resources_buildings_patch(opt, dry_run, &mut err);
                    },
                    ("buildings-update", Some(opt)) => {
                        call_result = self._resources_buildings_update(opt, dry_run, &mut err);
                    },
                    ("calendars-delete", Some(opt)) => {
                        call_result = self._resources_calendars_delete(opt, dry_run, &mut err);
                    },
                    ("calendars-get", Some(opt)) => {
                        call_result = self._resources_calendars_get(opt, dry_run, &mut err);
                    },
                    ("calendars-insert", Some(opt)) => {
                        call_result = self._resources_calendars_insert(opt, dry_run, &mut err);
                    },
                    ("calendars-list", Some(opt)) => {
                        call_result = self._resources_calendars_list(opt, dry_run, &mut err);
                    },
                    ("calendars-patch", Some(opt)) => {
                        call_result = self._resources_calendars_patch(opt, dry_run, &mut err);
                    },
                    ("calendars-update", Some(opt)) => {
                        call_result = self._resources_calendars_update(opt, dry_run, &mut err);
                    },
                    ("features-delete", Some(opt)) => {
                        call_result = self._resources_features_delete(opt, dry_run, &mut err);
                    },
                    ("features-get", Some(opt)) => {
                        call_result = self._resources_features_get(opt, dry_run, &mut err);
                    },
                    ("features-insert", Some(opt)) => {
                        call_result = self._resources_features_insert(opt, dry_run, &mut err);
                    },
                    ("features-list", Some(opt)) => {
                        call_result = self._resources_features_list(opt, dry_run, &mut err);
                    },
                    ("features-patch", Some(opt)) => {
                        call_result = self._resources_features_patch(opt, dry_run, &mut err);
                    },
                    ("features-rename", Some(opt)) => {
                        call_result = self._resources_features_rename(opt, dry_run, &mut err);
                    },
                    ("features-update", Some(opt)) => {
                        call_result = self._resources_features_update(opt, dry_run, &mut err);
                    },
                    _ => {
            ...
            ("role-assignments", Some(opt)) => {
                match opt.subcommand() {
                    ("delete", Some(opt)) => {
                        call_result = self._role_assignments_delete(opt, dry_run, &mut err);
                    },
                    ("get", Some(opt)) => {
                        call_result = self._role_assignments_get(opt, dry_run, &mut err);
                    },
                    ("insert", Some(opt)) => {
                        call_result = self._role_assignments_insert(opt, dry_run, &mut err);
                    },
                    ("list", Some(opt)) => {
                        call_result = self._role_assignments_list(opt, dry_run, &mut err);
                    },
                    _ => {
                        err.issues.push(CLIError::MissingMethodError("role-assignments".to_string()));
                        writeln!(io::stderr(), "{}\n", opt.usage()).ok();
                    }
                }
            },
            ("roles", Some(opt)) => {
                match opt.subcommand() {
                    ("delete", Some(opt)) => {
                        call_result = self._roles_delete(opt, dry_run, &mut err);
                    },
                    ("get", Some(opt)) => {
                        call_result = self._roles_get(opt, dry_run, &mut err);
                    },
                    ("insert", Some(opt)) => {
                        call_result = self._roles_insert(opt, dry_run, &mut err);
                    },
                    ("list", Some(opt)) => {
                        call_result = self._roles_list(opt, dry_run, &mut err);
                    },
                    ("patch", Some(opt)) => {
                        call_result = self._roles_patch(opt, dry_run, &mut err);
                    },
                    ("update", Some(opt)) => {
                        call_result = self._roles_update(opt, dry_run, &mut err);
                    },
                    _ => {
...
fn main() {
    ...
    let arg_data = [
        ...
        ("customers", "methods: 'get', 'patch' and 'update'", vec![
            ("get",
                  ...
                  vec![
                    (Some(r##"customer-key"##),
                     None,
                     Some(r##"Id of the customer to be retrieved"##),
                     Some(true),
                     Some(false)),
            ...
            ("patch",
                    Some(r##"Updates a customer. This method supports patch semantics."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/customers_patch",
                  vec![
                    (Some(r##"customer-key"##),
                     None,
                     Some(r##"Id of the customer to be updated"##),
                     Some(true),
                     Some(false)),
            ...
            ("update",
                    Some(r##"Updates a customer."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/customers_update",
                  vec![
                    (Some(r##"customer-key"##),
                     None,
                     Some(r##"Id of the customer to be updated"##),
        ...
        ("domain-aliases", "methods: 'delete', 'get', 'insert' and 'list'", vec![
            ("delete",
                    Some(r##"Deletes a Domain Alias of the customer."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/domain-aliases_delete",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
                    ...
                    (Some(r##"domain-alias-name"##),
                     None,
                     Some(r##"Name of domain alias to be retrieved."##),
                     Some(true),
                     Some(false)),
            ...
            ("get",
                    Some(r##"Retrieves a domain alias of the customer."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/domain-aliases_get",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
            ...
            ("insert",
                    Some(r##"Inserts a Domain alias of the customer."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/domain-aliases_insert",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
            ...
            ("list",
                    Some(r##"Lists the domain aliases of the customer."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/domain-aliases_list",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
        ...
        ("domains", "methods: 'delete', 'get', 'insert' and 'list'", vec![
            ("delete",
                    Some(r##"Deletes a domain of the customer."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/domains_delete",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
                    ...
                    (Some(r##"domain-name"##),
                     None,
                     Some(r##"Name of domain to be deleted"##),
                     Some(true),
                     Some(false)),
            ...
            ("get",
                  ...
                  vec![
                    ...
                    (Some(r##"domain-name"##),
                     None,
                     Some(r##"Name of domain to be retrieved"##),
                     Some(true),
                     Some(false)),
            ...
            ("insert",
                    Some(r##"Inserts a domain of the customer."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/domains_insert",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
            ...
            ("list",
                    Some(r##"Lists the domains of the customer."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/domains_list",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
        ...
        ("groups", "methods: 'aliases-delete', 'aliases-insert', 'aliases-list', 'delete', 'get', 'insert', 'list', 'patch' and 'update'", vec![
            ...
            ("list",
                    Some(r##"Retrieve all groups of a domain or of a user given a userKey (paginated)"##),
        ...
        ("members", "methods: 'delete', 'get', 'has-member', 'insert', 'list', 'patch' and 'update'", vec![
            ...
            ("has-member",
                    Some(r##"Checks whether the given user is a member of the group. Membership can be direct or nested."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/members_has-member",
                  vec![
                    (Some(r##"group-key"##),
                     None,
                     Some(r##"Identifies the group in the API request. The value can be the group's email address, group alias, or the unique group ID."##),
                     Some(true),
                     Some(false)),
        
                    (Some(r##"member-key"##),
                     None,
                     Some(r##"Identifies the user member in the API request. The value can be the user's primary email address, alias, or unique ID."##),
                     Some(true),
                     Some(false)),
        ...
        ("privileges", "methods: 'list'", vec![
            ("list",
                    Some(r##"Retrieves a paginated list of all privileges for a customer."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/privileges_list",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
        ...
        ("resources", "methods: 'buildings-delete', 'buildings-get', 'buildings-insert', 'buildings-list', 'buildings-patch', 'buildings-update', 'calendars-delete', 'calendars-get', 'calendars-insert', 'calendars-list', 'calendars-patch', 'calendars-update', 'features-delete', 'features-get', 'features-insert', 'features-list', 'features-patch', 'features-rename' and 'features-update'", vec![
            ("buildings-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_buildings-delete",
                  vec![
                    (Some(r##"customer"##),
                     None,
                    ...
                    (Some(r##"building-id"##),
                     None,
                     Some(r##"The ID of the building to delete."##),
                     Some(true),
                     Some(false)),
            ...
            ("buildings-get",
                    Some(r##"Retrieves a building."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_buildings-get",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
                    ...
                    (Some(r##"building-id"##),
                     None,
                     Some(r##"The unique ID of the building to retrieve."##),
                     Some(true),
                     Some(false)),
            ...
            ("buildings-insert",
                    Some(r##"Inserts a building."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_buildings-insert",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
            ...
            ("buildings-list",
                    Some(r##"Retrieves a list of buildings for an account."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_buildings-list",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
            ...
            ("buildings-patch",
                    Some(r##"Updates a building. This method supports patch semantics."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_buildings-patch",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
                    ...
                    (Some(r##"building-id"##),
                     None,
                     Some(r##"The ID of the building to update."##),
                     Some(true),
                     Some(false)),
            ...
            ("buildings-update",
                    Some(r##"Updates a building."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_buildings-update",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
            ...
            ("calendars-delete",
                    Some(r##"Deletes a calendar resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_calendars-delete",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
                    ...
                    (Some(r##"calendar-resource-id"##),
                     None,
                     Some(r##"The unique ID of the calendar resource to delete."##),
                     Some(true),
                     Some(false)),
            ...
            ("calendars-get",
                    Some(r##"Retrieves a calendar resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_calendars-get",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
                    ...
                    (Some(r##"calendar-resource-id"##),
                     None,
                     Some(r##"The unique ID of the calendar resource to retrieve."##),
                     Some(true),
                     Some(false)),
            ...
            ("calendars-insert",
                    Some(r##"Inserts a calendar resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_calendars-insert",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
            ...
            ("calendars-list",
                    Some(r##"Retrieves a list of calendar resources for an account."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_calendars-list",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
        ...
        This method supports patch semantics, meaning you only need to include the fields you wish to update. Fields that are not present in the request will be preserved. This method supports patch semantics."##),
                  ...
                  vec![
                    ...
                    (Some(r##"calendar-resource-id"##),
                     None,
                     Some(r##"The unique ID of the calendar resource to update."##),
                     Some(true),
                     Some(false)),
        ...
        This method supports patch semantics, meaning you only need to include the fields you wish to update. Fields that are not present in the request will be preserved."##),
            ...
            ("features-delete",
                    Some(r##"Deletes a feature."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_features-delete",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
                    ...
                    (Some(r##"feature-key"##),
                     None,
                     Some(r##"The unique ID of the feature to delete."##),
                     Some(true),
                     Some(false)),
            ...
            ("features-get",
                    Some(r##"Retrieves a feature."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_features-get",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
                    ...
                    (Some(r##"feature-key"##),
                     None,
                     Some(r##"The unique ID of the feature to retrieve."##),
                     Some(true),
                     Some(false)),
            ...
            ("features-insert",
                    Some(r##"Inserts a feature."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_features-insert",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
            ...
            ("features-list",
                    Some(r##"Retrieves a list of features for an account."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_features-list",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
            ...
            ("features-patch",
                    Some(r##"Updates a feature. This method supports patch semantics."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_features-patch",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
                    ...
                    (Some(r##"feature-key"##),
                     None,
                     Some(r##"The unique ID of the feature to update."##),
                     Some(true),
                     Some(false)),
            ...
            ("features-rename",
                    Some(r##"Renames a feature."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_features-rename",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
                    ...
                    (Some(r##"old-name"##),
                     None,
                     Some(r##"The unique ID of the feature to rename."##),
                     Some(true),
                     Some(false)),
            ...
            ("features-update",
                    Some(r##"Updates a feature."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/resources_features-update",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID."##),
        ...
        ("role-assignments", "methods: 'delete', 'get', 'insert' and 'list'", vec![
            ("delete",
                    Some(r##"Deletes a role assignment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/role-assignments_delete",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
                    ...
                    (Some(r##"role-assignment-id"##),
                     None,
                     Some(r##"Immutable ID of the role assignment."##),
                     Some(true),
                     Some(false)),
            ...
            ("get",
                    Some(r##"Retrieve a role assignment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/role-assignments_get",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
            ...
            ("insert",
                    Some(r##"Creates a role assignment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/role-assignments_insert",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
            ...
            ("list",
                    Some(r##"Retrieves a paginated list of all roleAssignments."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/role-assignments_list",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
        ...
        ("roles", "methods: 'delete', 'get', 'insert', 'list', 'patch' and 'update'", vec![
            ("delete",
                    Some(r##"Deletes a role."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/roles_delete",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
                    ...
                    (Some(r##"role-id"##),
                     None,
                     Some(r##"Immutable ID of the role."##),
                     Some(true),
                     Some(false)),
            ...
            ("get",
                    Some(r##"Retrieves a role."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/roles_get",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
            ...
            ("insert",
                    Some(r##"Creates a role."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/roles_insert",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
            ...
            ("list",
                    Some(r##"Retrieves a paginated list of all the roles in a domain."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/roles_list",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
            ...
            ("patch",
                    Some(r##"Updates a role. This method supports patch semantics."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/roles_patch",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
            ...
            ("update",
                    Some(r##"Updates a role."##),
                    "Details at http://byron.github.io/google-apis-rs/google_admin1_directory_cli/roles_update",
                  vec![
                    (Some(r##"customer"##),
                     None,
                     Some(r##"Immutable ID of the G Suite account."##),
