...
//! This documentation was generated from *Games Management* crate version *0.1.10+20151012*, where *20151012* is the exact revision of the *gamesManagement:v1management* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.10*.
//! 
