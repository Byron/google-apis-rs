...
impl<C> common::Hub for GameServices<C> {}
...
impl common::Part for AuthorizationLoggingOptions {}
...
impl<'a, C> common::CallBuilder for ProjectLocationGameServerDeploymentGetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationGameServerDeploymentGetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGameServerDeploymentGetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationGameServerDeploymentSetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationGameServerDeploymentSetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGameServerDeploymentSetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder
    for ProjectLocationGameServerDeploymentTestIamPermissionCall<'a, C>
{
}

impl<'a, C> ProjectLocationGameServerDeploymentTestIamPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
