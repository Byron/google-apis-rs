...
//! This documentation was generated from *taskqueue* crate version *0.1.8+20141111*, where *20141111* is the exact revision of the *taskqueue:v1beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.8*.
//! 
