...
//! This documentation was generated from *translate* crate version *1.0.1+20160627*, where *20160627* is the exact revision of the *translate:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.1*.
//! 
