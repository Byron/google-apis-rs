...
//! This documentation was generated from *Translate* crate version *1.0.8+20170525*, where *20170525* is the exact revision of the *translate:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.8*.
//! 
