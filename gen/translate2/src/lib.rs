...
//! This documentation was generated from *Translate* crate version *6.0.0+20170525*, where *20170525* is the exact revision of the *translate:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
...
//!
//! * detections
//!  * [*detect*](api::DetectionDetectCall) and [*list*](api::DetectionListCall)
//! * languages
//!  * [*list*](api::LanguageListCall)
//! * translations
//!  * [*list*](api::TranslationListCall) and [*translate*](api::TranslationTranslateCall)
//!
//!
//!
//!
