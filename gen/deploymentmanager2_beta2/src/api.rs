    ...
    C: common::Connector,
{
    ...
    pub fn update_policy(mut self, new_value: &str) -> DeploymentPatchCall<'a, C> {
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *update policy* query property to the given value.
    pub fn update_policy(mut self, new_value: &str) -> DeploymentUpdateCall<'a, C> {
        self._update_policy = Some(new_value.to_string());
        self
    }
    /// Sets the policy to use for deleting resources.
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, ManifestsListResponse)> {
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "{project}/global/deployments/{deployment}/manifests";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::NdevCloudmanReadonly.as_ref().to_string());
        }
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, ResourcesListResponse)> {
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "{project}/global/deployments/{deployment}/resources";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::NdevCloudmanReadonly.as_ref().to_string());
        }
