...
This documentation was generated from the *Eventarc* API at revision *20251219*. The CLI is at version *7.0.0*.
...
eventarc1 [options]
        projects
                ...
                locations-enrollments-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-enrollments-delete <name> [-p <v>]... [-o <out>]
                locations-enrollments-get <name> [-p <v>]... [-o <out>]
                locations-enrollments-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-enrollments-list <parent> [-p <v>]... [-o <out>]
                locations-enrollments-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-enrollments-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-enrollments-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-get <name> [-p <v>]... [-o <out>]
                locations-get-google-channel-config <name> [-p <v>]... [-o <out>]
                locations-google-api-sources-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-google-api-sources-delete <name> [-p <v>]... [-o <out>]
                locations-google-api-sources-get <name> [-p <v>]... [-o <out>]
                locations-google-api-sources-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-google-api-sources-list <parent> [-p <v>]... [-o <out>]
                locations-google-api-sources-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-google-api-sources-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-google-api-sources-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-list <name> [-p <v>]... [-o <out>]
                locations-message-buses-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-message-buses-delete <name> [-p <v>]... [-o <out>]
                locations-message-buses-get <name> [-p <v>]... [-o <out>]
                locations-message-buses-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-message-buses-list <parent> [-p <v>]... [-o <out>]
                locations-message-buses-list-enrollments <parent> [-p <v>]... [-o <out>]
                locations-message-buses-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-message-buses-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-message-buses-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-pipelines-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-pipelines-list <parent> [-p <v>]... [-o <out>]
                locations-pipelines-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-pipelines-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-pipelines-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
