...
impl<'n, 'a> Engine<'n, 'a> {
    fn _changes_create(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            ...
            match &temp_cursor.to_string()[..] {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["id", "kind", "start-time", "status"]);
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["page-token", "sort-order", "max-results", "sort-by"]
                                                            ));
                    }
                }
            }
    ...
    fn _managed_zones_create(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for kvarg in opt.values_of("kv").unwrap_or(Vec::new()).iter() {
            ...
            match &temp_cursor.to_string()[..] {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["creation-time", "description", "dns-name", "id", "kind", "name", "name-server-set", "name-servers"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                }
            }
        }
    ...
    fn _managed_zones_delete(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _managed_zones_get(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _managed_zones_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _resource_record_sets_list(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").unwrap_or(Vec::new()).iter() {
            ...
            match key {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                Vec::new() + &self.gp + &["page-token", "type", "name", "max-results"]
                                                            ));
                    }
                }
            }
...
fn main() {
    let arg_data = [
        ...
        ("managed-zones", "methods: 'create', 'delete', 'get' and 'list'", vec![
            ("create",  
