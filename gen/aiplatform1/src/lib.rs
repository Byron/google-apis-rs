...
//! This documentation was generated from *Aiplatform* crate version *7.0.0+20251219*, where *20251219* is the exact revision of the *aiplatform:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
...
//!
//! * [evaluate dataset](api::MethodEvaluateDatasetCall)
//! * [evaluate instances](api::MethodEvaluateInstanceCall)
//! * [generate instance rubrics](api::MethodGenerateInstanceRubricCall)
//!
//! Upload supported by ...
//!
...
//! let r = hub.projects().locations_reasoning_engines_memories_purge(...).doit().await
...
//! let r = hub.reasoning_engines().memories_purge(...).doit().await
...
//! let r = hub.reasoning_engines().sandbox_environments_create(...).doit().await
//! let r = hub.reasoning_engines().sandbox_environments_delete(...).doit().await
...
//! let r = hub.methods().evaluate_dataset(...).doit().await
//! ```
//!
