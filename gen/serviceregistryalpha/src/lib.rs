...
//! This documentation was generated from *Service Registry* crate version *5.0.2-beta-1+20160401*, where *20160401* is the exact revision of the *serviceregistry:alpha* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.2-beta-1*.
//! 
