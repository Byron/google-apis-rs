...
//! This documentation was generated from *Service Registry* crate version *8.0.0+20160401*, where *20160401* is the exact revision of the *serviceregistry:alpha* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
