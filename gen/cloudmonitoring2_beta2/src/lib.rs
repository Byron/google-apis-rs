...
//! This documentation was generated from *Cloud Monitoring* crate version *0.1.11+20160221*, where *20160221* is the exact revision of the *cloudmonitoring:v2beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.11*.
//! 
