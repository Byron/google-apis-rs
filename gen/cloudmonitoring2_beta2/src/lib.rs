...
//! This documentation was generated from *Cloud Monitoring* crate version *0.1.7+20150401*, where *20150401* is the exact revision of the *cloudmonitoring:v2beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.7*.
//! 
...
impl<'a, C, A> TimeseriesDescriptorListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListTimeseriesDescriptorsResponse)> {
        ...
        }
        {
            ...
            for param_name in ["project", "metric"].iter() {
