...
pub struct MetricDescriptorListCall<'a, S>
   ...
   pub(super) hub: &'a CloudMonitoring<S>,
   pub(super) _request: ListMetricDescriptorsRequest,
   pub(super) _project: String,
...
pub struct TimeseryListCall<'a, S>
   ...
   pub(super) hub: &'a CloudMonitoring<S>,
   pub(super) _request: ListTimeseriesRequest,
   pub(super) _project: String,
   pub(super) _metric: String,
   pub(super) _youngest: String,
   pub(super) _window: Option<String>,
   pub(super) _timespan: Option<String>,
   pub(super) _page_token: Option<String>,
...
pub struct TimeseryWriteCall<'a, S>
   ...
   pub(super) hub: &'a CloudMonitoring<S>,
   pub(super) _request: WriteTimeseriesRequest,
   pub(super) _project: String,
   pub(super) _delegate: Option<&'a mut dyn client::Delegate>,
   pub(super) _additional_params: HashMap<String, String>,
   pub(super) _scopes: BTreeSet<String>
...
pub struct TimeseriesDescriptorListCall<'a, S>
   ...
   pub(super) hub: &'a CloudMonitoring<S>,
   pub(super) _request: ListTimeseriesDescriptorsRequest,
   pub(super) _project: String,
   pub(super) _metric: String,
   pub(super) _youngest: String,
   pub(super) _window: Option<String>,
