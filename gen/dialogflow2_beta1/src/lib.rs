...
//! This documentation was generated from *Dialogflow* crate version *7.0.0+20251027*, where *20251027* is the exact revision of the *dialogflow:v2beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
...
//! let r = hub.projects().locations_generators_evaluations_create(...).doit().await
