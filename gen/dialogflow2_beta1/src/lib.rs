...
//! This documentation was generated from *Dialogflow* crate version *4.0.1+20220228*, where *20220228* is the exact revision of the *dialogflow:v2beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v4.0.1*.
//! 
...
//! use dialogflow2_beta1::{Dialogflow, oauth2, hyper, hyper_rustls};
//! 
