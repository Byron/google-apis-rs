...
use google_clouddebugger2::{api, yup_oauth2, Error};
...
{
    async fn _controller_debuggees_breakpoints_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .controller()
            .debuggees_breakpoints_list(opt.value_of("debuggee-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "success-on-timeout" => {
                    call = call.success_on_timeout(
                        value
                            .map(|v| arg_from_str(v, err, "success-on-timeout", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "agent-id" => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(
                                    ["agent-id", "success-on-timeout", "wait-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _controller_debuggees_breakpoints_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "breakpoint.canary-expire-time" => Some((
                ...
                "breakpoint.is-final-state" => Some((
                ...
                "breakpoint.location.column" => Some((
                ...
                "breakpoint.log-message-format" => Some((
                ...
                "breakpoint.status.description.format" => Some((
                ...
                "breakpoint.status.description.parameters" => Some((
                ...
                "breakpoint.status.is-error" => Some((
                    "breakpoint.status.isError",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "breakpoint.status.refers-to" => Some((
                    "breakpoint.status.refersTo",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "breakpoint.user-email" => Some((
        ...
        let mut request: api::UpdateActiveBreakpointRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.controller().debuggees_breakpoints_update(
            request,
            opt.value_of("debuggee-id").unwrap_or(""),
    ...
    async fn _controller_debuggees_register(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "debuggee.agent-version" => Some((
                    "debuggee.agentVersion",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "debuggee.canary-mode" => Some((
                    "debuggee.canaryMode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "debuggee.status.description.format" => Some((
                    "debuggee.status.description.format",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "debuggee.status.description.parameters" => Some((
                    "debuggee.status.description.parameters",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "debuggee.status.is-error" => Some((
                    "debuggee.status.isError",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "debuggee.status.refers-to" => Some((
                    "debuggee.status.refersTo",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "debuggee.uniquifier" => Some((
                    "debuggee.uniquifier",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
        ...
        let mut request: api::RegisterDebuggeeRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _debugger_debuggees_breakpoints_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.debugger().debuggees_breakpoints_delete(
            opt.value_of("debuggee-id").unwrap_or(""),
            opt.value_of("breakpoint-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _debugger_debuggees_breakpoints_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.debugger().debuggees_breakpoints_get(
            opt.value_of("debuggee-id").unwrap_or(""),
            opt.value_of("breakpoint-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _debugger_debuggees_breakpoints_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            match key {
                ...
                "strip-results" => {
                    call = call.strip_results(
                        value
                            .map(|v| arg_from_str(v, err, "strip-results", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "include-inactive" => {
                ...
                "include-all-users" => {
                    call = call.include_all_users(
                        value
                            .map(|v| arg_from_str(v, err, "include-all-users", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "client-version" => {
    ...
    async fn _debugger_debuggees_breakpoints_set(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "status.description.format" => Some((
                ...
                "status.description.parameters" => Some((
        ...
        let mut request: api::Breakpoint = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .debugger()
            .debuggees_breakpoints_set(request, opt.value_of("debuggee-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _debugger_debuggees_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["client-version", "include-inactive", "project"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("controller", Some(opt)) => match opt.subcommand() {
                ("debuggees-breakpoints-list", Some(opt)) => {
                    call_result = self
                        ._controller_debuggees_breakpoints_list(opt, dry_run, &mut err)
                        .await;
                }
                ("debuggees-breakpoints-update", Some(opt)) => {
                    call_result = self
                        ._controller_debuggees_breakpoints_update(opt, dry_run, &mut err)
                        .await;
                }
                ("debuggees-register", Some(opt)) => {
                    call_result = self
                        ._controller_debuggees_register(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("controller".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("debugger", Some(opt)) => match opt.subcommand() {
                ("debuggees-breakpoints-delete", Some(opt)) => {
                    call_result = self
                        ._debugger_debuggees_breakpoints_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("debuggees-breakpoints-get", Some(opt)) => {
                    call_result = self
                        ._debugger_debuggees_breakpoints_get(opt, dry_run, &mut err)
                        .await;
                }
                ("debuggees-breakpoints-list", Some(opt)) => {
                    call_result = self
                        ._debugger_debuggees_breakpoints_list(opt, dry_run, &mut err)
                        .await;
                }
                ("debuggees-breakpoints-set", Some(opt)) => {
                    call_result = self
                        ._debugger_debuggees_breakpoints_set(opt, dry_run, &mut err)
                        .await;
                }
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("debugger".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "clouddebugger2-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/clouddebugger2", config_dir))
        .build()
        .await
        .unwrap();
