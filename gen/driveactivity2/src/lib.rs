...
//! This documentation was generated from *Drive Activity* crate version *8.0.0+20251028*, where *20251028* is the exact revision of the *driveactivity:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
