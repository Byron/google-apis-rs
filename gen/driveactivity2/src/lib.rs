...
//! This documentation was generated from *Drive Activity* crate version *6.0.0+20240623*, where *20240623* is the exact revision of the *driveactivity:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v6.0.0*.
//!
