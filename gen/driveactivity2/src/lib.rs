...
//! This documentation was generated from *Drive Activity* crate version *5.0.3+20230122*, where *20230122* is the exact revision of the *driveactivity:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.3*.
//! 
