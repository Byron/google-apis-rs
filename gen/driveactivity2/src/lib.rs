...
//! This documentation was generated from *Drive Activity* crate version *2.0.8+20210326*, where *20210326* is the exact revision of the *driveactivity:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.8*.
//! 
