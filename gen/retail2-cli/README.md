...
This documentation was generated from the *Cloud Retail* API at revision *20251218*. The CLI is at version *7.0.0*.
...
retail2 [options]
        projects
                ...
                locations-catalogs-generative-question-batch-update <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-catalogs-generative-questions-list <parent> [-p <v>]... [-o <out>]
                locations-catalogs-get-attributes-config <name> [-p <v>]... [-o <out>]
                locations-catalogs-get-completion-config <name> [-p <v>]... [-o <out>]
                locations-catalogs-get-conversational-search-customization-config <name> [-p <v>]... [-o <out>]
                locations-catalogs-get-default-branch <catalog> [-p <v>]... [-o <out>]
                locations-catalogs-get-generative-question-feature <catalog> [-p <v>]... [-o <out>]
                ...
                locations-catalogs-placements-conversational-search <placement> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-catalogs-serving-configs-conversational-search <placement> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-catalogs-update-conversational-search-customization-config <catalog> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-catalogs-update-generative-question <catalog> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-catalogs-update-generative-question-feature <catalog> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-catalogs-user-events-collect <parent> (-r <kv>)... [-p <v>]... [-o <out>]
