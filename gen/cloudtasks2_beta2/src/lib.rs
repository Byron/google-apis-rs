...
//! This documentation was generated from *Cloud Tasks* crate version *1.0.10+20190618*, where *20190618* is the exact revision of the *cloudtasks:v2beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.10*.
//! 
