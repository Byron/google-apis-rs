...
//! This documentation was generated from *Cloud Tasks* crate version *7.0.0+20251216*, where *20251216* is the exact revision of the *cloudtasks:v2beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
