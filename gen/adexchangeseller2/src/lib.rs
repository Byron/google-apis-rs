...
//! This documentation was generated from *Ad Exchange Seller* crate version *0.1.13+20151127*, where *20151127* is the exact revision of the *adexchangeseller:v2.0* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.13*.
//! 
