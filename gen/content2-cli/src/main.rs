...
use google_content2::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _accounts_claimwebsite(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().claimwebsite(
            ...
            .iter()
        {
            ...
            match key {
                "overwrite" => {
                    call = call.overwrite(
                        value
                            .map(|v| arg_from_str(v, err, "overwrite", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _accounts_custombatch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AccountsCustomBatchRequest =
    ...
    async fn _accounts_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().delete(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _accounts_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "business-information.address.country" => Some((
                ...
                "business-information.address.locality" => Some((
                ...
                "business-information.address.postal-code" => Some((
                ...
                "business-information.address.region" => Some((
                    "businessInformation.address.region",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "business-information.address.street-address" => Some((
                    "businessInformation.address.streetAddress",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "business-information.customer-service.email" => Some((
                    "businessInformation.customerService.email",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "business-information.customer-service.phone-number" => Some((
                    "businessInformation.customerService.phoneNumber",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "business-information.customer-service.url" => Some((
                    "businessInformation.customerService.url",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "business-information.korean-business-registration-number" => Some((
                    "businessInformation.koreanBusinessRegistrationNumber",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "business-information.phone-number" => Some((
                ...
                "google-my-business-link.gmb-email" => Some((
                ...
                "google-my-business-link.status" => Some((
                    "googleMyBusinessLink.status",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut call = self
            .hub
            .accounts()
            .insert(request, opt.value_of("merchant-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_link(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["action", "link-type", "linked-account-id"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::AccountsLinkRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.accounts().link(
            request,
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
    ...
    async fn _accounts_update(
        ...
        let mut request: api::Account = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.accounts().update(
            request,
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
    ...
    async fn _accountstatuses_custombatch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AccountstatusesCustomBatchRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _accountstatuses_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accountstatuses().get(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _accountstatuses_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["destinations", "max-results", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _accounttax_custombatch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AccounttaxCustomBatchRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _accounttax_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounttax().get(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _accounttax_update(
        ...
        let mut request: api::AccountTax = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.accounttax().update(
            request,
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
    ...
    async fn _datafeeds_custombatch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::DatafeedsCustomBatchRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _datafeeds_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.datafeeds().delete(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("datafeed-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _datafeeds_fetchnow(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.datafeeds().fetchnow(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("datafeed-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _datafeeds_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.datafeeds().get(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("datafeed-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _datafeeds_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "fetch-schedule.day-of-month" => Some((
                ...
                "fetch-schedule.minute-of-hour" => Some((
        ...
        let mut request: api::Datafeed = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .datafeeds()
            .insert(request, opt.value_of("merchant-id").unwrap_or(""));
    ...
    async fn _datafeeds_update(
        ...
        let mut request: api::Datafeed = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.datafeeds().update(
            request,
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("datafeed-id").unwrap_or(""),
        );
    ...
    async fn _datafeedstatuses_custombatch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::DatafeedstatusesCustomBatchRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _datafeedstatuses_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.datafeedstatuses().get(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("datafeed-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _datafeedstatuses_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _inventory_custombatch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::InventoryCustomBatchRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _inventory_set(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "installment.amount.currency" => Some((
                ...
                "loyalty-points.points-value" => Some((
                ...
                "sale-price-effective-date" => Some((
        ...
        let mut request: api::InventorySetRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.inventory().set(
            request,
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("store-code").unwrap_or(""),
    ...
    async fn _liasettings_custombatch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::LiasettingsCustomBatchRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _liasettings_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.liasettings().get(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _liasettings_getaccessiblegmbaccounts(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.liasettings().getaccessiblegmbaccounts(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _liasettings_listposdataproviders(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _liasettings_requestgmbaccess(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.liasettings().requestgmbaccess(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("gmb-email").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _liasettings_requestinventoryverification(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.liasettings().requestinventoryverification(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("country").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _liasettings_setinventoryverificationcontact(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.liasettings().setinventoryverificationcontact(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("country").unwrap_or(""),
            opt.value_of("language").unwrap_or(""),
            opt.value_of("contact-name").unwrap_or(""),
            opt.value_of("contact-email").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _liasettings_setposdataprovider(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.liasettings().setposdataprovider(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
            opt.value_of("country").unwrap_or(""),
        );
            ...
            .iter()
        {
            ...
            match key {
                ...
                "pos-data-provider-id" => {
                    call = call.pos_data_provider_id(
                        value
                            .map(|v| arg_from_str(v, err, "pos-data-provider-id", "uint64"))
                            .unwrap_or(0),
                    );
                }
                _ => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["pos-data-provider-id", "pos-external-account-id"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _liasettings_update(
        ...
        let mut request: api::LiaSettings = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.liasettings().update(
            request,
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
    ...
    async fn _orderreports_listdisbursements(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .orderreports()
            .listdisbursements(opt.value_of("merchant-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _orderreports_listtransactions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.orderreports().listtransactions(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("disbursement-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _orders_createtestorder(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "test-order.predefined-pickup-details" => Some((
                    "testOrder.predefinedPickupDetails",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
    ...
    async fn _pos_custombatch(
        ...
        let mut request: api::PosCustomBatchRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _pos_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.pos().delete(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("target-merchant-id").unwrap_or(""),
            opt.value_of("store-code").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
    ...
    async fn _pos_insert(
        ...
        let mut request: api::PosStore = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.pos().insert(
            request,
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("target-merchant-id").unwrap_or(""),
        );
    ...
    async fn _pos_inventory(
        ...
        let mut request: api::PosInventoryRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.pos().inventory(
            request,
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("target-merchant-id").unwrap_or(""),
        );
    ...
    async fn _pos_list(
        ...
        let mut call = self.hub.pos().list(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("target-merchant-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _pos_sale(
        ...
        let mut request: api::PosSaleRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.pos().sale(
            request,
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("target-merchant-id").unwrap_or(""),
        );
    ...
    async fn _products_custombatch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ProductsCustomBatchRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _products_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.products().delete(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _products_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "cost-of-goods-sold.currency" => Some((
                ...
                "max-energy-efficiency-class" => Some((
                ...
                "min-energy-efficiency-class" => Some((
                ...
                "shipping-height.value" => Some((
                    "shippingHeight.value",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                ...
                "shipping-length.value" => Some((
                    "shippingLength.value",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "shipping-weight.unit" => Some((
                    "shippingWeight.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "unit-pricing-base-measure.unit" => Some((
                ...
                "unit-pricing-base-measure.value" => Some((
                ...
                "unit-pricing-measure.unit" => Some((
                ...
                "unit-pricing-measure.value" => Some((
            ...
            .iter()
        {
            ...
            match key {
                ...
                "include-invalid-inserted-items" => {
                    call = call.include_invalid_inserted_items(
                        value
                            .map(|v| {
                                arg_from_str(v, err, "include-invalid-inserted-items", "boolean")
                            })
                            .unwrap_or(false),
                    );
                }
    ...
    async fn _productstatuses_custombatch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ProductstatusesCustomBatchRequest =
            serde_json::value::from_value(object).unwrap();
            ...
            .iter()
        {
            ...
            match key {
                "include-attributes" => {
                    call = call.include_attributes(
                        value
                            .map(|v| arg_from_str(v, err, "include-attributes", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _productstatuses_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.productstatuses().get(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _productstatuses_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _shippingsettings_custombatch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ShippingsettingsCustomBatchRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _shippingsettings_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.shippingsettings().get(
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _shippingsettings_getsupportedcarriers(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .shippingsettings()
            .getsupportedcarriers(opt.value_of("merchant-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _shippingsettings_getsupportedholidays(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .shippingsettings()
            .getsupportedholidays(opt.value_of("merchant-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _shippingsettings_getsupportedpickupservices(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .shippingsettings()
            .getsupportedpickupservices(opt.value_of("merchant-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _shippingsettings_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _shippingsettings_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ShippingSettings = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.shippingsettings().update(
            request,
            opt.value_of("merchant-id").unwrap_or(""),
            opt.value_of("account-id").unwrap_or(""),
        );
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ...
            ("accountstatuses", Some(opt)) => match opt.subcommand() {
                ("custombatch", Some(opt)) => {
                    call_result = self
                        ._accountstatuses_custombatch(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("accountstatuses".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("accounttax", Some(opt)) => match opt.subcommand() {
                ("custombatch", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("accounttax".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("datafeeds", Some(opt)) => match opt.subcommand() {
                ("custombatch", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("datafeeds".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("datafeedstatuses", Some(opt)) => match opt.subcommand() {
                ("custombatch", Some(opt)) => {
                    call_result = self
                        ._datafeedstatuses_custombatch(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("datafeedstatuses".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("inventory", Some(opt)) => match opt.subcommand() {
                ("custombatch", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("inventory".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("liasettings", Some(opt)) => match opt.subcommand() {
                ("custombatch", Some(opt)) => {
                ...
                ("getaccessiblegmbaccounts", Some(opt)) => {
                    call_result = self
                        ._liasettings_getaccessiblegmbaccounts(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                ...
                ("listposdataproviders", Some(opt)) => {
                    call_result = self
                        ._liasettings_listposdataproviders(opt, dry_run, &mut err)
                        .await;
                }
                ("requestgmbaccess", Some(opt)) => {
                    call_result = self
                        ._liasettings_requestgmbaccess(opt, dry_run, &mut err)
                        .await;
                }
                ("requestinventoryverification", Some(opt)) => {
                    call_result = self
                        ._liasettings_requestinventoryverification(opt, dry_run, &mut err)
                        .await;
                }
                ("setinventoryverificationcontact", Some(opt)) => {
                    call_result = self
                        ._liasettings_setinventoryverificationcontact(opt, dry_run, &mut err)
                        .await;
                }
                ("setposdataprovider", Some(opt)) => {
                    call_result = self
                        ._liasettings_setposdataprovider(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("liasettings".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("orderreports", Some(opt)) => match opt.subcommand() {
                ("listdisbursements", Some(opt)) => {
                    call_result = self
                        ._orderreports_listdisbursements(opt, dry_run, &mut err)
                        .await;
                }
                ("listtransactions", Some(opt)) => {
                    call_result = self
                        ._orderreports_listtransactions(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("orderreports".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("pos", Some(opt)) => match opt.subcommand() {
                ("custombatch", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("pos".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("productstatuses", Some(opt)) => match opt.subcommand() {
                ("custombatch", Some(opt)) => {
                    call_result = self
                        ._productstatuses_custombatch(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("productstatuses".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("shippingsettings", Some(opt)) => match opt.subcommand() {
                ("custombatch", Some(opt)) => {
                    call_result = self
                        ._shippingsettings_custombatch(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                ("getsupportedcarriers", Some(opt)) => {
                    call_result = self
                        ._shippingsettings_getsupportedcarriers(opt, dry_run, &mut err)
                        .await;
                }
                ("getsupportedholidays", Some(opt)) => {
                    call_result = self
                        ._shippingsettings_getsupportedholidays(opt, dry_run, &mut err)
                        .await;
                }
                ("getsupportedpickupservices", Some(opt)) => {
                    call_result = self
                        ._shippingsettings_getsupportedpickupservices(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("shippingsettings".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "content2-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/content2", config_dir))
        .build()
        .await
        .unwrap();
