...
impl<'n, 'a> Engine<'n, 'a> {
    ...
    fn _operations_cancel(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _operations_delete(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _variants_import(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _variantsets_create(&self, opt: &ArgMatches<'n, 'a>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
...
fn main() {
    ...
    let arg_data = [
        ("callsets", "methods: 'create', 'delete', 'get', 'patch' and 'search'", vec![
            ...
            ("search",  
                    Some(r##"Gets a list of call sets matching the criteria. Implements [GlobalAllianceApi.searchCallSets](https://github.com/ga4gh/schemas/blob/v0.5.1/src/main/resources/avro/variantmethods.avdl#L178)."##),
        ...
        ("readgroupsets", "methods: 'coveragebuckets-list', 'delete', 'export', 'get', 'import', 'patch' and 'search'", vec![
            ...
            ("export",  
                  ...
                  vec![
                    (Some(r##"read-group-set-id"##),
                     None,
                     Some(r##"Required. The ID of the read group set to export."##),
                     Some(true),
                     Some(false)),
            ...
            ("search",  
                    Some(r##"Searches for read group sets matching the criteria. Implements [GlobalAllianceApi.searchReadGroupSets](https://github.com/ga4gh/schemas/blob/v0.5.1/src/main/resources/avro/readmethods.avdl#L135)."##),
        ...
        ("references", "methods: 'bases-list', 'get' and 'search'", vec![
            ("bases-list",  
                    Some(r##"Lists the bases in a reference, optionally restricted to a range. Implements [GlobalAllianceApi.getReferenceBases](https://github.com/ga4gh/schemas/blob/v0.5.1/src/main/resources/avro/referencemethods.avdl#L221)."##),
            ...
            ("get",  
                    Some(r##"Gets a reference. Implements [GlobalAllianceApi.getReference](https://github.com/ga4gh/schemas/blob/v0.5.1/src/main/resources/avro/referencemethods.avdl#L158)."##),
            ...
            ("search",  
                    Some(r##"Searches for references which match the given criteria. Implements [GlobalAllianceApi.searchReferences](https://github.com/ga4gh/schemas/blob/v0.5.1/src/main/resources/avro/referencemethods.avdl#L146)."##),
        ...
        ("referencesets", "methods: 'get' and 'search'", vec![
            ("get",  
                    Some(r##"Gets a reference set. Implements [GlobalAllianceApi.getReferenceSet](https://github.com/ga4gh/schemas/blob/v0.5.1/src/main/resources/avro/referencemethods.avdl#L83)."##),
            ...
            ("search",  
                    Some(r##"Searches for reference sets which match the given criteria. Implements [GlobalAllianceApi.searchReferenceSets](http://ga4gh.org/documentation/api/v0.5.1/ga4gh_api.html#/schema/org.ga4gh.searchReferenceSets)."##),
        ...
        ("variants", "methods: 'create', 'delete', 'get', 'import', 'merge', 'patch' and 'search'", vec![
            ...
            ("patch",  
                    Some(r##"Updates a variant. This method supports patch semantics. Returns the modified variant without its calls."##),
            ...
            ("search",  
                    Some(r##"Gets a list of variants matching the criteria. Implements [GlobalAllianceApi.searchVariants](https://github.com/ga4gh/schemas/blob/v0.5.1/src/main/resources/avro/variantmethods.avdl#L126)."##),
        ...
        ("variantsets", "methods: 'create', 'delete', 'export', 'get', 'patch' and 'search'", vec![
            ...
            ("patch",  
                    Some(r##"Updates a variant set. This method supports patch semantics."##),
            ...
            ("search",  
                    Some(r##"Returns a list of all variant sets matching search criteria. Implements [GlobalAllianceApi.searchVariantSets](https://github.com/ga4gh/schemas/blob/v0.5.1/src/main/resources/avro/variantmethods.avdl#L49)."##),
