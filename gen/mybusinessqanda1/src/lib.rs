...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/mybusinessqanda1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](MyBusinessQ&A) ... 
//! 
//! * locations
//!  * [*questions answers list*](api::LocationQuestionAnswerListCall), [*questions answers upsert*](api::LocationQuestionAnswerUpsertCall), [*questions create*](api::LocationQuestionCreateCall), [*questions delete*](api::LocationQuestionDeleteCall), [*questions delete answers*](api::LocationQuestionDeleteAnswerCall), [*questions list*](api::LocationQuestionListCall) and [*questions patch*](api::LocationQuestionPatchCall)
//! 
//! 
//! 
//! 
