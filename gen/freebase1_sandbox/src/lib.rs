...
//! This documentation was generated from *freebase* crate version *0.1.4+20150330*, where *20150330* is the exact revision of the *freebase:v1sandbox* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.4*.
//! 
