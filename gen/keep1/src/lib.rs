...
//! This documentation was generated from *Keep* crate version *7.0.0+20251215*, where *20251215* is the exact revision of the *keep:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
//! Everything else about the *Keep* *v1* API can be found at the
//! [official documentation site](https://developers.google.com/workspace/keep/api).
