...
//! This documentation was generated from *networkconnectivity* crate version *7.0.0+20251125*, where *20251125* is the exact revision of the *networkconnectivity:v1alpha1* schema built by the [mako](http://www.makotemplates.org/) code generator *v7.0.0*.
//!
