...
//! This documentation was generated from *networkconnectivity* crate version *8.0.0+20251014*, where *20251014* is the exact revision of the *networkconnectivity:v1alpha1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
