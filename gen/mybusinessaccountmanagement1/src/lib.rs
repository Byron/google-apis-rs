...
//! This documentation was generated from *My Business Account Management* crate version *8.0.0+20251028*, where *20251028* is the exact revision of the *mybusinessaccountmanagement:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v8.0.0*.
//!
