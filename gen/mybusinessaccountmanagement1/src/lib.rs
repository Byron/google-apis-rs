...
//! This documentation was generated from *My Business Account Management* crate version *5.0.5+20240624*, where *20240624* is the exact revision of the *mybusinessaccountmanagement:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v5.0.5*.
//! 
