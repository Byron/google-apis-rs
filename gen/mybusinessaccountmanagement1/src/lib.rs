...
//! This documentation was generated from *My Business Account Management* crate version *2.0.4+20210330*, where *20210330* is the exact revision of the *mybusinessaccountmanagement:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v2.0.4*.
//! 
...
//! * locations
//!  * [*admins create*](api::LocationAdminCreateCall), [*admins delete*](api::LocationAdminDeleteCall), [*admins list*](api::LocationAdminListCall), [*admins patch*](api::LocationAdminPatchCall) and [*transfer location*](api::LocationTransferLocationCall)
//! 
//! 
//! 
//! 
