...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::Logging<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>
    >,
    gp: Vec<&'static str>,
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "update-time" => Some(("updateTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["create-time", "description", "lifecycle-state", "locked", "name", "retention-days", "update-time"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["page-size", "resource-names", "page-token"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
...
async fn main() {
    ...
    let arg_data = [
        ("billing-accounts", "methods: 'buckets-get', 'buckets-views-get', 'exclusions-create', 'exclusions-delete', 'exclusions-get', 'exclusions-list', 'exclusions-patch', 'locations-buckets-create', 'locations-buckets-delete', 'locations-buckets-list', 'locations-buckets-patch', 'locations-buckets-undelete', 'locations-buckets-views-create', 'locations-buckets-views-delete', 'locations-buckets-views-list', 'locations-buckets-views-patch', 'locations-get', 'locations-list', 'logs-delete', 'logs-list', 'sinks-create', 'sinks-delete', 'sinks-get', 'sinks-list', 'sinks-patch' and 'sinks-update'", vec![
            ("buckets-get",
                    Some(r##"Gets a bucket."##),
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_cli/billing-accounts_buckets-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the bucket: "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "organizations/[ORGANIZATION_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "billingAccounts/[BILLING_ACCOUNT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "folders/[FOLDER_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" Example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id"."##),
                     Some(true),
                     Some(false)),
            ...
            ("buckets-views-get",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the policy: "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]/views/[VIEW_ID]" Example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id/views/my-view-id"."##),
                     Some(true),
                     Some(false)),
            ...
            ("exclusions-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent resource in which to create the exclusion: "projects/[PROJECT_ID]" "organizations/[ORGANIZATION_ID]" "billingAccounts/[BILLING_ACCOUNT_ID]" "folders/[FOLDER_ID]" Examples: "projects/my-logging-project", "organizations/123456789"."##),
                     Some(true),
                     Some(false)),
            ...
            ("locations-buckets-create",
                    Some(r##"Creates a bucket that can be used to store log entries. Once a bucket has been created, the region cannot be changed."##),
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_cli/billing-accounts_locations-buckets-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The resource in which to create the bucket: "projects/[PROJECT_ID]/locations/[LOCATION_ID]" Example: "projects/my-logging-project/locations/global""##),
                     Some(true),
                     Some(false)),
            ...
            ("locations-buckets-delete",
                    Some(r##"Deletes a bucket. Moves the bucket to the DELETE_REQUESTED state. After 7 days, the bucket will be purged and all logs in the bucket will be permanently deleted."##),
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_cli/billing-accounts_locations-buckets-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full resource name of the bucket to delete. "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "organizations/[ORGANIZATION_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "billingAccounts/[BILLING_ACCOUNT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "folders/[FOLDER_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" Example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id"."##),
                     Some(true),
                     Some(false)),
            ...
            ("locations-buckets-patch",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full resource name of the bucket to update. "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "organizations/[ORGANIZATION_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "billingAccounts/[BILLING_ACCOUNT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "folders/[FOLDER_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" Example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id". Also requires permission "resourcemanager.projects.updateLiens" to set the locked property"##),
                     Some(true),
                     Some(false)),
            ...
            ("locations-buckets-undelete",
                    Some(r##"Undeletes a bucket. A bucket that has been deleted may be undeleted within the grace period of 7 days."##),
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_cli/billing-accounts_locations-buckets-undelete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full resource name of the bucket to undelete. "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "organizations/[ORGANIZATION_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "billingAccounts/[BILLING_ACCOUNT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" "folders/[FOLDER_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" Example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id"."##),
                     Some(true),
                     Some(false)),
            ...
            ("locations-buckets-views-create",
                    Some(r##"Creates a view over logs in a bucket. A bucket may contain a maximum of 50 views."##),
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_cli/billing-accounts_locations-buckets-views-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The bucket in which to create the view "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" Example: "projects/my-logging-project/locations/my-location/buckets/my-bucket""##),
                     Some(true),
                     Some(false)),
            ...
            ("locations-buckets-views-delete",
                    Some(r##"Deletes a view from a bucket."##),
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_cli/billing-accounts_locations-buckets-views-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full resource name of the view to delete: "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]/views/[VIEW_ID]" Example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id/views/my-view-id"."##),
                     Some(true),
                     Some(false)),
            ...
            ("locations-buckets-views-list",
                    Some(r##"Lists views on a bucket."##),
            ...
            ("locations-buckets-views-patch",
                    Some(r##"Updates a view. This method replaces the following fields in the existing view with values from the new view: filter."##),
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_cli/billing-accounts_locations-buckets-views-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full resource name of the view to update "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]/views/[VIEW_ID]" Example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id/views/my-view-id"."##),
                     Some(true),
                     Some(false)),
            ...
            ("sinks-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The resource in which to create the sink: "projects/[PROJECT_ID]" "organizations/[ORGANIZATION_ID]" "billingAccounts/[BILLING_ACCOUNT_ID]" "folders/[FOLDER_ID]" Examples: "projects/my-logging-project", "organizations/123456789"."##),
                     Some(true),
                     Some(false)),
            ...
            ("sinks-get",
                  ...
                  vec![
                    (Some(r##"sink-name"##),
                     None,
                     Some(r##"Required. The resource name of the sink: "projects/[PROJECT_ID]/sinks/[SINK_ID]" "organizations/[ORGANIZATION_ID]/sinks/[SINK_ID]" "billingAccounts/[BILLING_ACCOUNT_ID]/sinks/[SINK_ID]" "folders/[FOLDER_ID]/sinks/[SINK_ID]" Example: "projects/my-project-id/sinks/my-sink-id"."##),
                     Some(true),
                     Some(false)),
        ...
        ("entries", "methods: 'list', 'tail' and 'write'", vec![
            ("list",
            ...
            ("tail",
                    Some(r##"Streaming read of log entries as they are ingested. Until the stream is terminated, it will continue reading logs."##),
        ...
        ("folders", "methods: 'exclusions-create', 'exclusions-delete', 'exclusions-get', 'exclusions-list', 'exclusions-patch', 'locations-buckets-create', 'locations-buckets-delete', 'locations-buckets-get', 'locations-buckets-list', 'locations-buckets-patch', 'locations-buckets-undelete', 'locations-buckets-views-create', 'locations-buckets-views-delete', 'locations-buckets-views-get', 'locations-buckets-views-list', 'locations-buckets-views-patch', 'locations-get', 'locations-list', 'logs-delete', 'logs-list', 'sinks-create', 'sinks-delete', 'sinks-get', 'sinks-list', 'sinks-patch' and 'sinks-update'", vec![
            ("exclusions-create",
                    Some(r##"Creates a new exclusion in a specified parent resource. Only log entries belonging to that resource can be excluded. You can have up to 10 exclusions in a resource."##),
        ...
        ("locations", "methods: 'buckets-create', 'buckets-delete', 'buckets-get', 'buckets-list', 'buckets-patch', 'buckets-undelete', 'buckets-views-create', 'buckets-views-delete', 'buckets-views-get', 'buckets-views-list', 'buckets-views-patch', 'get' and 'list'", vec![
            ("buckets-create",
                    Some(r##"Creates a bucket that can be used to store log entries. Once a bucket has been created, the region cannot be changed."##),
        ...
        ("methods", "methods: 'get-cmek-settings' and 'update-cmek-settings'", vec![
            ...
            ("update-cmek-settings",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name for the CMEK settings to update. "projects/[PROJECT_ID]/cmekSettings" "organizations/[ORGANIZATION_ID]/cmekSettings" "billingAccounts/[BILLING_ACCOUNT_ID]/cmekSettings" "folders/[FOLDER_ID]/cmekSettings" Example: "organizations/12345/cmekSettings".Note: CMEK for the Logs Router can currently only be configured for GCP organizations. Once configured, it applies to all projects and folders in the GCP organization."##),
                     Some(true),
                     Some(false)),
        ...
        ("organizations", "methods: 'exclusions-create', 'exclusions-delete', 'exclusions-get', 'exclusions-list', 'exclusions-patch', 'get-cmek-settings', 'locations-buckets-create', 'locations-buckets-delete', 'locations-buckets-get', 'locations-buckets-list', 'locations-buckets-patch', 'locations-buckets-undelete', 'locations-buckets-views-create', 'locations-buckets-views-delete', 'locations-buckets-views-get', 'locations-buckets-views-list', 'locations-buckets-views-patch', 'locations-get', 'locations-list', 'logs-delete', 'logs-list', 'sinks-create', 'sinks-delete', 'sinks-get', 'sinks-list', 'sinks-patch', 'sinks-update' and 'update-cmek-settings'", vec![
            ("exclusions-create",
                    Some(r##"Creates a new exclusion in a specified parent resource. Only log entries belonging to that resource can be excluded. You can have up to 10 exclusions in a resource."##),
        ...
        ("projects", "methods: 'exclusions-create', 'exclusions-delete', 'exclusions-get', 'exclusions-list', 'exclusions-patch', 'locations-buckets-create', 'locations-buckets-delete', 'locations-buckets-get', 'locations-buckets-list', 'locations-buckets-patch', 'locations-buckets-undelete', 'locations-buckets-views-create', 'locations-buckets-views-delete', 'locations-buckets-views-get', 'locations-buckets-views-list', 'locations-buckets-views-patch', 'locations-get', 'locations-list', 'logs-delete', 'logs-list', 'metrics-create', 'metrics-delete', 'metrics-get', 'metrics-list', 'metrics-update', 'sinks-create', 'sinks-delete', 'sinks-get', 'sinks-list', 'sinks-patch' and 'sinks-update'", vec![
            ("exclusions-create",
                    Some(r##"Creates a new exclusion in a specified parent resource. Only log entries belonging to that resource can be excluded. You can have up to 10 exclusions in a resource."##),
