...
This documentation was generated from the *Logging* API at revision *20251202*. The CLI is at version *7.0.0*.
...
logging2 [options]
        billing-accounts
                ...
                locations-saved-queries-get <name> [-p <v>]... [-o <out>]
                locations-saved-queries-list <parent> [-p <v>]... [-o <out>]
                locations-saved-queries-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
        ...
        folders
                ...
                locations-get <name> [-p <v>]... [-o <out>]
                locations-list <name> [-p <v>]... [-o <out>]
                locations-log-scopes-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-log-scopes-delete <name> [-p <v>]... [-o <out>]
                locations-log-scopes-get <name> [-p <v>]... [-o <out>]
                locations-log-scopes-list <parent> [-p <v>]... [-o <out>]
                locations-log-scopes-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-operations-cancel <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-operations-get <name> [-p <v>]... [-o <out>]
                locations-operations-list <name> [-p <v>]... [-o <out>]
                locations-recent-queries-list <parent> [-p <v>]... [-o <out>]
