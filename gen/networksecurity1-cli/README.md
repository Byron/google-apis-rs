...
This documentation was generated from the *NetworkSecurity* API at revision *20251203*. The CLI is at version *7.0.0*.
...
networksecurity1 [options]
        ...
        projects
                ...
                locations-authz-policies-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-authz-policies-delete <name> [-p <v>]... [-o <out>]
                locations-authz-policies-get <name> [-p <v>]... [-o <out>]
                locations-authz-policies-get-iam-policy <resource> [-p <v>]... [-o <out>]
                locations-authz-policies-list <parent> [-p <v>]... [-o <out>]
                locations-authz-policies-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-authz-policies-set-iam-policy <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-authz-policies-test-iam-permissions <resource> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-backend-authentication-configs-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-backend-authentication-configs-delete <name> [-p <v>]... [-o <out>]
                locations-backend-authentication-configs-get <name> [-p <v>]... [-o <out>]
                locations-backend-authentication-configs-list <parent> [-p <v>]... [-o <out>]
                locations-backend-authentication-configs-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-dns-threat-detectors-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-dns-threat-detectors-delete <name> [-p <v>]... [-o <out>]
                locations-dns-threat-detectors-get <name> [-p <v>]... [-o <out>]
                locations-dns-threat-detectors-list <parent> [-p <v>]... [-o <out>]
                locations-dns-threat-detectors-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                locations-intercept-deployment-groups-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-intercept-deployment-groups-delete <name> [-p <v>]... [-o <out>]
                locations-intercept-deployment-groups-get <name> [-p <v>]... [-o <out>]
                locations-intercept-deployment-groups-list <parent> [-p <v>]... [-o <out>]
                locations-intercept-deployment-groups-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-intercept-deployments-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-intercept-deployments-delete <name> [-p <v>]... [-o <out>]
                locations-intercept-deployments-get <name> [-p <v>]... [-o <out>]
                locations-intercept-deployments-list <parent> [-p <v>]... [-o <out>]
                locations-intercept-deployments-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-intercept-endpoint-group-associations-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-intercept-endpoint-group-associations-delete <name> [-p <v>]... [-o <out>]
                locations-intercept-endpoint-group-associations-get <name> [-p <v>]... [-o <out>]
                locations-intercept-endpoint-group-associations-list <parent> [-p <v>]... [-o <out>]
                locations-intercept-endpoint-group-associations-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-intercept-endpoint-groups-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-intercept-endpoint-groups-delete <name> [-p <v>]... [-o <out>]
                locations-intercept-endpoint-groups-get <name> [-p <v>]... [-o <out>]
                locations-intercept-endpoint-groups-list <parent> [-p <v>]... [-o <out>]
                locations-intercept-endpoint-groups-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-list <name> [-p <v>]... [-o <out>]
                locations-mirroring-deployment-groups-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-mirroring-deployment-groups-delete <name> [-p <v>]... [-o <out>]
                locations-mirroring-deployment-groups-get <name> [-p <v>]... [-o <out>]
                locations-mirroring-deployment-groups-list <parent> [-p <v>]... [-o <out>]
                locations-mirroring-deployment-groups-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-mirroring-deployments-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-mirroring-deployments-delete <name> [-p <v>]... [-o <out>]
                locations-mirroring-deployments-get <name> [-p <v>]... [-o <out>]
                locations-mirroring-deployments-list <parent> [-p <v>]... [-o <out>]
                locations-mirroring-deployments-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-mirroring-endpoint-group-associations-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-mirroring-endpoint-group-associations-delete <name> [-p <v>]... [-o <out>]
                locations-mirroring-endpoint-group-associations-get <name> [-p <v>]... [-o <out>]
                locations-mirroring-endpoint-group-associations-list <parent> [-p <v>]... [-o <out>]
                locations-mirroring-endpoint-group-associations-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-mirroring-endpoint-groups-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-mirroring-endpoint-groups-delete <name> [-p <v>]... [-o <out>]
                locations-mirroring-endpoint-groups-get <name> [-p <v>]... [-o <out>]
                locations-mirroring-endpoint-groups-list <parent> [-p <v>]... [-o <out>]
                locations-mirroring-endpoint-groups-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-operations-cancel <name> (-r <kv>)... [-p <v>]... [-o <out>]
                locations-operations-delete <name> [-p <v>]... [-o <out>]
                locations-operations-get <name> [-p <v>]... [-o <out>]
                locations-operations-list <name> [-p <v>]... [-o <out>]
