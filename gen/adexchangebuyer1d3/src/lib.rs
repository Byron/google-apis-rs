...
//! This documentation was generated from *Ad Exchange Buyer* crate version *0.1.14+20160831*, where *20160831* is the exact revision of the *adexchangebuyer:v1.3* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.14*.
//! 
